...
class TestRoleAndScopeAccess:
    ...
    - Users of each role can confirm their authentication status via verify_auth
    ...
    async def test_superadmin_can_verify_auth(
        ...
        This confirms HMAC signature-based authentication works correctly."""
    ...
    async def test_regular_user_can_verify_auth(
        ...
        This confirms authentication is valid with a regular user's keypair."""
