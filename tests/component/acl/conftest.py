...
@asynccontextmanager
async def _acl_domain_ctx(root_ctx: RootContext) -> AsyncIterator[None]:
    """Set up repositories and processors for ACL-domain component tests.
...
def server_cleanup_contexts() -> list[CleanupContext]:
    """Provide cleanup contexts for ACL-domain component tests.
    ...
    - _acl_domain_ctx: repositories and processors wired with real clients
    """
    return [
        redis_ctx,
        database_ctx,
