...
from ai.backend.manager.api.rest.etcd.registry import register_etcd_module
from ai.backend.manager.api.rest.resource.registry import register_resource_module
...
def server_module_registrars() -> list[ModuleRegistrar]:
    ...
    return [register_auth_module, register_etcd_module, register_resource_module]
