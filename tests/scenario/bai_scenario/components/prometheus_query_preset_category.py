...
A category is a name presets are filed under, in the same global catalog. The presets
pointing at one are laid by the preset table; this one lays categories and a caller.
"""
