...
def _context(
    ...
    *,
    ...
    # Read by the scratch handover before it decides there is nothing to hand over: with no
    # overriding identity and no uid-match feature, these keep it a no-op here.
    ctx.uid = None
    ctx.main_gid = None
    return ctx
