...
async def test_request_id_middleware_with_custom_request_id(aiohttp_client) -> None:
...
async def test_request_id_middleware_without_request_id(aiohttp_client) -> None:
    async def test_handler(request: web.Request) -> web.Response:
