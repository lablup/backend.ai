...
class TestDevInventoryBuilder:
    ...
    @pytest.fixture()
    def inventory(self, builder: DevInventoryBuilder) -> dict[str, Any]:
        return builder.build()

    def test_build_returns_dict(self, inventory: dict[str, Any]) -> None:
        assert isinstance(inventory, dict)

    def test_node_groups_present(self, inventory: dict[str, Any]) -> None:
        expected_groups = [
            "mgmt",
            "compute",
            "agent",
    ...
    def test_mgmt_has_one_local_node(self, inventory: dict[str, Any]) -> None:
        mgmt = inventory["mgmt"]
        assert len(mgmt) == 1
        host, data = mgmt[0]
        assert host == "@local"
    ...
    def test_compute_is_empty(self, inventory: dict[str, Any]) -> None:
        assert inventory["compute"] == []
        assert inventory["agent"] == []

    def test_host_data_has_required_keys(self, inventory: dict[str, Any]) -> None:
    ...
    def test_services_dict_has_all_services(self, inventory: dict[str, Any]) -> None:
        _, data = inventory["mgmt"][0]
    ...
    def test_service_types(self, inventory: dict[str, Any]) -> None:
        _, data = inventory["mgmt"][0]
        services = data["services"]
    ...
    def test_enterprise_stubs_disabled(self, inventory: dict[str, Any]) -> None:
        _, data = inventory["mgmt"][0]
        services = data["services"]
    ...
    def test_ports_match_halfstack(self, inventory: dict[str, Any]) -> None:
        _, data = inventory["mgmt"][0]
        services = data["services"]
    ...
    def test_appproxy_ports(self, inventory: dict[str, Any]) -> None:
        _, data = inventory["mgmt"][0]
    ...
    def test_credentials_from_shared_defaults(self, inventory: dict[str, Any]) -> None:
        _, data = inventory["mgmt"][0]
        services = data["services"]
    ...
    def test_config_objects_in_inventory(self, inventory: dict[str, Any]) -> None:
        config_keys = [
            "postgresConfig",
            "redisConfig",
            "etcdConfig",
    ...
    def test_default_versions_in_host_data(self, inventory: dict[str, Any]) -> None:
        _, data = inventory["mgmt"][0]
