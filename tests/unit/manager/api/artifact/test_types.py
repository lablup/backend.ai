...
from ai.backend.manager.api.gql.artifact.types import (
    ImportArtifactsInput,
)


class TestArtifactTypes:
    """Tests for artifact GraphQL types."""

    def test_import_artifacts_input_options_defaults_to_none(self) -> None:
