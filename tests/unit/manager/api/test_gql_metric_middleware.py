"""Tests for GQLMetricMiddleware async resolver timing fix."""
...
class TestGQLMetricMiddlewareAsyncResolver:
    ...
    async def test_async_resolver_returns_coroutine_for_batching(
        self,
        middleware: GQLMetricMiddleware,
        resolve_info: MagicMock,
        metric_observer: MagicMock,
        ...
        result = middleware.resolve(async_resolver, None, resolve_info)
