"""The legacy user GraphQL types filter by the main keypair marker.
...
from ai.backend.manager.api.gql_legacy.user import User, UserNode
...
class _SpecCase:
    """A filter spec set together with the statement the loader applies it to."""
