"""
Tests for UpdateFairShareSpecAction in ResourceGroupService.
...
@pytest.fixture
def service(mock_repository: MagicMock) -> ResourceGroupService:
...
def _create_scaling_group(
    ...
    scheduler_options = ResourceGroupSchedulerOptions(
    ...
    return ResourceGroupData(
        ...
        metadata=ResourceGroupMetadata(description="Test", created_at=datetime.now(tz=UTC)),
        ...
        scheduler=ResourceGroupSchedulerConfig(name=SchedulerType.FIFO, options=scheduler_options),
...
class TestValidation:
    ...
    @pytest.fixture
    def existing_scaling_group_with_cpu(self) -> ResourceGroupData:
    ...
    async def test_v1_valid_resource_type_succeeds(
        ...
        existing_scaling_group_with_cpu: ResourceGroupData,
...
class TestFiltering:
    ...
    @pytest.fixture
    def existing_scaling_group_cpu_cuda(self) -> ResourceGroupData:
    ...
    async def test_f1_filters_types_not_in_capacity(
        ...
        service: ResourceGroupService,
        mock_repository: MagicMock,
        existing_scaling_group_cpu_cuda: ResourceGroupData,
    ...
    @pytest.fixture
    def existing_scaling_group_cpu_mem(self) -> ResourceGroupData:
    ...
    async def test_f2_keeps_all_types_in_capacity(
        ...
        service: ResourceGroupService,
        mock_repository: MagicMock,
        existing_scaling_group_cpu_mem: ResourceGroupData,
        capacity_cpu_mem_cuda: ResourceInfo,
        action_update_half_life: UpdateFairShareSpecAction,
    ) -> None:
        mock_repository.get_scaling_group_by_name = AsyncMock(
...
class TestMerge:
    ...
    @pytest.fixture
    def existing_scaling_group_cpu_only(self) -> ResourceGroupData:
        return _create_scaling_group(ResourceSlot({"cpu": Decimal("1.0")}))
    ...
    async def test_m1_adds_new_resource_type(
        ...
        service: ResourceGroupService,
        mock_repository: MagicMock,
        existing_scaling_group_cpu_only: ResourceGroupData,
...
class TestEdgeCases:
    ...
    @pytest.fixture
    def existing_scaling_group_cpu(self) -> ResourceGroupData:
        return _create_scaling_group(ResourceSlot({"cpu": Decimal("1.0")}))
    ...
    async def test_e2_empty_list_preserves_weights(
        ...
        service: ResourceGroupService,
        mock_repository: MagicMock,
        existing_scaling_group_cpu: ResourceGroupData,
