...
class TestMountNameValidationRule:
    ...
    def test_valid_mount_names(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_duplicate_alias_names(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_empty_alias_name(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_reserved_folder_names(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_alias_same_as_original_folder(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_work_directory_prefix_handling(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_combined_mount_maps(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_duplicate_across_maps(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_none_alias_values(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_special_characters_in_names(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_large_mount_map(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
    ...
    def test_unicode_names(self, mount_rule: MountNameValidationRule, basic_context: SessionCreationContext) -> None:
