...
class TestResourceInfo:
    ...
    @pytest.fixture
    async def resource_group_with_alive_schedulable_agents(
        self,
        db_with_cleanup: ExtendedAsyncSAEngine,
    ...
    @pytest.fixture
    async def resource_group_with_mixed_agent_statuses(
        self,
        db_with_cleanup: ExtendedAsyncSAEngine,
        base_scaling_group: str,
        base_scaling_group_id: ResourceGroupID,
    ...
    @pytest.fixture
    async def resource_group_with_non_schedulable_agents(
        self,
        db_with_cleanup: ExtendedAsyncSAEngine,
        base_scaling_group: str,
        base_scaling_group_id: ResourceGroupID,
    ...
    @pytest.fixture
    async def resource_group_with_running_kernels(
        self,
        db_with_cleanup: ExtendedAsyncSAEngine,
        base_scaling_group: str,
        base_scaling_group_id: ResourceGroupID,
    ...
    @pytest.fixture
    async def resource_group_with_mixed_kernel_statuses(
        self,
        db_with_cleanup: ExtendedAsyncSAEngine,
        base_scaling_group: str,
        base_scaling_group_id: ResourceGroupID,
    ...
    async def test_capacity_sums_alive_schedulable_agents(
        self,
        db_source: ResourceGroupDBSource,
        resource_group_with_alive_schedulable_agents: tuple[str, list[ResourceSlot]],
    ) -> None:
        """Capacity should sum capacity from agent_resources for ALIVE, schedulable agents."""
        resource_group, agent_slots = resource_group_with_alive_schedulable_agents

        result = await db_source.get_resource_info(resource_group)
    ...
    async def test_excludes_not_alive_agents(
        self,
        db_source: ResourceGroupDBSource,
        resource_group_with_mixed_agent_statuses: tuple[str, ResourceSlot],
    ) -> None:
        """Capacity should only include ALIVE agents, excluding LOST/TERMINATED."""
        resource_group, expected_capacity = resource_group_with_mixed_agent_statuses
    ...
    async def test_excludes_non_schedulable_agents(
        self,
        db_source: ResourceGroupDBSource,
        resource_group_with_non_schedulable_agents: tuple[str, ResourceSlot],
    ) -> None:
        """Capacity should only include schedulable agents."""
        resource_group, expected_capacity = resource_group_with_non_schedulable_agents
    ...
    async def test_used_sums_from_agent_resources(
        self,
        db_source: ResourceGroupDBSource,
        resource_group_with_running_kernels: tuple[str, ResourceSlot, list[ResourceSlot]],
    ) -> None:
        """Used should sum agent_resources.used from ALIVE agents."""
        resource_group, _, kernel_slots = resource_group_with_running_kernels
    ...
    async def test_used_reflects_agent_resources(
        self,
        db_source: ResourceGroupDBSource,
        resource_group_with_mixed_kernel_statuses: tuple[str, ResourceSlot, ResourceSlot],
    ) -> None:
        """Used should reflect agent_resources.used values."""
        resource_group, _, expected_used = resource_group_with_mixed_kernel_statuses
    ...
    async def test_free_equals_capacity_minus_used(
        ...
        resource_group, agent_capacity, kernel_slots = resource_group_with_running_kernels
