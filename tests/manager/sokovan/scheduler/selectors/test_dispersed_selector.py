        ...
        agents = [
            create_agent_info(
                ...
                occupied_slots=ResourceSlot({
                    SlotName("cpu"): Decimal("6"),
                    SlotName("mem"): Decimal("12288"),
                }),
            ),
            create_agent_info(
    ...
    def test_handles_mixed_resource_types(
        ...
        agents = [
            ...
            create_agent_info(
                agent_id="cpu-agent",
                available_slots=ResourceSlot({
                    SlotName("cpu"): Decimal("32"),
                    SlotName("mem"): Decimal("65536"),
                }),
                occupied_slots=ResourceSlot({
                    SlotName("cpu"): Decimal("16"),
                    SlotName("mem"): Decimal("32768"),
    ...
    def test_dispersed_opposite_of_concentrated(
        ...
        agents = [
            create_agent_info(
                ...
                occupied_slots=ResourceSlot({
                    SlotName("cpu"): Decimal("7"),
                    SlotName("mem"): Decimal("14336"),
                }),
            ),
            create_agent_info(
                agent_id="agent-2",
