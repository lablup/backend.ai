...
class TestSessionLifecycle:
    async def test_session_read_and_update_lifecycle(
        ...
        # 1. get_info
        info_result = await admin_registry.session.get_info(session_seed.session_id)
        ...
        renamed_result = await admin_registry.session.get_info(session_seed.session_id)
        ...
        # 5. status_history
        history_result = await admin_registry.session.get_status_history(session_seed.session_id)
