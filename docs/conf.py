...
# Expose the current Backend.AI client API version as the |bai_api_version|
...
# The `bai_` prefix keeps the global substitution from colliding with the
# plain `api_version` that already appears in docs as a session-template
...
bai_api_version = _read_api_version()
rst_prolog = f"""
.. |bai_api_version| replace:: {bai_api_version}
"""
