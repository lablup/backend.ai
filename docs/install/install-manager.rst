...
.. list-table::
   ...
   * - ``{S3AKEY}``
     - The access key for AWS S3 or compatible services\ :raw-html-m2r:`<sup><a href="#fn1">[1]</a></sup>`
   * - ``{S3SKEY}``
...
:raw-html-m2r:`<b name="fn1"><sup>\[1\]</sup></b>` AWS S3 is used to store the output files generated by the user code in kernels' ``/home/work/.output`` directory.
