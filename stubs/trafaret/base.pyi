...
class Trafaret(metaclass=TrafaretMeta):
    ...
    def _failure(self, error: Optional[str] = None, value: _Any = ...) -> NoReturn: ...
...
class OnError(Trafaret):
    def __init__(self, trafaret: Trafaret, message: str, code: Optional[str] = None) -> None: ...
    def transform(self, value: _Any, context: Optional[_Any] = None): ...
