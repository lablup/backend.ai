...
**This file archives the releases up to 26.3.0.** Every release from 26.4 onward
lives under [`CHANGELOG/`](CHANGELOG/):

| Looking for | Go to |
|---|---|
| Which version a feature landed in | [`CHANGELOG/README.md`](CHANGELOG/README.md) |
| The full changelog of a version branch | [`CHANGELOG/`](CHANGELOG/) — one file per version branch, holding every release of that branch (`26.4.0`, `26.4.1`, ..., `26.4.9`) |
