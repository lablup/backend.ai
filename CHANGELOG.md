...
### Miscellaneous
* Upgrade the base CPython version from 3.12.6 to 3.12.8 ([#3302](https://github.com/lablup/backend.ai/issues/3302))## 24.09.0b1 (2024-09-30)
...
* Bring back etcetra-backed Etcd as an option for distributed lock backend ([#2079](https://github.com/lablup/backend.ai/issues/2079))
...
* Shutdown agent properly by removing a code that waits a canceled task. ([#2392](https://github.com/lablup/backend.ai/issues/2392))
...
* Add the minimum page size check when paginating in the client CLI ([#1465](https://github.com/lablup/backend.ai/issues/1465))
