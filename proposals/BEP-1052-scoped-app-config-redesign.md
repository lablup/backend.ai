...
- **`MyAppConfig.id`**: the implementation encodes the
...
For the merged view, use `myAppConfigs` (returns `MyAppConfig`) —
see §5.
...
**merged view** (`MyAppConfig`) — different from the raw USER rows
