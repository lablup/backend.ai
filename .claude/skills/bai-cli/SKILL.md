...
- **scheduling-history**: sub session / kernel / deployment / route — each (search, search-scoped) · sub replica-group — search · search-scoped takes exactly one of `--deployment-id` / `--replica-group-id`
