#!/usr/bin/env python3
"""Get deployment status and details (GraphQL version)."""
import json
import requests
...
# NOTE: deployment query requires a relay Global ID (base64-encoded), not a raw UUID.
# e.g. "TW9kZWxEZXBsb3ltZW50OjEyMzQ1Njc4LTEyMzQtMTIzNC0xMjM0LTEyMzQ1Njc4OTBhYg=="
