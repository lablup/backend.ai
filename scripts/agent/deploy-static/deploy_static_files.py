...
STATIC_FILE = (
    "https://backend-ai-k8s-agent-static.s3.ap-northeast-2.amazonaws.com/bai-static.tar.gz"
)
...
for ip in sys.argv[1:]:
    ...
    stdin, stdout, stderr = ssh.exec_command(
        f"wget https://backend-ai-k8s-agent-static.s3.ap-northeast-2.amazonaws.com/bai-static.tar.gz && tar xvf {pwd}/bai-static.tar.gz && sudo mv {pwd}/backend.ai /opt && sudo chown {whoami}:{whoami} /opt/backend.ai"
    )
