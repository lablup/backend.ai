...
$docker_sudo docker pull lablup/python-tensorflow:1.15-py36
$docker_sudo docker pull lablup/python-pytorch:1.4-py36
if [ $ENABLE_CUDA -eq 1 ]; then
    $docker_sudo docker pull lablup/python-tensorflow:1.15-py36-cuda9
    $docker_sudo docker pull lablup/python-pytorch:1.4-py36-cuda10
    $docker_sudo docker pull lablup/ngc-digits:19.11-tensorflow
    $docker_sudo docker pull lablup/ngc-pytorch:19.11-py3
    $docker_sudo docker pull lablup/ngc-tensorflow:19.11-py3
fi
...
echo " "
TE}export BACKEND_ACCESS_KEY=AKIAIOSFODNN7EXAMPLE${NC}"
echo "> ${WHITE}export BACKEND_SECRET_KEY=wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY${NC}"
echo " "
echo "Please add these environment variables to your shell configuration files."
show_important_note "You should change your default admin API keypairs for production environment!"
