import{B as i,d as e,I as t,b as s,k as n,f as a,i as o,y as l,t as d,g as r,_ as c,e as v,a as p}from"./backend-ai-webui-4aa407c2.js";import{t as u}from"./translate-unsafe-html-4b1a4468.js";import"./lablup-activity-panel-88f99595.js";let h=class extends i{constructor(){super(...arguments),this.notification=Object(),this.manager_version="",this.manager_version_latest="",this.webui_version="",this.api_version="",this.docker_version="",this.pgsql_version="",this.redis_version="",this.etcd_version="",this.license_valid=!1,this.license_type="",this.license_licensee="",this.license_key="",this.license_expiration="",this.account_changed=!0,this.use_ssl=!0}static get styles(){return[e,t,s,n,a,o`
        div.indicator,
        span.indicator {
          font-size: 9px;
          margin-right: 5px;
    ...
    `}firstUpdated(){this.notification=globalThis.lablupNotification,void 0===globalThis.backendaiclient||null===globalThis.backendaiclient?document.addEventListener("backend-ai-connected",(()=>{this.updateInformation()}),!0):this.updateInformation()}async _viewStateChanged(i){await this.updateComplete}_updateLicenseInfo(){globalThis.backendaiclient.enterprise.getLicense().then((i=>{this.license_valid=i.valid,this.license_type=i.type,this.license_licensee=i.licensee,this.license_key=i.licenseKey,this.license_expiration=i.expiration})).catch((i=>{this.license_valid=!1,this.license_type=r("information.CannotRead"),this.license_licensee=r("information.CannotRead"),this.license_key=r("information.CannotRead"),this.license_expiration=r("information.CannotRead")}))}updateInformation(){this.manager_version=globalThis.backendaiclient.managerVersion,this.webui_version=globalThis.packageVersion,this.api_version=globalThis.backendaiclient.apiVersion,this.docker_version=r("information.Compatible"),this.pgsql_version=r("information.Compatible"),this.redis_version=r("information.Compatible"),this.etcd_version=r("information.Compatible"),void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._updateLicenseInfo()}),!0):this._updateLicenseInfo(),globalThis.backendaiclient._config.endpoint.startsWith("https:")?this.use_ssl=!0:this.use_ssl=!1}};c([v({type:Object})],h.prototype,"notification",void 0),c([v({type:String})],h.prototype,"manager_version",void 0),c([v({type:String})],h.prototype,"manager_version_latest",void 0),c([v({type:String})],h.prototype,"webui_version",void 0),c([v({type:String})],h.prototype,"api_version",void 0),c([v({type:String})],h.prototype,"docker_version",void 0),c([v({type:String})],h.prototype,"pgsql_version",void 0),c([v({type:String})],h.prototype,"redis_version",void 0),c([v({type:String})],h.prototype,"etcd_version",void 0),c([v({type:Boolean})],h.prototype,"license_valid",void 0),c([v({type:String})],h.prototype,"license_type",void 0),c([v({type:String})],h.prototype,"license_licensee",void 0),c([v({type:String})],h.prototype,"license_key",void 0),c([v({type:String})],h.prototype,"license_expiration",void 0),c([v({type:Boolean})],h.prototype,"account_changed",void 0),c([v({type:Boolean})],h.prototype,"use_ssl",void 0),h=c([p("backend-ai-information-view")],h);var g=h;export{g as default};
