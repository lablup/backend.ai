import{_ as e,e as t,c as i,a as s,B as a,d as o,I as r,b as l,i as n,h as d,Z as c,y as u,t as p,g as h,a1 as g,a2 as v,L as m}from"./backend-ai-webui-ab578ea5.js";import"./mwc-tab-bar-49a4eacc.js";import"./lablup-activity-panel-6b88454f.js";import"./vaadin-grid-f8664f17.js";import"./vaadin-grid-sort-column-ae65cab0.js";import"./lablup-progress-bar-25f67c3a.js";import"./backend-ai-list-status-c05abf3d.js";import"./backend-ai-storage-host-settings-view-6c17195f.js";import"./vaadin-item-4ab5696f.js";import"./label-dd1fb8bb.js";import"./select-9993aa3a.js";import"./switch-d2f58a6c.js";import"./backend-ai-multi-select-66dcf92b.js";import"./textfield-a1aae808.js";import"./mwc-switch-89803115.js";import"./dir-utils-1d3affeb.js";import"./vaadin-item-mixin-c0aca504.js";import"./mwc-check-list-item-dda66b12.js";
/**
 @license
 Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
 */var b;let _=b=class extends a{constructor(){super(...arguments),this._enableAgentSchedulable=!1,this.condition="running",this.list_condition="loading",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.enableAgentSchedulable=!1,this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundUtilizationRenderer=this.utilizationRenderer.bind(this),this._boundDiskRenderer=this.diskRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
          ...
          `}
            ...
            <div>
              ...
              <div class="layout horizontal justified flex progress-bar-section">
                ...
                <lablup-progress-bar class="utilization" progress="${t.mem_util.ratio}" description="${b.bytesToGiB(t.mem_util.current)}/${b.bytesToGiB(t.mem_util.capacity)} GiB"></lablup-progress-bar>
              </div>
              ${t.cuda_util?u`
                <div class="layout horizontal justified flex progress-bar-section">
                ...
                <div class="layout horizontal justified flex progress-bar-section">
                  ...
                  <lablup-progress-bar class="utilization" progress="${(null===(n=t.cuda_mem)||void 0===n?void 0:n.ratio)||0}" description="${b.bytesToGiB(null===(d=t.cuda_mem)||void 0===d?void 0:d.current)}/${b.bytesToGiB(null===(h=t.cuda_mem)||void 0===h?void 0:h.capacity)} GiB"></lablup-progress-bar>
                </div>
              `:u``}
            </div>
              ...
              <div class="vertical layout start-justified flex">
                ...
                ${(null===(i=null===(t=this.agentDetail)||void 0===t?void 0:t.live_stat)||void 0===i?void 0:i.node)?u`
                  <div class="horizontal layout justified" style="width:100px;">
                    <span>TX: </span>
                    <span>${b.bytesToMB(this.agentDetail.live_stat.node.net_tx.current)}MiB</span>
                  </div>
                  <div class="horizontal layout justified flex" style="width:100px;">
                    <span>RX: </span>
                    <span>${b.bytesToMB(this.agentDetail.live_stat.node.net_rx.current)}MiB</span>
                  </div>
                `:u`
 ...
 */
let x=class extends a{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.allowedSessionTypes=["interactive","batch","inference"],this.enableSchedulerOpts=!1,this.enableWSProxyAddr=!1,this.functionCount=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.resourceGroups=[],this.resourceGroupInfo={},this.domains=[]}static get styles(){return[o,r,l,n`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
    ...
    `}};e([t({type:Object})],x.prototype,"_boundControlRenderer",void 0),e([t({type:Array})],x.prototype,"domains",void 0),e([t({type:Object})],x.prototype,"resourceGroupInfo",void 0),e([t({type:Array})],x.prototype,"resourceGroups",void 0),e([t({type:Array})],x.prototype,"schedulerTypes",void 0),e([t({type:Object})],x.prototype,"schedulerOpts",void 0),e([m()],x.prototype,"allowedSessionTypes",void 0),e([t({type:Boolean})],x.prototype,"enableSchedulerOpts",void 0),e([t({type:Boolean})],x.prototype,"enableWSProxyAddr",void 0),e([t({type:Number})],x.prototype,"functionCount",void 0),e([i("#resource-group-name")],x.prototype,"resourceGroupNameInput",void 0),e([i("#resource-group-description")],x.prototype,"resourceGroupDescriptionInput",void 0),e([i("#resource-group-domain")],x.prototype,"resourceGroupDomainSelect",void 0),e([i("#resource-group-scheduler")],x.prototype,"resourceGroupSchedulerSelect",void 0),e([i("#resource-group-active")],x.prototype,"resourceGroupActiveSwitch",void 0),e([i("#resource-group-wsproxy-address")],x.prototype,"resourceGroupWSProxyaddressInput",void 0),e([i("#allowed-session-types")],x.prototype,"allowedSessionTypesSelect",void 0),e([i("#num-retries-to-skip")],x.prototype,"numberOfRetriesToSkip",void 0),e([i("#pending-timeout")],x.prototype,"timeoutInput",void 0),e([i("#delete-resource-group")],x.prototype,"deleteResourceGroupInput",void 0),x=e([s("backend-ai-resource-group-list")],x);
/**
 @license
 Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
 */
let w=class extends a{constructor(){super(...arguments),this._status="inactive",this._tab="running-lists",this.enableStorageProxy=!1}static get styles(){return[o,n`
    ...
    `}};e([m()],w.prototype,"_status",void 0),e([m()],w.prototype,"_tab",void 0),e([m()],w.prototype,"enableStorageProxy",void 0),w=e([s("backend-ai-agent-view")],w);var $=w;export{$ as default};
