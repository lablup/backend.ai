import{_ as e,b as t,n as i,u as o,e as s,s as a,c as l,I as r,a2 as d,a as n,m as c,d as m,i as p,x as h}from"./backend-ai-webui-8aa3adc0.js";import"./lablup-expansion-5c02cbff.js";
/**
 @license
 Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
 */var u;let v=u=class extends a{constructor(){super(),this.label="",this.validationMessage="",this.enableClearButton=!1,this.openUp=!1,this.required=!1,this._valid=!0,this.selectedItemList=[],this.items=[]}static get styles(){return[l,r,d,n,c,m,p`
        lablup-shields {
          margin: 1px;
        }
    ...
    `}};v.DEFAULT_ITEM_HEIGHT=56,v.DEFAULT_ITEM_MARGIN=25,e([t("#list")],v.prototype,"comboBox",void 0),e([t("#menu",!0)],v.prototype,"menu",void 0),e([t("#dropdown-icon",!0)],v.prototype,"dropdownIcon",void 0),e([i({type:Array})],v.prototype,"selectedItemList",void 0),e([i({type:Array})],v.prototype,"items",void 0),e([i({type:String,attribute:"label"})],v.prototype,"label",void 0),e([i({type:String,attribute:"validation-message"})],v.prototype,"validationMessage",void 0),e([i({type:Boolean,attribute:"enable-clear-button"})],v.prototype,"enableClearButton",void 0),e([i({type:Boolean,attribute:"open-up"})],v.prototype,"openUp",void 0),e([i({type:Boolean,attribute:"required"})],v.prototype,"required",void 0),e([o()],v.prototype,"_valid",void 0),v=u=e([s("backend-ai-multi-select")],v);
