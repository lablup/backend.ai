import{_ as e,c as t,e as s,bo as i,y as c,K as h,i as a,bp as o,a as r}from"./backend-ai-webui-ab578ea5.js";
/**
 * @license
 ...
 * SPDX-LIcense-Identifier: Apache-2.0
 */
const p=a`:host(:not([twoline])){height:56px}:host(:not([left])) .mdc-deprecated-list-item__meta{height:40px;width:40px}`
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let l=class extends d{};l.styles=[o,p],l=e([r("mwc-check-list-item")],l);
