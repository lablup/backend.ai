import{_ as t,e,c as s,a as i,B as a,d as o,I as r,b as n,i as l,h as d,Z as c,y as p,t as u,g}from"./backend-ai-webui-a4c9279e.js";import"./mwc-tab-bar-55d02322.js";import"./lablup-activity-panel-9e249bcf.js";import"./backend-ai-list-status-81daf06e.js";import"./vaadin-grid-9c1f3abc.js";import"./vaadin-grid-sort-column-59e1f7ac.js";import"./lablup-progress-bar-eb5b8018.js";import"./mwc-switch-4bc9d980.js";import"./dir-utils-454ec8ed.js";
/**
 @license
    ...
    `]}firstUpdated(){var t;this.notification=globalThis.lablupNotification,this.agentDetailDialog=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#agent-detail")}connectedCallback(){super.connectedCallback()}async _viewStateChanged(t){await this.updateComplete,!1!==t&&(void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._enableAgentSchedulable=globalThis.backendaiclient.supports("schedulable"),this._loadAgentList()}),!0):(this._enableAgentSchedulable=globalThis.backendaiclient.supports("schedulable"),this._loadAgentList()))}_loadAgentList(){var t;if(!0!==this.active)return;this.listCondition="loading",null===(t=this._listStatus)||void 0===t||t.show();const e=["id","status","available_slots","occupied_slots","architecture"];globalThis.backendaiclient.supports("schedulable")&&e.push("schedulable");const s="running"===this.condition?"ALIVE":"TERMINATED";globalThis.backendaiclient.agentSummary.list(s,e,100,0,1e4).then((t=>{var e,s,i;const a=null===(e=t.agent_summary_list)||void 0===e?void 0:e.items;if(void 0!==a&&0!=a.length){let t;""!==this.filter&&(t=this.filter.split(":")),Object.keys(a).map(((e,s)=>{var i,o,r,n,l,d,c,p,u;const g=a[e];if(""===this.filter||t[0]in g&&g[t[0]]===t[1]){const t=JSON.parse(g.occupied_slots),s=JSON.parse(g.available_slots);["cpu","mem"].forEach((e=>{e in t==!1&&(t[e]="0")})),a[e].cpu_slots=parseInt(s.cpu),a[e].used_cpu_slots=parseInt(t.cpu),null!==g.cpu_cur_pct?(a[e].cpu_total_usage_ratio=a[e].used_cpu_slots/a[e].cpu_slots,a[e].total_cpu_percent=null===(i=100*a[e].cpu_total_usage_ratio)||void 0===i?void 0:i.toFixed(2)):(a[e].cpu_total_usage_ratio=0,a[e].total_cpu_percent=null===(o=100*a[e].cpu_total_usage_ratio)||void 0===o?void 0:o.toFixed(2)),a[e].mem_slots=parseInt(globalThis.backendaiclient.utils.changeBinaryUnit(s.mem,"g")),a[e].used_mem_slots=parseInt(globalThis.backendaiclient.utils.changeBinaryUnit(t.mem,"g")),a[e].mem_total_usage_ratio=a[e].used_mem_slots/a[e].mem_slots,a[e].total_mem_percent=null===(r=100*a[e].mem_total_usage_ratio)||void 0===r?void 0:r.toFixed(2),"cuda.device"in s&&(a[e].cuda_gpu_slots=parseInt(s["cuda.device"]),a[e].used_cuda_gpu_slots="cuda.device"in t?parseInt(t["cuda.device"]):0,a[e].used_cuda_gpu_slots_ratio=a[e].used_cuda_gpu_slots/a[e].cuda_gpu_slots,a[e].total_cuda_gpu_percent=null===(n=100*a[e].used_cuda_gpu_slots_ratio)||void 0===n?void 0:n.toFixed(2)),"cuda.shares"in s&&(a[e].cuda_fgpu_slots=parseInt(s["cuda.shares"]),a[e].used_cuda_fgpu_slots="cuda.shares"in t?parseInt(t["cuda.shares"]):0,a[e].used_cuda_fgpu_slots_ratio=a[e].used_cuda_fgpu_slots/a[e].cuda_fgpu_slots,a[e].total_cuda_fgpu_percent=null===(l=100*a[e].used_cuda_fgpu_slots_ratio)||void 0===l?void 0:l.toFixed(2)),"rocm.device"in s&&(a[e].rocm_gpu_slots=parseInt(s["rocm.device"]),a[e].used_rocm_gpu_slots="rocm.device"in t?parseInt(t["rocm.device"]):0,a[e].used_rocm_gpu_slots_ratio=a[e].used_rocm_gpu_slots/a[e].rocm_gpu_slots,a[e].total_rocm_gpu_percent=null===(d=100*a[e].used_rocm_gpu_slots_ratio)||void 0===d?void 0:d.toFixed(2)),"tpu.device"in s&&(a[e].tpu_slots=parseInt(s["tpu.device"]),a[e].used_tpu_slots="tpu.device"in t?parseInt(t["tpu.device"]):0,a[e].used_tpu_slots_ratio=a[e].used_tpu_slots/a[e].tpu_slots,a[e].total_tpu_percent=null===(c=100*a[e].used_tpu_slots_ratio)||void 0===c?void 0:c.toFixed(2)),"ipu.device"in s&&(a[e].ipu_slots=parseInt(s["ipu.device"]),a[e].used_ipu_slots="ipu.device"in t?parseInt(t["ipu.device"]):0,a[e].used_ipu_slots_ratio=a[e].used_ipu_slots/a[e].ipu_slots,a[e].total_ipu_percent=null===(p=100*a[e].used_ipu_slots_ratio)||void 0===p?void 0:p.toFixed(2)),"atom.device"in s&&(a[e].atom_slots=parseInt(s["atom.device"]),a[e].used_atom_slots="atom.device"in t?parseInt(t["atom.device"]):0,a[e].used_atom_slots_ratio=a[e].used_atom_slots/a[e].atom_slots,a[e].total_atom_percent=null===(u=100*a[e].used_atom_slots_ratio)||void 0===u?void 0:u.toFixed(2)),"schedulable"in g&&(a[e].schedulable=g.schedulable),this.agentsObject[a[e].id]=a[e]}}))}this.agents=a,this._agentGrid.recalculateColumnWidths(),0===(null===(s=this.agents)||void 0===s?void 0:s.length)?this.listCondition="no-data":null===(i=this._listStatus)||void 0===i||i.hide(),!0===this.active&&setTimeout((()=>{this._loadAgentList()}),15e3)})).catch((t=>{var e;null===(e=this._listStatus)||void 0===e||e.hide(),t&&t.message&&(console.log(t),this.notification.text=d.relieve(t.title),this.notification.detail=t.message,this.notification.show(!0,t))}))}_isRunning(){return"running"===this.condition}_indexRenderer(t,e,s){const i=s.index+1;c(p`
        ...
        <div class="layout flex">
          ...
          ${s.item.ipu_slots?p`
            <div class="layout horizontal center-justified flex progress-bar-section">
              <div class="layout horizontal start resource-indicator">
                <img class="indicator-icon fg green" src="/resources/icons/tpu.svg"/>
                <span class="monospace" style="padding-left:5px;">${s.item.used_ipu_slots}/${s.item.ipu_slots}</span>
                <span class="indicator">IPU</span>
              </div>
              <span class="flex"></span>
              <lablup-progress-bar id="ipu-bar" progress="${s.item.used_ipu_slots_ratio}"
                                  description="${s.item.used_ipu_slots}"></lablup-progress-bar>
            </div>
          `:p``}
          ${s.item.atom_slots?p`
            <div class="layout horizontal center-justified flex progress-bar-section">
              <div class="layout horizontal start resource-indicator">
                <img class="indicator-icon fg green" src="/resources/icons/tpu.svg"/>
                <span class="monospace" style="padding-left:5px;">${s.item.used_atom_slots}/${s.item.atom_slots}</span>
                <span class="indicator">ATOM</span>
              </div>
              <span class="flex"></span>
              <lablup-progress-bar id="atom-bar" progress="${s.item.used_atom_slots_ratio}"
                                  description="${s.item.used_atom_slots}"></lablup-progress-bar>
            </div>
          `:p``}
        </div>`,t)}schedulableRenderer(t,e,s){var i;c(p`
      ...
      <div class="list-wrapper">
        <vaadin-grid class="${this.condition}" theme="row-stripes column-borders compact" aria-label="Job list"
          ...
          <vaadin-grid-column resizable auto-width header="${u("agent.Endpoint")}"
                              .renderer="${this._boundEndpointRenderer}">
          </vaadin-grid-column>
          <vaadin-grid-sort-column auto-width resizable path="architecture" header="${u("agent.Architecture")}">
          </vaadin-grid-sort-column>
          <vaadin-grid-column resizable auto-width header="${u("agent.Allocation")}"
...
Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
*/
let m=class extends a{constructor(){super(),this._status="inactive",this._tab="running-lists",this.hideAgents=!0}static get styles(){return[o,l`
        h3.tab {
    ...
    `}};t([e({type:String})],m.prototype,"_status",void 0),t([e({type:String})],m.prototype,"_tab",void 0),t([e({type:Boolean})],m.prototype,"hideAgents",void 0),m=t([i("backend-ai-agent-summary-view")],m);var b=m;export{b as default};
