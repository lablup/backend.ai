import{_ as e,n as t,e as i,B as a,c as o,I as s,a as l,F as n,d,i as r,aQ as c,aR as h,g,x as p,t as w,a4 as u}from"./backend-ai-webui-aedf1078.js";let v=class extends a{constructor(){super(...arguments),this.webUIShell=Object(),this.clientConfig=Object(),this.client=Object(),this.notification=Object(),this.passwordChangeDialog=Object(),this.failDialog=Object(),this.token=""}static get styles(){return[o,s,l,n,d,r`
        mwc-textfield {
          width: 100%;
        }
      ...
      <backend-ai-dialog id="update-password-dialog" fixed backdrop blockscrolling persistent style="padding:0;">
        ...
        <div slot="content" class="login-panel intro centered">
          ...
          <div style="margin:20px;">
            <mwc-textfield id="email" label="${w("data.explorer.EnterEmailAddress")}"
                autofocus auto-validate validationMessage="${w("signup.InvalidEmail")}"
                pattern="^[A-Z0-9a-z#-_]+@.+\\..+$" maxLength="64"
                placeholder="${w("maxLength.64chars")}">
            </mwc-textfield>
            <mwc-textfield id="password1" label="${w("webui.menu.NewPassword")}" type="password"
                auto-validate validationMessage="${w("webui.menu.InvalidPasswordMessage")}"
                pattern=${u.passwordRegex}
                maxLength="64">
            </mwc-textfield>
            <mwc-textfield id="password2" label="${w("webui.menu.NewPasswordAgain")}" type="password"
                auto-validate validationMessage="${w("webui.menu.InvalidPasswordMessage")}"
                pattern=${u.passwordRegex}
                maxLength="64">
            </mwc-textfield>
      ...
      <backend-ai-dialog id="verification-fail-dialog" fixed backdrop blockscrolling persistent style="padding:0;">
        ...
        <div slot="content" class="login-panel intro centered">
          ...
          <div class="horizontal layout center" style="margin:10px;">
            <p style="width:350px;">${w("login.InvalidChangePasswordTokenMessage")}</p>
          </div>
        </div>
