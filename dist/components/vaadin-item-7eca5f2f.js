 ...
 */;class d extends(n(a(i(r)))){static get template(){return s`
    ...
    `}static get is(){return"vaadin-item"}constructor(){super(),this.value}ready(){super.ready(),this.setAttribute("role","option")}}customElements.define(d.is,d);
