import{_ as e,n as t,e as i,t as a,B as s,b as o,I as r,a as n,i as d,d as l,j as c,k as p,p as h,x as u,f as g,g as b}from"./backend-ai-webui-Cvl-SpQz.js";import"./backend-ai-list-status-f8CFHFrI.js";import"./backend-ai-storage-host-settings-view-hoG2t2-_.js";import"./lablup-progress-bar-EimNTyGU.js";import"./vaadin-grid-BXsNAAkf.js";import"./vaadin-grid-sort-column-pQVDIafs.js";import"./dir-utils-BVJL0QLI.js";var v;let m=v=class extends s{constructor(){super(),this.condition="running",this.listCondition="loading",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[o,r,n,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `,e)}resourceRenderer(e,t,i){const a=JSON.parse(i.item.usage),s=a.capacity_bytes>0?a.used_bytes/a.capacity_bytes:0,o=(100*s).toFixed(3);h(u`
      ...
      `,e)}capabilitiesRenderer(e,t,i){h(u`
      ...
      `,e)}showStorageProxyDetailDialog(e){const t=new CustomEvent("backend-ai-selected-storage-proxy",{detail:e});document.dispatchEvent(t)}controlRenderer(e,t,i){let a;try{const e=JSON.parse(i.item.performance_metric);a=!(Object.keys(e).length>0)}catch(e){a=!0}h(u`
        <div
          id="controls"
      ...
      <div class="list-wrapper">
        ...
        >
          ...
          <vaadin-grid-column
            resizable
            width="80px"
            header="${g("agent.Endpoint")}"
            .renderer="${this._boundEndpointRenderer}"
          ></vaadin-grid-column>
          <vaadin-grid-column
            width="100px"
            resizable
            header="${g("agent.BackendType")}"
            .renderer="${this._boundTypeRenderer}"
          ></vaadin-grid-column>
          <vaadin-grid-column
            resizable
            width="60px"
            header="${g("agent.Resources")}"
      ...
      <backend-ai-dialog
        ...
        scrollable
      >
        <span slot="title">${g("agent.DetailedInformation")}</span>
        <div slot="content">
          <div class="horizontal start start-justified layout">
            ...
            <div style="margin-left:10px;">
              ...
              ${"live_stat"in this.storageProxyDetail&&"node"in this.storageProxyDetail.live_stat?u`
                    <div>
                      TX:
                      ${v.bytesToMB(this.storageProxyDetail.live_stat.node.net_tx.current)}
                      MB
                    </div>
                    <div>
                      RX:
                      ${v.bytesToMB(this.storageProxyDetail.live_stat.node.net_rx.current)}
                      MB
                    </div>
                  `:u``}
            </div>
