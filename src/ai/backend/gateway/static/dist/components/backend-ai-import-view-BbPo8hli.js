import{_ as t,n as e,e as o,t as i,B as a,b as s,I as n,a as r,c as l,i as c,g as d,d as h,x as p,f as u}from"./backend-ai-webui-Cvl-SpQz.js";import"./backend-ai-resource-monitor-CC5VpAfR.js";import"./backend-ai-session-launcher-D0P9lnX7.js";import"./lablup-activity-panel-BAVa23-B.js";import"./lablup-progress-bar-EimNTyGU.js";import"./mwc-switch-Dl-Uk4v9.js";import"./vaadin-grid-selection-column-DJf--6Dp.js";import"./active-mixin-lW8Qt-OC.js";import"./dir-utils-BVJL0QLI.js";import"./vaadin-grid-BXsNAAkf.js";import"./mwc-check-list-item-BwnFSR0R.js";import"./vaadin-grid-filter-column-CSCqhIok.js";let m=class extends a{constructor(){super(...arguments),this.condition="running",this.authenticated=!1,this.indicator=Object(),this.notification=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importNotebookMessage="",this.importGithubMessage="",this.importGitlabMessage="",this.allowedGroups=[],this.allowed_folder_type=[],this.vhost="",this.vhosts=[],this.storageInfo=Object(),this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.sessionLauncherType="neo"}static get styles(){return[s,n,r,l,c`
        div.description {
          font-size: 14px;
