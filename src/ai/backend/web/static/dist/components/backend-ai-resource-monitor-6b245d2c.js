import{_ as e,e as t,c as s,a as r,B as o,d as i,I as a,b as c,k as l,f as n,i as d,g as p,h as u,y as _,t as h}from"./backend-ai-webui-4b02c088.js";import"./lablup-progress-bar-b0e5bcbd.js";import"./mwc-switch-ac6c36fa.js";import"./label-fece23ff.js";import"./backend-ai-session-launcher-20894f9d.js";let g=class extends o{constructor(){super(),this.is_connected=!1,this.direction="horizontal",this.location="",this.aliases=Object(),this.aggregate_updating=!1,this.project_resource_monitor=!1,this.active=!1,this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-resource-monitor"}static get styles(){return[i,a,c,l,n,d`
        mwc-linear-progress {
          height: 5px;
      ...
      <div class="layout ${this.direction}-card flex wrap">
        <div id="resource-gauges" class="layout ${this.direction} ${this.direction}-panel resources flex wrap">
          ...
          ${this.total_slot.rocm_device_slot?_`
          <div class="layout horizontal center-justified monitor">
            <div class="layout vertical center center-justified resource-name">
          ...
          ${this.total_slot.tpu_device_slot?_`
          <div class="layout horizontal center-justified monitor">
            <div class="layout vertical center center-justified resource-name">
      ...
      <div class="vertical start-justified layout">
        ...
        <div class="layout horizontal center-justified monitor">
          <div class="layout vertical center center-justified" style="margin-right:5px;">
            ...
            <span class="gauge-name">${h("session.launcher.Project")}</span>
          </div>
