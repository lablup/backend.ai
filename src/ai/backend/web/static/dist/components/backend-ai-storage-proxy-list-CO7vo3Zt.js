import{_ as e,n as t,e as i,t as a,B as s,b as o,I as r,a as n,i as d,d as l,s as c,l as p,Q as h,k as b,f as u,g}from"./backend-ai-webui-CuYxUCgf.js";import"./backend-ai-list-status-B9npEM5q.js";import"./backend-ai-storage-host-settings-view-BM90Rc2U.js";import"./lablup-progress-bar-C_dQSfpj.js";var v;let m=v=class extends s{constructor(){super(),this.condition="running",this.listCondition="loading",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[o,r,n,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `,e)}resourceRenderer(e,t,i){const a=JSON.parse(i.item.usage),s=a.capacity_bytes>0?a.used_bytes/a.capacity_bytes:0,o=(100*s).toFixed(3);h(b`
      ...
      `,e)}capabilitiesRenderer(e,t,i){h(b`
        <div class="layout vertical start justified wrap">
          ${i.item.capabilities?i.item.capabilities.map((e=>b`
                  <lablup-shields
                    app=""
                    color="blue"
                    description="${e}"
      ...
      `,e)}showStorageProxyDetailDialog(e){const t=new CustomEvent("backend-ai-selected-storage-proxy",{detail:e});document.dispatchEvent(t)}controlRenderer(e,t,i){let a;try{const e=JSON.parse(i.item.performance_metric);a=!(Object.keys(e).length>0)}catch(e){a=!0}h(b`
        <div
          id="controls"
      ...
      `,e)}static bytesToMB(e,t=1){return Number(e/10**6).toFixed(t)}render(){return b`
      <div class="list-wrapper">
        ...
        <backend-ai-list-status
          ...
          message="${g("agent.NoAgentToDisplay")}"
        ></backend-ai-list-status>
      </div>
      <backend-ai-dialog
      ...
      >
        ...
        <div slot="content">
          <div class="horizontal start start-justified layout">
            ${"cpu_util_live"in this.storageProxyDetail?b`
                  <div>
                    <h3>CPU</h3>
                    <div
                    ...
                    >
                      ${this.storageProxyDetail.cpu_util_live.map((e=>b`
                          <div
            ...
            <div style="margin-left:10px;">
              ...
              <h3>Network</h3>
              ${"live_stat"in this.storageProxyDetail&&"node"in this.storageProxyDetail.live_stat?b`
                    <div>
                      TX:
