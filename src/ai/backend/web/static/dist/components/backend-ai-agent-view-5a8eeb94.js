import{_ as e,n as t,b as i,e as s,B as a,c as o,I as r,a as l,i as n,f as d,l as c,x as u,t as p,g as h,N as g,O as v,u as b}from"./backend-ai-webui-d4819018.js";import"./mwc-tab-bar-c1cdf3c3.js";import"./lablup-activity-panel-9287ea5d.js";import"./vaadin-grid-8bcb41b9.js";import"./vaadin-grid-sort-column-c47c2602.js";import"./lablup-progress-bar-eedf2fcd.js";import"./backend-ai-list-status-9e3ec948.js";import"./backend-ai-storage-host-settings-view-07afc231.js";import"./vaadin-item-8bb5ffd1.js";import"./mwc-switch-79aabe22.js";import"./backend-ai-multi-select-8ac12992.js";import"./dir-utils-31fa6465.js";import"./vaadin-item-mixin-526ba629.js";import"./mwc-check-list-item-de5f8c59.js";
/**
 @license
    ...
    `}render(){return u`
      <div class="list-wrapper">
        <vaadin-grid class="${this.condition}" theme="row-stripes column-borders compact" aria-label="Job list"
          ...
          <vaadin-grid-sort-column frozen resizable width="100px" path="id" header="${p("agent.Endpoint")}"
          ...
          `:u``}
          <vaadin-grid-column frozen-to-end auto-width flex-grow="0" header="${p("general.Control")}"
...
let x=class extends a{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.allowedSessionTypes=["interactive","batch","inference"],this.enableSchedulerOpts=!1,this.enableWSProxyAddr=!1,this.enableIsPublic=!1,this.functionCount=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.resourceGroups=[],this.resourceGroupInfo={},this.domains=[]}static get styles(){return[o,r,l,n`
    ...
    `,e)}_indexRenderer(e,t,i){const s=i.index+1;c(u`
      ...
      `,e)}_launchDialogById(e){var t;(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(e)).show()}_hideDialogById(e){var t;(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(e)).hide()}_controlRenderer(e,t,i){c(u`
        <div id="controls" class="layout horizontal flex center">
          <mwc-icon-button class="fg green" icon="assignment"
            @click=${()=>this._launchDetailDialog(i.item)}></mwc-icon-button>
          <mwc-icon-button class="fg blue" icon="settings"
            @click=${()=>this._launchModifyDialog(i.item)}></mwc-icon-button>
          <mwc-icon-button class="fg red" icon="delete"
            @click=${()=>this._launchDeleteDialog(i.item)}></mwc-icon-button>
        </div>
      ...
      <vaadin-grid theme="row-stripes column-borders compact" aria-label="Job list" .items="${this.resourceGroups}">
        ...
        <vaadin-grid-column frozen flex-grow="1" header="${p("resourceGroup.Name")}" path="name" resizable>
        </vaadin-grid-column>
        ...
        `:u``}
        <vaadin-grid-column frozen-to-end resizable width="150px" header="${p("general.Control")}" .renderer=${this._boundControlRenderer}>
        </vaadin-grid-column>
      </vaadin-grid>
        ...
        ${Object.keys(this.resourceGroupInfo).length>0?u`
          ...
          <div slot="content" class="intro">
            ...
            <div>
              ...
              <mwc-textarea readonly value="${null!==(k=null===($=this.resourceGroupInfo)||void 0===$?void 0:$.description)&&void 0!==k?k:""}">
              </mwc-textarea>
            </div>
          </div>`:""}
      </backend-ai-dialog>
