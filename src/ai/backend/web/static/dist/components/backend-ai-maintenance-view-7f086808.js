import{_ as e,n as a,b as t,e as i,B as n,c as s,I as c,a as l,m as o,d,i as r,x as g,t as m,h as u,g as b,f as h}from"./backend-ai-webui-d4819018.js";import"./lablup-activity-panel-9287ea5d.js";
/**
 @license
 Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
 */let p=class extends n{constructor(){super(...arguments),this.images=Object(),this.scanning=!1,this.recalculating=!1,this.notification=Object(),this.indicator=Object()}static get styles(){return[s,c,l,o,d,r`
        div.indicator,
        span.indicator {
          font-size: 9px;
          margin-right: 5px;
        ...
        <lablup-activity-panel title="${m("maintenance.Fix")}">
          <div slot="message" class="vertical flex layout wrap setting-item">
            <div class="vertical center-justified layout setting-desc">
              ...
              <div class="description">${u("maintenance.DescMatchDatabase")}
              </div>
            </div>
            <mwc-button
                  outlined
          ...
          <div slot="message">
            <div class="horizontal flex layout wrap setting-item">
              <div class="vertical center-justified layout setting-desc">
                ...
                <div class="description">${u("maintenance.DescRescanImageList")}
                </div>
              </div>
              <mwc-button
                  outlined
            ...
            <div class="horizontal flex layout wrap setting-item temporarily-hide">
              <div class="vertical center-justified layout setting-desc">
                ...
                <div class="description">${m("maintenance.DescCleanupOldImages")}
                </div>
              </div>
              <mwc-button
                  outlined
