import{_ as e,n as t,e as i,t as s,B as a,b as o,I as r,a as n,u as l,c as d,i as c,g as p,d as u,f as m,p as h,x as g}from"./backend-ai-webui-lOeH5wm0.js";import"./lablup-grid-sort-filter-column-dmgaHakF.js";import"./lablup-loading-spinner-BLtqYp_r.js";import"./vaadin-grid-selection-column-C0ZTUnb4.js";import"./vaadin-grid-N4zkwbUz.js";import"./vaadin-grid-filter-column-Dh0eJ51s.js";import"./vaadin-grid-sort-column-D-9QH2qr.js";import"./mwc-switch-LFsBjlfT.js";import"./backend-ai-list-status-lp5cMEa4.js";import"./vaadin-item-BmlF1MUT.js";import"./lablup-activity-panel-CFkpiKMq.js";import"./mwc-tab-bar-Den_PPlp.js";import"./active-mixin-kD9mK8Tx.js";import"./dir-utils-0BBYFvya.js";import"./vaadin-item-mixin-BRrJ0Z3H.js";let v=class extends a{constructor(){super(),this.selectedImages=[],this.modifiedImage=Object(),this.alias=Object(),this.indicator=Object(),this.deleteAppInfo=Object(),this.deleteAppRow=Object(),this.openManageAppModal=!1,this.openManageImageResourceModal=!1,this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object(),this.servicePortsMsg="",this.cpuValue=0,this.listCondition="loading",this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this._boundBaseImageRenderer=this.baseImageRenderer.bind(this),this._boundConstraintRenderer=this.constraintRenderer.bind(this),this._boundDigestRenderer=this.digestRenderer.bind(this),this.installImageNameList=[],this.deleteImageNameList=[],this.images=[],this.allowed_registries=[],this.servicePorts=[],this.modifiedImage={}}static get styles(){return[o,r,n,l,d,c`
        vaadin-grid {
          border: 0;
          font-size: 14px;
