import{m as e,r as t,i,o as s,p as n,q as o,T as a,D as l,P as r,_ as c,n as d,e as p,t as u,B as h,b as m,I as g,a as v,d as _,Q as b,k as f,g as y,f as w,u as k,v as x,c as A}from"./backend-ai-webui-64Hb1TBh.js";import{J as S}from"./vaadin-iconset-uUI3AAzK.js";import"./backend-ai-resource-monitor-0yCuJ-11.js";import"./backend-ai-session-launcher-DLC0dD-G.js";import"./backend-ai-list-status-CmUqpj8c.js";import"./lablup-grid-sort-filter-column-D-EEtuCs.js";import"./lablup-progress-bar-WXW3UbcM.js";import"./vaadin-grid-filter-column-BoK9W3KL.js";import"./lablup-activity-panel-B9IpMT33.js";import"./mwc-formfield-DV-8nMxX.js";import"./mwc-tab-bar-DNZ-1j5s.js";import"./mwc-switch-B8pW8CkE.js";import"./slider-DeHZ65il.js";import"./mwc-check-list-item-8Zd0FtHH.js";
/**
 * @license
...
${i.item[this.sessionNameField]}</pre
      ...
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?b(f``,e):b(f`
        ...
        `,e)}usageRenderer(e,t,i){var s,n,o,a,l,r,c,d,p,u,h,m,g,v,_,y,w,k,x,A,S,$,T,C,I,D,E,R,M,j,z,F,L,O,P,B,U,G,K,H,q,V,W,J,Z,Y,Q,X,ee,te,ie,se,ne,oe,ae,le,re,ce,de,pe,ue,he,me,ge,ve,_e,be,fe,ye,we;["batch","interactive","inference","running"].includes(this.condition)?b(f`
          <div class="vertical start start-justified layout">
            ...
            ${i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${i.item.live_stat?`${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(F=null===(z=i.item.live_stat)||void 0===z?void 0:z.cuda_mem)||void 0===F?void 0:F.current,2),2)} /\n                          ${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(O=null===(L=i.item.live_stat)||void 0===L?void 0:L.cuda_mem)||void 0===O?void 0:O.capacity,2),2)}`:"-"}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
            ...
            ${i.item.ipu_slot&&parseFloat(i.item.ipu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      IPU(util)
                      ${i.item.live_stat?(100*(null===(J=null===(W=i.item.live_stat)||void 0===W?void 0:W.ipu_util)||void 0===J?void 0:J.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(Q=null===(Y=null===(Z=i.item)||void 0===Z?void 0:Z.live_stat)||void 0===Y?void 0:Y.ipu_util)||void 0===Q?void 0:Q.current)/(null===(te=null===(ee=null===(X=i.item)||void 0===X?void 0:X.live_stat)||void 0===ee?void 0:ee.ipu_util)||void 0===te?void 0:te.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
