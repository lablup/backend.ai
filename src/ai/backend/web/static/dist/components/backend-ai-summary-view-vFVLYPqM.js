import{_ as t,n as e,t as i,s,I as a,a as r,i as o,x as n,g as l,e as c,B as p,b as u,c as d,d as h,f as m,h as _,j as g,k as v}from"./backend-ai-webui-dvRyOX_e.js";import"./backend-ai-resource-monitor-C7nG6TNh.js";import"./lablup-activity-panel-CUzA1T9h.js";import"./lablup-loading-spinner-DTpOeT_t.js";import"./lablup-progress-bar-DeByvCD9.js";import"./backend-ai-session-launcher-DU0kNHBS.js";import"./mwc-switch-C1VxcxVe.js";import"./vaadin-grid-selection-column-DHR7-_MG.js";import"./active-mixin-_JOWYQWx.js";import"./dir-utils-BTQok0yH.js";import"./vaadin-grid-DjH0sPLR.js";import"./mwc-check-list-item-BMr63zxO.js";import"./vaadin-grid-filter-column-Bstvob6v.js";let b=class extends s{constructor(){super(...arguments),this.currentNumber=50,this.maxNumber=100,this.unit="%",this.url="",this.textcolor="#888888",this.chartcolor="#ff2222",this.size=200,this.fontsize=60,this.chartFontSize="0",this.indicatorPath="",this.prefix="",this.sizeParam=""}static get is(){return"lablup-piechart"}static get styles(){return[a,r,o`
        ...
        <div slot="message">
          ...
          <div class="vertical-card" style="align-items: flex-start">
            ${this.is_superadmin?n`
                  <div class="layout horizontal center flex resource">
                    ...
                    <div class="layout vertical start-justified wrap">
                      <lablup-progress-bar
                        ...
                        description="${this._addComma(this._prefixFormatWithTrailingZeros(this.cpu_used,0))}/${this._addComma(this._prefixFormatWithTrailingZeros(this.cpu_total,0))} ${m("summary.CoresReserved")}."
                      ></lablup-progress-bar>
                      <lablup-progress-bar
                        id="cpu-usage-bar-2"
                        class="end"
                        progress="${this.cpu_current_usage_ratio/100}"
                        description="${m("summary.Using")} ${this._prefixFormatWithTrailingZeros(this.cpu_total_percent,1)} % (util. ${this._prefixFormatWithTrailingZeros(this.cpu_percent,1)} %)"
                      ></lablup-progress-bar>
                    </div>
                    <div class="layout vertical center center-justified">
                      <span class="percentage start-bar">
                        ${this._prefixFormatWithTrailingZeros(this.cpu_total_percent,1)+"%"}
                      </span>
                      <span class="percentage end-bar">
                        ${this._prefixFormatWithTrailingZeros(this.cpu_percent,1)+"%"}
                      </span>
                    </div>
                  </div>
                  ...
                  <div class="layout horizontal center flex resource">
                    ...
                    <div class="layout vertical start-justified wrap">
                      <lablup-progress-bar
                        ...
                        description="${this._addComma(this._prefixFormatWithTrailingZeros(this.mem_allocated,2))} / ${this._addComma(this._prefixFormatWithTrailingZeros(this.mem_total,2))} GiB ${m("summary.reserved")}."
                      ></lablup-progress-bar>
                      <lablup-progress-bar
                        id="mem-usage-bar-2"
                        class="end"
                        progress="${this.mem_current_usage_ratio/100}"
                        description="${m("summary.Using")} ${this._addComma(this._prefixFormatWithTrailingZeros(this.mem_used,2))} GiB
                    (${0!==parseInt(this.mem_used)?this._prefixFormatWithTrailingZeros(parseInt(this.mem_used)/parseInt(this.mem_total)*100,1):"0"} %)"
                      ></lablup-progress-bar>
                    </div>
                    <div class="layout vertical center center-justified">
                      <span class="percentage start-bar">
                        ${this._prefixFormatWithTrailingZeros(this.mem_total_usage_ratio,1)+"%"}
                      </span>
                      <span class="percentage end-bar">
                        ${(0!==parseInt(this.mem_used)?this._prefixFormatWithTrailingZeros(parseInt(this.mem_used)/parseInt(this.mem_total)*100,1):"0")+"%"}
                      </span>
                  ...
                  ${this.cuda_gpu_total||this.cuda_fgpu_total||this.rocm_gpu_total||this.tpu_total||this.ipu_total||this.atom_total||this.atom_plus_total||this.warboy_total||this.hyperaccel_lpu_total?n`
                        <div class="resource-line"></div>
                        <div class="layout horizontal center flex resource">
                          <div
                            class="layout vertical center center-justified resource-name"
                          ...
                          <div class="layout vertical">
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormat(this.cuda_gpu_used,2)} / ${this._prefixFormat(this.cuda_gpu_total,2)} CUDA GPUs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="gpu-usage-bar-2"
                                        class="end"
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${0!==this.cuda_gpu_used?this._prefixFormatWithTrailingZeros(this.cuda_gpu_used/this.cuda_gpu_total*100,1):0}%
                                      </span>
                                      <span class="percentage end-bar">
                                        &nbsp;
                                      </span>
                            ...
                            ${this.cuda_fgpu_total?n`
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${0!==this.cuda_fgpu_used?this._prefixFormatWithTrailingZeros(this.cuda_fgpu_used/this.cuda_fgpu_total*100,1):0}%
                                      </span>
                                      <span class="percentage end-bar">
                                        &nbsp;
                                      </span>
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormat(this.rocm_gpu_used,2)} / ${this._prefixFormat(this.rocm_gpu_total,2)} ROCm GPUs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${this._prefixFormatWithTrailingZeros(this.rocm_gpu_used,1)+"%"}
                                      </span>
                                      <span class="percentage end-bar">
                                        &nbsp;
                                      </span>
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithTrailingZeros(this.tpu_used,2)} / ${this._prefixFormatWithTrailingZeros(this.tpu_total,2)} TPUs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="tpu-usage-bar-2"
                                        class="end"
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${this._prefixFormatWithTrailingZeros(this.tpu_used,1)+"%"}
                                      </span>
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithTrailingZeros(this.ipu_used,2)} / ${this._prefixFormatWithTrailingZeros(this.ipu_total,2)} IPUs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="ipu-usage-bar-2"
                                        class="end"
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${this._prefixFormatWithTrailingZeros(this.ipu_used,1)+"%"}
                                      </span>
                                      <span class="percentage end-bar"></span>
                                    </div>
                                  </div>
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithTrailingZeros(this.atom_used,2)} / ${this._prefixFormatWithTrailingZeros(this.atom_total,2)} ATOMs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="atom-usage-bar-2"
                                        class="end"
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${this._prefixFormatWithTrailingZeros(this.atom_used,1)+"%"}
                                      </span>
                                      <span class="percentage end-bar"></span>
                                    </div>
                                  </div>
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithTrailingZeros(this.atom_plus_used,2)} / ${this._prefixFormatWithTrailingZeros(this.atom_plus_total,2)} ATOM+ ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${this._prefixFormatWithTrailingZeros(this.atom_plus_used,1)+"%"}
                                      </span>
                                      <span class="percentage end-bar"></span>
                                    </div>
                                  </div>
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithTrailingZeros(this.warboy_used,2)} / ${this._prefixFormatWithTrailingZeros(this.warboy_total,2)} Warboys ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${this._prefixFormatWithTrailingZeros(this.warboy_used,1)+"%"}
                                      </span>
                                      <span class="percentage end-bar"></span>
                                    </div>
                                  </div>
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithTrailingZeros(this.hyperaccel_lpu_used,2)} / ${this._prefixFormatWithTrailingZeros(this.hyperaccel_lpu_total,2)} Hyperaccel LPUs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                    ...
                                    >
                                      <span class="percentage start-bar">
                                        ${this._prefixFormatWithTrailingZeros(this.hyperaccel_lpu_used,1)+"%"}
                                      </span>
                                      <span class="percentage end-bar"></span>
                                    </div>
                                  </div>
    ...
    `}};t([e({type:String})],x.prototype,"condition",void 0),t([e({type:Number})],x.prototype,"sessions",void 0),t([e({type:Object})],x.prototype,"jobs",void 0),t([e({type:Number})],x.prototype,"agents",void 0),t([e({type:Boolean})],x.prototype,"is_admin",void 0),t([e({type:Boolean})],x.prototype,"is_superadmin",void 0),t([e({type:Object})],x.prototype,"resources",void 0),t([e({type:Object})],x.prototype,"update_checker",void 0),t([e({type:Boolean})],x.prototype,"authenticated",void 0),t([e({type:String})],x.prototype,"manager_version",void 0),t([e({type:String})],x.prototype,"webui_version",void 0),t([e({type:Number})],x.prototype,"cpu_total",void 0),t([e({type:Number})],x.prototype,"cpu_used",void 0),t([e({type:String})],x.prototype,"cpu_percent",void 0),t([e({type:String})],x.prototype,"cpu_total_percent",void 0),t([e({type:Number})],x.prototype,"cpu_total_usage_ratio",void 0),t([e({type:Number})],x.prototype,"cpu_current_usage_ratio",void 0),t([e({type:String})],x.prototype,"mem_total",void 0),t([e({type:String})],x.prototype,"mem_used",void 0),t([e({type:String})],x.prototype,"mem_allocated",void 0),t([e({type:Number})],x.prototype,"mem_total_usage_ratio",void 0),t([e({type:Number})],x.prototype,"mem_current_usage_ratio",void 0),t([e({type:String})],x.prototype,"mem_current_usage_percent",void 0),t([e({type:Number})],x.prototype,"cuda_gpu_total",void 0),t([e({type:Number})],x.prototype,"cuda_gpu_used",void 0),t([e({type:Number})],x.prototype,"cuda_fgpu_total",void 0),t([e({type:Number})],x.prototype,"cuda_fgpu_used",void 0),t([e({type:Number})],x.prototype,"rocm_gpu_total",void 0),t([e({type:Number})],x.prototype,"rocm_gpu_used",void 0),t([e({type:Number})],x.prototype,"tpu_total",void 0),t([e({type:Number})],x.prototype,"tpu_used",void 0),t([e({type:Number})],x.prototype,"ipu_total",void 0),t([e({type:Number})],x.prototype,"ipu_used",void 0),t([e({type:Number})],x.prototype,"atom_total",void 0),t([e({type:Number})],x.prototype,"atom_used",void 0),t([e({type:Object})],x.prototype,"notification",void 0),t([e({type:Object})],x.prototype,"resourcePolicy",void 0),t([e({type:Object})],x.prototype,"invitations",void 0),t([e({type:Object})],x.prototype,"appDownloadMap",void 0),t([e({type:String})],x.prototype,"appDownloadUrl",void 0),t([e({type:Boolean})],x.prototype,"allowAppDownloadPanel",void 0),t([e({type:String})],x.prototype,"downloadAppOS",void 0),t([c("#resource-monitor")],x.prototype,"resourceMonitor",void 0),t([c("#resource-panel")],x.prototype,"resourcePanel",void 0),x=t([i("backend-ai-summary-view")],x);var w=x;export{w as default};
