import{_ as t,n as e,e as o,t as i,B as a,b as n,I as s,a as r,c as l,i as c,g as d,d as h,k as p,f as u}from"./backend-ai-webui-ClPaDngW.js";import"./backend-ai-resource-monitor-QJpWtdUa.js";import"./backend-ai-session-launcher-VTqQXX0O.js";import"./lablup-activity-panel-CMRQ6cmG.js";import"./lablup-progress-bar-DWfFzAsr.js";import"./mwc-switch-DNCscRWy.js";import"./slider-BH95QYxl.js";import"./mwc-check-list-item-s9xKKbad.js";import"./vaadin-grid-filter-column-COSP5o_y.js";let m=class extends a{constructor(){super(...arguments),this.condition="running",this.authenticated=!1,this.indicator=Object(),this.notification=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importNotebookMessage="",this.importGithubMessage="",this.importGitlabMessage="",this.allowedGroups=[],this.allowed_folder_type=[],this.vhost="",this.vhosts=[],this.storageInfo=Object(),this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.sessionLauncherType="neo"}static get styles(){return[n,s,r,l,c`
        div.description {
          font-size: 14px;
