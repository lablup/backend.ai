import{m as e,r as t,i,o as s,p as o,q as n,T as a,D as l,P as r,_ as c,n as d,e as p,t as u,B as h,b as m,I as g,a as v,d as _,Q as b,k as f,g as y,f as w,u as k,v as x,c as A}from"./backend-ai-webui-DDgiEQ8A.js";import{J as S}from"./vaadin-iconset-Bek0H3_B.js";import"./backend-ai-resource-monitor-BLiuagjt.js";import"./backend-ai-session-launcher-BVQvFdWs.js";import"./backend-ai-list-status-CjXf2ZH4.js";import"./lablup-grid-sort-filter-column-BH_CFus6.js";import"./lablup-progress-bar-D6tN2SzX.js";import"./vaadin-grid-filter-column-tdWQLd9x.js";import"./lablup-activity-panel-DTwwLrVC.js";import"./mwc-formfield-B9xL3pKJ.js";import"./mwc-tab-bar-CPRdx4tw.js";import"./mwc-switch-3GZYhcOo.js";import"./slider-DTFqACqN.js";import"./mwc-check-list-item-DDtuDJtO.js";
/**
 * @license
 ...
 */;class R extends(E(a(l(r)))){static get is(){return"vaadin-grid-tree-toggle"}static get template(){return n`
    ...
    `),d.hasOwnProperty("kernel")||d.hasOwnProperty("session"))u.push(f`
      ...
      `);else if(d.hasOwnProperty("scheduler")){const e=null!==(a=null===(n=d.scheduler.failed_predicates)||void 0===n?void 0:n.length)&&void 0!==a?a:0,t=null!==(r=null===(l=d.scheduler.passed_predicates)||void 0===l?void 0:l.length)&&void 0!==r?r:0;u.push(f`
        <div class="vertical layout start flex" style="width:100%;">
          <div style="width:100%;">
            <h3
      ...
      `);b(u,p)}_openStatusDetailDialog(e,t,i){this.selectedSessionStatus={info:e,data:t,reserved_time:i},this._renderStatusDetail(),this.sessionStatusInfoDialog.show()}_validateSessionName(e){const t=this.compute_sessions.map((e=>e[this.sessionNameField])),i=e.target.parentNode,s=i.querySelector("#session-name-field").innerText,o=i.querySelector("#session-rename-field");o.validityTransform=(e,i)=>{if(i.valid){const i=!t.includes(e)||e===s;return i||(o.validationMessage=y("session.Validation.SessionNameAlreadyExist")),{valid:i,customError:!i}}return i.valueMissing?(o.validationMessage=y("session.Validation.SessionNameRequired"),{valid:i.valid,valueMissing:!i.valid}):i.patternMismatch?(o.validationMessage=y("session.Validation.SluggedStrings"),{valid:i.valid,patternMismatch:!i.valid}):(o.validationMessage=y("session.Validation.EnterValidSessionName"),{valid:i.valid,customError:!i.valid})}}_renameSessionName(e,t){const i=t.target.parentNode,s=i.querySelector("#session-name-field"),o=i.querySelector("#session-rename-field"),n=i.querySelector("#session-rename-icon");if("none"===s.style.display){if(!o.checkValidity())return o.reportValidity(),void(n.on=!0);{const t=globalThis.backendaiclient.APIMajorVersion<5?s.value:e;globalThis.backendaiclient.rename(t,o.value).then((e=>{this.refreshList(),this.notification.text=y("session.SessionRenamed"),this.notification.detail="",this.notification.show()})).catch((e=>{o.value=s.innerText,e&&e.message&&(this.notification.text=_.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))})).finally((()=>{this._toggleSessionNameField(s,o)}))}}else this._toggleSessionNameField(s,o)}_toggleSessionNameField(e,t){"block"===t.style.display?(e.style.display="block",t.style.display="none"):(e.style.display="none",t.style.display="block",t.focus())}static secondsToDHMS(e){const t=Math.floor(e/86400),i=Math.floor(e%86400/3600),s=Math.floor(e%3600/60),o=parseInt(e)%60,n=t<0||i<0||s<0||o<0?y("session.TimeoutExceeded"):"",a=`${void 0!==t&&t>0?String(t)+"d":""}${i.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}`;return n.length>0?n:a}_getIdleSessionTimeout(e){if(globalThis.backendaiutils.isEmpty(e))return null;let t="",i=1/0;for(const[s,o]of Object.entries(e))null!=o&&"number"==typeof o&&null!=i&&o<i&&(t=s,i=o);return i?[t,N.secondsToDHMS(i)]:null}_openIdleChecksInfoDialog(){var e,t,i;this._helpDescriptionTitle=y("session.IdleChecks"),this._helpDescription=`\n      <p>${y("session.IdleChecksDesc")}</p>\n      ${(null===(e=this.activeIdleCheckList)||void 0===e?void 0:e.has("session_lifetime"))?`\n        <strong>${y("session.MaxSessionLifetime")}</strong>\n        <p>${y("session.MaxSessionLifetimeDesc")}</p>\n        `:""}\n      ${(null===(t=this.activeIdleCheckList)||void 0===t?void 0:t.has("network_timeout"))?`\n        <strong>${y("session.NetworkIdleTimeout")}</strong>\n        <p>${y("session.NetworkIdleTimeoutDesc")}</p>\n      `:""}\n      ${(null===(i=this.activeIdleCheckList)||void 0===i?void 0:i.has("utilization"))?`\n        <strong>${y("session.UtilizationIdleTimeout")}</strong>\n        <p>${y("session.UtilizationIdleTimeoutDesc")}</p>\n        <div style="margin:10px 5% 20px 5%;">\n          <li>\n            <span style="font-weight:500">${y("session.GracePeriod")}</span>\n            <div style="padding-left:20px;">${y("session.GracePeriodDesc")}</div>\n          </li>\n          <li>\n            <span style="font-weight:500">${y("session.UtilizationThreshold")}</span>\n            <div style="padding-left:20px;">${y("session.UtilizationThresholdDesc")}</div>\n          </li>\n        </div>\n      `:""}\n    `,this.helpDescriptionDialog.show()}async _openSFTPSessionConnectionInfoDialog(e,t){const i=await globalThis.backendaiclient.get_direct_access_info(e),s=i.public_host.replace(/^https?:\/\//,""),o=i.sshd_ports,n=new CustomEvent("read-ssh-key-and-launch-ssh-dialog",{detail:{sessionUuid:e,host:s,port:o,mounted:t}});document.dispatchEvent(n)}_createUtilizationIdleCheckDropdown(e,t){const i=e.target,s=document.createElement("mwc-menu");s.anchor=i,s.className="util-dropdown-menu",s.style.boxShadow="0 1px 1px rgba(0, 0, 0, 0.2)",s.setAttribute("open",""),s.setAttribute("fixed",""),s.setAttribute("corner","BOTTOM_START");let o=f``;globalThis.backendaiutils.isEmpty(t)||(o=f`
        <style>
        ...
        ${Object.keys(t).map((e=>{let[i,s]=t[e];i=i>=0?parseFloat(i).toFixed(1):"-";const o=this.getUtilizationCheckerColor([i,s]);return f`
          ...
          `}))}
      `,document.body.appendChild(s)),b(o,s)}_removeUtilizationIdleCheckDropdown(){var e;const t=document.getElementsByClassName("util-dropdown-menu");for(;t[0];)null===(e=t[0].parentNode)||void 0===e||e.removeChild(t[0])}sessionTypeRenderer(e,t,i){const s=JSON.parse(i.item.inference_metrics||"{}");b(f`
...
${i.item[this.sessionNameField]}</pre
        ...
        <lablup-shields
          ...
          ui="round"
        ></lablup-shields>
      `,e)}controlRenderer(e,t,i){var s;let o=!0;o="API"===this._connectionMode&&i.item.access_key===globalThis.backendaiclient._config._accessKey||i.item.user_email===globalThis.backendaiclient.email,b(f`
        <div
          id="controls"
      ...
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?b(f``,e):b(f`
          ...
          <div class="layout vertical flex" style="padding-left: 25px">
            ...
            <div class="layout horizontal center configuration">
              ...
              ${i.item.hyeraccel_lpu_slot?f`
                  ...
                  `:f``}
              ${i.item.cuda_gpu_slot||i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot||i.item.tpu_slot||i.item.ipu_slot||i.item.atom_slot||i.item.atom_plus_slot||i.item.gaudi2_slot||i.item.warboy_slot||i.item.hyperaccel_lpu_slot?f``:f`
                    <mwc-icon class="fg green indicator">view_module</mwc-icon>
                    <span>-</span>
                    <span class="indicator">GPU</span>
                  `}
        ...
        `,e)}usageRenderer(e,t,i){var s,o,n,a,l,r,c,d,p,u,h,m,g,v,_,y,w,k,x,A,S,$,T,C,I,D,E,R,M,j,z,F,L,O,P,B,U,G,K,H,q,V,W,J,Z,Y,Q,X,ee,te,ie,se,oe,ne,ae,le,re,ce,de,pe,ue,he,me,ge,ve,_e,be,fe,ye,we,ke,xe,Ae,Se,$e,Te;["batch","interactive","inference","running"].includes(this.condition)?b(f`
          <div class="vertical start start-justified layout">
            <div class="vertical start-justified layout">
              <div class="usage-items">
                CPU
                ${i.item.live_stat?(100*(null===(o=null===(s=i.item.live_stat)||void 0===s?void 0:s.cpu_util)||void 0===o?void 0:o.ratio)).toFixed(1):"-"}
                %
              </div>
            ...
            ${i.item.cuda_fgpu_slot?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${i.item.live_stat?`${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(D=null===(I=i.item.live_stat)||void 0===I?void 0:I.cuda_mem)||void 0===D?void 0:D.current,2),2)} /\n                            ${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(R=null===(E=i.item.live_stat)||void 0===E?void 0:E.cuda_mem)||void 0===R?void 0:R.capacity,2),2)}`:"-"}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
            ...
            ${i.item.ipu_slot&&parseFloat(i.item.ipu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    ...
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(oe=null===(se=null===(ie=i.item)||void 0===ie?void 0:ie.live_stat)||void 0===se?void 0:se.ipu_util)||void 0===oe?void 0:oe.current)/(null===(le=null===(ae=null===(ne=i.item)||void 0===ne?void 0:ne.live_stat)||void 0===ae?void 0:ae.ipu_util)||void 0===le?void 0:le.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
      ...
      `,e)}idleChecksRenderer(e,t,i){var s;const o=null===(s=Object.keys(i.item.idle_checks))||void 0===s?void 0:s.map((e=>{var t,s;const o=i.item.idle_checks[e],n=null==o?void 0:o.remaining;if(!n)return;const a=globalThis.backendaiclient.utils.elapsedTimeToTotalSeconds(n),l=null==o?void 0:o.remaining_time_type;let r,c="var(--token-colorSuccess";return!a||a<3600?c="var(--token-colorError)":a<14400&&(c="var(--token-colorWarning)"),"utilization"===e&&(null==o?void 0:o.extra)&&(!a||a<14400)&&(c=this.getUtilizationCheckerColor(null===(t=null==o?void 0:o.extra)||void 0===t?void 0:t.resources,null===(s=null==o?void 0:o.extra)||void 0===s?void 0:s.thresholds_check_operator)),r="utilization"===e?f`
          ...
          `:f``})),n=f`
      ${o}
    `;b(n,e)}agentListRenderer(e,t,i){b(f`
        <pre>${i.item.agents_ids_with_container_ids}</pre>
      `,e)}_aggregateSharedMemory(e){let t=0;return Object.keys(e).forEach((i=>{var s,o;t+=Number(null!==(o=null===(s=e[i])||void 0===s?void 0:s.shmem)&&void 0!==o?o:0)})),N.bytesToGiB(t)}userInfoRenderer(e,t,i){const s="API"===this._connectionMode?i.item.access_key:i.item.user_email;b(f`
    ...
    `}_parseSessionInfoToCommitSessionInfo(e="",t="",i=""){const s=["",""],[o,n]=e?e.split(":"):s,[a,...l]=n?n.split("-"):s;return{environment:o,version:a,tags:l,session:{name:t,id:i}}}render(){var e,t,i;return f`
