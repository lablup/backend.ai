import{_ as s,n as t,e,t as i,B as a,b as o,I as r,a as l,i as n,d,p as c,x as p,f as u,g as _}from"./backend-ai-webui-Cvl-SpQz.js";import"./lablup-progress-bar-EimNTyGU.js";import"./mwc-switch-Dl-Uk4v9.js";import"./vaadin-grid-BXsNAAkf.js";import"./vaadin-grid-sort-column-pQVDIafs.js";import"./backend-ai-list-status-f8CFHFrI.js";import"./lablup-activity-panel-BAVa23-B.js";import"./mwc-tab-bar-D9RZyju8.js";import"./dir-utils-BVJL0QLI.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
