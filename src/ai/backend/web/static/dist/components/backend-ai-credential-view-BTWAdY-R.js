import{_ as e,n as i,e as t,t as a,B as s,b as o,I as r,a as n,u as l,c as d,i as c,d as u,g as p,p as h,x as m,f as v,J as y}from"./backend-ai-webui-lOeH5wm0.js";import{J as _}from"./vaadin-iconset-BzKID4Eb.js";import"./backend-ai-list-status-lp5cMEa4.js";import"./lablup-grid-sort-filter-column-dmgaHakF.js";import"./vaadin-grid-N4zkwbUz.js";import"./vaadin-grid-filter-column-Dh0eJ51s.js";import"./vaadin-grid-sort-column-D-9QH2qr.js";import"./vaadin-item-BmlF1MUT.js";import"./backend-ai-multi-select-BEOsd4Qx.js";import"./mwc-switch-LFsBjlfT.js";import"./lablup-activity-panel-CFkpiKMq.js";import"./mwc-formfield-D5bUqlch.js";import"./mwc-tab-bar-Den_PPlp.js";import"./dir-utils-0BBYFvya.js";import"./vaadin-item-mixin-BRrJ0Z3H.js";import"./active-mixin-kD9mK8Tx.js";import"./mwc-check-list-item-BlHgQxB4.js";import"./state-lXWEb-cA.js";var g;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let f=g=class extends s{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey="",this.supportMainAccessKey=!1,this._mainAccessKeyList=[]}static get styles(){return[o,r,n,l,d,c`
        vaadin-grid {
          border: 0;
          font-size: 14px;
