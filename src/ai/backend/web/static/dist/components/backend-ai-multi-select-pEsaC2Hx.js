import{_ as e,e as t,n as i,t as o,s,b as a,I as l,Y as r,a as d,u as c,c as n,i as m,x as p}from"./backend-ai-webui-BSTsu8kd.js";import"./mwc-check-list-item-CNGmLrUf.js";import{r as h}from"./state-C0ZsXUf2.js";var v;let u=v=class extends s{constructor(){super(),this.label="",this.validationMessage="",this.enableClearButton=!1,this.openUp=!1,this.required=!1,this._valid=!0,this.selectedItemList=[],this.items=[]}static get styles(){return[a,l,r,d,c,n,m`
        lablup-shields {
          margin: 1px;
        }
