import{l as e,r as t,i,m as s,o,T as n,D as a,P as l,_ as r,n as c,e as d,t as p,B as u,b as h,I as m,a as g,d as v,p as b,x as _,g as f,f as y,q as w,u as k,c as x}from"./backend-ai-webui-CjuQ-zwV.js";import{J as A}from"./vaadin-iconset-CSH7kwmR.js";import"./backend-ai-resource-monitor-CgYtqVDb.js";import"./backend-ai-session-launcher-CBCFIe7r.js";import"./backend-ai-list-status-CJXBdPRs.js";import"./lablup-grid-sort-filter-column-Csd58c2v.js";import"./lablup-progress-bar-BAxHd3WG.js";import{i as S}from"./vaadin-grid-CQXObRT4.js";import"./vaadin-grid-filter-column-DxuGPs1Z.js";import"./vaadin-grid-selection-column-BUFV06Wx.js";import"./vaadin-grid-sort-column-DTiFbihy.js";import"./lablup-activity-panel-BS50zM_6.js";import"./mwc-formfield-BR8zVCOG.js";import"./mwc-tab-bar-Ccckm9rk.js";import"./mwc-switch-sbY7v1dx.js";import"./lablup-codemirror-Bl6-Y2la.js";import"./mwc-check-list-item-BfkjsOoK.js";import"./dir-utils-Bwa9NiC0.js";import"./active-mixin-Crljre_V.js";
/**
 * @license
...
${i.item[this.sessionNameField]}</pre
      ...
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?b(_``,e):b(_`
          ...
          <div class="layout vertical flex" style="padding-left: 25px">
            ...
            <div class="layout horizontal center configuration">
              ...
              ${i.item.hyeraccel_lpu_slot?_`
                  ...
                  `:_``}
              ${i.item.cuda_gpu_slot||i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot||i.item.tpu_slot||i.item.ipu_slot||i.item.atom_slot||i.item.warboy_slot||i.item.hyperaccel_lpu_slot?_``:_`
                    <mwc-icon class="fg green indicator">view_module</mwc-icon>
                    <span>-</span>
                    <span class="indicator">GPU</span>
                  `}
        ...
        `,e)}usageRenderer(e,t,i){var s,o,n,a,l,r,c,d,p,u,h,m,g,v,f,y,w,k,x,A,S,$,T,C,I,E,D,R,N,M,z,L,O,F,P,B,U,G,H,q,V,K,J,W,Y,Z,Q,X,ee,te,ie,se,oe,ne,ae,le,re,ce,de,pe,ue,he,me,ge,ve,be,_e,fe;["batch","interactive","inference","running"].includes(this.condition)?b(_`
          <div class="vertical start start-justified layout">
            ...
            <div class="vertical start-justified layout">
              <div class="usage-items">
                RAM
                ${j.bytesToGiB(null===(d=null===(c=i.item.live_stat)||void 0===c?void 0:c.mem)||void 0===d?void 0:d.current,1)}/${j.bytesToGiB(null===(u=null===(p=i.item.live_stat)||void 0===p?void 0:p.mem)||void 0===u?void 0:u.capacity,1)}
                GiB
              </div>
              <div class="horizontal start-justified center layout">
                <lablup-progress-bar
            ...
            ${i.item.rocm_gpu_slot&&parseFloat(i.item.cuda_rocm_gpu_slot)>0?_`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(util)
                      ${(100*(null===(E=null===(I=i.item.live_stat)||void 0===I?void 0:I.rocm_util)||void 0===E?void 0:E.ratio)).toFixed(1)}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(R=null===(D=i.item.live_stat)||void 0===D?void 0:D.rocm_util)||void 0===R?void 0:R.current)/(null===(M=null===(N=i.item.live_stat)||void 0===N?void 0:N.rocm_util)||void 0===M?void 0:M.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
            ...
            ${i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot?_`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${j.bytesToGiB(null===(L=null===(z=i.item.live_stat)||void 0===z?void 0:z.cuda_mem)||void 0===L?void 0:L.current,1)}/${j.bytesToGiB(null===(F=null===(O=i.item.live_stat)||void 0===O?void 0:O.cuda_mem)||void 0===F?void 0:F.capacity,1)}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
    ...
    `;b(n,e)}agentListRenderer(e,t,i){var s;b(_`
      ...
      <backend-ai-dialog id="commit-session-dialog" fixed backdrop>
        ...
        <div slot="content" class="vertical layout center flex">
          ...
          <div class="vertical flex start layout" style="width:100%;">
            <h4 class="commit-session-title">
              ${y("session.ConvertSessionToImage")}
            </h4>
        ...
        <div slot="footer" class="horizontal end-justified flex layout">
          <mwc-button
            unelevated
            class="ok"
            style="font-size: ${this.pushImageInsteadOfCommiting?"smaller":"inherit"}"
            ?disabled="${""===(null==e?void 0:e.environment)||this.pushImageInsteadOfCommiting&&!this.canStartImagifying}"
            @click=${t=>{this.pushImageInsteadOfCommiting?this._requestConvertSessionToimage(e):this._requestCommitSession(e)}}
            label="${this.pushImageInsteadOfCommiting?y("button.PushToImage"):y("button.Commit")}"
          ></mwc-button>
        </div>
      </backend-ai-dialog>
      ...
      <div class="layout horizontal center filters">
        <div id="multiple-action-buttons" style="display:none;">
          <mwc-button icon="delete" class="multiple-action-button" raised style="margin:8px;"
                           @click="${()=>this._openTerminateSelectedSessionsDialog()}">${y("session.Terminate")}</mwc-button>
        </div>
        <span class="flex"></span>
        <div class="vertical layout" style="display:none">
          <mwc-textfield id="access-key-filter" type="search" maxLength="64"
                      label="${y("general.AccessKey")}" no-label-float .value="${this.filterAccessKey}"
      ...
      <div class="list-wrapper">
        <vaadin-grid id="list-grid" theme="row-stripes column-borders compact dark" aria-label="Session list"
          ...
          ${this.is_admin?_`
                  ...
                  ></lablup-grid-sort-filter-column>
                `:_``}
          <lablup-grid-sort-filter-column frozen path="${this.sessionNameField}" auto-width header="${y("session.SessionInfo")}" resizable
                                     .renderer="${this._boundSessionInfoRenderer}">
          </lablup-grid-sort-filter-column>
          <lablup-grid-sort-filter-column width="120px" path="status" header="${y("session.Status")}" resizable
      ...
      <backend-ai-dialog id="terminate-selected-sessions-dialog" fixed backdrop>
        ...
        <div slot="footer" class="horizontal end-justified flex layout">
          <mwc-button class="warning fg red"
                      @click="${()=>this._terminateSelectedSessionsWithCheck(!0)}">${y("button.ForceTerminate")}
          </mwc-button>
          <span class="flex"></span>
          <mwc-button class="cancel" @click="${e=>this._hideDialog(e)}">${y("button.Cancel")}
          </mwc-button>
    ...
    `}_updateSessionPage(e){"previous-page"===e.target.id?this.current_page-=1:this.current_page+=1,this.refreshList()}_updateImagifyAvailabilityStatus(e){this.canStartImagifying=e.target._validity.valid,this.newImageName=e.target.value}};var M;r([c({type:Boolean,reflect:!0})],N.prototype,"active",void 0),r([c({type:String})],N.prototype,"condition",void 0),r([c({type:Object})],N.prototype,"jobs",void 0),r([c({type:Array})],N.prototype,"compute_sessions",void 0),r([c({type:Array})],N.prototype,"terminationQueue",void 0),r([c({type:String})],N.prototype,"filterAccessKey",void 0),r([c({type:String})],N.prototype,"sessionNameField",void 0),r([c({type:Array})],N.prototype,"appSupportList",void 0),r([c({type:Object})],N.prototype,"appTemplate",void 0),r([c({type:Object})],N.prototype,"imageInfo",void 0),r([c({type:Array})],N.prototype,"_selected_items",void 0),r([c({type:Object})],N.prototype,"_boundControlRenderer",void 0),r([c({type:Object})],N.prototype,"_boundConfigRenderer",void 0),r([c({type:Object})],N.prototype,"_boundUsageRenderer",void 0),r([c({type:Object})],N.prototype,"_boundReservationRenderer",void 0),r([c({type:Object})],N.prototype,"_boundIdleChecksHeaderderer",void 0),r([c({type:Object})],N.prototype,"_boundIdleChecksRenderer",void 0),r([c({type:Object})],N.prototype,"_boundAgentListRenderer",void 0),r([c({type:Object})],N.prototype,"_boundSessionInfoRenderer",void 0),r([c({type:Object})],N.prototype,"_boundArchitectureRenderer",void 0),r([c({type:Object})],N.prototype,"_boundCheckboxRenderer",void 0),r([c({type:Object})],N.prototype,"_boundUserInfoRenderer",void 0),r([c({type:Object})],N.prototype,"_boundStatusRenderer",void 0),r([c({type:Object})],N.prototype,"_boundSessionTypeRenderer",void 0),r([c({type:Boolean})],N.prototype,"refreshing",void 0),r([c({type:Boolean})],N.prototype,"is_admin",void 0),r([c({type:Boolean})],N.prototype,"is_superadmin",void 0),r([c({type:String})],N.prototype,"_connectionMode",void 0),r([c({type:Object})],N.prototype,"notification",void 0),r([c({type:Boolean})],N.prototype,"enableScalingGroup",void 0),r([c({type:Boolean})],N.prototype,"isDisplayingAllocatedShmemEnabled",void 0),r([c({type:String})],N.prototype,"listCondition",void 0),r([c({type:Object})],N.prototype,"refreshTimer",void 0),r([c({type:Object})],N.prototype,"kernel_labels",void 0),r([c({type:Object})],N.prototype,"kernel_icons",void 0),r([c({type:Object})],N.prototype,"indicator",void 0),r([c({type:String})],N.prototype,"_helpDescription",void 0),r([c({type:String})],N.prototype,"_helpDescriptionTitle",void 0),r([c({type:String})],N.prototype,"_helpDescriptionIcon",void 0),r([c({type:Set})],N.prototype,"activeIdleCheckList",void 0),r([c({type:Proxy})],N.prototype,"statusColorTable",void 0),r([c({type:Proxy})],N.prototype,"idleChecksTable",void 0),r([c({type:Proxy})],N.prototype,"sessionTypeColorTable",void 0),r([c({type:Number})],N.prototype,"sshPort",void 0),r([c({type:Number})],N.prototype,"vncPort",void 0),r([c({type:Number})],N.prototype,"current_page",void 0),r([c({type:Number})],N.prototype,"session_page_limit",void 0),r([c({type:Number})],N.prototype,"total_session_count",void 0),r([c({type:Number})],N.prototype,"_APIMajorVersion",void 0),r([c({type:Object})],N.prototype,"selectedSessionStatus",void 0),r([c({type:Boolean})],N.prototype,"isUserInfoMaskEnabled",void 0),r([c({type:Boolean})],N.prototype,"pushImageInsteadOfCommiting",void 0),r([c({type:Boolean})],N.prototype,"canStartImagifying",void 0),r([c({type:String})],N.prototype,"newImageName",void 0),r([d("#loading-spinner")],N.prototype,"spinner",void 0),r([d("#list-grid")],N.prototype,"_grid",void 0),r([d("#access-key-filter")],N.prototype,"accessKeyFilterInput",void 0),r([d("#multiple-action-buttons")],N.prototype,"multipleActionButtons",void 0),r([d("#access-key-filter-helper-text")],N.prototype,"accessKeyFilterHelperText",void 0),r([d("#terminate-session-dialog")],N.prototype,"terminateSessionDialog",void 0),r([d("#terminate-selected-sessions-dialog")],N.prototype,"terminateSelectedSessionsDialog",void 0),r([d("#status-detail-dialog")],N.prototype,"sessionStatusInfoDialog",void 0),r([d("#work-dialog")],N.prototype,"workDialog",void 0),r([d("#help-description")],N.prototype,"helpDescriptionDialog",void 0),r([d("#commit-session-dialog")],N.prototype,"commitSessionDialog",void 0),r([d("#commit-current-session-path-input")],N.prototype,"commitSessionInput",void 0),r([d("#list-status")],N.prototype,"_listStatus",void 0),N=j=r([p("backend-ai-session-list")],N);let z=M=class extends u{constructor(){super(),this._status="inactive",this.active=!1,this.is_admin=!1,this.enableInferenceWorkload=!1,this.enableSFTPSession=!1,this.filterAccessKey="",this._connectionMode="API",this._defaultFileName="",this.active=!1,this._status="inactive"}static get styles(){return[h,m,g,k,x,i`
        mwc-menu {
