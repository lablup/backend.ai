import{_ as e,n as t,e as i,t as s,B as a,b as o,I as r,a as n,u as l,c as d,i as c,g as u,d as m,f as p,p as h,x as g}from"./backend-ai-webui-BSTsu8kd.js";import"./lablup-grid-sort-filter-column-BJmlT9Fm.js";import"./lablup-loading-spinner-DB1YFiaJ.js";import"./vaadin-grid-selection-column-DD_fJnQr.js";import"./vaadin-grid-4zZ_WRaE.js";import"./vaadin-grid-filter-column-C4799fbS.js";import"./vaadin-grid-sort-column-CFNnjezT.js";import"./mwc-switch-CVREhZCO.js";import"./backend-ai-list-status-pKk3hVBx.js";import"./vaadin-item-CeHaoNvT.js";import"./lablup-activity-panel-Zn9sUJ18.js";import"./mwc-tab-bar-C2qdFQtR.js";import"./active-mixin-BdQ6Kygl.js";import"./dir-utils-BTOUAXq0.js";import"./vaadin-item-mixin-ClHtfPpF.js";let v=class extends a{constructor(){super(),this.selectedIndex=0,this.selectedImages=[],this._cuda_gpu_disabled=!1,this._cuda_fgpu_disabled=!1,this._rocm_gpu_disabled=!1,this._tpu_disabled=!1,this._ipu_disabled=!1,this._atom_disabled=!1,this._warboy_disabled=!1,this._hyperaccel_lpu_disabled=!1,this.alias=Object(),this.indicator=Object(),this.deleteAppInfo=Object(),this.deleteAppRow=Object(),this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object(),this.servicePortsMsg="",this._range={cpu:["1","2","3","4","5","6","7","8"],mem:["64MB","128MB","256MB","512MB","1GB","2GB","4GB","8GB","16GB","32GB","256GB","512GB"],"cuda-gpu":["0","1","2","3","4","5","6","7"],"cuda-fgpu":["0","0.1","0.2","0.5","1.0","2.0","4.0","8.0"],"rocm-gpu":["0","1","2","3","4","5","6","7"],tpu:["0","1","2","3","4"],ipu:["0","1","2","3","4"],atom:["0","1","2","3","4"],warboy:["0","1","2","3","4"],hyperaccel_lpu:["0","1","2","3","4"]},this.cpuValue=0,this.listCondition="loading",this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this._boundBaseImageRenderer=this.baseImageRenderer.bind(this),this._boundConstraintRenderer=this.constraintRenderer.bind(this),this._boundDigestRenderer=this.digestRenderer.bind(this),this.installImageNameList=[],this.deleteImageNameList=[],this.images=[],this.allowed_registries=[],this.servicePorts=[]}static get styles(){return[o,r,n,l,d,c`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `]}firstUpdated(){var e;this.indicator=globalThis.lablupIndicator,this.notification=globalThis.lablupNotification,this.resourceBroker=globalThis.resourceBroker,void 0===globalThis.backendaiclient||null===globalThis.backendaiclient||!1===globalThis.backendaiclient.ready?document.addEventListener("backend-ai-connected",(()=>{this._getImages()}),!0):this._getImages(),this._grid=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("#testgrid"),this._grid.addEventListener("sorter-changed",(e=>{this._refreshSorter(e)})),document.addEventListener("image-rescanned",(()=>{this._getImages()})),this.installImageDialog.addEventListener("didHide",(()=>{this._uncheckSelectedRow()})),this.deleteImageDialog.addEventListener("didHide",(()=>{this._uncheckSelectedRow()}))}_removeRow(){this.deleteAppRow.remove(),this.deleteAppInfoDialog.hide(),this.notification.text=u("environment.AppInfoDeleted"),this.notification.show()}_addRow(){const e=this.modifyAppContainer.children[this.modifyAppContainer.children.length-1],t=this._createRow();this.modifyAppContainer.insertBefore(t,e)}_createRow(){const e=document.createElement("div");e.setAttribute("class","row extra");const t=document.createElement("mwc-textfield");t.setAttribute("type","text");const i=document.createElement("mwc-textfield");t.setAttribute("type","text");const s=document.createElement("mwc-textfield");t.setAttribute("type","number");const a=document.createElement("mwc-icon-button");return a.setAttribute("class","fg pink"),a.setAttribute("icon","remove"),a.addEventListener("click",(e=>this._checkDeleteAppInfo(e))),e.appendChild(s),e.appendChild(i),e.appendChild(t),e.appendChild(a),e}_checkDeleteAppInfo(e){var t;this.deleteAppRow=e.target.parentNode;const i=[...this.deleteAppRow.children].filter((e=>"MWC-TEXTFIELD"===e.tagName)).map((e=>e.value));(null===(t=i.filter((e=>""===e)))||void 0===t?void 0:t.length)===i.length?this._removeRow():(this.deleteAppInfo=i,this.deleteAppInfoDialog.show())}_clearRows(){const e=this.modifyAppContainer.querySelectorAll(".row");e[e.length-1].querySelectorAll("mwc-textfield").forEach((e=>{e.value=""})),this.modifyAppContainer.querySelectorAll(".row.extra").forEach((e=>{e.remove()}))}_uncheckSelectedRow(){this._grid.selectedItems=[]}_refreshSorter(e){const t=e.target,i=t.path.toString();t.direction&&("asc"===t.direction?this._grid.items.sort(((e,t)=>e[i]<t[i]?-1:e[i]>t[i]?1:0)):this._grid.items.sort(((e,t)=>e[i]>t[i]?-1:e[i]<t[i]?1:0)))}async _viewStateChanged(e){await this.updateComplete}_getImages(){var e;this.listCondition="loading",null===(e=this._listStatus)||void 0===e||e.show(),globalThis.backendaiclient.domain.get(globalThis.backendaiclient._config.domainName,["allowed_docker_registries"]).then((e=>(this.allowed_registries=e.domain.allowed_docker_registries,globalThis.backendaiclient.image.list(["name","tag","registry","architecture","digest","installed","labels { key value }","resource_limits { key min max }"],!1,!0)))).then((e=>{var t;const i=e.images,s=[];i.forEach((e=>{var t,i;if("registry"in e&&this.allowed_registries.includes(e.registry)){const a=e.tag.split("-");if(void 0!==a[1]){let s,o;e.baseversion=a[0],e.baseimage=a[1],void 0!==a[2]&&(s=this._humanizeName(a.slice(2,a.indexOf("customized_")).join("-")),o=null===(i=null===(t=e.labels)||void 0===t?void 0:t.find((e=>"ai.backend.customized-image.name"===e.key)))||void 0===i?void 0:i.value,e.constraint=[s,null!=o?o:void 0])}else void 0!==e.tag?e.baseversion=e.tag:e.baseversion="";const o=e.name.split("/");void 0!==o[1]?(e.namespace=o[0],e.lang=o.slice(1).join("")):(e.namespace="",e.lang=o[0]);const r=e.lang.split("-");let n;n=void 0!==e.baseimage?[this._humanizeName(e.baseimage)]:[],void 0!==r[1]&&("r"===r[0]?(e.lang=r[0],n.push(this._humanizeName(r[0]))):(e.lang=r[1],n.push(this._humanizeName(r[0])))),e.baseimage=n,e.lang=this._humanizeName(e.lang);e.resource_limits.forEach((t=>{0==t.max&&(t.max="∞"),"cuda.device"==t.key&&(t.key="cuda_device"),"cuda.shares"==t.key&&(t.key="cuda_shares"),"rocm.device"==t.key&&(t.key="rocm_device"),"tpu.device"==t.key&&(t.key="tpu_device"),"ipu.device"==t.key&&(t.key="ipu_device"),"atom.device"==t.key&&(t.key="atom_device"),"warboy.device"==t.key&&(t.key="warboy_device"),"hyperaccel-lpu.device"==t.key&&(t.key="hyperaccl_lpu_device"),null!==t.min&&void 0!==t.min&&(e[t.key+"_limit_min"]=this._addUnit(t.min)),null!==t.max&&void 0!==t.max?e[t.key+"_limit_max"]=this._addUnit(t.max):e[t.key+"_limit_max"]=1/0})),e.labels=e.labels.reduce(((e,t)=>({...e,[t.key]:t.value})),{}),s.push(e)}}));const a=s.sort(((e,t)=>t.installed-e.installed));this.images=a,0==this.images.length?this.listCondition="no-data":null===(t=this._listStatus)||void 0===t||t.hide()})).catch((e=>{var t;console.log(e),void 0!==e.message?(this.notification.text=m.relieve(e.title),this.notification.detail=e.message):this.notification.text=m.relieve("Problem occurred during image metadata loading."),this.notification.show(!0,e),null===(t=this._listStatus)||void 0===t||t.hide()}))}_addUnit(e){const t=e.substr(-1);return"m"==t?e.slice(0,-1)+"MiB":"g"==t?e.slice(0,-1)+"GiB":"t"==t?e.slice(0,-1)+"TiB":e}_symbolicUnit(e){const t=e.substr(-2);return"MB"==t?e.slice(0,-2)+"m":"GB"==t?e.slice(0,-2)+"g":"TB"==t?e.slice(0,-2)+"t":e}_humanizeName(e){this.alias=this.resourceBroker.imageTagAlias;const t=this.resourceBroker.imageTagReplace;for(const[i,s]of Object.entries(t)){const t=new RegExp(i);if(t.test(e))return e.replace(t,s)}return e in this.alias?this.alias[e]:e}_changeSliderValue(e){var t,i;const s=this._range[e.id].filter(((t,i)=>i===e.value));(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("#modify-image-"+e.id)).label=s[0],(null===(i=this.shadowRoot)||void 0===i?void 0:i.querySelector("#modify-image-"+e.id)).value=s[0]}_markIfUnlimited(e){return["-",0,"Unlimited",1/0,"Infinity"].includes(e)?"∞":e}_hideDialogById(e){var t;return(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(e)).hide()}_launchDialogById(e){var t;return(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(e)).show()}modifyImage(){const e=this.modifyImageCpu.label,t=this.modifyImageMemory.label,i=this.modifyImageCudaGpu.label,s=this.modifyImageCudaFGpu.label,a=this.modifyImageRocmGpu.label,o=this.modifyImageTpu.label,r=this.modifyImageIpu.label,n=this.modifyImageAtom.label,l=this.modifyImageWarboy.label,d=this.modifyImageHyperaccelLPU.label,{resource_limits:c}=this.images[this.selectedIndex],m={},p=this._cuda_gpu_disabled?this._cuda_fgpu_disabled?1:2:this._cuda_fgpu_disabled?2:3;e!==c[0].min&&(m.cpu={min:e});const h=this._symbolicUnit(t);h!==c[p].min&&(m.mem={min:h}),this._cuda_gpu_disabled||i===c[1].min||(m["cuda.device"]={min:i}),this._cuda_fgpu_disabled||s===c[2].min||(m["cuda.shares"]={min:s}),this._rocm_gpu_disabled||a===c[3].min||(m["rocm.device"]={min:a}),this._tpu_disabled||o===c[4].min||(m["tpu.device"]={min:o}),this._ipu_disabled||r===c[5].min||(m["ipu.device"]={min:r}),this._atom_disabled||n===c[6].min||(m["atom.device"]={min:n}),this._warboy_disabled||l===c[6].min||(m["warboy.device"]={min:l}),this._hyperaccel_lpu_disabled||d===c[6].min||(m["hyperaccel-lpu.device"]={min:d});const g=this.images[this.selectedIndex];if(0===Object.keys(m).length)return this.notification.text=u("environment.NoChangeMade"),this.notification.show(),void this._hideDialogById("#modify-image-dialog");globalThis.backendaiclient.image.modifyResource(g.registry,g.name,g.tag,m).then((e=>{e.reduce(((e,t)=>e&&"ok"===t.result),!0)?(this._getImages(),this.requestUpdate(),this.notification.text=u("environment.SuccessfullyModified")):this.notification.text=u("environment.ProblemOccurred"),this.notification.show(),this._hideDialogById("#modify-image-dialog")}))}openInstallImageDialog(){this.selectedImages=this._grid.selectedItems.filter((e=>!e.installed)),this.installImageNameList=this.selectedImages.map((e=>(Object.keys(e).map((t=>{["registry","name","tag"].includes(t)&&t in e&&(e[t]=e[t].replace(/\s/g,""))})),e.registry+"/"+e.name+":"+e.tag))),this.selectedImages.length>0?this.installImageDialog.show():(this.notification.text=u("environment.SelectedImagesAlreadyInstalled"),this.notification.show())}_installImage(){this.installImageDialog.hide(),this.selectedImages.forEach((async e=>{const t='[id="'+e.registry.replace(/\./gi,"-")+"-"+e.name.replace("/","-")+"-"+e.tag.replace(/\./gi,"-")+'"]';this._grid.querySelector(t).setAttribute("style","display:block;");const i=e.registry+"/"+e.name+":"+e.tag;let s=!1;const a=Object();"resource_limits"in e&&e.resource_limits.forEach((e=>{a[e.key.replace("_",".")]=e.min})),"cuda.device"in a&&"cuda.shares"in a?(s=!0,a.gpu=0,a.fgpu=a["cuda.shares"]):"cuda.device"in a?(a.gpu=a["cuda.device"],s=!0):s=!1,a.mem.endsWith("g")?a.mem=a.mem.replace("g",".5g"):a.mem.endsWith("m")&&(a.mem=Number(a.mem.slice(0,-1))+256+"m"),a.domain=globalThis.backendaiclient._config.domainName,a.group_name=globalThis.backendaiclient.current_group;const o=await globalThis.backendaiclient.get_resource_slots();s&&("cuda.device"in o||"cuda.shares"in o||(delete a.gpu,delete a.fgpu,delete a["cuda.shares"],delete a["cuda.device"])),"cuda.device"in o&&"cuda.shares"in o?"fgpu"in a&&"gpu"in a&&(delete a.gpu,delete a["cuda.device"]):"cuda.device"in o?(delete a.fgpu,delete a["cuda.shares"]):"cuda.shares"in o&&(delete a.gpu,delete a["cuda.device"]),a.enqueueOnly=!0,a.type="batch",a.startupCommand='echo "Image is installed"',this.notification.text=u("environment.InstallingImage")+i+u("environment.TakesTime"),this.notification.show();const r=await this.indicator.start("indeterminate");r.set(10,u("import.Downloading")),globalThis.backendaiclient.image.install(i,e.architecture,a).then((()=>{r.end(1e3)})).catch((e=>{this._grid.querySelector(t).className=u("environment.Installing"),this._grid.querySelector(t).setAttribute("style","display:none;"),this._uncheckSelectedRow(),this.notification.text=m.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e),r.set(100,p("environment.DescProblemOccurred")),r.end(1e3)}))}))}openDeleteImageDialog(){this.selectedImages=this._grid.selectedItems.filter((e=>e.installed)),this.deleteImageNameList=this.selectedImages.map((e=>e.registry+"/"+e.name+":"+e.tag)),this.selectedImages.length>0?this.deleteImageDialog.show():(this.notification.text=u("environment.SelectedImagesNotInstalled"),this.notification.show())}_deleteImage(){}_setPulldownDefaults(e){var t,i,s,a,o,r,n,l,d,c,u,m,h,g,v,y,b,_;this._cuda_gpu_disabled=0===e.filter((e=>"cuda_device"===e.key)).length,this._cuda_fgpu_disabled=0===e.filter((e=>"cuda_shares"===e.key)).length,this._rocm_gpu_disabled=0===e.filter((e=>"rocm_device"===e.key)).length,this._tpu_disabled=0===e.filter((e=>"tpu_device"===e.key)).length,this._ipu_disabled=0===e.filter((e=>"ipu_device"===e.key)).length,this._atom_disabled=0===e.filter((e=>"atom_device"===e.key)).length,this._warboy_disabled=0===e.filter((e=>"warboy_device"===e.key)).length,this._hyperaccel_lpu_disabled=0===e.filter((e=>"hyperaccel_lpu_device"===e.key)).length;const f=e.reduce(((e,t)=>{const{key:i,...s}=t,a=s;return e[t.key]=a,e}),{});this.modifyImageCpu.label=f.cpu.min,this._cuda_gpu_disabled?(this.modifyImageCudaGpu.label=p("environment.Disabled"),(null===(i=this.shadowRoot)||void 0===i?void 0:i.querySelector("mwc-slider#cuda-gpu")).value=0):(this.modifyImageCudaGpu.label=f.cuda_device.min,(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("mwc-slider#cuda-gpu")).value=this._range["cuda-gpu"].indexOf(this._range["cuda-gpu"].filter((e=>e===f.cuda_device.min))[0])),this._cuda_fgpu_disabled?(this.modifyImageCudaFGpu.label=p("environment.Disabled"),(null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector("mwc-slider#cuda-gpu")).value=0):(this.modifyImageCudaFGpu.label=f.cuda_shares.min,(null===(s=this.shadowRoot)||void 0===s?void 0:s.querySelector("mwc-slider#cuda-fgpu")).value=this._range["cuda-fgpu"].indexOf(this._range["cuda-fgpu"].filter((e=>e===f.cuda_shares.min))[0])),this._rocm_gpu_disabled?(this.modifyImageRocmGpu.label=p("environment.Disabled"),(null===(r=this.shadowRoot)||void 0===r?void 0:r.querySelector("mwc-slider#rocm-gpu")).value=0):(this.modifyImageRocmGpu.label=f.rocm_device.min,(null===(o=this.shadowRoot)||void 0===o?void 0:o.querySelector("mwc-slider#rocm-gpu")).value=this._range["rocm-gpu"].indexOf(this._range["rocm-gpu"].filter((e=>e===f.rocm_device.min))[0])),this._tpu_disabled?(this.modifyImageTpu.label=p("environment.Disabled"),(null===(l=this.shadowRoot)||void 0===l?void 0:l.querySelector("mwc-slider#tpu")).value=0):(this.modifyImageTpu.label=f.tpu_device.min,(null===(n=this.shadowRoot)||void 0===n?void 0:n.querySelector("mwc-slider#tpu")).value=this._range.tpu.indexOf(this._range.tpu.filter((e=>e===f.tpu_device.min))[0])),this._ipu_disabled?(this.modifyImageTpu.label=p("environment.Disabled"),(null===(c=this.shadowRoot)||void 0===c?void 0:c.querySelector("mwc-slider#ipu")).value=0):(this.modifyImageIpu.label=f.ipu_device.min,(null===(d=this.shadowRoot)||void 0===d?void 0:d.querySelector("mwc-slider#ipu")).value=this._range.ipu.indexOf(this._range.ipu.filter((e=>e===f.ipu_device.min))[0])),this._atom_disabled?(this.modifyImageAtom.label=p("environment.Disabled"),(null===(m=this.shadowRoot)||void 0===m?void 0:m.querySelector("mwc-slider#atom")).value=0):(this.modifyImageAtom.label=f.atom_device.min,(null===(u=this.shadowRoot)||void 0===u?void 0:u.querySelector("mwc-slider#atom")).value=this._range.atom.indexOf(this._range.atom.filter((e=>e===f.atom_device.min))[0])),this._warboy_disabled?(this.modifyImageWarboy.label=p("environment.Disabled"),(null===(g=this.shadowRoot)||void 0===g?void 0:g.querySelector("mwc-slider#warboy")).value=0):(this.modifyImageWarboy.label=f.warboy_device.min,(null===(h=this.shadowRoot)||void 0===h?void 0:h.querySelector("mwc-slider#warboy")).value=this._range.warboy.indexOf(this._range.warboy.filter((e=>e===f.warboy_device.min))[0])),this._hyperaccel_lpu_disabled?(this.modifyImageHyperaccelLPU.label=p("environment.Disabled"),(null===(y=this.shadowRoot)||void 0===y?void 0:y.querySelector("mwc-slider#hyperaccel-lpu")).value=0):(this.modifyImageHyperaccelLPU.label=f.hyperaccel_lpu_device.min,(null===(v=this.shadowRoot)||void 0===v?void 0:v.querySelector("mwc-slider#hyperaccel-lpu")).value=this._range["hyperaccel-lpu"].indexOf(this._range["hyperaccel-lpu"].filter((e=>e===f.hyperaccel_lpu_device.min))[0])),this.modifyImageMemory.label=this._addUnit(f.mem.min),(null===(b=this.shadowRoot)||void 0===b?void 0:b.querySelector("mwc-slider#cpu")).value=this._range.cpu.indexOf(this._range.cpu.filter((e=>e===f.cpu.min))[0]),(null===(_=this.shadowRoot)||void 0===_?void 0:_.querySelector("mwc-slider#mem")).value=this._range.mem.indexOf(this._range.mem.filter((e=>e===this._addUnit(f.mem.min)))[0]),this._updateSliderLayout()}_updateSliderLayout(){var e;null===(e=this.shadowRoot)||void 0===e||e.querySelectorAll("mwc-slider").forEach((e=>{e.layout()}))}_decodeServicePort(){""===this.images[this.selectedIndex].labels["ai.backend.service-ports"]?this.servicePorts=[]:this.servicePorts=this.images[this.selectedIndex].labels["ai.backend.service-ports"].split(",").map((e=>{const t=e.split(":");return{app:t[0],protocol:t[1],port:t[2]}}))}_isServicePortValid(){var e;const t=(null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("#modify-app-container")).querySelectorAll(".row:not(.header)"),i=new Set;for(const e of Array.from(t)){const t=e.querySelectorAll("mwc-textfield");if(Array.prototype.every.call(t,(e=>""===e.value)))continue;const s=t[0].value,a=t[1].value,o=parseInt(t[2].value);if(""===s)return this.servicePortsMsg=u("environment.AppNameMustNotBeEmpty"),!1;if(!["http","tcp","pty","preopen"].includes(a))return this.servicePortsMsg=u("environment.ProtocolMustBeOneOfSupported"),!1;if(i.has(o))return this.servicePortsMsg=u("environment.PortMustBeUnique"),!1;if(o>=66535||o<0)return this.servicePortsMsg=u("environment.PortMustBeInRange"),!1;if([2e3,2001,2002,2003,2200,7681].includes(o))return this.servicePortsMsg=u("environment.PortReservedForInternalUse"),!1;i.add(o)}return!0}_parseServicePort(){var e;const t=(null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("#modify-app-container")).querySelectorAll(".row:not(.header)");return Array.prototype.filter.call(t,(e=>(e=>0===Array.prototype.filter.call(e.querySelectorAll("mwc-textfield"),((e,t)=>""===e.value)).length)(e))).map((e=>(e=>Array.prototype.map.call(e.querySelectorAll("mwc-textfield"),(e=>e.value)).join(":"))(e))).join(",")}modifyServicePort(){if(this._isServicePortValid()){const e=this._parseServicePort(),t=this.images[this.selectedIndex];this.servicePortsMsg="",globalThis.backendaiclient.image.modifyLabel(t.registry,t.name,t.tag,"ai.backend.service-ports",e).then((({result:e})=>{this.notification.text=u("ok"===e?"environment.DescServicePortModified":"dialog.ErrorOccurred"),this._getImages(),this.requestUpdate(),this._clearRows(),this.notification.show(),this._hideDialogById("#modify-app-dialog")}))}}requirementsRenderer(e,t,i){h(g`
      ...
      <div class="list-wrapper">
        ...
        <backend-ai-list-status
          ...
          message="${u("environment.NoImageToDisplay")}"
        ></backend-ai-list-status>
      </div>
      ...
      <backend-ai-dialog id="modify-app-dialog" fixed backdrop>
        ...
        <div slot="content" id="modify-app-container">
          ...
          ${null===(e=this.servicePorts)||void 0===e?void 0:e.map(((e,t)=>g`
              <div class="row">
    ...
    `}};var y;e([t({type:Array})],v.prototype,"images",void 0),e([t({type:Object})],v.prototype,"resourceBroker",void 0),e([t({type:Array})],v.prototype,"allowed_registries",void 0),e([t({type:Array})],v.prototype,"servicePorts",void 0),e([t({type:Number})],v.prototype,"selectedIndex",void 0),e([t({type:Array})],v.prototype,"selectedImages",void 0),e([t({type:Boolean})],v.prototype,"_cuda_gpu_disabled",void 0),e([t({type:Boolean})],v.prototype,"_cuda_fgpu_disabled",void 0),e([t({type:Boolean})],v.prototype,"_rocm_gpu_disabled",void 0),e([t({type:Boolean})],v.prototype,"_tpu_disabled",void 0),e([t({type:Boolean})],v.prototype,"_ipu_disabled",void 0),e([t({type:Boolean})],v.prototype,"_atom_disabled",void 0),e([t({type:Boolean})],v.prototype,"_warboy_disabled",void 0),e([t({type:Boolean})],v.prototype,"_hyperaccel_lpu_disabled",void 0),e([t({type:Object})],v.prototype,"alias",void 0),e([t({type:Object})],v.prototype,"indicator",void 0),e([t({type:Array})],v.prototype,"installImageNameList",void 0),e([t({type:Array})],v.prototype,"deleteImageNameList",void 0),e([t({type:Object})],v.prototype,"deleteAppInfo",void 0),e([t({type:Object})],v.prototype,"deleteAppRow",void 0),e([t({type:Object})],v.prototype,"installImageResource",void 0),e([t({type:Object})],v.prototype,"selectedCheckbox",void 0),e([t({type:Object})],v.prototype,"_grid",void 0),e([t({type:String})],v.prototype,"servicePortsMsg",void 0),e([t({type:Object})],v.prototype,"_range",void 0),e([t({type:Number})],v.prototype,"cpuValue",void 0),e([t({type:String})],v.prototype,"listCondition",void 0),e([t({type:Object})],v.prototype,"_boundRequirementsRenderer",void 0),e([t({type:Object})],v.prototype,"_boundControlsRenderer",void 0),e([t({type:Object})],v.prototype,"_boundInstallRenderer",void 0),e([t({type:Object})],v.prototype,"_boundBaseImageRenderer",void 0),e([t({type:Object})],v.prototype,"_boundConstraintRenderer",void 0),e([t({type:Object})],v.prototype,"_boundDigestRenderer",void 0),e([i("#loading-spinner")],v.prototype,"spinner",void 0),e([i("#modify-image-cpu")],v.prototype,"modifyImageCpu",void 0),e([i("#modify-image-mem")],v.prototype,"modifyImageMemory",void 0),e([i("#modify-image-cuda-gpu")],v.prototype,"modifyImageCudaGpu",void 0),e([i("#modify-image-cuda-fgpu")],v.prototype,"modifyImageCudaFGpu",void 0),e([i("#modify-image-rocm-gpu")],v.prototype,"modifyImageRocmGpu",void 0),e([i("#modify-image-tpu")],v.prototype,"modifyImageTpu",void 0),e([i("#modify-image-ipu")],v.prototype,"modifyImageIpu",void 0),e([i("#modify-image-atom")],v.prototype,"modifyImageAtom",void 0),e([i("#modify-image-warboy")],v.prototype,"modifyImageWarboy",void 0),e([i("#modify-image-hyperaccel-lpu")],v.prototype,"modifyImageHyperaccelLPU",void 0),e([i("#delete-app-info-dialog")],v.prototype,"deleteAppInfoDialog",void 0),e([i("#delete-image-dialog")],v.prototype,"deleteImageDialog",void 0),e([i("#install-image-dialog")],v.prototype,"installImageDialog",void 0),e([i("#modify-app-container")],v.prototype,"modifyAppContainer",void 0),e([i("#list-status")],v.prototype,"_listStatus",void 0),v=e([s("backend-ai-environment-list")],v);let b=y=class extends a{constructor(){super(),this._listCondition="loading",this._editMode=!1,this._registryType="docker",this._selectedIndex=-1,this._boundIsEnabledRenderer=this._isEnabledRenderer.bind(this),this._boundControlsRenderer=this._controlsRenderer.bind(this),this._boundPasswordRenderer=this._passwordRenderer.bind(this),this._allowed_registries=[],this._editMode=!1,this._hostnames=[],this._registryList=[]}static get styles(){return[o,r,n,c`
      ...
      <div class="list-wrapper">
        ...
        <backend-ai-list-status
          ...
          message="${u("registry.NoRegistryToDisplay")}"
        ></backend-ai-list-status>
      </div>
      <backend-ai-dialog
      ...
      <div style="margin:0px;">
        ...
        <div class="list-wrapper">
          ...
          <backend-ai-list-status
            id="list-status"
            statusCondition="${this.listCondition}"
            message="${u("resourcePreset.NoResourcePresetToDisplay")}"
          ></backend-ai-list-status>
        </div>
      </div>
      <backend-ai-dialog
