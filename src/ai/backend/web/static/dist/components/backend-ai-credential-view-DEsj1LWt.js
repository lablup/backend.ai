import{_ as e,n as i,e as t,t as s,B as o,b as a,I as r,a as l,u as n,c,i as d,d as u,g as p,p as h,x as m,f as v,J as y}from"./backend-ai-webui-OltTK2Ch.js";import{J as _}from"./vaadin-iconset-BEs5Zaee.js";import"./backend-ai-list-status-CM5iFAFu.js";import"./lablup-grid-sort-filter-column-CdHo1rZQ.js";import"./vaadin-grid-ori3mwSb.js";import"./vaadin-grid-filter-column-Bnf0nHtq.js";import"./vaadin-grid-sort-column-tC8_iSFZ.js";import"./vaadin-item-CnjrvEvN.js";import"./backend-ai-multi-select-Ann5dYhv.js";import{r as g}from"./state-C2MI6VlB.js";import"./mwc-switch-B4ridzlv.js";import"./lablup-activity-panel-Xrp0-Ruq.js";import"./mwc-formfield-BpzDVRBt.js";import"./mwc-tab-bar-C0onxas8.js";import"./dir-utils-Djx442Fy.js";import"./vaadin-item-mixin-BB0DaYV9.js";import"./active-mixin-CTraZYwJ.js";import"./mwc-check-list-item-Sgao1Cvj.js";var f;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let w=f=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey="",this.supportMainAccessKey=!1,this._mainAccessKeyList=[]}static get styles(){return[a,r,l,n,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
