import{_ as e,n as i,e as t,t as s,B as o,b as a,I as r,a as l,u as n,c,i as d,d as u,g as p,p as h,x as m,f as v,J as y}from"./backend-ai-webui-CEkmyWzH.js";import{J as _}from"./vaadin-iconset-BHKQI7m_.js";import"./backend-ai-list-status-BSRIl_1w.js";import"./lablup-grid-sort-filter-column-DzcmFvsU.js";import"./vaadin-grid-CEkjE_UW.js";import"./vaadin-grid-filter-column-ypb9dUQY.js";import"./vaadin-grid-sort-column-Cj6ziZx7.js";import"./vaadin-item-C4uRsb4h.js";import"./backend-ai-multi-select-D53iOu5m.js";import{r as g}from"./state-BYF3zJJE.js";import"./mwc-switch-CqK04O9c.js";import"./lablup-activity-panel-UIqbmNZG.js";import"./mwc-formfield-CXBhFJL9.js";import"./mwc-tab-bar-dwOfEq0G.js";import"./dir-utils-B8E3jKp1.js";import"./vaadin-item-mixin-D-6TH4P9.js";import"./active-mixin-CXUW9-EG.js";import"./mwc-check-list-item-Dg-xDA_j.js";var f;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let w=f=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey="",this.supportMainAccessKey=!1,this._mainAccessKeyList=[]}static get styles(){return[a,r,l,n,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
        ...
        <div slot="content">
          ...
          <div class="vertical center layout distancing" id="dropdown-area">
            ...
            <div
              ...
              style=${this.isDeprecatedMaxVfolderCountInKeypairResourcePolicy?"display:none;":"width:100%;"}
            >
              <mwc-textfield
    ...
    `}_indexRenderer(e,i,t){const s=t.index+1;h(m`
      ...
      `,e)}_displayResourcesByResourceUnit(e=0,i=!1,t=""){let s=0;const o=this._markIfUnlimited(e,i);switch(t=t.toLowerCase()){case"cpu":case"cuda_device":case"max_vfolder_count":s=0;break;case"mem":case"cuda_shares":s=1}return["∞","-"].includes(o)?o:Number(o).toFixed(s)}resourceRenderer(e,i,t){h(m`
        ...
        ${this.isDeprecatedMaxVfolderCountInKeypairResourcePolicy?m``:m`
              <div class="layout horizontal wrap center">
                <div class="layout horizontal configuration">
