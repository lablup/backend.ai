      ...
      <lablup-activity-panel noheader narrow autowidth>
        <div slot="message">
          ...
          <div id="registry-lists" class="tab-content">
            ${globalThis.backendaiclient.supports("container-registry-gql")&&"registry-lists"===this._activeTab?g`
