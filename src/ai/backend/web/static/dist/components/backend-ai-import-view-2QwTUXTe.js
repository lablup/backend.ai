import{_ as t,n as e,e as o,t as i,B as a,b as n,I as s,a as r,c as l,i as c,g as h,d,k as p,f as u}from"./backend-ai-webui-fhpimN3V.js";import"./backend-ai-session-launcher-D9XJSQcm.js";import"./lablup-progress-bar-Bx-7_C9f.js";import"./mwc-check-list-item-B9c_dSPA.js";let m=class extends a{constructor(){super(...arguments),this.condition="running",this.authenticated=!1,this.indicator=Object(),this.notification=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importNotebookMessage="",this.importGithubMessage="",this.importGitlabMessage="",this.allowedGroups=[],this.allowed_folder_type=[],this.vhost="",this.vhosts=[],this.storageInfo=Object(),this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.sessionLauncherType="neo"}static get styles(){return[n,s,r,l,c`
        div.description {
          font-size: 14px;
                ...
                <div slot="message">
                  <div class="horizontal wrap layout center">
                    <mwc-textfield
                      ...
                      autoValidate
                      validationMessage="${h("import.WrongURLType")}"
