import{_ as e,n as i,b as t,e as s,B as o,c as a,I as r,a as l,q as n,d as c,i as d,f as u,g as p,p as h,x as m,t as v,w as y,Q as _}from"./backend-ai-webui-56a57161.js";import{J as g}from"./json_to_csv-35c9e191.js";import"./backend-ai-list-status-712186f5.js";import"./lablup-grid-sort-filter-column-9fca2927.js";import"./vaadin-grid-5b4c4952.js";import"./vaadin-grid-filter-column-e0749f8b.js";import"./vaadin-grid-sort-column-d2fa540e.js";import"./vaadin-iconset-3cf18983.js";import"./vaadin-item-515717af.js";import"./backend-ai-multi-select-95ea12b2.js";import"./mwc-switch-be8a973a.js";import"./lablup-activity-panel-375f75db.js";import"./mwc-formfield-f4b36fa9.js";import"./mwc-tab-bar-b177b3ef.js";import"./dir-utils-fec807e6.js";import"./vaadin-item-mixin-b94963ac.js";import"./mwc-check-list-item-b24ec567.js";var f;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let w=f=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey=""}static get styles(){return[a,r,l,n,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
    ...
    `}_indexRenderer(e,i,t){const s=t.index+1;h(m`
        <div>${s}</div>
      `,e)}_displayResourcesByResourceUnit(e=0,i=!1,t=""){let s=0;const o=this._markIfUnlimited(e,i);switch(t=t.toLowerCase()){case"cpu":case"cuda_device":s=0;break;case"mem":case"cuda_shares":s=1}return["∞","-"].includes(o)?o:Number(o).toFixed(s)}resourceRenderer(e,i,t){h(m`
        <div class="layout horizontal wrap center">
          <div class="layout horizontal configuration">
