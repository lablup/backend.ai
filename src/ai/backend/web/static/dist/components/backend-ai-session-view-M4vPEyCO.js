import{m as e,r as t,i,o as s,p as n,q as o,T as a,D as l,P as r,_ as c,n as d,e as p,t as u,B as h,b as m,I as g,a as v,d as _,Q as b,k as f,g as y,f as w,u as k,v as x,c as A}from"./backend-ai-webui-ByNpTuXm.js";import{J as S}from"./vaadin-iconset-rP3nP1wE.js";import"./backend-ai-resource-monitor-clyqF90r.js";import"./backend-ai-session-launcher-BsQnCFDD.js";import"./backend-ai-list-status-DX06bbhO.js";import"./lablup-grid-sort-filter-column-CCcvjTZ3.js";import"./lablup-progress-bar-BeiecOEw.js";import"./vaadin-grid-filter-column-BprXdEAq.js";import"./lablup-activity-panel-tS7OfMvz.js";import"./mwc-formfield-BtDLDrX-.js";import"./mwc-tab-bar-BPWPSxoQ.js";import"./mwc-switch-DgdT8TP6.js";import"./slider-Bb_Jsuzf.js";import"./mwc-check-list-item-BplstmkF.js";
/**
 * @license
...
${i.item[this.sessionNameField]}</pre
      ...
      `,e)}controlRenderer(e,t,i){var s;let n=!0;n="API"===this._connectionMode&&i.item.access_key===globalThis.backendaiclient._config._accessKey||i.item.user_email===globalThis.backendaiclient.email,b(f`
        ...
        >
          ...
          ${this._isRunning&&!this._isPreparing(i.item.status)||this._isError(i.item.status)?f`
                ...
                ></vaadin-tooltip>
              `:f``}
          ${!(this._isRunning&&!this._isPreparing(i.item.status)||this._APIMajorVersion>4)||this._isPending(i.item.status)||this._isPreparing(i.item.status)?f`
                <mwc-icon-button
                  fab
                  flat
                  inverted
      ...
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?b(f``,e):b(f`
          ...
          <div class="layout vertical flex" style="padding-left: 25px">
            ...
            <div class="layout horizontal center configuration">
              ...
              ${i.item.hyeraccel_lpu_slot?f`
                  ...
                  `:f``}
              ${i.item.cuda_gpu_slot||i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot||i.item.tpu_slot||i.item.ipu_slot||i.item.atom_slot||i.item.atom_plus_slot||i.item.warboy_slot||i.item.hyperaccel_lpu_slot?f``:f`
                    <mwc-icon class="fg green indicator">view_module</mwc-icon>
                    <span>-</span>
                    <span class="indicator">GPU</span>
                  `}
        ...
        `,e)}usageRenderer(e,t,i){var s,n,o,a,l,r,c,d,p,u,h,m,g,v,_,y,w,k,x,A,S,$,T,C,I,D,E,R,M,j,z,L,F,O,P,B,U,G,K,H,q,V,J,W,Y,Z,Q,X,ee,te,ie,se,ne,oe,ae,le,re,ce,de,pe,ue,he,me,ge,ve,_e,be,fe,ye,we;["batch","interactive","inference","running"].includes(this.condition)?b(f`
          <div class="vertical start start-justified layout">
            ...
            <div class="vertical start-justified layout">
              <div class="usage-items">
                RAM
                ${i.item.live_stat?N.bytesToGiB(null===(d=null===(c=i.item.live_stat)||void 0===c?void 0:c.mem)||void 0===d?void 0:d.current,1)/N.bytesToGiB(null===(u=null===(p=i.item.live_stat)||void 0===p?void 0:p.mem)||void 0===u?void 0:u.capacity,1):"-"}
                GiB
              </div>
              <div class="horizontal start-justified center layout">
                <lablup-progress-bar
            ...
            ${i.item.cuda_fgpu_slot&&parseFloat(i.item.cuda_fgpu_slot)>0?f`
                ...
                `:f``}
            ${i.item.rocm_gpu_slot&&parseFloat(i.item.cuda_rocm_gpu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(util)
                      ${i.item.live_stat?(100*(null===(D=null===(I=i.item.live_stat)||void 0===I?void 0:I.rocm_util)||void 0===D?void 0:D.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                ...
                `:f``}
            ${i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${i.item.live_stat?N.bytesToGiB(null===(L=null===(z=i.item.live_stat)||void 0===z?void 0:z.cuda_mem)||void 0===L?void 0:L.current,1)/N.bytesToGiB(null===(O=null===(F=i.item.live_stat)||void 0===F?void 0:F.cuda_mem)||void 0===O?void 0:O.capacity,1):"-"}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
            ...
            ${i.item.tpu_slot&&parseFloat(i.item.tpu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      TPU(util)
                      ${i.item.live_stat?(100*(null===(G=null===(U=i.item.live_stat)||void 0===U?void 0:U.tpu_util)||void 0===G?void 0:G.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
            ...
            ${i.item.ipu_slot&&parseFloat(i.item.ipu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      IPU(util)
                      ${i.item.live_stat?(100*(null===(W=null===(J=i.item.live_stat)||void 0===J?void 0:J.ipu_util)||void 0===W?void 0:W.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
            ...
            ${i.item.atom_slot&&parseFloat(i.item.atom_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      ATOM(util)
                      ${i.item.live_stat?(100*(null===(se=null===(ie=i.item.live_stat)||void 0===ie?void 0:ie.atom_util)||void 0===se?void 0:se.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
            ...
            <div class="horizontal start-justified center layout">
              ...
              >
                R:
                ${i.item.live_stat?null===(ue=null===(pe=null===(de=i.item)||void 0===de?void 0:de.live_stat)||void 0===pe?void 0:pe.io_read)||void 0===ue?void 0:ue.current.toFixed(1):"-"}
                MB / W:
                ${i.item.live_stat?null===(ge=null===(me=null===(he=i.item)||void 0===he?void 0:he.live_stat)||void 0===me?void 0:me.io_write)||void 0===ge?void 0:ge.current.toFixed(1):"-"}
                MB
              </div>
            </div>
          </div>
          ...
          <div class="layout horizontal center flex">
            ...
            <div class="vertical start layout">
              <span style="font-size:9px">
                ${null!==(be=null===(_e=null===(ve=i.item.live_stat)||void 0===ve?void 0:ve.io_read)||void 0===_e?void 0:_e.current.toFixed(1))&&void 0!==be?be:"-"}
            ...
            <div class="vertical start layout">
              <span style="font-size:8px">
                ${null!==(we=null===(ye=null===(fe=i.item.live_stat)||void 0===fe?void 0:fe.io_write)||void 0===ye?void 0:ye.current.toFixed(1))&&void 0!==we?we:"-"}
                <span class="indicator">MB</span>
              </span>
