import{B as t,g as i,d as e,I as s,b as o,z as n,f as l,i as a,y as d,t as c,j as r,h as u,_ as h,e as p,c as v,a as g}from"./backend-ai-webui-ab578ea5.js";import"./vaadin-grid-f8664f17.js";import"./vaadin-grid-sort-column-ae65cab0.js";import"./mwc-switch-89803115.js";import"./lablup-activity-panel-6b88454f.js";import"./dir-utils-1d3affeb.js";
/**
 @license
 ...
 */let m=class extends t{constructor(){super(),this.images=Object(),this.schedulerOptions=Object(),this.networkOptions=Object(),this.notification=Object(),this.imagePullingBehavior=[{name:i("settings.image.digest"),behavior:"digest"},{name:i("settings.image.tag"),behavior:"tag"},{name:i("settings.image.none"),behavior:"none"}],this.jobschedulerType=["fifo","lifo","drf"],this.selectedSchedulerType="",this._helpDescriptionTitle="",this._helpDescription="",this.optionRange=Object(),this.options={image_pulling_behavior:"digest",cuda_gpu:!1,cuda_fgpu:!1,rocm_gpu:!1,tpu:!1,ipu:!1,atom:!1,warboy:!1,schedulerType:"fifo",scheduler:{num_retries_to_skip:"0"},network:{mtu:""}},this.optionRange={numRetries:{min:0,max:1e3},mtu:{min:0,max:15e3}},this.optionsAndId=[{option:"num_retries_to_skip",id:"num-retries"},{option:"mtu",id:"mtu"}]}static get is(){return"backend-ai-settings-view"}static get styles(){return[e,s,o,n,l,a`
      ...
      <div class="horizontal layout wrap">
          ...
          <div slot="message" class="horizontal wrap layout">
            ...
            <div class="horizontal layout setting-item">
              <div class="vertical center-justified layout setting-desc-select">
                ...
                <div class="description-extra">${r("settings.DescImagePullBehavior")}<br />
              ...
              <div class="vertical center-justified layout">
                ...
                ${this.imagePullingBehavior.map((t=>d`
          ...
          <div slot="message" class="horizontal wrap layout">
            <div class="horizontal layout setting-item">
              <div class="vertical center-justified layout setting-desc-shrink">
                ...
                <div class="description-shrink">${r("settings.DescUseCLIonGUI")}
                </div>
              </div>
              <div class="vertical center-justified layout setting-button">
            ...
            <div class="horizontal layout setting-item">
              <div class="vertical center-justified layout setting-desc-shrink">
                ...
                <div class="description-shrink">${r("settings.DescUseGUIonWeb")}
                </div>
              </div>
              <div class="vertical center-justified layout setting-button">
            ...
            <div style="margin:auto 16px;">
                ...
                <div class="horizontal layout wrap start start-justified">
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${r("settings.DescAllowAgentSideRegistration")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      <div class="title">${c("settings.OverlayNetwork")}</div>
                      <div class="description-shrink">${r("settings.OverlayNetworkConfiguration")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout">
                      <mwc-button
              ...
              <div class="vertical layout wrap">
                <div class="horizontal layout wrap start start-justified">
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${r("settings.DescCUDAGPUsupport")}
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${r("settings.DescROCMGPUsupport")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-select" style="margin: 15px 0px;">
                      ...
                      <div class="description-shrink">${c("settings.SchedulerConfiguration")}<br/>
                          ${c("settings.Require2009orAbove")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout">
                ...
                <div class="horizontal wrap layout">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      <div class="title">${c("settings.IPUsupport")}</div>
                      <div class="description-shrink">${r("settings.DescIPUsupport")} <br/>${c("settings.RequireIPUPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      <div class="title">${c("settings.ATOMsupport")}</div>
                      <div class="description-shrink">${r("settings.DescATOMsupport")} <br/>${c("settings.RequireATOMPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      <div class="title">${c("settings.Warboysupport")}</div>
                      <div class="description-shrink">${r("settings.DescWarboysupport")} <br/>${c("settings.RequireWarboyPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
        ...
        <backend-ai-dialog id="scheduler-env-dialog" class="env-dialog" fixed backdrop persistent closeWithConfirmation>
          <span slot="title" class="horizontal layout center">${r("settings.ConfigPerJobSchduler")}</span>
          <span slot="action">
          ...
          <div slot="content" id="scheduler-env-container" class="vertical layout centered env-container" style="width: 100%;">
            <mwc-select
              id="scheduler-switch"
              required
              label="${c("settings.Scheduler")}"
              style="margin-bottom: 10px;"
              validationMessage="${c("settings.SchedulerRequired")}"
              @selected="${t=>this.changeSelectedScheduleType(t)}">
              ${this.jobschedulerType.map((t=>d`
                <mwc-list-item value="${t}">
                  ${t.toUpperCase()}
                </mwc-list-item>`))}
            </mwc-select>
            <h4>${c("settings.SchedulerOptions")}</h4>
            <div class="horizontal center layout flex row">
              <span slot="title">${c("settings.SessionCreationRetries")}</span>
              ...
              <mwc-textfield  id="num-retries"
                              required
                              autoValidate
                              validationMessage="${c("settings.InputRequired")}"
                              type="number"
                              pattern="[0-9]+"
          ...
          <div slot="footer" class="horizontal end-justified flex layout">
            <mwc-button
              ...
              label="${c("button.DeleteAll")}"></mwc-button>
            <mwc-button
              unelevated
              ...
              label="${c("button.Save")}"></mwc-button>
          </div>
        </backend-ai-dialog>
        <backend-ai-dialog id="overlay-network-env-dialog" class="env-dialog" fixed backdrop persistent closeWithConfirmation>
          <span slot="title" class="horizontal layout center">${r("settings.OverlayNetworkSettings")}</span>
          <span slot="action">
        ...
        <backend-ai-dialog id="env-config-confirmation" warning fixed>
          ...
          <div slot="content">
            <p>${c("settings.EnvConfigWillDisappear")}</p>
            <p>${c("dialog.ask.DoYouWantToProceed")}</p>
          </div>
          <div slot="footer" class="horizontal end-justified flex layout">
            <mwc-button
               id="env-config-remain-button"
               style="width:auto;"
               label="${c("button.Cancel")}"
