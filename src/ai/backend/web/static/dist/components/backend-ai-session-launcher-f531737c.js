import{_ as e,e as t,c as i,a as s,s as o,d as n,I as a,b as r,k as l,f as d,i as c,y as h,B as u,h as p,g as m,Z as _,t as v,o as g}from"./backend-ai-webui-8cfa3078.js";import"./lablup-progress-bar-983562b2.js";import"./mwc-check-list-item-783de9f1.js";import"./slider-69ab92f2.js";import{r as f,n as y,o as b,T as x,D as w,j as k,P as D,h as C,p as S,q as I,s as T,A as E,t as P,l as M,E as $,k as A,v as O,w as z,x as R,y as B,z as F,B as V,H as L,I as N,J as q,K as j,L as H,M as U,N as G,O as W,Q as Y,e as K,R as X,g as Q,S as J,U as Z,V as ee,W as te,X as ie,Y as se,Z as oe,_ as ne,$ as ae,a0 as re}from"./vaadin-grid-3c702f04.js";import{i as le,I as de,a as ce,b as he,r as ue,h as pe,F as me}from"./vaadin-grid-filter-column-ca649020.js";import"./vaadin-grid-selection-column-a6951a8c.js";import{i as _e}from"./vaadin-item-styles-c40a397b.js";import"./expansion-bbc88840.js";import"./label-0b8afd05.js";import"./lablup-codemirror-f59b6c49.js";
/**
 @license
...
`,De=e=>class extends(E(P(M(e)))){static get properties(){return{tabindex:{type:Number,value:0,reflectToAttribute:!0}}}get _activeKeys(){return["Enter"," "]}ready(){super.ready(),this.hasAttribute("role")||this.setAttribute("role","button")}_onKeyDown(e){super._onKeyDown(e),this._activeKeys.includes(e.key)&&(e.preventDefault(),this.click())}}
/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;f("vaadin-button",ke,{moduleId:"vaadin-button-styles"});class Ce extends(De($(x(k(D))))){static get is(){return"vaadin-button"}static get template(){return(e=>e`
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;let Me;f("vaadin-date-picker-overlay",c`
    [part='overlay'] {
      display: flex;
      flex: auto;
    }
  ...
  `,{moduleId:"vaadin-date-picker-overlay-styles"});class $e extends(Pe(be)){static get is(){return"vaadin-date-picker-overlay"}static get template(){return Me||(Me=super.template.cloneNode(!0),Me.content.querySelector('[part~="overlay"]').removeAttribute("tabindex")),Me}}
/**
@license
...
*/
function Ae(e,t,i,s,o){let n;o&&(n="object"==typeof i&&null!==i,n&&(s=e.__dataTemp[t]));let a=s!==i&&(s==s||i==i);return n&&a&&(e.__dataTemp[t]=i),a}customElements.define($e.is,$e);const Oe=z((e=>class extends e{_shouldPropertyChange(e,t,i){return Ae(this,e,t,i,!0)}})),ze=z((e=>class extends e{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(e,t,i){return Ae(this,e,t,i,this.mutableData)}}));Oe._mutablePropertyChange=Ae;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let Re=null;function Be(){return Re}Be.prototype=Object.create(HTMLTemplateElement.prototype,{constructor:{value:Be,writable:!0}});const Fe=R(Be),Ve=Oe(Fe);const Le=R(class{});class Ne extends Le{constructor(e){super(),this._configureProperties(e),this.root=this._stampTemplate(this.__dataHost);let t=[];this.children=t;for(let e=this.root.firstChild;e;e=e.nextSibling)t.push(e),e.__templatizeInstance=this;this.__templatizeOwner&&this.__templatizeOwner.__hideTemplateChildren__&&this._showHideChildren(!0);let i=this.__templatizeOptions;(e&&i.instanceProps||!i.instanceProps)&&this._enableProperties()}_configureProperties(e){if(this.__templatizeOptions.forwardHostProp)for(let e in this.__hostProps)this._setPendingProperty(e,this.__dataHost["_host_"+e]);for(let t in e)this._setPendingProperty(t,e[t])}forwardHostProp(e,t){this._setPendingPropertyOrPath(e,t,!1,!0)&&this.__dataHost._enqueueClient(this)}_addEventListenerToNode(e,t,i){if(this._methodHost&&this.__templatizeOptions.parentModel)this._methodHost._addEventListenerToNode(e,t,(e=>{e.model=this,i(e)}));else{let s=this.__dataHost.__dataHost;s&&s._addEventListenerToNode(e,t,i)}}_showHideChildren(e){!function(e,t){for(let i=0;i<t.length;i++){let s=t[i];if(Boolean(e)!=Boolean(s.__hideTemplateChildren__))if(s.nodeType===Node.TEXT_NODE)e?(s.__polymerTextContent__=s.textContent,s.textContent=""):s.textContent=s.__polymerTextContent__;else if("slot"===s.localName)if(e)s.__polymerReplaced__=document.createComment("hidden-slot"),B(B(s).parentNode).replaceChild(s.__polymerReplaced__,s);else{const e=s.__polymerReplaced__;e&&B(B(e).parentNode).replaceChild(s,e)}else s.style&&(e?(s.__polymerDisplay__=s.style.display,s.style.display="none"):s.style.display=s.__polymerDisplay__);s.__hideTemplateChildren__=e,s._showHideChildren&&s._showHideChildren(e)}}(e,this.children)}_setUnmanagedPropertyToNode(e,t,i){e.__hideTemplateChildren__&&e.nodeType==Node.TEXT_NODE&&"textContent"==t?e.__polymerTextContent__=i:super._setUnmanagedPropertyToNode(e,t,i)}get parentModel(){let e=this.__parentModel;if(!e){let t;e=this;do{e=e.__dataHost.__dataHost}while((t=e.__templatizeOptions)&&!t.parentModel);this.__parentModel=e}return e}dispatchEvent(e){return!0}}Ne.prototype.__dataHost,Ne.prototype.__templatizeOptions,Ne.prototype._methodHost,Ne.prototype.__templatizeOwner,Ne.prototype.__hostProps;const qe=Oe(Ne);function je(e){let t=e.__dataHost;return t&&t._methodHost||t}function He(e,t,i){let s=i.mutableData?qe:Ne;Ye.mixin&&(s=Ye.mixin(s));let o=class extends s{};return o.prototype.__templatizeOptions=i,o.prototype._bindTemplate(e),function(e,t,i,s){let o=i.hostProps||{};for(let t in s.instanceProps){delete o[t];let i=s.notifyInstanceProp;i&&e.prototype._addPropertyEffect(t,e.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:We(t,i)})}if(s.forwardHostProp&&t.__dataHost)for(let t in o)i.hasHostProps||(i.hasHostProps=!0),e.prototype._addPropertyEffect(t,e.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:function(e,t,i){e.__dataHost._setPendingPropertyOrPath("_host_"+t,i[t],!0,!0)}})}(o,e,t,i),o}function Ue(e,t,i,s){let o=i.forwardHostProp;if(o&&t.hasHostProps){const n="template"==e.localName;let a=t.templatizeTemplateClass;if(!a){if(n){let e=i.mutableData?Ve:Fe;class s extends e{}a=t.templatizeTemplateClass=s}else{const i=e.constructor;class s extends i{}a=t.templatizeTemplateClass=s}let r=t.hostProps;for(let e in r)a.prototype._addPropertyEffect("_host_"+e,a.prototype.PROPERTY_EFFECT_TYPES.PROPAGATE,{fn:Ge(e,o)}),a.prototype._createNotifyingProperty("_host_"+e);V&&s&&function(e,t,i){const s=i.constructor._properties,{propertyEffects:o}=e,{instanceProps:n}=t;for(let e in o)if(!(s[e]||n&&n[e])){const t=o[e];for(let i=0;i<t.length;i++){const{part:s}=t[i].info;if(!s.signature||!s.signature.static){console.warn(`Property '${e}' used in template but not declared in 'properties'; attribute will not be observed.`);break}}}}(t,i,s)}if(e.__dataProto&&Object.assign(e.__data,e.__dataProto),n)!function(e,t){Re=e,Object.setPrototypeOf(e,t.prototype),new t,Re=null}(e,a),e.__dataTemp={},e.__dataPending=null,e.__dataOld=null,e._enableProperties();else{Object.setPrototypeOf(e,a.prototype);const i=t.hostProps;for(let t in i)if(t="_host_"+t,t in e){const i=e[t];delete e[t],e.__data[t]=i}}}}function Ge(e,t){return function(e,i,s){t.call(e.__templatizeOwner,i.substring("_host_".length),s[i])}}function We(e,t){return function(e,i,s){t.call(e.__templatizeOwner,e,i,s[i])}}function Ye(e,t,i){if(F&&!je(e))throw new Error("strictTemplatePolicy: template owner not trusted");if(i=i||{},e.__templatizeOwner)throw new Error("A <template> can only be templatized once");e.__templatizeOwner=t;let s=(t?t.constructor:Ne)._parseTemplate(e),o=s.templatizeInstanceClass;o||(o=He(e,s,i),s.templatizeInstanceClass=o);const n=je(e);Ue(e,s,i,n);let a=class extends o{};return a.prototype._methodHost=n,a.prototype.__dataHost=e,a.prototype.__templatizeOwner=t,a.prototype.__hostProps=s.hostProps,a}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;f("vaadin-date-picker",he,{moduleId:"vaadin-date-picker-styles"});class wt extends(xt(ce(x($(D))))){static get is(){return"vaadin-date-picker"}static get template(){return C`
      <style>
        :host([opened]) {
          pointer-events: auto;
        }
 ...
 */;let $t;f("vaadin-time-picker-overlay",c`
  ...
  `,{moduleId:"vaadin-time-picker-overlay-styles"});class At extends(Mt(be)){static get is(){return"vaadin-time-picker-overlay"}static get template(){return $t||($t=super.template.cloneNode(!0),$t.content.querySelector('[part~="overlay"]').removeAttribute("tabindex")),$t}}
/**
 * @license
 * Copyright (c) 2015 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 ...
 * Copyright (c) 2018 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */,Vt="00:00:00.000",Lt="23:59:59.999";f("vaadin-time-picker",he,{moduleId:"vaadin-time-picker-styles"});class Nt extends(Ft(ce(x($(D))))){static get is(){return"vaadin-time-picker"}static get template(){return C`
      <style>
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
f("vaadin-date-time-picker",he,{moduleId:"vaadin-date-time-picker"});const Ht=jt(wt,"i18n").value(),Ut=jt(Nt,"i18n").value(),Gt=Object.keys(Ht),Wt=Object.keys(Ut);class Yt extends J{constructor(e,t){super(e,`${t}-picker`,`vaadin-${t}-picker`,{initializer:(e,i)=>{i[`__${t}Picker`]=e}})}}class Kt extends(me(ae(M(x($(D)))))){static get template(){return C`
      <style>
                ...
                ${this.resource_templates_filtered.map((e=>h`
                  <mwc-list-item value="${e.name}"
                    ...
                    <div class="horizontal layout end-justified">
                      ...
                      <div style="width:50px;text-align:right;">${e.mem}GiB</div>
                      <div style="width:60px;text-align:right;">${e.shmem?h`
                        ${parseFloat(globalThis.backendaiclient.utils.changeBinaryUnit(e.shared_memory,"g")).toFixed(2)} GiB
                      `:h`64MB`}
                      </div>
                      <div style="width:80px;text-align:right;">
                        ${e.cuda_device&&e.cuda_device>0?h`${e.cuda_device} GPU`:h``}
                        ${e.cuda_shares&&e.cuda_shares>0?h`${e.cuda_shares} GPU`:h``}
                        ${e.rocm_device&&e.rocm_device>0?h`${e.rocm_device} GPU`:h``}
                        ${e.tpu_device&&e.tpu_device>0?h`${e.tpu_device} TPU`:h``}
                        ${e.ipu_device&&e.ipu_device>0?h`${e.ipu_device} IPU`:h``}
                        ${e.atom_device&&e.atom_device>0?h`${e.atom_device} ATOM`:h``}
                      </div>
                      <div style="display:none">)</div>
                    </div>
                  </mwc-list-item>
            ...
            <wl-expansion name="resource-group">
              ...
              <div class="vertical layout">
                <div>
                  ...
                  <mwc-list-item hasMeta class="resource-type">
                    <div>${v("webui.menu.AIAccelerator")}</div>
                    <mwc-icon-button slot="meta" icon="info" class="fg info"
