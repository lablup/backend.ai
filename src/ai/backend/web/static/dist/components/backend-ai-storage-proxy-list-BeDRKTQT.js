import{_ as e,n as t,e as i,t as a,B as s,b as o,I as r,a as n,i as d,d as l,j as c,k as p,p as h,x as g,f as u,g as b}from"./backend-ai-webui-Ctt4r6tq.js";import"./backend-ai-list-status-WG1GtUnM.js";import"./backend-ai-storage-host-settings-view-S-PgAvAJ.js";import"./lablup-progress-bar-C561xwKS.js";import"./vaadin-grid-BWGeJ8xx.js";import"./vaadin-grid-sort-column-DFxqRMu8.js";import"./dir-utils-pJ1eDNm2.js";var m;let v=m=class extends s{constructor(){super(),this.condition="running",this.listCondition="loading",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[o,r,n,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
