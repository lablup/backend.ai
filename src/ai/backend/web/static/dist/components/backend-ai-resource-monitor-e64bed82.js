import{_ as e,n as t,b as s,e as r,B as i,c as o,I as a,a as c,F as l,d as n,i as p,g as d,f as u,x as _,t as h}from"./backend-ai-webui-aedf1078.js";import"./lablup-progress-bar-309da793.js";import"./mwc-switch-5506e5cb.js";import"./label-4414bd3d.js";import"./backend-ai-session-launcher-7bd6e30f.js";let g=class extends i{constructor(){super(),this.is_connected=!1,this.direction="horizontal",this.location="",this.aliases=Object(),this.aggregate_updating=!1,this.project_resource_monitor=!1,this.active=!1,this.resourceBroker=globalThis.resourceBroker,this.notification=globalThis.lablupNotification,this.init_resource()}static get is(){return"backend-ai-resource-monitor"}static get styles(){return[o,a,c,l,n,p`
        mwc-linear-progress {
          height: 5px;
          ...
          <div class="layout horizontal center-justified monitor">
            ...
            <div class="layout vertical center-justified wrap short-indicator">
              ...
              <lablup-progress-bar id="tpu-usage-bar-2" class="end"
                progress="${this.used_slot_percent.tpu_device/100}" buffer="${this.used_slot_percent.tpu_device/100}"
          ...
          <div class="layout horizontal center-justified monitor">
            ...
            <div class="layout vertical center-justified wrap short-indicator">
              ...
              <lablup-progress-bar id="ipu-usage-bar-2" class="end"
                progress="${this.used_slot_percent.ipu_device/100}" buffer="${this.used_slot_percent.ipu_device/100}"
          ...
          <div class="layout horizontal center-justified monitor">
            ...
            <div class="layout vertical center-justified wrap short-indicator">
              ...
              <lablup-progress-bar id="atom-usage-bar-2" class="end"
                progress="${this.used_slot_percent.atom_device/100}" buffer="${this.used_slot_percent.atom_device/100}"
          ...
          <div class="layout horizontal center-justified monitor">
            ...
            <div class="layout vertical center-justified wrap short-indicator">
              ...
              <lablup-progress-bar id="warboy-usage-bar-2" class="end"
                progress="${this.used_slot_percent.warboy_device/100}" buffer="${this.used_slot_percent.warboy_device/100}"
