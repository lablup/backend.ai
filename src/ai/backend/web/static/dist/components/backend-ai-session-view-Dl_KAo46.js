...
${i.item[this.sessionNameField]}</pre
      ...
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?b(_``,e):b(_`
        ...
        `,e)}usageRenderer(e,t,i){var s,o,n,a,l,r,c,d,p,u,h,m,g,v,f,y,w,k,x,A,S,T,$,C,I,E,D,R,N,z,M,L,F,O,P,B,U,G,H,q,V,K,J,W,Y,Z,Q,X,ee,te,ie,se,oe,ne,ae,le,re,ce,de,pe,ue,he,me,ge,ve,be,_e,fe;["batch","interactive","inference","running"].includes(this.condition)?b(_`
          <div class="vertical start start-justified layout">
            ...
            ${i.item.rocm_gpu_slot&&parseFloat(i.item.cuda_rocm_gpu_slot)>0?_`
                  <div class="vertical start-justified layout">
                    ...
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(R=null===(D=i.item.live_stat)||void 0===D?void 0:D.rocm_util)||void 0===R?void 0:R.current)/(null===(z=null===(N=i.item.live_stat)||void 0===N?void 0:N.rocm_util)||void 0===z?void 0:z.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
            ...
            ${i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot?_`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${j.bytesToGiB(null===(L=null===(M=i.item.live_stat)||void 0===M?void 0:M.cuda_mem)||void 0===L?void 0:L.current,1)}/${j.bytesToGiB(null===(O=null===(F=i.item.live_stat)||void 0===F?void 0:F.cuda_mem)||void 0===O?void 0:O.capacity,1)}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
    ...
    `}};r([c({type:String})],M.prototype,"_status",void 0),r([c({type:Boolean,reflect:!0})],M.prototype,"active",void 0),r([c({type:Boolean})],M.prototype,"is_admin",void 0),r([c({type:Boolean})],M.prototype,"enableInferenceWorkload",void 0),r([c({type:Boolean})],M.prototype,"enableSFTPSession",void 0),r([c({type:String})],M.prototype,"filterAccessKey",void 0),r([c({type:String})],M.prototype,"_connectionMode",void 0),r([c({type:Object})],M.prototype,"_defaultFileName",void 0),r([c({type:Object})],M.prototype,"resourceBroker",void 0),r([function(t){return(i,s)=>e(i,s,{get(){return(this.renderRoot??(T??=document.createDocumentFragment())).querySelectorAll(t)}})}("backend-ai-session-list")],M.prototype,"sessionList",void 0),r([d("#running-jobs")],M.prototype,"runningJobs",void 0),r([d("#resource-monitor")],M.prototype,"resourceMonitor",void 0),r([d("#export-file-name")],M.prototype,"exportFileNameInput",void 0),r([d("#date-from")],M.prototype,"dateFromInput",void 0),r([d("#date-to")],M.prototype,"dateToInput",void 0),r([d("#dropdown-menu")],M.prototype,"dropdownMenu",void 0),r([d("#export-to-csv")],M.prototype,"exportToCsvDialog",void 0),M=z=r([p("backend-ai-session-view")],M);
