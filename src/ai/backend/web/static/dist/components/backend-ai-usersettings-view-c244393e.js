import{_ as t,n as e,b as i,e as s,B as a,c as o,I as r,a as n,i as l,l as c,x as d,t as p,g as h,m as g,d as u,L as b,f as v,h as m,N as y}from"./backend-ai-webui-8aa3adc0.js";import"./mwc-tab-bar-62606cb0.js";import"./lablup-activity-panel-583c8bf2.js";import"./lablup-codemirror-1c4013a8.js";import"./lablup-loading-spinner-9b75a60c.js";import"./vaadin-grid-112dabc9.js";import"./vaadin-grid-selection-column-2b116d20.js";import"./vaadin-grid-sort-column-00b2d020.js";import"./vaadin-iconset-82932f7f.js";import"./mwc-switch-49915f1a.js";import"./backend-ai-list-status-6b509513.js";import"./dir-utils-f8170f68.js";let f=class extends a{constructor(){super(...arguments),this.timestamp="",this.errorType="",this.requestUrl="",this.statusCode="",this.statusText="",this.title="",this.message="",this.logs=[],this._selected_items=[],this.listCondition="loading",this._grid=Object(),this.logView=[],this._pageSize=25,this._currentPage=1,this._totalLogCount=0,this.boundTimeStampRenderer=this.timeStampRenderer.bind(this),this.boundStatusRenderer=this.statusRenderer.bind(this),this.boundErrTitleRenderer=this.errTitleRenderer.bind(this),this.boundErrMsgRenderer=this.errMsgRenderer.bind(this),this.boundErrTypeRenderer=this.errTypeRenderer.bind(this),this.boundMethodRenderer=this.methodRenderer.bind(this),this.boundReqUrlRenderer=this.reqUrlRender.bind(this),this.boundParamRenderer=this.paramRenderer.bind(this)}static get styles(){return[o,r,n,l`
      ...
      <div class="list-wrapper">
        ...
        <backend-ai-list-status id="list-status" statusCondition="${this.listCondition}" message="${h("logs.NoLogToDisplay")}"></backend-ai-list-status>
      </div>
