import{_ as e,n as t,e as s,t as i,B as a,b as o,I as r,a as l,i as n,d,p as c,x as p,f as u,g as _}from"./backend-ai-webui-Ctt4r6tq.js";import"./lablup-progress-bar-C561xwKS.js";import"./mwc-switch-BfiAvkcD.js";import"./vaadin-grid-BWGeJ8xx.js";import"./vaadin-grid-sort-column-DFxqRMu8.js";import"./backend-ai-list-status-WG1GtUnM.js";import"./lablup-activity-panel-g9kerG2l.js";import"./mwc-tab-bar-DRadV-4R.js";import"./dir-utils-pJ1eDNm2.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
