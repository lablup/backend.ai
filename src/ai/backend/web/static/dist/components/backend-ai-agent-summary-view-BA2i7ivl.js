import{_ as t,n as s,e,t as i,B as a,b as o,I as r,a as l,i as n,d,Q as c,k as p,f as u,g as _}from"./backend-ai-webui-DSafjoko.js";import"./lablup-progress-bar-DpcC3Gtx.js";import"./mwc-switch-D15G8e-c.js";import"./backend-ai-list-status-DAvukEsd.js";import"./lablup-activity-panel-BwH92Ud0.js";import"./mwc-tab-bar-wgQ9kATQ.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
