...
const C=document.createElement("template");C.innerHTML="\n  <style>\n    @font-face {\n      font-family: \"vaadin-grid-tree-icons\";\n      src: url(data:application/font-woff;charset=utf-8;base64,) format('woff');\n      font-weight: normal;\n      font-style: normal;\n    }\n  </style>\n",document.head.appendChild(C.content);class I extends(s(n(o))){static get template(){return a`
    ...
    `),c.hasOwnProperty("kernel")||c.hasOwnProperty("session"))p.push(b`
      ...
      `);else if(c.hasOwnProperty("scheduler")){const e=null!==(o=null===(n=c.scheduler.failed_predicates)||void 0===n?void 0:n.length)&&void 0!==o?o:0,t=null!==(l=null===(a=c.scheduler.passed_predicates)||void 0===a?void 0:a.length)&&void 0!==l?l:0;p.push(b`
        <div class="vertical layout start flex" style="width:100%;">
          <div style="width:100%;">
            <h3
              style="width:100%;padding-left:15px;border-bottom:1px solid #ccc;"
          ...
          <lablup-expansion summary="Predicates">
            ...
            <mwc-list>
              ${c.scheduler.failed_predicates.map((e=>b`
                ...
                `))}
              ${c.scheduler.passed_predicates.map((e=>b`
      ...
      `)}else if(c.hasOwnProperty("error")){const e=null!==(r=c.error.collection)&&void 0!==r?r:[c.error];p.push(b`
        <div class="vertical layout start flex" style="width:100%;">
          <div style="width:100%;">
            <h3
              style="width:100%;padding-left:15px;border-bottom:1px solid #ccc;"
...
${e.traceback}</pre
      ...
      `);v(p,d)}_openStatusDetailDialog(e,t,i){this.selectedSessionStatus={info:e,data:t,reserved_time:i},this._renderStatusDetail(),this.sessionStatusInfoDialog.show()}_validateSessionName(e){const t=this.compute_sessions.map((e=>e[this.sessionNameField])),i=e.target.parentNode,s=i.querySelector("#session-name-field").innerText,n=i.querySelector("#session-rename-field");n.validityTransform=(e,i)=>{if(i.valid){const i=!t.includes(e)||e===s;return i||(n.validationMessage=_("session.Validation.SessionNameAlreadyExist")),{valid:i,customError:!i}}return i.valueMissing?(n.validationMessage=_("session.Validation.SessionNameRequired"),{valid:i.valid,valueMissing:!i.valid}):i.patternMismatch?(n.validationMessage=_("session.Validation.SluggedStrings"),{valid:i.valid,patternMismatch:!i.valid}):(n.validationMessage=_("session.Validation.EnterValidSessionName"),{valid:i.valid,customError:!i.valid})}}_renameSessionName(e,t){const i=t.target.parentNode,s=i.querySelector("#session-name-field"),n=i.querySelector("#session-rename-field"),o=i.querySelector("#session-rename-icon");if("none"===s.style.display){if(!n.checkValidity())return n.reportValidity(),void(o.on=!0);{const t=globalThis.backendaiclient.APIMajorVersion<5?s.value:e;globalThis.backendaiclient.rename(t,n.value).then((e=>{this.refreshList(),this.notification.text=_("session.SessionRenamed"),this.notification.show()})).catch((e=>{n.value=s.innerText,e&&e.message&&(this.notification.text=g.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))})).finally((()=>{this._toggleSessionNameField(s,n)}))}}else this._toggleSessionNameField(s,n)}_toggleSessionNameField(e,t){"block"===t.style.display?(e.style.display="block",t.style.display="none"):(e.style.display="none",t.style.display="block",t.focus())}static secondsToDHMS(e){const t=Math.floor(e/86400),i=Math.floor(e%86400/3600),s=Math.floor(e%3600/60),n=parseInt(e)%60,o=t<0||i<0||s<0||n<0?_("session.TimeoutExceeded"):"",a=`${void 0!==t&&t>0?String(t)+"d":""}${i.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}:${n.toString().padStart(2,"0")}`;return o.length>0?o:a}_getIdleSessionTimeout(e){if(globalThis.backendaiutils.isEmpty(e))return null;let t="",i=1/0;for(const[s,n]of Object.entries(e))null!=n&&"number"==typeof n&&null!=i&&n<i&&(t=s,i=n);return i?[t,D.secondsToDHMS(i)]:null}_openIdleChecksInfoDialog(){var e,t,i;this._helpDescriptionTitle=_("session.IdleChecks"),this._helpDescription=`\n      <p>${_("session.IdleChecksDesc")}</p>\n      ${(null===(e=this.activeIdleCheckList)||void 0===e?void 0:e.has("session_lifetime"))?`\n        <strong>${_("session.MaxSessionLifetime")}</strong>\n        <p>${_("session.MaxSessionLifetimeDesc")}</p>\n        `:""}\n      ${(null===(t=this.activeIdleCheckList)||void 0===t?void 0:t.has("network_timeout"))?`\n        <strong>${_("session.NetworkIdleTimeout")}</strong>\n        <p>${_("session.NetworkIdleTimeoutDesc")}</p>\n      `:""}\n      ${(null===(i=this.activeIdleCheckList)||void 0===i?void 0:i.has("utilization"))?`\n        <strong>${_("session.UtilizationIdleTimeout")}</strong>\n        <p>${_("session.UtilizationIdleTimeoutDesc")}</p>\n        <div style="margin:10px 5% 20px 5%;">\n          <li>\n            <span style="font-weight:500">${_("session.GracePeriod")}</span>\n            <div style="padding-left:20px;">${_("session.GracePeriodDesc")}</div>\n          </li>\n          <li>\n            <span style="font-weight:500">${_("session.UtilizationThreshold")}</span>\n            <div style="padding-left:20px;">${_("session.UtilizationThresholdDesc")}</div>\n          </li>\n        </div>\n      `:""}\n    `,this.helpDescriptionDialog.show()}async _openSFTPSessionConnectionInfoDialog(e,t){const i=await globalThis.backendaiclient.get_direct_access_info(e),s=i.public_host.replace(/^https?:\/\//,""),n=i.sshd_ports,o=new CustomEvent("read-ssh-key-and-launch-ssh-dialog",{detail:{sessionUuid:e,host:s,port:n,mounted:t}});document.dispatchEvent(o)}_createUtilizationIdleCheckDropdown(e,t){const i=e.target,s=document.createElement("mwc-menu");s.anchor=i,s.className="util-dropdown-menu",s.style.boxShadow="0 1px 1px rgba(0, 0, 0, 0.2)",s.setAttribute("open",""),s.setAttribute("fixed",""),s.setAttribute("corner","BOTTOM_START");let n=b``;globalThis.backendaiutils.isEmpty(t)||(n=b`
        ...
        ${Object.keys(t).map((e=>{let[i,s]=t[e];i=i>=0?parseFloat(i).toFixed(1):"-";const n=this.getUtilizationCheckerColor([i,s]);return b`
          ...
          `}))}
      `,document.body.appendChild(s)),v(n,s)}_removeUtilizationIdleCheckDropdown(){var e;const t=document.getElementsByClassName("util-dropdown-menu");for(;t[0];)null===(e=t[0].parentNode)||void 0===e||e.removeChild(t[0])}sessionTypeRenderer(e,t,i){const s=JSON.parse(i.item.inference_metrics||"{}");v(b`
...
${i.item[this.sessionNameField]}</pre
        ...
        <lablup-shields
          ...
          ui="round"
        ></lablup-shields>
      `,e)}controlRenderer(e,t,i){var s;let n=!0;n="API"===this._connectionMode&&i.item.access_key===globalThis.backendaiclient._config._accessKey||i.item.user_email===globalThis.backendaiclient.email,v(b`
        <div
          id="controls"
      ...
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?v(b``,e):v(b`
        ...
        `,e)}usageRenderer(e,t,i){var s,n,o,a,l,r,c,d,p,u,h,m,g,_,f,y,w,k,x,A,S,T,$,C,I,E,R,j,N,M,z,L,F,O,P,B,U,G,H,q,V,K,J,W,Y,Z,Q,X,ee,te,ie,se,ne,oe,ae,le,re,ce,de,pe,ue,he,me,ge,ve,be,_e,fe;["batch","interactive","inference","running"].includes(this.condition)?v(b`
          <div class="vertical start start-justified layout">
            ...
            <div class="vertical start-justified layout">
              <div class="usage-items">
                RAM
                ${D.bytesToGiB(null===(d=null===(c=i.item.live_stat)||void 0===c?void 0:c.mem)||void 0===d?void 0:d.current,1)}/${D.bytesToGiB(null===(u=null===(p=i.item.live_stat)||void 0===p?void 0:p.mem)||void 0===u?void 0:u.capacity,1)}
                GiB
              </div>
              <div class="horizontal start-justified center layout">
                <lablup-progress-bar
            ...
            ${i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot?b`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${D.bytesToGiB(null===(L=null===(z=i.item.live_stat)||void 0===z?void 0:z.cuda_mem)||void 0===L?void 0:L.current,1)}/${D.bytesToGiB(null===(O=null===(F=i.item.live_stat)||void 0===F?void 0:F.cuda_mem)||void 0===O?void 0:O.capacity,1)}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
      ...
      `,e)}idleChecksRenderer(e,t,i){var s;const n=null===(s=Object.keys(i.item.idle_checks))||void 0===s?void 0:s.map((e=>{var t,s;const n=i.item.idle_checks[e],o=null==n?void 0:n.remaining;if(!o)return;const a=globalThis.backendaiclient.utils.elapsedTimeToTotalSeconds(o),l=null==n?void 0:n.remaining_time_type;let r,c="#527A42";return!a||a<3600?c="#e05d44":a<14400&&(c="#D8B541"),"utilization"===e&&(null==n?void 0:n.extra)&&(!a||a<14400)&&(c=this.getUtilizationCheckerColor(null===(t=null==n?void 0:n.extra)||void 0===t?void 0:t.resources,null===(s=null==n?void 0:n.extra)||void 0===s?void 0:s.thresholds_check_operator)),r="utilization"===e?b`
            <button
    ...
    `}_updateSessionPage(e){"previous-page"===e.target.id?this.current_page-=1:this.current_page+=1,this.refreshList()}};var R;l([r({type:Boolean,reflect:!0})],E.prototype,"active",void 0),l([r({type:String})],E.prototype,"condition",void 0),l([r({type:Object})],E.prototype,"jobs",void 0),l([r({type:Array})],E.prototype,"compute_sessions",void 0),l([r({type:Array})],E.prototype,"terminationQueue",void 0),l([r({type:String})],E.prototype,"filterAccessKey",void 0),l([r({type:String})],E.prototype,"sessionNameField",void 0),l([r({type:Array})],E.prototype,"appSupportList",void 0),l([r({type:Object})],E.prototype,"appTemplate",void 0),l([r({type:Object})],E.prototype,"imageInfo",void 0),l([r({type:Array})],E.prototype,"_selected_items",void 0),l([r({type:Object})],E.prototype,"_boundControlRenderer",void 0),l([r({type:Object})],E.prototype,"_boundConfigRenderer",void 0),l([r({type:Object})],E.prototype,"_boundUsageRenderer",void 0),l([r({type:Object})],E.prototype,"_boundReservationRenderer",void 0),l([r({type:Object})],E.prototype,"_boundIdleChecksHeaderderer",void 0),l([r({type:Object})],E.prototype,"_boundIdleChecksRenderer",void 0),l([r({type:Object})],E.prototype,"_boundAgentRenderer",void 0),l([r({type:Object})],E.prototype,"_boundSessionInfoRenderer",void 0),l([r({type:Object})],E.prototype,"_boundArchitectureRenderer",void 0),l([r({type:Object})],E.prototype,"_boundCheckboxRenderer",void 0),l([r({type:Object})],E.prototype,"_boundUserInfoRenderer",void 0),l([r({type:Object})],E.prototype,"_boundStatusRenderer",void 0),l([r({type:Object})],E.prototype,"_boundSessionTypeRenderer",void 0),l([r({type:Boolean})],E.prototype,"refreshing",void 0),l([r({type:Boolean})],E.prototype,"is_admin",void 0),l([r({type:Boolean})],E.prototype,"is_superadmin",void 0),l([r({type:String})],E.prototype,"_connectionMode",void 0),l([r({type:Object})],E.prototype,"notification",void 0),l([r({type:Boolean})],E.prototype,"enableScalingGroup",void 0),l([r({type:Boolean})],E.prototype,"isDisplayingAllocatedShmemEnabled",void 0),l([r({type:String})],E.prototype,"listCondition",void 0),l([r({type:Object})],E.prototype,"refreshTimer",void 0),l([r({type:Object})],E.prototype,"kernel_labels",void 0),l([r({type:Object})],E.prototype,"kernel_icons",void 0),l([r({type:Object})],E.prototype,"indicator",void 0),l([r({type:String})],E.prototype,"_helpDescription",void 0),l([r({type:String})],E.prototype,"_helpDescriptionTitle",void 0),l([r({type:String})],E.prototype,"_helpDescriptionIcon",void 0),l([r({type:Set})],E.prototype,"activeIdleCheckList",void 0),l([r({type:Proxy})],E.prototype,"statusColorTable",void 0),l([r({type:Proxy})],E.prototype,"idleChecksTable",void 0),l([r({type:Proxy})],E.prototype,"sessionTypeColorTable",void 0),l([r({type:Number})],E.prototype,"sshPort",void 0),l([r({type:Number})],E.prototype,"vncPort",void 0),l([r({type:Number})],E.prototype,"current_page",void 0),l([r({type:Number})],E.prototype,"session_page_limit",void 0),l([r({type:Number})],E.prototype,"total_session_count",void 0),l([r({type:Number})],E.prototype,"_APIMajorVersion",void 0),l([r({type:Object})],E.prototype,"selectedSessionStatus",void 0),l([r({type:Boolean})],E.prototype,"isUserInfoMaskEnabled",void 0),l([c("#loading-spinner")],E.prototype,"spinner",void 0),l([c("#list-grid")],E.prototype,"_grid",void 0),l([c("#access-key-filter")],E.prototype,"accessKeyFilterInput",void 0),l([c("#multiple-action-buttons")],E.prototype,"multipleActionButtons",void 0),l([c("#access-key-filter-helper-text")],E.prototype,"accessKeyFilterHelperText",void 0),l([c("#terminate-session-dialog")],E.prototype,"terminateSessionDialog",void 0),l([c("#terminate-selected-sessions-dialog")],E.prototype,"terminateSelectedSessionsDialog",void 0),l([c("#status-detail-dialog")],E.prototype,"sessionStatusInfoDialog",void 0),l([c("#work-dialog")],E.prototype,"workDialog",void 0),l([c("#help-description")],E.prototype,"helpDescriptionDialog",void 0),l([c("#commit-session-dialog")],E.prototype,"commitSessionDialog",void 0),l([c("#commit-current-session-path-input")],E.prototype,"commitSessionInput",void 0),l([c("#list-status")],E.prototype,"_listStatus",void 0),E=D=l([d("backend-ai-session-list")],E);let j=R=class extends p{constructor(){super(),this._status="inactive",this.active=!1,this.is_admin=!1,this.enableInferenceWorkload=!1,this.enableSFTPSession=!1,this.filterAccessKey="",this._connectionMode="API",this._defaultFileName="",this.active=!1,this._status="inactive"}static get styles(){return[u,h,m,w,k,i`
        h3.tab {
