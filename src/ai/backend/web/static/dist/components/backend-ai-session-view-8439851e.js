import{o as e,r as t,i,T as s,D as o,P as n,l as a,_ as l,n as r,b as c,e as d,B as p,c as u,I as h,a as m,f as g,m as v,x as b,g as _,t as f,p as y,q as w,d as k}from"./backend-ai-webui-2e94680f.js";import{J as x}from"./vaadin-iconset-2f31ab0f.js";import"./backend-ai-resource-monitor-0c1823a6.js";import"./backend-ai-session-launcher-4e7b8a26.js";import"./backend-ai-list-status-84ee85b9.js";import"./lablup-grid-sort-filter-column-14246e0c.js";import"./lablup-progress-bar-99287387.js";import{i as A}from"./vaadin-grid-8b7e9eef.js";import"./vaadin-grid-filter-column-b7417720.js";import"./vaadin-grid-selection-column-606c4d9c.js";import"./vaadin-grid-sort-column-6cb5d412.js";import"./lablup-activity-panel-da7c7aa2.js";import"./mwc-formfield-33a8f868.js";import"./mwc-tab-bar-e11f869d.js";import"./mwc-switch-89de5e16.js";import"./lablup-codemirror-37a091dc.js";import"./mwc-check-list-item-a63802f4.js";import"./dir-utils-6bfe4cc0.js";
/**
 * @license
...
${i.item[this.sessionNameField]}</pre
      ...
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?v(b``,e):v(b`
        ...
        `,e)}usageRenderer(e,t,i){var s,o,n,a,l,r,c,d,p,u,h,m,g,_,f,y,w,k,x,A,S,T,$,C,I,E,R,j,N,M,z,L,F,P,O,B,U,G,H,q,V,K,J,W,Y,Z,Q,X,ee,te,ie,se,oe,ne,ae,le,re,ce,de,pe,ue,he,me,ge,ve,be,_e,fe;["batch","interactive","inference","running"].includes(this.condition)?v(b`
          <div class="vertical start start-justified layout">
            ...
            ${i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot?b`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${D.bytesToGiB(null===(L=null===(z=i.item.live_stat)||void 0===z?void 0:z.cuda_mem)||void 0===L?void 0:L.current,1)}/${D.bytesToGiB(null===(P=null===(F=i.item.live_stat)||void 0===F?void 0:F.cuda_mem)||void 0===P?void 0:P.capacity,1)}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
