import{_ as t,n as e,b as o,e as i,B as a,c as r,I as s,a as n,d as l,i as c,g as d,f as p,x as h,t as u}from"./backend-ai-webui-8aa3adc0.js";import"./backend-ai-resource-monitor-30f301ce.js";import"./backend-ai-session-launcher-40513d5c.js";import"./lablup-activity-panel-583c8bf2.js";import"./mwc-switch-49915f1a.js";import"./lablup-progress-bar-44fdea38.js";import"./lablup-expansion-5c02cbff.js";import"./slider-7fe3949e.js";import"./vaadin-grid-112dabc9.js";import"./dir-utils-f8170f68.js";import"./vaadin-grid-filter-column-33ab50ff.js";import"./vaadin-grid-selection-column-2b116d20.js";import"./media-query-controller-e3bce885.js";import"./lablup-codemirror-1c4013a8.js";
/**
 @license
 Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
 */
let m=class extends a{constructor(){super(...arguments),this.condition="running",this.authenticated=!1,this.indicator=Object(),this.notification=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importNotebookMessage="",this.importGithubMessage="",this.importGitlabMessage="",this.allowedGroups=[],this.allowed_folder_type=[],this.vhost="",this.vhosts=[],this.storageInfo=Object(),this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon=""}static get styles(){return[r,s,n,l,c`
        div.description {
          font-size: 14px;
      ...
      .newSessionDialogTitle="${u("session.launcher.StartImportedNotebook")}"></backend-ai-session-launcher>
      <div class="horizontal wrap layout">
        <lablup-activity-panel title="${u("summary.ResourceStatistics")}" elevation="1" width="350" height="490" narrow>
          <div slot="message">
        ...
        <lablup-activity-panel title="${u("import.CreateNotebookButton")}" elevation="1" height="490">
          <div slot="message">
            <div class="vertical wrap layout center description">
              ...
              <mwc-textfield id="notebook-badge-url" label="${u("import.NotebookBadgeURL")}"
                             autoValidate validationMessage="${d("import.WrongURLType")}"
                             pattern="^(https?):\/\/([\\w\.\/\-]{1,})\.ipynb$"
                             maxLength="2048" placeholder="${u("maxLength.2048chars")}"
                             @change="${t=>this.urlTextfieldChanged(t,"create-notebook-button")}"></mwc-textfield>
              <mwc-button id="create-notebook-button" disabled fullwidth @click="${()=>this.createNotebookBadge()}" icon="code">${u("import.CreateButtonCode")}</mwc-button>
              <mwc-textarea id="notebook-badge-code" label="${u("import.NotebookBadgeCodeHTML")}" @click="${t=>this._copyTextArea(t)}"></mwc-textarea>
              <mwc-textarea id="notebook-badge-code-markdown" label="${u("import.NotebookBadgeCodeMarkdown")}" @click="${t=>this._copyTextArea(t)}"></mwc-textarea>
            </div>
          </div>
        </lablup-activity-panel>
      </div>
      <div class="horizontal wrap layout">
        <lablup-activity-panel title="${u("import.ImportGithubRepo")}" elevation="1" horizontalsize="2x">
          <div slot="message">
            <div class="description">
              <p>${u("import.RepoWillBeFolder")}</p>
            </div>
            <div class="horizontal wrap layout center">
              <mwc-textfield id="github-repo-url" class="repo-url" label="${u("import.GitHubURL")}"
                             autoValidate validationMessage="${d("import.WrongURLType")}"
              ...
              <mwc-select class="github-select" id="github-add-folder-host" label="${u("data.Host")}">
      ...
      <div class="horizontal wrap layout">
        <lablup-activity-panel title="${u("import.ImportGitlabRepo")}" elevation="1" horizontalsize="2x">
          <div slot="message">
            <div class="description">
              <p>${u("import.GitlabRepoWillBeFolder")}</p>
            </div>
            <div class="horizontal wrap layout center">
              <mwc-textfield id="gitlab-repo-url" class="repo-url" label="${u("import.GitlabURL")}"
                             autoValidate validationMessage="${d("import.WrongURLType")}"
              ...
              <mwc-textfield id="gitlab-default-branch-name" label="${u("import.GitlabDefaultBranch")}"
                             maxLength="200" placeholder="${u("maxLength.200chars")}"></mwc-textfield>
              <mwc-select id="gitlab-add-folder-host" label="${u("data.Host")}">
                ${this.vhosts.map(((t,e)=>h`
                <mwc-list-item hasMeta value="${t}" ?selected="${t===this.vhost}">
                    <span>${t}</span>
                </mwc-list-item>
