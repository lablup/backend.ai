                ...
                <div class="horizontal layout wrap start start-justified">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${g("settings.DescROCMGPUsupport")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                ...
                <div class="horizontal wrap layout">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${g("settings.DescIPUsupport")} <br/>${c("settings.RequireIPUPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${g("settings.DescATOMsupport")} <br/>${c("settings.RequireATOMPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
