import{_ as t,n as e,e as o,t as i,B as a,b as s,I as n,a as r,c as l,i as c,g as d,d as h,x as p,f as u}from"./backend-ai-webui-CHZ-bl4E.js";import"./backend-ai-resource-monitor-IcRtGLgh.js";import"./backend-ai-session-launcher-DRI4wcXt.js";import"./lablup-activity-panel-BRVLvaCu.js";import"./lablup-progress-bar-uZGTrT3Q.js";import"./mwc-switch-BjHJLnvp.js";import"./lablup-codemirror-BgUcazZm.js";import"./vaadin-grid-selection-column-BumTARFS.js";import"./active-mixin-J6dpTpJf.js";import"./dir-utils-Oo-ABbXC.js";import"./vaadin-grid-BPP02Fg2.js";import"./mwc-check-list-item-MD7Fe8pP.js";import"./vaadin-grid-filter-column-uYx0Tpjv.js";let m=class extends a{constructor(){super(...arguments),this.condition="running",this.authenticated=!1,this.indicator=Object(),this.notification=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importNotebookMessage="",this.importGithubMessage="",this.importGitlabMessage="",this.allowedGroups=[],this.allowed_folder_type=[],this.vhost="",this.vhosts=[],this.storageInfo=Object(),this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon=""}static get styles(){return[s,n,r,l,c`
        div.description {
          font-size: 14px;
