        ...
        <div slot="message">
          ...
          <div class="vertical-card" style="align-items: flex-start">
            ${this.is_superadmin?n`
                  ...
                  ${this.cuda_gpu_total||this.cuda_fgpu_total||this.rocm_gpu_total||this.tpu_total||this.ipu_total||this.atom_total||this.warboy_total?n`
                        <div class="resource-line"></div>
                        <div class="layout horizontal center flex resource">
                          <div
                            class="layout vertical center center-justified resource-name"
                            ...
                            <div class="wrap layout">
                              ...
                              <div class="horizontal center layout">
                                ...
                                ${[...t.perm].map((t=>n`
                                    <lablup-shields
                                      app=""
                                      color="${["green","blue","red"][["r","w","d"].indexOf(t)]}"
