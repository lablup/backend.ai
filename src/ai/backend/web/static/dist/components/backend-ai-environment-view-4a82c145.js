import{_ as e,e as t,c as i,a,B as s,d as o,I as r,b as l,x as n,f as d,i as c,g as u,h as p,t as m,A as h,y as g}from"./backend-ai-webui-40033228.js";import"./tab-group-db2a7c79.js";import"./mwc-tab-bar-d6347470.js";import"./lablup-activity-panel-e5620827.js";import"./lablup-grid-sort-filter-column-f1de0eca.js";import"./lablup-loading-spinner-597745a9.js";import"./vaadin-grid-474fcd24.js";import"./vaadin-grid-selection-column-7e3d5c44.js";import"./vaadin-grid-filter-column-bf757e1e.js";import"./vaadin-grid-sort-column-b778c90f.js";import"./select-f46db480.js";import"./textfield-309de3d3.js";import"./label-c131d4c3.js";import"./slider-5f500024.js";import"./vaadin-icons-7d848d50.js";import"./vaadin-item-styles-86cff5de.js";import"./vaadin-item-adda4d14.js";import"./backend-ai-list-status-70fdca8d.js";import"./mwc-switch-1bc0aa46.js";import"./radio-behavior-8d7f3314.js";import"./progress-spinner-90783f23.js";import"./input-behavior-b68fcb29.js";import"./dom-repeat-743402fd.js";let v=class extends s{constructor(){super(),this.selectedIndex=0,this.selectedImages=[],this._cuda_gpu_disabled=!1,this._cuda_fgpu_disabled=!1,this._rocm_gpu_disabled=!1,this._tpu_disabled=!1,this.alias=Object(),this.indicator=Object(),this.deleteAppInfo=Object(),this.deleteAppRow=Object(),this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object(),this.servicePortsMsg="",this._range={cpu:["1","2","3","4","5","6","7","8"],mem:["64MB","128MB","256MB","512MB","1GB","2GB","4GB","8GB","16GB","32GB","256GB","512GB"],"cuda-gpu":["0","1","2","3","4","5","6","7"],"cuda-fgpu":["0","0.1","0.2","0.5","1.0","2.0"],"rocm-gpu":["0","1","2","3","4","5","6","7"],tpu:["0","1","2"]},this.cpuValue=0,this.listCondition="loading",this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this._boundBaseImageRenderer=this.baseImageRenderer.bind(this),this._boundConstraintRenderer=this.constraintRenderer.bind(this),this._boundDigestRenderer=this.digestRenderer.bind(this),this.installImageNameList=[],this.deleteImageNameList=[],this.images=[],this.allowed_registries=[],this.servicePorts=[]}static get styles(){return[o,r,l,n,d,c`
         vaadin-grid {
           border: 0;
           font-size: 14px;
