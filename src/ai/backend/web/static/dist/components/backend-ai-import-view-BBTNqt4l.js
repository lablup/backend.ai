import{_ as t,n as e,e as o,t as i,B as a,b as s,I as n,a as r,c as l,i as c,g as d,d as h,x as p,f as u}from"./backend-ai-webui-BSTsu8kd.js";import"./backend-ai-resource-monitor-BdcLrZvb.js";import"./backend-ai-session-launcher-BszCqnVC.js";import"./lablup-activity-panel-Zn9sUJ18.js";import"./lablup-progress-bar-dpwHIgbj.js";import"./mwc-switch-CVREhZCO.js";import"./lablup-codemirror-B20UPoy_.js";import"./vaadin-grid-selection-column-DD_fJnQr.js";import"./active-mixin-BdQ6Kygl.js";import"./dir-utils-BTOUAXq0.js";import"./vaadin-grid-4zZ_WRaE.js";import"./mwc-check-list-item-CNGmLrUf.js";import"./vaadin-grid-filter-column-C4799fbS.js";let m=class extends a{constructor(){super(...arguments),this.condition="running",this.authenticated=!1,this.indicator=Object(),this.notification=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importNotebookMessage="",this.importGithubMessage="",this.importGitlabMessage="",this.allowedGroups=[],this.allowed_folder_type=[],this.vhost="",this.vhosts=[],this.storageInfo=Object(),this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon=""}static get styles(){return[s,n,r,l,c`
        div.description {
          font-size: 14px;
