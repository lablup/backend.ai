import{_ as t,n as s,b as e,e as i,B as a,c as o,I as r,a as n,i as l,f as d,m as c,x as p,t as u,g as _}from"./backend-ai-webui-2e94680f.js";import"./lablup-progress-bar-99287387.js";import"./mwc-switch-89de5e16.js";import"./vaadin-grid-8b7e9eef.js";import"./vaadin-grid-sort-column-6cb5d412.js";import"./backend-ai-list-status-84ee85b9.js";import"./lablup-activity-panel-da7c7aa2.js";import"./mwc-tab-bar-e11f869d.js";import"./dir-utils-6bfe4cc0.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,n,l`
        vaadin-grid {
          border: 0;
          font-size: 14px;
