import{_ as e,n as t,e as i,t as a,B as s,b as o,I as r,a as n,i as d,d as l,s as c,l as p,Q as h,k as g,f as u,g as b}from"./backend-ai-webui-64Hb1TBh.js";import"./backend-ai-list-status-CmUqpj8c.js";import"./backend-ai-storage-host-settings-view-CmHCzm2T.js";import"./lablup-progress-bar-WXW3UbcM.js";var v;let m=v=class extends s{constructor(){super(),this.condition="running",this.listCondition="loading",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[o,r,n,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
