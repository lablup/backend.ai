                ...
                <div class="horizontal wrap layout">
                  ...
                  <div class="horizontal layout setting-item">
                    <div
                      class="vertical center-justified layout setting-desc-shrink"
                    >
                      <div class="title">${h("settings.ATOMPlusSupport")}</div>
                      <div class="description-shrink">
                        ${v("settings.DescATOMPlusSupport")}
                        <br />
                        ${h("settings.RequireATOMPlusPlugin")}
                      </div>
                    </div>
                    <div
                      class="vertical center-justified layout setting-button"
                  ...
                  <div class="horizontal layout setting-item">
                    <div
                      class="vertical center-justified layout setting-desc-shrink"
                    >
                      <div class="title">${h("settings.RNGDSupport")}</div>
                      <div class="description-shrink">
                        ${v("settings.DescRNGDSupport")}
                        <br />
                        ${h("settings.RequireRNGDPlugin")}
                      </div>
                    </div>
                    <div
                      class="vertical center-justified layout setting-button"
