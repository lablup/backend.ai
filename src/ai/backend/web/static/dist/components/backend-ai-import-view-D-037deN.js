import{_ as t,n as e,e as o,t as i,B as a,b as s,I as n,a as r,c as l,i as c,g as d,d as h,k as p,f as u}from"./backend-ai-webui-CLYyD6h8.js";import"./backend-ai-resource-monitor-CAelG_Ci.js";import"./backend-ai-session-launcher-a-8syaHw.js";import"./lablup-activity-panel-Dyi59ndz.js";import"./lablup-progress-bar-EYqurZQb.js";import"./mwc-switch-DxvjLBGN.js";import"./slider-DA5MYMl2.js";import"./mwc-check-list-item-RNdnDTVG.js";import"./vaadin-grid-filter-column-Chtr67lZ.js";let m=class extends a{constructor(){super(...arguments),this.condition="running",this.authenticated=!1,this.indicator=Object(),this.notification=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importNotebookMessage="",this.importGithubMessage="",this.importGitlabMessage="",this.allowedGroups=[],this.allowed_folder_type=[],this.vhost="",this.vhosts=[],this.storageInfo=Object(),this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.sessionLauncherType="neo"}static get styles(){return[s,n,r,l,c`
        div.description {
          font-size: 14px;
