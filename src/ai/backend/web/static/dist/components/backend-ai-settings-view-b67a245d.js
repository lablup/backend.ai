import{_ as t,n as i,b as e,e as s,B as o,g as n,c as l,I as a,a as d,F as c,d as r,i as u,x as h,t as p,h as v,f as g}from"./backend-ai-webui-aedf1078.js";import"./vaadin-grid-609be2ad.js";import"./vaadin-grid-sort-column-8ddab2be.js";import"./mwc-switch-5506e5cb.js";import"./lablup-activity-panel-897d665b.js";import"./dir-utils-086eb4a0.js";
/**
 @license
 ...
 */let m=class extends o{constructor(){super(),this.images=Object(),this.schedulerOptions=Object(),this.networkOptions=Object(),this.notification=Object(),this.imagePullingBehavior=[{name:n("settings.image.digest"),behavior:"digest"},{name:n("settings.image.tag"),behavior:"tag"},{name:n("settings.image.none"),behavior:"none"}],this.jobschedulerType=["fifo","lifo","drf"],this.selectedSchedulerType="",this._helpDescriptionTitle="",this._helpDescription="",this.optionRange=Object(),this.options={image_pulling_behavior:"digest",cuda_gpu:!1,cuda_fgpu:!1,rocm_gpu:!1,tpu:!1,ipu:!1,atom:!1,warboy:!1,schedulerType:"fifo",scheduler:{num_retries_to_skip:"0"},network:{mtu:""}},this.optionRange={numRetries:{min:0,max:1e3},mtu:{min:0,max:15e3}},this.optionsAndId=[{option:"num_retries_to_skip",id:"num-retries"},{option:"mtu",id:"mtu"}]}static get is(){return"backend-ai-settings-view"}static get styles(){return[l,a,d,c,r,u`
      ...
      <div class="horizontal layout wrap">
          ...
          <div slot="message" class="horizontal wrap layout">
            <div class="horizontal layout setting-item">
              <div class="vertical center-justified layout setting-desc">
                <div class="title">${p("settings.RegisterNewImagesFromRepo")}</div>
                <div class="description">${p("settings.DescRegisterNewImagesFromRepo")}
                </div>
              </div>
            ...
            <div class="horizontal layout setting-item">
              <div class="vertical center-justified layout setting-desc-select">
                ...
                <div class="description-extra">${v("settings.DescImagePullBehavior")}<br />
          ...
          <div slot="message" class="horizontal wrap layout">
            <div class="horizontal layout setting-item">
              <div class="vertical center-justified layout setting-desc-shrink">
                ...
                <div class="description-shrink">${v("settings.DescUseCLIonGUI")}
                </div>
              </div>
              <div class="vertical center-justified layout setting-button">
            ...
            <div class="horizontal layout setting-item">
              <div class="vertical center-justified layout setting-desc-shrink">
                ...
                <div class="description-shrink">${v("settings.DescUseGUIonWeb")}
                </div>
              </div>
              <div class="vertical center-justified layout setting-button">
        ...
        <lablup-activity-panel title="${p("settings.Scaling")} & ${p("settings.Plugins")}" narrow autowidth>
            ...
            <div style="margin:auto 16px;">
              ...
              <div class="vertical wrap layout">
                <div class="horizontal layout wrap start start-justified">
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      <div class="title">${p("settings.AllowAgentSideRegistration")}</div>
                      <div class="description-shrink">${v("settings.DescAllowAgentSideRegistration")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${v("settings.OverlayNetworkConfiguration")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout">
                      <mwc-button
                ...
                <div class="horizontal layout wrap start start-justified">
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${v("settings.DescCUDAGPUsupport")}
                        ${this.options.cuda_fgpu?h`<br />${p("settings.CUDAGPUdisabledByFGPUsupport")}`:h``}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${v("settings.DescROCMGPUsupport")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-select" style="margin: 15px 0px;">
                      ...
                      <div class="description-shrink">${p("settings.SchedulerConfiguration")}<br/>
                ...
                <div class="horizontal wrap layout">
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${p("settings.DescFractionalGPU")} <br/> ${p("settings.RequireFGPUPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${p("settings.DescTPU")} <br/>${p("settings.RequireTPUPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${v("settings.DescIPUsupport")} <br/>${p("settings.RequireIPUPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${v("settings.DescATOMsupport")} <br/>${p("settings.RequireATOMPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
                  ...
                  <div class="horizontal layout setting-item">
                    <div class="vertical center-justified layout setting-desc-shrink">
                      ...
                      <div class="description-shrink">${v("settings.DescWarboysupport")} <br/>${p("settings.RequireWarboyPlugin")}
                      </div>
                    </div>
                    <div class="vertical center-justified layout setting-button">
        ...
        <backend-ai-dialog id="scheduler-env-dialog" class="env-dialog" fixed backdrop persistent closeWithConfirmation>
          <span slot="title" class="horizontal layout center">${v("settings.ConfigPerJobSchduler")}</span>
          <span slot="action">
          ...
          <div slot="footer" class="horizontal end-justified flex layout">
            <mwc-button
              ...
              label="${p("button.DeleteAll")}"></mwc-button>
            <mwc-button
              unelevated
              ...
              label="${p("button.Save")}"></mwc-button>
          </div>
        </backend-ai-dialog>
        <backend-ai-dialog id="overlay-network-env-dialog" class="env-dialog" fixed backdrop persistent closeWithConfirmation>
          <span slot="title" class="horizontal layout center">${v("settings.OverlayNetworkSettings")}</span>
          <span slot="action">
