import{_ as e,n as t,e as s,t as i,B as a,b as o,I as r,a as l,i as n,d,p as c,x as p,f as u,g as _}from"./backend-ai-webui-CjuQ-zwV.js";import"./lablup-progress-bar-BAxHd3WG.js";import"./mwc-switch-sbY7v1dx.js";import"./vaadin-grid-CQXObRT4.js";import"./vaadin-grid-sort-column-DTiFbihy.js";import"./backend-ai-list-status-CJXBdPRs.js";import"./lablup-activity-panel-BS50zM_6.js";import"./mwc-tab-bar-Ccckm9rk.js";import"./dir-utils-Bwa9NiC0.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
