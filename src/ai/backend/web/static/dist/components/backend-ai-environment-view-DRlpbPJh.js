import{_ as e,n as t,e as i,t as s,B as a,b as o,I as r,a as n,u as l,c as d,i as c,g as m,d as p,f as u,p as h,x as g}from"./backend-ai-webui-CIWf64l9.js";import"./lablup-grid-sort-filter-column-SVgwwBLv.js";import"./lablup-loading-spinner-48nj9lFN.js";import"./vaadin-grid-selection-column-DOZFAGhx.js";import"./vaadin-grid-DrZ96AmD.js";import"./vaadin-grid-filter-column-CO77cdSP.js";import"./vaadin-grid-sort-column-zhb7fnUt.js";import"./mwc-switch-C2RXURcQ.js";import"./backend-ai-list-status-By1v0Aw_.js";import"./vaadin-item-DLJ2wdVN.js";import"./lablup-activity-panel-lTIDjCSL.js";import"./mwc-tab-bar-DcTuSqKR.js";import"./active-mixin-B7RXOX6j.js";import"./dir-utils-CaIthdrG.js";import"./vaadin-item-mixin-DWuHn-rp.js";let v=class extends a{constructor(){super(),this.selectedImages=[],this.modifiedImage=Object(),this.alias=Object(),this.indicator=Object(),this.deleteAppInfo=Object(),this.deleteAppRow=Object(),this.openManageAppModal=!1,this.openManageImageResourceModal=!1,this.installImageResource=Object(),this.selectedCheckbox=Object(),this._grid=Object(),this.servicePortsMsg="",this.cpuValue=0,this.listCondition="loading",this._boundRequirementsRenderer=this.requirementsRenderer.bind(this),this._boundControlsRenderer=this.controlsRenderer.bind(this),this._boundInstallRenderer=this.installRenderer.bind(this),this._boundBaseImageRenderer=this.baseImageRenderer.bind(this),this._boundConstraintRenderer=this.constraintRenderer.bind(this),this._boundDigestRenderer=this.digestRenderer.bind(this),this.installImageNameList=[],this.deleteImageNameList=[],this.images=[],this.allowed_registries=[],this.servicePorts=[],this.modifiedImage={}}static get styles(){return[o,r,n,l,d,c`
        vaadin-grid {
          border: 0;
          font-size: 14px;
