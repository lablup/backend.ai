import{k as e,r as t,i,T as s,D as o,P as n,l as a,m as r,n as l,O as c,p as d,q as p,E as h,u,v as m,w as g,x as _,_ as b,e as v,c as f,a as y,B as w,d as k,I as x,b as A,h as S,Z as T,y as $,g as C,t as I,o as D,z as E,f as R}from"./backend-ai-webui-ab578ea5.js";import"./backend-ai-resource-monitor-22bf2221.js";import{i as M}from"./vaadin-grid-f8664f17.js";import"./vaadin-grid-selection-column-628c9cc2.js";import"./vaadin-grid-sort-column-ae65cab0.js";import"./vaadin-grid-filter-column-205b0321.js";import"./vaadin-iconset-143ddd31.js";import"./expansion-3249fdeb.js";import"./backend-ai-list-status-c05abf3d.js";import"./lablup-grid-sort-filter-column-ebf79bc4.js";import"./lablup-progress-bar-25f67c3a.js";import"./mwc-tab-bar-49a4eacc.js";import"./lablup-activity-panel-6b88454f.js";import"./backend-ai-session-launcher-8cfb2480.js";import{J as z}from"./json_to_csv-35c9e191.js";import"./mwc-switch-89803115.js";import"./label-dd1fb8bb.js";import"./dir-utils-1d3affeb.js";import"./radio-behavior-2904b95e.js";import"./mwc-check-list-item-dda66b12.js";import"./slider-745ce7ba.js";import"./media-query-controller-c0b142ca.js";import"./textfield-a1aae808.js";import"./lablup-codemirror-3133ec43.js";
/**
 * @license
...
const j=document.createElement("template");j.innerHTML="\n  <style>\n    @font-face {\n      font-family: \"vaadin-grid-tree-icons\";\n      src: url(data:application/font-woff;charset=utf-8;base64,) format('woff');\n      font-weight: normal;\n      font-style: normal;\n    }\n  </style>\n",document.head.appendChild(j.content);class O extends(s(o(n))){static get template(){return a`
      ...
      <slot></slot>
    `}static get is(){return"vaadin-grid-tree-toggle"}static get properties(){return{level:{type:Number,value:0,observer:"_levelChanged"},leaf:{type:Boolean,value:!1,reflectToAttribute:!0},expanded:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0}}}ready(){super.ready(),this.addEventListener("click",(e=>this._onClick(e)))}_onClick(e){this.leaf||M(e.target)||e.target instanceof HTMLLabelElement||(e.preventDefault(),this.expanded=!this.expanded)}_levelChanged(e){const t=Number(e).toString();this.style.setProperty("---level",t)}}customElements.define(O.is,O);let N;t("vaadin-tooltip-overlay",[r,i`
  :host {
...
const P=500;let F=P,B=P,U=P;const G=new Set;let H=!1,q=null,V=null;class K{constructor(e){this.host=e}get openedProp(){return this.host.manual?"opened":"_autoOpened"}get focusDelay(){const e=this.host;return null!=e.focusDelay&&e.focusDelay>0?e.focusDelay:F}get hoverDelay(){const e=this.host;return null!=e.hoverDelay&&e.hoverDelay>0?e.hoverDelay:B}get hideDelay(){const e=this.host;return null!=e.hideDelay&&e.hideDelay>0?e.hideDelay:U}open(e={immediate:!1}){const{immediate:t,hover:i,focus:s}=e,o=i&&this.hoverDelay>0,n=s&&this.focusDelay>0;t||!o&&!n||this.__closeTimeout?this.__showTooltip():this.__warmupTooltip(n)}close(e){!e&&this.hideDelay>0?this.__scheduleClose():(this.__abortClose(),this._setOpened(!1)),this.__abortWarmUp(),H&&(this.__abortCooldown(),this.__scheduleCooldown())}_isOpened(){return this.host[this.openedProp]}_setOpened(e){this.host[this.openedProp]=e}__flushClosingTooltips(){G.forEach((e=>{e._stateController.close(!0),G.delete(e)}))}__showTooltip(){this.__abortClose(),this.__flushClosingTooltips(),this._setOpened(!0),H=!0,this.__abortWarmUp(),this.__abortCooldown()}__warmupTooltip(e){this._isOpened()||(H?this.__showTooltip():this.__scheduleWarmUp(e))}__abortClose(){this.__closeTimeout&&(clearTimeout(this.__closeTimeout),this.__closeTimeout=null)}__abortCooldown(){V&&(clearTimeout(V),V=null)}__abortWarmUp(){q&&(clearTimeout(q),q=null)}__scheduleClose(){this._isOpened()&&(G.add(this.host),this.__closeTimeout=setTimeout((()=>{G.delete(this.host),this.__closeTimeout=null,this._setOpened(!1)}),this.hideDelay))}__scheduleCooldown(){V=setTimeout((()=>{V=null,H=!1}),this.hideDelay)}__scheduleWarmUp(e){const t=e?this.focusDelay:this.hoverDelay;q=setTimeout((()=>{q=null,H=!0,this.__showTooltip()}),t)}}class J extends(d(p(h(n)))){static get is(){return"vaadin-tooltip"}static get template(){return a`
    ...
    <div class="vertical layout justified start">
    ...
    </div>`),c.hasOwnProperty("kernel")||c.hasOwnProperty("session"))p.push($`
        <div class="vertical layout start flex" style="width:100%;">
        <div style="width:100%;">
          <h3 style="width:100%;padding-left:15px;border-bottom:1px solid #ccc;">${C("session.StatusDetail")}</h3>
      ...
      `);else if(c.hasOwnProperty("scheduler")){const e=null!==(n=null===(o=c.scheduler.failed_predicates)||void 0===o?void 0:o.length)&&void 0!==n?n:0,t=null!==(r=null===(a=c.scheduler.passed_predicates)||void 0===a?void 0:a.length)&&void 0!==r?r:0;p.push($`
        <div class="vertical layout start flex" style="width:100%;">
          <div style="width:100%;">
            <h3 style="width:100%;padding-left:15px;border-bottom:1px solid #ccc;">${C("session.StatusDetail")}</h3>
            <div class="vertical layout flex" style="width:100%;">
    ...
    `)}else if(c.hasOwnProperty("error")){const e=null!==(l=c.error.collection)&&void 0!==l?l:[c.error];p.push($`
      <div class="vertical layout start flex" style="width:100%;">
        <div style="width:100%;">
          <h3 style="width:100%;padding-left:15px;border-bottom:1px solid #ccc;">${C("session.StatusDetail")}</h3>
            ${e.map((e=>$`
              <div style="border-radius: 4px;background-color:var(--paper-grey-300);padding:10px;margin:10px;">
                ...
                ${!this.is_superadmin&&globalThis.backendaiclient._config.hideAgents||!e.agent_id?$``:$`
                  <div class="vertical layout start">
      ...
      `);T(p,d)}_openStatusDetailDialog(e,t,i){this.selectedSessionStatus={info:e,data:t,reserved_time:i},this._renderStatusDetail(),this.sessionStatusInfoDialog.show()}_validateSessionName(e){const t=this.compute_sessions.map((e=>e[this.sessionNameField])),i=e.target.parentNode,s=i.querySelector("#session-name-field").innerText,o=i.querySelector("#session-rename-field");o.validityTransform=(e,i)=>{if(i.valid){const i=!t.includes(e)||e===s;return i||(o.validationMessage=C("session.Validation.SessionNameAlreadyExist")),{valid:i,customError:!i}}return i.valueMissing?(o.validationMessage=C("session.Validation.SessionNameRequired"),{valid:i.valid,valueMissing:!i.valid}):i.patternMismatch?(o.validationMessage=C("session.Validation.SluggedStrings"),{valid:i.valid,patternMismatch:!i.valid}):(o.validationMessage=C("session.Validation.EnterValidSessionName"),{valid:i.valid,customError:!i.valid})}}_renameSessionName(e,t){const i=t.target.parentNode,s=i.querySelector("#session-name-field"),o=i.querySelector("#session-rename-field"),n=i.querySelector("#session-rename-icon");if("none"===s.style.display){if(!o.checkValidity())return o.reportValidity(),void(n.on=!0);{const t=globalThis.backendaiclient.APIMajorVersion<5?s.value:e;globalThis.backendaiclient.rename(t,o.value).then((e=>{this.refreshList(),this.notification.text=C("session.SessionRenamed"),this.notification.show()})).catch((e=>{o.value=s.innerText,e&&e.message&&(this.notification.text=S.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))})).finally((()=>{this._toggleSessionNameField(s,o)}))}}else this._toggleSessionNameField(s,o)}_toggleSessionNameField(e,t){"block"===t.style.display?(e.style.display="block",t.style.display="none"):(e.style.display="none",t.style.display="block",t.focus())}static secondsToDHMS(e){const t=Math.floor(e/86400),i=Math.floor(e%86400/3600),s=Math.floor(e%3600/60),o=parseInt(e)%60,n=t<0||i<0||s<0||o<0?C("session.TimeoutExceeded"):"",a=`${void 0!==t&&t>0?String(t)+"d":""}${i.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}`;return n.length>0?n:a}_getIdleSessionTimeout(e){if(globalThis.backendaiutils.isEmpty(e))return null;let t="",i=1/0;for(const[s,o]of Object.entries(e))null!=o&&"number"==typeof o&&null!=i&&o<i&&(t=s,i=o);return i?[t,Y.secondsToDHMS(i)]:null}_openIdleChecksInfoDialog(){var e,t,i;this._helpDescriptionTitle=C("session.IdleChecks"),this._helpDescription=`\n      <p>${C("session.IdleChecksDesc")}</p>\n      ${(null===(e=this.activeIdleCheckList)||void 0===e?void 0:e.has("session_lifetime"))?`\n        <strong>${C("session.MaxSessionLifetime")}</strong>\n        <p>${C("session.MaxSessionLifetimeDesc")}</p>\n        `:""}\n      ${(null===(t=this.activeIdleCheckList)||void 0===t?void 0:t.has("network_timeout"))?`\n        <strong>${C("session.NetworkIdleTimeout")}</strong>\n        <p>${C("session.NetworkIdleTimeoutDesc")}</p>\n      `:""}\n      ${(null===(i=this.activeIdleCheckList)||void 0===i?void 0:i.has("utilization"))?`\n        <strong>${C("session.UtilizationIdleTimeout")}</strong>\n        <p>${C("session.UtilizationIdleTimeoutDesc")}</p>\n        <div style="margin:10px 5% 20px 5%;">\n          <li>\n            <span style="font-weight:500">${C("session.GracePeriod")}</span>\n            <div style="padding-left:20px;">${C("session.GracePeriodDesc")}</div>\n          </li>\n          <li>\n            <span style="font-weight:500">${C("session.UtilizationThreshold")}</span>\n            <div style="padding-left:20px;">${C("session.UtilizationThresholdDesc")}</div>\n          </li>\n        </div>\n      `:""}\n    `,this.helpDescriptionDialog.show()}async _openSFTPSessionConnectionInfoDialog(e){const t=await globalThis.backendaiclient.get_direct_access_info(e),i=t.public_host.replace(/^https?:\/\//,""),s=t.sshd_ports,o=new CustomEvent("read-ssh-key-and-launch-ssh-dialog",{detail:{sessionUuid:e,host:i,port:s}});document.dispatchEvent(o)}_createUtilizationIdleCheckDropdown(e,t){const i=e.target,s=document.createElement("mwc-menu");s.anchor=i,s.className="util-dropdown-menu",s.style.boxShadow="0 1px 1px rgba(0, 0, 0, 0.2)",s.setAttribute("open",""),s.setAttribute("fixed",""),s.setAttribute("corner","BOTTOM_START");let o=$``;globalThis.backendaiutils.isEmpty(t)||(o=$`
        <style>
        ...
        <mwc-list-item class="util-detail-menu-header">
          <div>${C("session.Utilization")} / ${C("session.Threshold")} (%)</div>
        </mwc-list-item>${Object.keys(t).map((e=>{let[i,s]=t[e];i=i>=0?parseFloat(i).toFixed(1):"-";const o=this.getUtilizationCheckerColor([i,s]);return $`
            ...
            `}))}
      `,document.body.appendChild(s)),T(o,s)}_removeUtilizationIdleCheckDropdown(){const e=document.getElementsByClassName("util-dropdown-menu");for(;e[0];)e[0].parentNode.removeChild(e[0])}sessionTypeRenderer(e,t,i){const s=JSON.parse(i.item.inference_metrics||"{}");T($`
        <div class="layout vertical start">
          <lablup-shields color="${this.sessionTypeColorTable[i.item.type]}"
              description="${i.item.type}" ui="round"></lablup-shields>
          ${"INFERENCE"===i.item.type?$`
      ...
      `,e)}sessionInfoRenderer(e,t,i){"system"===this.condition?T($`
          <style>
            #session-name-field {
              display: block;
              white-space: pre-wrap;
        ...
        `,e):T($`
          ...
          <div class="layout vertical start">
            <div class="horizontal center center-justified layout">
              ...
              ${this._isRunning&&!this._isPreparing(i.item.status)&&globalThis.backendaiclient.email==i.item.user_email?$`
              <mwc-textfield id="session-rename-field" required autoValidate
                               pattern="^(?:[a-zA-Z0-9][a-zA-Z0-9._-]{2,}[a-zA-Z0-9])?$" maxLength="64"
                               validationMessage="${C("session.Validation.EnterValidSessionName")}"
            ...
            `}
              <div class="vertical start layout">
                ${i.item.sessionTags?i.item.sessionTags.map((e=>$`
                <div class="horizontal center layout">
                  ${e.map((e=>("Env"===e.category&&(e.category=e.tag),e.category&&i.item.baseversion&&(e.tag=i.item.baseversion),$`
                ...
                ${i.item.additional_reqs?$`
                  <div class="layout horizontal center wrap">
                    ${i.item.additional_reqs.map((e=>$`
                        <lablup-shields app=""
                                        color="green"
                                        description="${e}"
                                        ui="round"
        ...
        `,e)}architectureRenderer(e,t,i){T($`
        <lablup-shields app=""
                        color="lightgreen"
                        description="${i.item.architecture}"
                        ui="round"></lablup-shields>
      `,e)}controlRenderer(e,t,i){var s;let o=!0;o="API"===this._connectionMode&&i.item.access_key===globalThis.backendaiclient._config._accessKey||i.item.user_email===globalThis.backendaiclient.email,T($`
        <div id="controls" class="layout horizontal wrap center"
          ...
          ${i.item.appSupport&&"system"!==this.condition?$`
            ...
            <vaadin-tooltip for="${i.index+"-apps"}" text="${I("session.SeeAppDialog")}" position="top-start"></vaadin-tooltip>
            ...
            <vaadin-tooltip for="${i.index+"-terminal"}" text="${I("session.ExecuteTerminalApp")}" position="top-start"></vaadin-tooltip>
          `:$``}
          ${this._isRunning&&"system"===this.condition?$`
          ...
          <vaadin-tooltip for="${i.index+"-sftp-connection-info"}" text="${I("data.explorer.RunSSH/SFTPserver")}" position="top-start"></vaadin-tooltip>
          `:$``}
          ${this._isRunning&&!this._isPreparing(i.item.status)||this._isError(i.item.status)?$`
            ...
            <vaadin-tooltip for="${i.index+"-power"}" text="${I("session.TerminateSession")}" position="top-start"></vaadin-tooltip>
          `:$``}
          ${(this._isRunning&&!this._isPreparing(i.item.status)||this._APIMajorVersion>4)&&!this._isPending(i.item.status)?$`
            ...
            <vaadin-tooltip for="${i.index+"-assignment"}" text="${I("session.SeeContainerLogs")}" position="top-start"></vaadin-tooltip>
          `:$`
            ...
            <vaadin-tooltip for="${i.index+"-assignment"}" text="${I("session.NoLogMsgAvailable")}" position="top-start"></vaadin-tooltip>
          `}
          ${this._isContainerCommitEnabled?$`
            ...
            <vaadin-tooltip for="${i.index+"-archive"}" text="${I("session.RequestContainerCommit")}" position="top-start"></vaadin-tooltip>
          `:$``}
        </div>
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?T($``,e):T($`
          <div class="layout horizontal center flex">
            <div class="layout horizontal center configuration">
              ${i.item.mounts.length>0?$`
          ...
          <div class="layout vertical flex" style="padding-left: 25px">
            <div class="layout horizontal center configuration">
              ...
              <span class="indicator">${I("session.core")}</span>
            </div>
            <div class="layout horizontal center configuration">
            ...
            <div class="layout horizontal center configuration">
              ...
              ${i.item.warboy_slot?$`
                ...
                `:$``}
              ${i.item.cuda_gpu_slot||i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot||i.item.tpu_slot||i.item.ipu_slot||i.item.atom_slot||i.item.warboy_slot?$``:$`
                <wl-icon class="fg green indicator">view_module</wl-icon>
                <span>-</span>
                <span class="indicator">GPU</span>
                `}
       ...
       `,e)}usageRenderer(e,t,i){["batch","interactive","inference","running"].includes(this.condition)?T($`
        <div class="vertical start start-justified layout">
          ...
          ${i.item.cuda_gpu_slot&&parseInt(i.item.cuda_gpu_slot)>0?$`
          <div class="horizontal start-justified center layout">
          ...
          ${i.item.cuda_fgpu_slot&&parseFloat(i.item.cuda_fgpu_slot)>0?$`
          <div class="horizontal start-justified center layout">
            <div class="usage-items">GPU(util)</div>
            <div class="horizontal start-justified center layout">
              <lablup-progress-bar class="usage"
          ...
          ${i.item.rocm_gpu_slot&&parseFloat(i.item.cuda_rocm_gpu_slot)>0?$`
          <div class="horizontal start-justified center layout">
            <div class="usage-items">GPU(util)</div>
            <div class="horizontal start-justified center layout">
              <lablup-progress-bar class="usage"
          ...
          ${i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot?$`
          <div class="horizontal start-justified center layout">
          ...
          ${i.item.tpu_slot&&parseFloat(i.item.tpu_slot)>0?$`
          <div class="horizontal start-justified center layout">
          ...
          ${i.item.ipu_slot&&parseFloat(i.item.ipu_slot)>0?$`
          <div class="horizontal start-justified center layout">
          ...
          ${i.item.atom_slot&&parseFloat(i.item.atom_slot)>0?$`
          <div class="horizontal start-justified center layout">
      ...
      `,e)}idleChecksRenderer(e,t,i){var s;const o=null===(s=Object.keys(i.item.idle_checks))||void 0===s?void 0:s.map((e=>{var t,s;const o=i.item.idle_checks[e],n=null==o?void 0:o.remaining;if(!n)return;const a=globalThis.backendaiclient.utils.elapsedTimeToTotalSeconds(n),r=null==o?void 0:o.remaining_time_type;let l,c="#527A42";return!a||a<3600?c="#e05d44":a<14400&&(c="#D8B541"),"utilization"===e&&(null==o?void 0:o.extra)&&(!a||a<14400)&&(c=this.getUtilizationCheckerColor(null===(t=null==o?void 0:o.extra)||void 0===t?void 0:t.resources,null===(s=null==o?void 0:o.extra)||void 0===s?void 0:s.thresholds_check_operator)),l="utilization"===e?$`
          ...
          >
            ${C("session."+this.idleChecksTable[e])}
          </button>
        `:$`
          <button
            class="idle-check-key"
      ...
      `,e)}_toggleCheckbox(e){const t=this._selected_items.findIndex((t=>t.session_id==e.session_id));-1===t?this._selected_items.push(e):this._selected_items.splice(t,1),this._selected_items.length>0?this.multipleActionButtons.style.display="block":this.multipleActionButtons.style.display="none"}_aggregateSharedMemory(e){let t=0;return Object.keys(e).forEach((i=>{var s,o;t+=Number(null!==(o=null===(s=e[i])||void 0===s?void 0:s.shmem)&&void 0!==o?o:0)})),Y.bytesToGiB(t)}checkboxRenderer(e,t,i){this._isRunning&&!this._isPreparing(i.item.status)||this._APIMajorVersion>4?T($`
        ...
        `,e):T($``,e)}userInfoRenderer(e,t,i){const s="API"===this._connectionMode?i.item.access_key:i.item.user_email;T($`
        <div class="layout vertical">
          <span class="indicator">${this._getUserId(s)}</span>
        </div>
      `,e)}statusRenderer(e,t,i){var s;T($`
        <div class="horizontal layout center">
          <span style="font-size: 12px;">${i.item.status}</span>
          ${i.item.status_data&&"{}"!==i.item.status_data?$`
        ...
        `:$``}
        ${this._isContainerCommitEnabled&&void 0!==(null===(s=i.item)||void 0===s?void 0:s.commit_status)?$`
      ...
      <backend-ai-dialog id="commit-session-dialog" fixed backdrop>
          ...
          <mwc-list style="width:100%">
            ...
            <mwc-list-item twoline noninteractive class="commit-session-info">
              ...
              <span class="monospace horizontal layout" slot="secondary">
                ${e?null===(s=null==e?void 0:e.tags)||void 0===s?void 0:s.map((e=>$`
                    <lablup-shields app=""
                      color="green"
                      description="${e}"
                      ui="round"
        ...
        <div slot="footer" class="horizontal end-justified flex layout">
          <mwc-button
              ...
              label="${I("button.Commit")}"></mwc-button>
        </div>
      </backend-ai-dialog>
    `}_parseSessionInfoToCommitSessionInfo(e="",t="",i=""){const s=["",""],[o,n]=e?e.split(":"):s,[a,...r]=n?n.split("-"):s;return{environment:o,version:a,tags:r,session:{name:t,id:i}}}render(){var e,t,i;return $`
      ...
      <div class="layout horizontal center filters">
        ...
        <div class="vertical layout" style="display:none">
          <wl-textfield id="access-key-filter" type="search" maxLength="64"
                      label="${I("general.AccessKey")}" no-label-float .value="${this.filterAccessKey}"
                      style="margin-right:20px;"
                      @change="${e=>this._updateFilterAccessKey(e)}">
          </wl-textfield>
          <span id="access-key-filter-helper-text">${I("maxLength.64chars")}</span>
        </div>
      </div>
      <div class="list-wrapper">
        <vaadin-grid id="list-grid" theme="row-stripes column-borders compact" aria-label="Session list"
          ...
          `:$``}
          <lablup-grid-sort-filter-column frozen path="${this.sessionNameField}" auto-width header="${I("session.SessionInfo")}" resizable
                                     .renderer="${this._boundSessionInfoRenderer}">
          </lablup-grid-sort-filter-column>
          <lablup-grid-sort-filter-column width="120px" path="status" header="${I("session.Status")}" resizable
                                     .renderer="${this._boundStatusRenderer}">
          </lablup-grid-sort-filter-column>
          <vaadin-grid-column width=${this._isContainerCommitEnabled?"260px":"210px"} flex-grow="0" resizable header="${I("general.Control")}"
                              .renderer="${this._boundControlRenderer}"></vaadin-grid-column>
          <vaadin-grid-column width="200px" flex-grow="0" resizable header="${I("session.Configuration")}"
                              .renderer="${this._boundConfigRenderer}"></vaadin-grid-column>
          <vaadin-grid-column width="140px" flex-grow="0" resizable header="${I("session.Usage")}"
                              .renderer="${this._boundUsageRenderer}">
          </vaadin-grid-column>
          <vaadin-grid-sort-column resizable width="180px" flex-grow="0" header="${I("session.Reservation")}"
                                   path="created_at" .renderer="${this._boundReservationRenderer}">
          </vaadin-grid-sort-column>
          ${globalThis.backendaiclient.supports("idle-checks")&&this.activeIdleCheckList.size>0?$`
          ...
          `:$``}
          <lablup-grid-sort-filter-column width="110px" path="architecture" header="${I("session.Architecture")}" resizable
                                     .renderer="${this._boundArchitectureRenderer}">
          </lablup-grid-sort-filter-column>
          ${this._isIntegratedCondition?$`
            <lablup-grid-sort-filter-column path="type" width="140px" flex-grow="0" header="${I("session.launcher.SessionType")}" resizable .renderer="${this._boundSessionTypeRenderer}"></lablup-grid-sort-filter-column>
        `:$``}
          ${this.is_superadmin||!globalThis.backendaiclient._config.hideAgents?$`
            <lablup-grid-sort-filter-column path="agent" auto-width flex-grow="0" resizable header="${I("session.Agent")}"
                                .renderer="${this._boundAgentRenderer}">
            </lablup-grid-sort-filter-column>
                `:$``}
          </vaadin-grid>
          <backend-ai-list-status id="list-status" statusCondition="${this.listCondition}" message="${C("session.NoSessionToDisplay")}"></backend-ai-list-status>
        </div>
      </div>
      ...
      <backend-ai-dialog id="terminate-session-dialog" fixed backdrop>
        <span slot="title">${I("dialog.title.LetsDouble-Check")}</span>
        <div slot="content">
          <p>${I("usersettings.SessionTerminationDialog")}</p>
        </div>
        <div slot="footer" class="horizontal end-justified flex layout">
          <wl-button class="warning fg red" inverted flat @click="${()=>this._terminateSessionWithCheck(!0)}">
            ${I("button.ForceTerminate")}
          </wl-button>
          <span class="flex"></span>
          <wl-button class="cancel" inverted flat @click="${e=>this._hideDialog(e)}">${I("button.Cancel")}
          </wl-button>
          <wl-button class="ok" @click="${()=>this._terminateSessionWithCheck()}">${I("button.Okay")}</wl-button>
        </div>
      </backend-ai-dialog>
      <backend-ai-dialog id="terminate-selected-sessions-dialog" fixed backdrop>
        ...
        <div slot="footer" class="horizontal end-justified flex layout">
          <wl-button class="warning fg red" inverted flat
                      @click="${()=>this._terminateSelectedSessionsWithCheck(!0)}">${I("button.ForceTerminate")}
          </wl-button>
          <span class="flex"></span>
          <wl-button class="cancel" inverted flat @click="${e=>this._hideDialog(e)}">${I("button.Cancel")}
          </wl-button>
          <wl-button class="ok" @click="${()=>this._terminateSelectedSessionsWithCheck()}">${I("button.Okay")}
          </wl-button>
        </div>
      </backend-ai-dialog>
      <backend-ai-dialog id="status-detail-dialog" narrowLayout fixed backdrop>
        <span slot="title">${I("session.StatusInfo")}</span>
 ...
 */
var ee;b([v({type:Boolean,reflect:!0})],X.prototype,"active",void 0),b([v({type:String})],X.prototype,"condition",void 0),b([v({type:Object})],X.prototype,"jobs",void 0),b([v({type:Array})],X.prototype,"compute_sessions",void 0),b([v({type:Array})],X.prototype,"terminationQueue",void 0),b([v({type:String})],X.prototype,"filterAccessKey",void 0),b([v({type:String})],X.prototype,"sessionNameField",void 0),b([v({type:Array})],X.prototype,"appSupportList",void 0),b([v({type:Object})],X.prototype,"appTemplate",void 0),b([v({type:Object})],X.prototype,"imageInfo",void 0),b([v({type:Array})],X.prototype,"_selected_items",void 0),b([v({type:Object})],X.prototype,"_boundControlRenderer",void 0),b([v({type:Object})],X.prototype,"_boundConfigRenderer",void 0),b([v({type:Object})],X.prototype,"_boundUsageRenderer",void 0),b([v({type:Object})],X.prototype,"_boundReservationRenderer",void 0),b([v({type:Object})],X.prototype,"_boundIdleChecksHeaderderer",void 0),b([v({type:Object})],X.prototype,"_boundIdleChecksRenderer",void 0),b([v({type:Object})],X.prototype,"_boundAgentRenderer",void 0),b([v({type:Object})],X.prototype,"_boundSessionInfoRenderer",void 0),b([v({type:Object})],X.prototype,"_boundArchitectureRenderer",void 0),b([v({type:Object})],X.prototype,"_boundCheckboxRenderer",void 0),b([v({type:Object})],X.prototype,"_boundUserInfoRenderer",void 0),b([v({type:Object})],X.prototype,"_boundStatusRenderer",void 0),b([v({type:Object})],X.prototype,"_boundSessionTypeRenderer",void 0),b([v({type:Boolean})],X.prototype,"refreshing",void 0),b([v({type:Boolean})],X.prototype,"is_admin",void 0),b([v({type:Boolean})],X.prototype,"is_superadmin",void 0),b([v({type:String})],X.prototype,"_connectionMode",void 0),b([v({type:Object})],X.prototype,"notification",void 0),b([v({type:Boolean})],X.prototype,"enableScalingGroup",void 0),b([v({type:Boolean})],X.prototype,"isDisplayingAllocatedShmemEnabled",void 0),b([v({type:String})],X.prototype,"listCondition",void 0),b([v({type:Object})],X.prototype,"refreshTimer",void 0),b([v({type:Object})],X.prototype,"kernel_labels",void 0),b([v({type:Object})],X.prototype,"kernel_icons",void 0),b([v({type:Object})],X.prototype,"indicator",void 0),b([v({type:String})],X.prototype,"_helpDescription",void 0),b([v({type:String})],X.prototype,"_helpDescriptionTitle",void 0),b([v({type:String})],X.prototype,"_helpDescriptionIcon",void 0),b([v({type:Set})],X.prototype,"activeIdleCheckList",void 0),b([v({type:Proxy})],X.prototype,"statusColorTable",void 0),b([v({type:Proxy})],X.prototype,"idleChecksTable",void 0),b([v({type:Proxy})],X.prototype,"sessionTypeColorTable",void 0),b([v({type:Number})],X.prototype,"sshPort",void 0),b([v({type:Number})],X.prototype,"vncPort",void 0),b([v({type:Number})],X.prototype,"current_page",void 0),b([v({type:Number})],X.prototype,"session_page_limit",void 0),b([v({type:Number})],X.prototype,"total_session_count",void 0),b([v({type:Number})],X.prototype,"_APIMajorVersion",void 0),b([v({type:Object})],X.prototype,"selectedSessionStatus",void 0),b([v({type:Boolean})],X.prototype,"isUserInfoMaskEnabled",void 0),b([f("#loading-spinner")],X.prototype,"spinner",void 0),b([f("#list-grid")],X.prototype,"_grid",void 0),b([f("#access-key-filter")],X.prototype,"accessKeyFilterInput",void 0),b([f("#multiple-action-buttons")],X.prototype,"multipleActionButtons",void 0),b([f("#access-key-filter-helper-text")],X.prototype,"accessKeyFilterHelperText",void 0),b([f("#terminate-session-dialog")],X.prototype,"terminateSessionDialog",void 0),b([f("#terminate-selected-sessions-dialog")],X.prototype,"terminateSelectedSessionsDialog",void 0),b([f("#status-detail-dialog")],X.prototype,"sessionStatusInfoDialog",void 0),b([f("#work-dialog")],X.prototype,"workDialog",void 0),b([f("#help-description")],X.prototype,"helpDescriptionDialog",void 0),b([f("#commit-session-dialog")],X.prototype,"commitSessionDialog",void 0),b([f("#commit-current-session-path-input")],X.prototype,"commitSessionInput",void 0),b([f("#list-status")],X.prototype,"_listStatus",void 0),X=Y=b([y("backend-ai-session-list")],X);let te=ee=class extends w{constructor(){super(),this._status="inactive",this.active=!1,this.is_admin=!1,this.enableInferenceWorkload=!1,this.enableSFTPSession=!1,this.filterAccessKey="",this._connectionMode="API",this._defaultFileName="",this.active=!1,this._status="inactive"}static get styles(){return[k,x,A,E,R,i`
        h3.tab {
          ...
          <h3 class="tab horizontal center layout" style="margin-top:0;margin-bottom:0;">
            <div class="scroll hide-scrollbar">
              <div class="horizontal layout flex start-justified" style="width:70%;">
                <mwc-tab-bar>
                  <mwc-tab title="running" label="${I("session.Running")}" @click="${e=>this._showTab(e.target)}"></mwc-tab>
                  <mwc-tab title="interactive" label="${I("session.Interactive")}" @click="${e=>this._showTab(e.target)}"></mwc-tab>
                  <mwc-tab title="batch" label="${I("session.Batch")}" @click="${e=>this._showTab(e.target)}"></mwc-tab>
                  ${this.enableInferenceWorkload?$`
                  <mwc-tab title="inference" label="${I("session.Inference")}" @click="${e=>this._showTab(e.target)}"></mwc-tab>
                  `:$``}
                  ${this.enableSFTPSession?$`
                  <mwc-tab title="system" label="${I("session.System")}" @click="${e=>this._showTab(e.target)}"></mwc-tab>
                  `:$``}
                  <mwc-tab title="finished" label="${I("session.Finished")}" @click="${e=>this._showTab(e.target)}"></mwc-tab>
                  <mwc-tab title="others" label="${I("session.Others")}" @click="${e=>this._showTab(e.target)}"></mwc-tab>
                </mwc-tab-bar>
              </div>
            </div>
            ${this.is_admin?$`
      ...
      <backend-ai-dialog id="export-to-csv" fixed backdrop>
        <span slot="title">${I("session.ExportSessionListToCSVFile")}</span>
        <div slot="content">
          <mwc-textfield id="export-file-name" label="File name"
                          validationMessage="${I("data.explorer.ValueRequired")}"
        ...
        <div slot="footer" class="horizontal center-justified flex layout">
          <mwc-button unelevated
                      fullwidth
                      icon="get_app"
                      label="${I("session.ExportCSVFile")}"
                      @click="${this._exportToCSV}"></mwc-button>
        </div>
      </backend-ai-dialog>
    `}};b([v({type:String})],te.prototype,"_status",void 0),b([v({type:Boolean,reflect:!0})],te.prototype,"active",void 0),b([v({type:Boolean})],te.prototype,"is_admin",void 0),b([v({type:Boolean})],te.prototype,"enableInferenceWorkload",void 0),b([v({type:Boolean})],te.prototype,"enableSFTPSession",void 0),b([v({type:String})],te.prototype,"filterAccessKey",void 0),b([v({type:String})],te.prototype,"_connectionMode",void 0),b([v({type:Object})],te.prototype,"_defaultFileName",void 0),b([function(t){return e({descriptor:e=>({get(){var e,i;return null!==(i=null===(e=this.renderRoot)||void 0===e?void 0:e.querySelectorAll(t))&&void 0!==i?i:[]},enumerable:!0,configurable:!0})})}("backend-ai-session-list")],te.prototype,"sessionList",void 0),b([f("#running-jobs")],te.prototype,"runningJobs",void 0),b([f("#resource-monitor")],te.prototype,"resourceMonitor",void 0),b([f("#export-file-name")],te.prototype,"exportFileNameInput",void 0),b([f("#date-from")],te.prototype,"dateFromInput",void 0),b([f("#date-to")],te.prototype,"dateToInput",void 0),b([f("#dropdown-menu")],te.prototype,"dropdownMenu",void 0),b([f("#export-to-csv")],te.prototype,"exportToCsvDialog",void 0),te=ee=b([y("backend-ai-session-view")],te);var ie=te;export{ie as default};
