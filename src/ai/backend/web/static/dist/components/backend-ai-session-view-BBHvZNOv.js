 ...
 */;class R extends(E(a(l(r)))){static get is(){return"vaadin-grid-tree-toggle"}static get template(){return o`
    ...
    `),d.hasOwnProperty("kernel")||d.hasOwnProperty("session"))u.push(f`
        <div class="vertical layout start flex" style="width:100%;">
          <div style="width:100%;">
            ...
            <div class="vertical layout flex" style="width:100%;">
              <mwc-list>
                ${(null===(t=d.kernel)||void 0===t?void 0:t.exit_code)?f`
                      <mwc-list-item
                        twoline
                        noninteractive
      ...
      `);else if(d.hasOwnProperty("scheduler")){const e=null!==(a=null===(o=d.scheduler.failed_predicates)||void 0===o?void 0:o.length)&&void 0!==a?a:0,t=null!==(r=null===(l=d.scheduler.passed_predicates)||void 0===l?void 0:l.length)&&void 0!==r?r:0;u.push(f`
        <div class="vertical layout start flex" style="width:100%;">
          <div style="width:100%;">
            <h3
      ...
      `)}else if(d.hasOwnProperty("error")){const e=null!==(c=d.error.collection)&&void 0!==c?c:[d.error];u.push(f`
        <div class="vertical layout start flex" style="width:100%;">
          <div style="width:100%;">
            <h3
              style="width:100%;padding-left:15px;border-bottom:1px solid var(--token-colorBorder, #ccc);"
      ...
      `);b(u,p)}_openStatusDetailDialog(e,t,i){this.selectedSessionStatus={info:e,data:t,reserved_time:i},this._renderStatusDetail(),this.sessionStatusInfoDialog.show()}_validateSessionName(e){const t=this.compute_sessions.map((e=>e[this.sessionNameField])),i=e.target.parentNode,s=i.querySelector("#session-name-field").innerText,n=i.querySelector("#session-rename-field");n.validityTransform=(e,i)=>{if(i.valid){const i=!t.includes(e)||e===s;return i||(n.validationMessage=y("session.Validation.SessionNameAlreadyExist")),{valid:i,customError:!i}}return i.valueMissing?(n.validationMessage=y("session.Validation.SessionNameRequired"),{valid:i.valid,valueMissing:!i.valid}):i.patternMismatch?(n.validationMessage=y("session.Validation.SluggedStrings"),{valid:i.valid,patternMismatch:!i.valid}):(n.validationMessage=y("session.Validation.EnterValidSessionName"),{valid:i.valid,customError:!i.valid})}}_renameSessionName(e,t){const i=t.target.parentNode,s=i.querySelector("#session-name-field"),n=i.querySelector("#session-rename-field"),o=i.querySelector("#session-rename-icon");if("none"===s.style.display){if(!n.checkValidity())return n.reportValidity(),void(o.on=!0);{const t=globalThis.backendaiclient.APIMajorVersion<5?s.value:e;globalThis.backendaiclient.rename(t,n.value).then((e=>{this.refreshList(),this.notification.text=y("session.SessionRenamed"),this.notification.detail="",this.notification.show()})).catch((e=>{n.value=s.innerText,e&&e.message&&(this.notification.text=_.relieve(e.title),this.notification.detail=e.message,this.notification.show(!0,e))})).finally((()=>{this._toggleSessionNameField(s,n)}))}}else this._toggleSessionNameField(s,n)}_toggleSessionNameField(e,t){"block"===t.style.display?(e.style.display="block",t.style.display="none"):(e.style.display="none",t.style.display="block",t.focus())}static secondsToDHMS(e){const t=Math.floor(e/86400),i=Math.floor(e%86400/3600),s=Math.floor(e%3600/60),n=parseInt(e)%60,o=t<0||i<0||s<0||n<0?y("session.TimeoutExceeded"):"",a=`${void 0!==t&&t>0?String(t)+"d":""}${i.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}:${n.toString().padStart(2,"0")}`;return o.length>0?o:a}_getIdleSessionTimeout(e){if(globalThis.backendaiutils.isEmpty(e))return null;let t="",i=1/0;for(const[s,n]of Object.entries(e))null!=n&&"number"==typeof n&&null!=i&&n<i&&(t=s,i=n);return i?[t,N.secondsToDHMS(i)]:null}_openIdleChecksInfoDialog(){var e,t,i;this._helpDescriptionTitle=y("session.IdleChecks"),this._helpDescription=`\n      <p>${y("session.IdleChecksDesc")}</p>\n      ${(null===(e=this.activeIdleCheckList)||void 0===e?void 0:e.has("session_lifetime"))?`\n        <strong>${y("session.MaxSessionLifetime")}</strong>\n        <p>${y("session.MaxSessionLifetimeDesc")}</p>\n        `:""}\n      ${(null===(t=this.activeIdleCheckList)||void 0===t?void 0:t.has("network_timeout"))?`\n        <strong>${y("session.NetworkIdleTimeout")}</strong>\n        <p>${y("session.NetworkIdleTimeoutDesc")}</p>\n      `:""}\n      ${(null===(i=this.activeIdleCheckList)||void 0===i?void 0:i.has("utilization"))?`\n        <strong>${y("session.UtilizationIdleTimeout")}</strong>\n        <p>${y("session.UtilizationIdleTimeoutDesc")}</p>\n        <div style="margin:10px 5% 20px 5%;">\n          <li>\n            <span style="font-weight:500">${y("session.GracePeriod")}</span>\n            <div style="padding-left:20px;">${y("session.GracePeriodDesc")}</div>\n          </li>\n          <li>\n            <span style="font-weight:500">${y("session.UtilizationThreshold")}</span>\n            <div style="padding-left:20px;">${y("session.UtilizationThresholdDesc")}</div>\n          </li>\n        </div>\n      `:""}\n    `,this.helpDescriptionDialog.show()}async _openSFTPSessionConnectionInfoDialog(e,t){const i=await globalThis.backendaiclient.get_direct_access_info(e),s=i.public_host.replace(/^https?:\/\//,""),n=i.sshd_ports,o=new CustomEvent("read-ssh-key-and-launch-ssh-dialog",{detail:{sessionUuid:e,host:s,port:n,mounted:t}});document.dispatchEvent(o)}_createUtilizationIdleCheckDropdown(e,t){const i=e.target,s=document.createElement("mwc-menu");s.anchor=i,s.className="util-dropdown-menu",s.style.boxShadow="0 1px 1px rgba(0, 0, 0, 0.2)",s.setAttribute("open",""),s.setAttribute("fixed",""),s.setAttribute("corner","BOTTOM_START");let n=f``;globalThis.backendaiutils.isEmpty(t)||(n=f`
        <style>
        ...
        ${Object.keys(t).map((e=>{let[i,s]=t[e];i=i>=0?parseFloat(i).toFixed(1):"-";const n=this.getUtilizationCheckerColor([i,s]);return f`
          ...
          `}))}
      `,document.body.appendChild(s)),b(n,s)}_removeUtilizationIdleCheckDropdown(){var e;const t=document.getElementsByClassName("util-dropdown-menu");for(;t[0];)null===(e=t[0].parentNode)||void 0===e||e.removeChild(t[0])}sessionTypeRenderer(e,t,i){const s=JSON.parse(i.item.inference_metrics||"{}");b(f`
      ...
      `,e)}sessionInfoRenderer(e,t,i){"system"===this.condition?b(f`
          <style>
            #session-name-field {
              display: block;
              white-space: pre-wrap;
...
${i.item[this.sessionNameField]}</pre
              >
              ${this._isRunning&&!this._isPreparing(i.item.status)&&globalThis.backendaiclient.email==i.item.user_email?f`
                    <mwc-textfield
              ...
              <mwc-icon-button
                ...
                icon="content_copy"
                @click="${async()=>await navigator.clipboard.writeText(i.item[this.sessionNameField])}"
              ></mwc-icon-button>
            </div>
            <div class="horizontal center center-justified layout">
              ${i.item.icon?f`
              ...
              <div class="vertical start layout">
                ${i.item.sessionTags?i.item.sessionTags.map((e=>f`
                        <div class="horizontal center layout">
                          ${e.map((e=>("Env"===e.category&&(e.category=e.tag),e.category&&i.item.baseversion&&(e.tag=i.item.baseversion),f`
                              <lablup-shields
                      ...
                      `)):f``}
                ${i.item.additional_reqs?f`
                      <div class="layout horizontal center wrap">
                        ${i.item.additional_reqs.map((e=>f`
                            <lablup-shields
                              app=""
                              color="green"
                              description="${e}"
        ...
        `,e)}architectureRenderer(e,t,i){b(f`
        <lablup-shields
          app=""
          color="lightgreen"
          ...
          ui="round"
        ></lablup-shields>
      `,e)}controlRenderer(e,t,i){var s;let n=!0;n="API"===this._connectionMode&&i.item.access_key===globalThis.backendaiclient._config._accessKey||i.item.user_email===globalThis.backendaiclient.email,b(f`
        <div
          id="controls"
        ...
        >
          ${i.item.appSupport&&"system"!==this.condition?f`
                <mwc-icon-button
          ...
          ${this._isRunning&&"system"===this.condition?f`
                ...
                ></vaadin-tooltip>
              `:f``}
          ${this._isRunning&&!this._isPreparing(i.item.status)||this._isError(i.item.status)?f`
                <mwc-icon-button
                ...
                ></vaadin-tooltip>
              `:f``}
          ${(this._isRunning&&!this._isPreparing(i.item.status)||this._APIMajorVersion>4)&&!["RESTARTING","PENDING","PULLING"].includes(i.item.status)?f`
                <mwc-icon-button
      ...
      `,e)}configRenderer(e,t,i){const s=i.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?b(f``,e):b(f`
          <div class="layout horizontal center flex">
            <div class="layout horizontal center configuration">
              ${i.item.mounts.length>0?f`
          ...
          <div class="layout vertical flex" style="padding-left: 25px">
            ...
            <div class="layout horizontal center configuration">
              ${i.item.cuda_gpu_slot?f`
                  ...
                  `:f``}
              ${!i.item.cuda_gpu_slot&&i.item.cuda_fgpu_slot?f`
                    <img
                      class="indicator-icon fg green"
                      src="/resources/icons/file_type_cuda.svg"
                    />
              ...
              ${i.item.atom_slot?f`
                  ...
                  `:f``}
              ${i.item.gaudi2_slot?f`
                    <img
                      class="indicator-icon fg green"
                      src="/resources/icons/gaudi.svg"
                    />
                    <span>${i.item.gaudi2_slot}</span>
                    <span class="indicator">Gaudi 2</span>
                  `:f``}
              ${i.item.atom_plus_slot?f`
                    <img
                      class="indicator-icon fg green"
                      src="/resources/icons/rebel.svg"
                    />
              ...
              ${i.item.rngd_slot?f`
                    <img
                      ...
                      src="/resources/icons/furiosa.svg"
                    />
                    <span>${i.item.rngd_slot}</span>
                    <span class="indicator">RNGD</span>
                  `:f``}
              ${i.item.hyeraccel_lpu_slot?f`
                    <img
                      class="indicator-icon fg green"
                  ...
                  `:f``}
              ${i.item.cuda_gpu_slot||i.item.cuda_fgpu_slot||i.item.rocm_gpu_slot||i.item.tpu_slot||i.item.ipu_slot||i.item.atom_slot||i.item.atom_plus_slot||i.item.gaudi2_slot||i.item.warboy_slot||i.item.rngd_slot||i.item.hyperaccel_lpu_slot?f``:f`
                    <mwc-icon class="fg green indicator">view_module</mwc-icon>
                    <span>-</span>
                    <span class="indicator">GPU</span>
                  `}
        ...
        `,e)}usageRenderer(e,t,i){var s,n,o,a,l,r,c,d,p,u,h,m,g,v,_,y,w,k,x,A,S,$,T,I,C,D,E,R,M,j,z,F,L,O,P,B,U,G,K,H,q,V,W,J,Z,Y,Q,X,ee,te,ie,se,ne,oe,ae,le,re,ce,de,pe,ue,he,me,ge,ve,_e,be,fe,ye,we,ke,xe,Ae,Se,$e,Te;["batch","interactive","inference","running"].includes(this.condition)?b(f`
          <div class="vertical start start-justified layout">
            <div class="vertical start-justified layout">
              <div class="usage-items">
                CPU
                ${i.item.live_stat?(100*(null===(n=null===(s=i.item.live_stat)||void 0===s?void 0:s.cpu_util)||void 0===n?void 0:n.ratio)).toFixed(1):"-"}
                %
              </div>
            ...
            <div class="vertical start-justified layout">
              <div class="usage-items">
                RAM
                ${i.item.live_stat?`${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(d=null===(c=i.item.live_stat)||void 0===c?void 0:c.mem)||void 0===d?void 0:d.current,2),2)} /\n                    ${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(u=null===(p=i.item.live_stat)||void 0===p?void 0:p.mem)||void 0===u?void 0:u.capacity,2),2)}`:"-"}
                GiB
              </div>
              <div class="horizontal start-justified center layout">
                <lablup-progress-bar
            ...
            ${i.item.cuda_gpu_slot&&parseInt(i.item.cuda_gpu_slot)>0?f`
                  <div class="vertical start-justified center layout">
                    <div class="usage-items">
                      GPU(util)
                      ${i.item.live_stat?(100*(null===(v=null===(g=i.item.live_stat)||void 0===g?void 0:g.cuda_util)||void 0===v?void 0:v.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(y=null===(_=i.item.live_stat)||void 0===_?void 0:_.cuda_util)||void 0===y?void 0:y.current)/(null===(k=null===(w=i.item.live_stat)||void 0===w?void 0:w.cuda_util)||void 0===k?void 0:k.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
                `:f``}
            ${i.item.cuda_fgpu_slot&&parseFloat(i.item.cuda_fgpu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(util)
                      ${i.item.live_stat?(100*(null===(A=null===(x=i.item.live_stat)||void 0===x?void 0:x.cuda_util)||void 0===A?void 0:A.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===($=null===(S=i.item.live_stat)||void 0===S?void 0:S.cuda_util)||void 0===$?void 0:$.current)/(null===(I=null===(T=i.item.live_stat)||void 0===T?void 0:T.cuda_util)||void 0===I?void 0:I.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
                `:f``}
            ${i.item.cuda_fgpu_slot?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${i.item.live_stat?`${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(D=null===(C=i.item.live_stat)||void 0===C?void 0:C.cuda_mem)||void 0===D?void 0:D.current,2),2)} /\n                            ${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(R=null===(E=i.item.live_stat)||void 0===E?void 0:E.cuda_mem)||void 0===R?void 0:R.capacity,2),2)}`:"-"}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${null===(j=null===(M=i.item.live_stat)||void 0===M?void 0:M.cuda_mem)||void 0===j?void 0:j.ratio}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
                `:f``}
            ${i.item.rocm_gpu_slot&&parseFloat(i.item.rocm_gpu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(util)
                      ${i.item.live_stat?(100*(null===(F=null===(z=i.item.live_stat)||void 0===z?void 0:z.rocm_util)||void 0===F?void 0:F.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(O=null===(L=i.item.live_stat)||void 0===L?void 0:L.rocm_util)||void 0===O?void 0:O.current)/(null===(B=null===(P=i.item.live_stat)||void 0===P?void 0:P.rocm_util)||void 0===B?void 0:B.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
            ...
            ${i.item.rocm_gpu_slot?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(mem)
                      ${i.item.live_stat?`${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(G=null===(U=i.item.live_stat)||void 0===U?void 0:U.rocm_mem)||void 0===G?void 0:G.current,2),2)} /\n                          ${N._prefixFormatWithoutTrailingZeros(N.bytesToGiB(null===(H=null===(K=i.item.live_stat)||void 0===K?void 0:K.rocm_mem)||void 0===H?void 0:H.capacity,2),2)}`:"-"}
                      GiB
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${null===(V=null===(q=i.item.live_stat)||void 0===q?void 0:q.rocm_mem)||void 0===V?void 0:V.ratio}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
                `:f``}
            ${i.item.tpu_slot&&parseFloat(i.item.tpu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      TPU(util)
                      ${i.item.live_stat?(100*(null===(J=null===(W=i.item.live_stat)||void 0===W?void 0:W.tpu_util)||void 0===J?void 0:J.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(Y=null===(Z=i.item.live_stat)||void 0===Z?void 0:Z.tpu_util)||void 0===Y?void 0:Y.current)/(null===(X=null===(Q=i.item.live_stat)||void 0===Q?void 0:Q.tpu_util)||void 0===X?void 0:X.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
                `:f``}
            ${i.item.ipu_slot&&parseFloat(i.item.ipu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      IPU(util)
                      ${i.item.live_stat?(100*(null===(te=null===(ee=i.item.live_stat)||void 0===ee?void 0:ee.ipu_util)||void 0===te?void 0:te.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(ne=null===(se=null===(ie=i.item)||void 0===ie?void 0:ie.live_stat)||void 0===se?void 0:se.ipu_util)||void 0===ne?void 0:ne.current)/(null===(le=null===(ae=null===(oe=i.item)||void 0===oe?void 0:oe.live_stat)||void 0===ae?void 0:ae.ipu_util)||void 0===le?void 0:le.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
                `:f``}
            ${i.item.atom_slot&&parseFloat(i.item.atom_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      ATOM(util)
                      ${i.item.live_stat?(100*(null===(ce=null===(re=i.item.live_stat)||void 0===re?void 0:re.atom_util)||void 0===ce?void 0:ce.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(ue=null===(pe=null===(de=i.item)||void 0===de?void 0:de.live_stat)||void 0===pe?void 0:pe.atom_util)||void 0===ue?void 0:ue.current)/(null===(ge=null===(me=null===(he=i.item)||void 0===he?void 0:he.live_stat)||void 0===me?void 0:me.atom_util)||void 0===ge?void 0:ge.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
            ...
            <div class="horizontal start-justified center layout">
              ...
              >
                R:
                ${i.item.live_stat?null===(be=null===(_e=null===(ve=i.item)||void 0===ve?void 0:ve.live_stat)||void 0===_e?void 0:_e.io_read)||void 0===be?void 0:be.current.toFixed(1):"-"}
                MB / W:
                ${i.item.live_stat?null===(we=null===(ye=null===(fe=i.item)||void 0===fe?void 0:fe.live_stat)||void 0===ye?void 0:ye.io_write)||void 0===we?void 0:we.current.toFixed(1):"-"}
                MB
              </div>
            </div>
          </div>
          ...
          <div class="layout horizontal center flex">
            ...
            <div class="vertical start layout">
              <span style="font-size:9px">
                ${null!==(Ae=null===(xe=null===(ke=i.item.live_stat)||void 0===ke?void 0:ke.io_read)||void 0===xe?void 0:xe.current.toFixed(1))&&void 0!==Ae?Ae:"-"}
            ...
            <div class="vertical start layout">
              <span style="font-size:8px">
                ${null!==(Te=null===($e=null===(Se=i.item.live_stat)||void 0===Se?void 0:Se.io_write)||void 0===$e?void 0:$e.current.toFixed(1))&&void 0!==Te?Te:"-"}
                <span class="indicator">MB</span>
              </span>
              <span class="indicator">WRITE</span>
            </div>
          </div>
        `,e)}reservationRenderer(e,t,i){b(f`
      ...
      `,e)}idleChecksHeaderRenderer(e,t){b(f`
      ...
      `,e)}idleChecksRenderer(e,t,i){var s;const n=null===(s=Object.keys(i.item.idle_checks))||void 0===s?void 0:s.map((e=>{var t,s;const n=i.item.idle_checks[e],o=null==n?void 0:n.remaining;if(!o)return;const a=globalThis.backendaiclient.utils.elapsedTimeToTotalSeconds(o),l=null==n?void 0:n.remaining_time_type;let r,c="var(--token-colorSuccess";return!a||a<3600?c="var(--token-colorError)":a<14400&&(c="var(--token-colorWarning)"),"utilization"===e&&(null==n?void 0:n.extra)&&(!a||a<14400)&&(c=this.getUtilizationCheckerColor(null===(t=null==n?void 0:n.extra)||void 0===t?void 0:t.resources,null===(s=null==n?void 0:n.extra)||void 0===s?void 0:s.thresholds_check_operator)),r="utilization"===e?f`
          ...
          `:f``})),o=f`
      ${n}
    `;b(o,e)}agentListRenderer(e,t,i){b(f`
        <pre>${i.item.agents_ids_with_container_ids}</pre>
      `,e)}_aggregateSharedMemory(e){let t=0;return Object.keys(e).forEach((i=>{var s,n;t+=Number(null!==(n=null===(s=e[i])||void 0===s?void 0:s.shmem)&&void 0!==n?n:0)})),N.bytesToGiB(t)}userInfoRenderer(e,t,i){const s="API"===this._connectionMode?i.item.access_key:i.item.user_email;b(f`
        <div class="layout vertical">
          <span class="indicator">${this._getUserId(s)}</span>
        </div>
      `,e)}statusRenderer(e,t,i){var s;b(f`
        <div class="horizontal layout center">
          <span style="font-size: 12px;">${i.item.status}</span>
          ${i.item.status_data&&"{}"!==i.item.status_data?f`
                <mwc-icon-button
        ...
        ${i.item.status_info?f`
            ...
            `:f``}
        ${this._isContainerCommitEnabled&&void 0!==(null===(s=i.item)||void 0===s?void 0:s.commit_status)?f`
              <lablup-shields
                app=""
    ...
    `}_parseSessionInfoToCommitSessionInfo(e="",t="",i=""){const s=["",""],[n,o]=e?e.split(":"):s,[a,...l]=o?o.split("-"):s;return{environment:n,version:a,tags:l,session:{name:t,id:i}}}render(){var e,t,i;return f`
    ...
    `}_updateSessionPage(e){"previous-page"===e.target.id?this.current_page-=1:this.current_page+=1,this.refreshList()}_validateImageName(){this.newImageNameInput.validityTransform=(e,t)=>t.valid?(this.canStartImagifying=!0,this.newImageName=e,{valid:t.valid,customError:!t.valid}):(this.canStartImagifying=!1,t.patternMismatch?(this.newImageNameInput.validationMessage=y("session.Validation.EnterValidSessionName"),{valid:t.valid,patternMismatch:!t.valid}):(this.newImageNameInput.validationMessage=y("session.Validation.EnterValidSessionName"),{valid:t.valid,customError:!t.valid}))}};var j;c([d({type:Boolean,reflect:!0})],M.prototype,"active",void 0),c([d({type:String})],M.prototype,"condition",void 0),c([d({type:Object})],M.prototype,"jobs",void 0),c([d({type:Array})],M.prototype,"compute_sessions",void 0),c([d({type:Array})],M.prototype,"terminationQueue",void 0),c([d({type:String})],M.prototype,"filterAccessKey",void 0),c([d({type:String})],M.prototype,"sessionNameField",void 0),c([d({type:Array})],M.prototype,"appSupportList",void 0),c([d({type:Object})],M.prototype,"appTemplate",void 0),c([d({type:Object})],M.prototype,"imageInfo",void 0),c([d({type:Array})],M.prototype,"_selected_items",void 0),c([d({type:Array})],M.prototype,"_manualCleanUpNeededContainers",void 0),c([d({type:Object})],M.prototype,"_boundControlRenderer",void 0),c([d({type:Object})],M.prototype,"_boundConfigRenderer",void 0),c([d({type:Object})],M.prototype,"_boundUsageRenderer",void 0),c([d({type:Object})],M.prototype,"_boundReservationRenderer",void 0),c([d({type:Object})],M.prototype,"_boundIdleChecksHeaderderer",void 0),c([d({type:Object})],M.prototype,"_boundIdleChecksRenderer",void 0),c([d({type:Object})],M.prototype,"_boundAgentListRenderer",void 0),c([d({type:Object})],M.prototype,"_boundSessionInfoRenderer",void 0),c([d({type:Object})],M.prototype,"_boundArchitectureRenderer",void 0),c([d({type:Object})],M.prototype,"_boundUserInfoRenderer",void 0),c([d({type:Object})],M.prototype,"_boundStatusRenderer",void 0),c([d({type:Object})],M.prototype,"_boundSessionTypeRenderer",void 0),c([d({type:Boolean})],M.prototype,"refreshing",void 0),c([d({type:Boolean})],M.prototype,"is_admin",void 0),c([d({type:Boolean})],M.prototype,"is_superadmin",void 0),c([d({type:String})],M.prototype,"_connectionMode",void 0),c([d({type:Object})],M.prototype,"notification",void 0),c([d({type:Boolean})],M.prototype,"enableScalingGroup",void 0),c([d({type:Boolean})],M.prototype,"isDisplayingAllocatedShmemEnabled",void 0),c([d({type:String})],M.prototype,"listCondition",void 0),c([d({type:Object})],M.prototype,"refreshTimer",void 0),c([d({type:Object})],M.prototype,"kernel_labels",void 0),c([d({type:Object})],M.prototype,"kernel_icons",void 0),c([d({type:Object})],M.prototype,"indicator",void 0),c([d({type:String})],M.prototype,"_helpDescription",void 0),c([d({type:String})],M.prototype,"_helpDescriptionTitle",void 0),c([d({type:String})],M.prototype,"_helpDescriptionIcon",void 0),c([d({type:Set})],M.prototype,"activeIdleCheckList",void 0),c([d({type:Array})],M.prototype,"selectedKernels",void 0),c([d({type:String})],M.prototype,"selectedKernelId",void 0),c([d({type:Proxy})],M.prototype,"statusColorTable",void 0),c([d({type:Proxy})],M.prototype,"idleChecksTable",void 0),c([d({type:Proxy})],M.prototype,"sessionTypeColorTable",void 0),c([d({type:Number})],M.prototype,"sshPort",void 0),c([d({type:Number})],M.prototype,"vncPort",void 0),c([d({type:Number})],M.prototype,"current_page",void 0),c([d({type:Number})],M.prototype,"session_page_limit",void 0),c([d({type:Number})],M.prototype,"total_session_count",void 0),c([d({type:Number})],M.prototype,"_APIMajorVersion",void 0),c([d({type:Object})],M.prototype,"selectedSessionStatus",void 0),c([d({type:Boolean})],M.prototype,"isUserInfoMaskEnabled",void 0),c([d({type:Boolean})],M.prototype,"pushImageInsteadOfCommiting",void 0),c([d({type:Boolean})],M.prototype,"canStartImagifying",void 0),c([d({type:String})],M.prototype,"newImageName",void 0),c([p("#loading-spinner")],M.prototype,"spinner",void 0),c([p("#list-grid")],M.prototype,"_grid",void 0),c([p("#access-key-filter")],M.prototype,"accessKeyFilterInput",void 0),c([p("#new-image-name-field")],M.prototype,"newImageNameInput",void 0),c([p("#multiple-action-buttons")],M.prototype,"multipleActionButtons",void 0),c([p("#access-key-filter-helper-text")],M.prototype,"accessKeyFilterHelperText",void 0),c([p("#terminate-session-dialog")],M.prototype,"terminateSessionDialog",void 0),c([p("#terminate-selected-sessions-dialog")],M.prototype,"terminateSelectedSessionsDialog",void 0),c([p("#force-terminate-confirmation-dialog")],M.prototype,"forceTerminateConfirmationDialog",void 0),c([p("#status-detail-dialog")],M.prototype,"sessionStatusInfoDialog",void 0),c([p("#work-dialog")],M.prototype,"workDialog",void 0),c([p("#help-description")],M.prototype,"helpDescriptionDialog",void 0),c([p("#commit-session-dialog")],M.prototype,"commitSessionDialog",void 0),c([p("#commit-current-session-path-input")],M.prototype,"commitSessionInput",void 0),c([p("#list-status")],M.prototype,"_listStatus",void 0),M=N=c([u("backend-ai-session-list")],M);let z=j=class extends h{constructor(){super(),this._status="inactive",this.active=!1,this.is_admin=!1,this.enableInferenceWorkload=!1,this.enableSFTPSession=!1,this.filterAccessKey="",this._connectionMode="API",this._defaultFileName="",this.active=!1,this._status="inactive"}static get styles(){return[m,g,v,x,A,i`
        mwc-menu {
    ...
    `}};c([d({type:String})],z.prototype,"_status",void 0),c([d({type:Boolean,reflect:!0})],z.prototype,"active",void 0),c([d({type:Boolean})],z.prototype,"is_admin",void 0),c([d({type:Boolean})],z.prototype,"enableInferenceWorkload",void 0),c([d({type:Boolean})],z.prototype,"enableSFTPSession",void 0),c([d({type:String})],z.prototype,"filterAccessKey",void 0),c([d({type:String})],z.prototype,"_connectionMode",void 0),c([d({type:Object})],z.prototype,"_defaultFileName",void 0),c([d({type:Object})],z.prototype,"resourceBroker",void 0),c([function(t){return(i,s)=>e(i,s,{get(){return(this.renderRoot??($??=document.createDocumentFragment())).querySelectorAll(t)}})}("backend-ai-session-list")],z.prototype,"sessionList",void 0),c([p("#running-jobs")],z.prototype,"runningJobs",void 0),c([p("#resource-monitor")],z.prototype,"resourceMonitor",void 0),c([p("#export-file-name")],z.prototype,"exportFileNameInput",void 0),c([p("#date-from")],z.prototype,"dateFromInput",void 0),c([p("#date-to")],z.prototype,"dateToInput",void 0),c([p("#dropdown-menu")],z.prototype,"dropdownMenu",void 0),c([p("#export-to-csv")],z.prototype,"exportToCsvDialog",void 0),z=j=c([u("backend-ai-session-view")],z);
