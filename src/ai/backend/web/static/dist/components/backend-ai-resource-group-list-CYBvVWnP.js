import{_ as e,n as i,K as t,e as o,t as r,B as s,b as a,I as l,a as n,i as u,d as c,Q as d,k as p,g as h,f as v}from"./backend-ai-webui-CLYyD6h8.js";import"./backend-ai-multi-select-COe_fzx4.js";import"./mwc-switch-DxvjLBGN.js";import"./vaadin-item-B2L2KM9f.js";import"./mwc-check-list-item-RNdnDTVG.js";import"./vaadin-item-mixin-Bo0fel8L.js";let m=class extends s{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.allowedSessionTypes=["interactive","batch","inference"],this.enableSchedulerOpts=!1,this.enableWSProxyAddr=!1,this.enableIsPublic=!1,this.functionCount=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.resourceGroups=[],this.resourceGroupInfo={},this.domains=[]}static get styles(){return[a,l,n,u`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
