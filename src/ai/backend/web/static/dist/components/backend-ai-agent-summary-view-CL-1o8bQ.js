import{_ as s,n as t,e,t as i,B as a,b as o,I as r,a as l,i as n,d,Q as c,k as p,f as u,g as _}from"./backend-ai-webui-ByNpTuXm.js";import"./lablup-progress-bar-BeiecOEw.js";import"./mwc-switch-DgdT8TP6.js";import"./backend-ai-list-status-DX06bbhO.js";import"./lablup-activity-panel-tS7OfMvz.js";import"./mwc-tab-bar-BPWPSxoQ.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
