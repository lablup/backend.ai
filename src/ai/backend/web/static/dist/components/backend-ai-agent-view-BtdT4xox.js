import{_ as e,n as t,e as i,t as s,B as a,b as o,I as r,a as l,i as n,d,p as c,x as u,f as p,g as h,j as g,k as v}from"./backend-ai-webui-OltTK2Ch.js";import"./lablup-progress-bar-CfQ38VFB.js";import"./vaadin-grid-ori3mwSb.js";import"./vaadin-grid-sort-column-tC8_iSFZ.js";import"./backend-ai-multi-select-Ann5dYhv.js";import"./mwc-switch-B4ridzlv.js";import"./vaadin-item-CnjrvEvN.js";import{r as m}from"./state-C2MI6VlB.js";import"./backend-ai-list-status-CM5iFAFu.js";import"./backend-ai-storage-host-settings-view-DW6ARzNY.js";import"./lablup-activity-panel-Xrp0-Ruq.js";import"./mwc-tab-bar-C0onxas8.js";import"./dir-utils-Djx442Fy.js";import"./mwc-check-list-item-Sgao1Cvj.js";import"./vaadin-item-mixin-BB0DaYV9.js";import"./active-mixin-CTraZYwJ.js";var b;let _=b=class extends a{constructor(){super(...arguments),this._enableAgentSchedulable=!1,this.condition="running",this.list_condition="loading",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.enableAgentSchedulable=!1,this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundUtilizationRenderer=this.utilizationRenderer.bind(this),this._boundDiskRenderer=this.diskRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
