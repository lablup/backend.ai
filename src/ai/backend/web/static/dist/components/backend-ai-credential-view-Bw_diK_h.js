import{_ as e,n as t,e as i,t as a,B as s,b as o,I as r,a as n,v as l,c,i as d,d as u,g as p,Q as h,k as m,f as v,L as y}from"./backend-ai-webui-DSafjoko.js";import{J as _}from"./vaadin-iconset-BaqebOD3.js";import"./backend-ai-list-status-DAvukEsd.js";import"./lablup-grid-sort-filter-column-D5ZxVjVi.js";import"./vaadin-grid-filter-column-DvuDq-Oh.js";import"./vaadin-item-CiwjbGF6.js";import"./backend-ai-multi-select-BJRvyM3g.js";import"./mwc-switch-D15G8e-c.js";import"./lablup-activity-panel-BwH92Ud0.js";import"./mwc-formfield-FhLL4NYA.js";import"./mwc-tab-bar-wgQ9kATQ.js";import"./vaadin-item-mixin-D66DC-q0.js";import"./mwc-check-list-item-DrjKQBNS.js";var g;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let f=g=class extends s{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey="",this.supportMainAccessKey=!1,this._mainAccessKeyList=[]}static get styles(){return[o,r,n,l,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
