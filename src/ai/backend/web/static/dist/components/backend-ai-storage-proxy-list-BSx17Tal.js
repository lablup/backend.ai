import{_ as e,n as t,e as i,t as a,B as s,b as o,I as r,a as n,i as d,d as l,j as c,k as p,p as h,x as g,f as u,g as b}from"./backend-ai-webui-lOeH5wm0.js";import"./backend-ai-list-status-lp5cMEa4.js";import"./backend-ai-storage-host-settings-view-DQYqb3hB.js";import"./lablup-progress-bar-DgrkVBGm.js";import"./vaadin-grid-N4zkwbUz.js";import"./vaadin-grid-sort-column-D-9QH2qr.js";import"./dir-utils-0BBYFvya.js";var m;let v=m=class extends s{constructor(){super(),this.condition="running",this.listCondition="loading",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[o,r,n,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
