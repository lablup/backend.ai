import{_ as e,e as t,n as i,a7 as o,t as s,h as r,b as a,I as l,a8 as n,a as d,a6 as c,c as u,i as p,k as h,a9 as v,aa as m,q as g,p as b,T as f,D as y,P as x,B as _,d as w,Q as G,g as I,f as k}from"./backend-ai-webui-CuYxUCgf.js";import"./mwc-check-list-item-B3NHddRA.js";var $;let S=$=class extends r{constructor(){super(),this.label="",this.validationMessage="",this.enableClearButton=!1,this.openUp=!1,this.required=!1,this._valid=!0,this.selectedItemList=[],this.items=[]}static get styles(){return[a,l,n,d,c,u,p`
        lablup-shields {
          margin: 1px;
        }
 ...
 * Copyright (c) 2017 - 2024 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;class O extends(T(f(y(x)))){static get template(){return g`
      <style>
        :host {
    ...
    `}static get is(){return"vaadin-item"}constructor(){super(),this.value,this.label}ready(){super.ready(),this.setAttribute("role","option")}}b(O);let R=class extends _{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.allowedSessionTypes=["interactive","batch","inference"],this.enableSchedulerOpts=!1,this.enableWSProxyAddr=!1,this.enableIsPublic=!1,this.functionCount=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.resourceGroups=[],this.resourceGroupInfo={},this.domains=[]}static get styles(){return[a,l,d,p`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
    ...
    `}};e([i({type:Object})],R.prototype,"_boundControlRenderer",void 0),e([i({type:Array})],R.prototype,"domains",void 0),e([i({type:Object})],R.prototype,"resourceGroupInfo",void 0),e([i({type:Array})],R.prototype,"resourceGroups",void 0),e([i({type:Array})],R.prototype,"schedulerTypes",void 0),e([i({type:Object})],R.prototype,"schedulerOpts",void 0),e([o()],R.prototype,"allowedSessionTypes",void 0),e([i({type:Boolean})],R.prototype,"enableSchedulerOpts",void 0),e([i({type:Boolean})],R.prototype,"enableWSProxyAddr",void 0),e([i({type:Boolean})],R.prototype,"enableIsPublic",void 0),e([i({type:Number})],R.prototype,"functionCount",void 0),e([t("#resource-group-name")],R.prototype,"resourceGroupNameInput",void 0),e([t("#resource-group-description")],R.prototype,"resourceGroupDescriptionInput",void 0),e([t("#resource-group-domain")],R.prototype,"resourceGroupDomainSelect",void 0),e([t("#resource-group-scheduler")],R.prototype,"resourceGroupSchedulerSelect",void 0),e([t("#resource-group-active")],R.prototype,"resourceGroupActiveSwitch",void 0),e([t("#resource-group-public")],R.prototype,"resourceGroupPublicSwitch",void 0),e([t("#resource-group-wsproxy-address")],R.prototype,"resourceGroupWSProxyAddressInput",void 0),e([t("#allowed-session-types")],R.prototype,"allowedSessionTypesSelect",void 0),e([t("#num-retries-to-skip")],R.prototype,"numberOfRetriesToSkip",void 0),e([t("#pending-timeout")],R.prototype,"timeoutInput",void 0),e([t("#delete-resource-group")],R.prototype,"deleteResourceGroupInput",void 0),e([t("#modify-resource-group")],R.prototype,"modifyResourceGroupButton",void 0),e([t("#create-resource-group")],R.prototype,"createResourceGroupButton",void 0),R=e([s("backend-ai-resource-group-list")],R);
