import{_ as t,n as e,t as i,h as s,I as a,a as r,i as o,k as n,g as l,e as p,B as c,b as u,c as d,d as h,f as m,j as _,s as g,l as v}from"./backend-ai-webui-CRIarMqw.js";import"./lablup-activity-panel-SxHHperO.js";let b=class extends s{constructor(){super(...arguments),this.currentNumber=50,this.maxNumber=100,this.unit="%",this.url="",this.textcolor="#888888",this.chartcolor="#ff2222",this.size=200,this.fontsize=60,this.chartFontSize="0",this.indicatorPath="",this.prefix="",this.sizeParam=""}static get is(){return"lablup-piechart"}static get styles(){return[a,r,o`
        #chart {
          cursor: pointer;
        }
