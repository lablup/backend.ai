import{r as e,T as t,h as r,D as o,P as i,S as a,w as s,x as l,v as n,y as d,C as h,z as u,o as p,m as c,K as m,l as _,t as g,I as f,L as v,e as b,E as x,G as y}from"./vaadin-grid-474fcd24.js";import{i as C}from"./backend-ai-webui-40033228.js";e("vaadin-input-container",C`
    :host {
 ...
 */
class w extends(t(o(i))){static get is(){return"vaadin-input-container"}static get template(){return r`
      <style>
        :host {
          display: flex;
          align-items: center;
    ...
    `}static get properties(){return{disabled:{type:Boolean,reflectToAttribute:!0},readonly:{type:Boolean,reflectToAttribute:!0},invalid:{type:Boolean,reflectToAttribute:!0}}}ready(){super.ready(),this.addEventListener("pointerdown",(e=>{e.target===this&&e.preventDefault()})),this.addEventListener("click",(e=>{e.target===this&&this.shadowRoot.querySelector("slot:not([name])").assignedNodes({flatten:!0}).forEach((e=>e.focus&&e.focus()))}))}}customElements.define(w.is,w);
/**
 * @license
...
`;e("",I,{moduleId:"lumo-field-button"});
/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
e("vaadin-text-field",B,{moduleId:"vaadin-text-field-styles"});class R extends(P(q(t(x(i))))){static get is(){return"vaadin-text-field"}static get template(){return r`
      <style>
        [part='input-field'] {
          flex-grow: 0;
        }
...
class F extends class extends i{}{static get template(){return r`
    ...
    `}static get is(){return"vaadin-grid-filter"}static get properties(){return{path:String,value:{type:String,notify:!0},_connected:Boolean}}connectedCallback(){super.connectedCallback(),this._connected=!0}static get observers(){return["_filterChanged(path, value, _connected)"]}ready(){super.ready();const e=this.firstElementChild;e&&"filter"!==e.getAttribute("slot")&&(console.warn('Make sure you have assigned slot="filter" to the child elements of <vaadin-grid-filter>'),e.setAttribute("slot","filter"))}_filterChanged(e,t,r){void 0!==e&&void 0!==t&&r&&(void 0===this._previousValue&&""===t||(this._previousValue=t,this._debouncerFilterChanged=_.debounce(this._debouncerFilterChanged,g.after(200),(()=>{this.dispatchEvent(new CustomEvent("filter-changed",{bubbles:!0}))}))))}focus(){this.$.filter.focus()}}customElements.define(F.is,F);
/**
 * @license
 * Copyright (c) 2016 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class O extends y{static get is(){return"vaadin-grid-filter-column"}static get properties(){return{path:String,header:String}}static get observers(){return["_onHeaderRendererOrBindingChanged(_headerRenderer, _headerCell, path, header, _filterValue)"]}constructor(){super(),this.__boundOnFilterValueChanged=this.__onFilterValueChanged.bind(this)}_defaultHeaderRenderer(e,t){let r=e.firstElementChild,o=r?r.firstElementChild:void 0;r||(r=document.createElement("vaadin-grid-filter"),o=document.createElement("vaadin-text-field"),o.setAttribute("slot","filter"),o.setAttribute("theme","small"),o.setAttribute("style","max-width: 100%;"),o.setAttribute("focus-target",""),o.addEventListener("value-changed",this.__boundOnFilterValueChanged),r.appendChild(o),e.appendChild(r)),r.path=this.path,r.value=this._filterValue,o.__rendererValue=this._filterValue,o.value=this._filterValue,o.label=this.__getHeader(this.header,this.path)}_computeHeaderRenderer(){return this._defaultHeaderRenderer}__onFilterValueChanged(e){e.detail.value!==e.target.__rendererValue&&(this._filterValue=e.detail.value)}__getHeader(e,t){return e||(t?this._generateHeader(t):void 0)}}customElements.define(O.is,O);export{V as F,D as I,P,$ as a,B as b,E as h,k as i,A as r};
