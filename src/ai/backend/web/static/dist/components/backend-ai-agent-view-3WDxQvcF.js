import{_ as e,n as t,e as i,t as s,B as a,b as o,I as r,a as l,i as n,d,p as c,x as u,f as p,g as h,j as g,k as v}from"./backend-ai-webui-CEkmyWzH.js";import"./lablup-progress-bar-BLK15lt9.js";import"./vaadin-grid-CEkjE_UW.js";import"./vaadin-grid-sort-column-Cj6ziZx7.js";import"./backend-ai-multi-select-D53iOu5m.js";import"./mwc-switch-CqK04O9c.js";import"./vaadin-item-C4uRsb4h.js";import{r as m}from"./state-BYF3zJJE.js";import"./backend-ai-list-status-BSRIl_1w.js";import"./backend-ai-storage-host-settings-view-ZtCqExHk.js";import"./lablup-activity-panel-UIqbmNZG.js";import"./mwc-tab-bar-dwOfEq0G.js";import"./dir-utils-B8E3jKp1.js";import"./mwc-check-list-item-Dg-xDA_j.js";import"./vaadin-item-mixin-D-6TH4P9.js";import"./active-mixin-CXUW9-EG.js";var b;let _=b=class extends a{constructor(){super(...arguments),this._enableAgentSchedulable=!1,this.condition="running",this.list_condition="loading",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.enableAgentSchedulable=!1,this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundUtilizationRenderer=this.utilizationRenderer.bind(this),this._boundDiskRenderer=this.diskRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
      ...
      `,e)}regionRenderer(e,t,i){let s,a,o,r;const l=i.item.region.split("/");switch(l.length>1?(s=l[0],a=l[1]):(s=l[0],a=""),s){case"aws":case"amazon":o="orange",r="aws";break;case"azure":o="blue",r="azure";break;case"gcp":case"google":o="lightblue",r="gcp";break;case"nbp":case"naver":o="green",r="nbp";break;case"openstack":o="red",r="openstack";break;case"dgx":o="green",r="local";break;default:o="yellow",r="local"}c(u`
        <div class="horizontal start-justified center layout wrap">
          <img
            ...
            style="width:32px;height:32px;${this.isDarkMode&&"local"===r?"filter:invert(1);":""}"
          />
          <lablup-shields
            app="${a}"
            color="${o}"
          ...
          ${i.item.hyperaccel_lpu_slots?u`
                ...
                >
                  <div class="layout horizontal start resource-indicator">
                    ...
                    />
                    <span class="monospace" style="padding-left:5px;">
                      ${i.item.used_hyperaccel_lpu_slots}/${i.item.hyperaccel_lpu_slots}
                    </span>
                  ...
                  <lablup-progress-bar
                    ...
                    progress="${i.item.used_hyperaccel_lpu_slots_ratio}"
                    description="${i.item.used_hyperaccel_lpu_slots}"
                  ></lablup-progress-bar>
                </div>
              `:u``}
        </div>
      ...
      `,e)}utilizationRenderer(e,t,i){var s,a,o,r,l,n,d,h,g,v,m,_;if("ALIVE"===i.item.status){let t={cpu_util:{capacity:0,current:0,ratio:0},mem_util:{capacity:0,current:0,ratio:0}};if((null===(a=null===(s=i.item.live_stat)||void 0===s?void 0:s.node)||void 0===a?void 0:a.cuda_util)&&(t=Object.assign(t,{cuda_util:{capacity:0,current:0,ratio:0}}),t.cuda_util.capacity=parseFloat(null!==(o=i.item.live_stat.node.cuda_util.capacity)&&void 0!==o?o:0),t.cuda_util.current=parseFloat(i.item.live_stat.node.cuda_util.current),t.cuda_util.ratio=t.cuda_util.current/100||0),null===(l=null===(r=i.item.live_stat)||void 0===r?void 0:r.node)||void 0===l?void 0:l.cuda_mem){let e;t=Object.assign(t,{cuda_mem:{capacity:0,current:0,ratio:0}}),t.cuda_mem.capacity=parseFloat(null!==(n=i.item.live_stat.node.cuda_mem.capacity)&&void 0!==n?n:0),t.cuda_mem.current=parseFloat(i.item.live_stat.node.cuda_mem.current),e=t.cuda_mem.capacity&&0!==t.cuda_mem.capacity?t.cuda_mem.capacity:100,t.cuda_mem.ratio=t.cuda_mem.current/e||0}if(i.item.live_stat&&i.item.live_stat.node&&i.item.live_stat.devices){const e=Object.keys(i.item.live_stat.devices.cpu_util).length;t.cpu_util.capacity=parseFloat(i.item.live_stat.node.cpu_util.capacity),t.cpu_util.current=parseFloat(i.item.live_stat.node.cpu_util.current),t.cpu_util.ratio=t.cpu_util.current/t.cpu_util.capacity/e||0,t.mem_util.capacity=parseInt(i.item.live_stat.node.mem.capacity),t.mem_util.current=parseInt(i.item.live_stat.node.mem.current),t.mem_util.ratio=t.mem_util.current/t.mem_util.capacity||0}c(u`
          <div>
            <div class="layout horizontal justified flex progress-bar-section">
              ...
              <lablup-progress-bar
                ...
                description="${(100*(null===(d=t.cpu_util)||void 0===d?void 0:d.ratio)).toFixed(1)} %"
              ></lablup-progress-bar>
            </div>
            <div class="layout horizontal justified flex progress-bar-section">
              ...
              <lablup-progress-bar
                ...
                description="${b.bytesToGiB(t.mem_util.current)}/${b.bytesToGiB(t.mem_util.capacity)} GiB"
              ></lablup-progress-bar>
            </div>
            ${t.cuda_util?u`
                  <div
                  ...
                  >
                    ...
                    <lablup-progress-bar
                      class="utilization"
                      progress="${null===(h=t.cuda_util)||void 0===h?void 0:h.ratio}"
                      description="${(100*(null===(g=t.cuda_util)||void 0===g?void 0:g.ratio)).toFixed(1)} %"
                    ></lablup-progress-bar>
                  </div>
                  <div
                    class="layout horizontal justified flex progress-bar-section"
                  >
                    ...
                    <lablup-progress-bar
                      class="utilization"
                      progress="${(null===(v=t.cuda_mem)||void 0===v?void 0:v.ratio)||0}"
                      description="${b.bytesToGiB(null===(m=t.cuda_mem)||void 0===m?void 0:m.current)}/${b.bytesToGiB(null===(_=t.cuda_mem)||void 0===_?void 0:_.capacity)} GiB"
                    ></lablup-progress-bar>
                  </div>
                `:u``}
          </div>
            ...
            <div class="vertical layout start-justified flex">
              ...
              ${(null===(i=null===(t=this.agentDetail)||void 0===t?void 0:t.live_stat)||void 0===i?void 0:i.node)?u`
                    ...
                    >
                      <span>TX:</span>
                      <span>
                        ${b.bytesToMB(this.agentDetail.live_stat.node.net_tx.current)}MiB
                      </span>
                    </div>
                    <div
                    ...
                    >
                      <span>RX:</span>
                      <span>
                        ${b.bytesToMB(this.agentDetail.live_stat.node.net_rx.current)}MiB
                      </span>
                    </div>
                  `:u`
      ...
      <div class="list-wrapper">
        ...
        >
          ...
          <vaadin-grid-column
            ...
            .renderer="${(e,t,i)=>this.regionRenderer(e,t,i)}"
          ></vaadin-grid-column>
          <vaadin-grid-sort-column
            auto-width
            flex-grow="0"
                    ...
                    <div role="listbox" class="vertical layout">
                      ...
                      <vaadin-item>
                        ...
                        <lablup-shields
                          ...
                          description=${(null===(m=this.resourceGroupInfo)||void 0===m?void 0:m.is_active)?"active":"inactive"}
                          ui="flat"
                        ></lablup-shields>
                      </vaadin-item>
                      ${this.enableIsPublic?u`
    ...
    `}};e([m()],w.prototype,"_status",void 0),e([m()],w.prototype,"_tab",void 0),e([m()],w.prototype,"enableStorageProxy",void 0),w=e([s("backend-ai-agent-view")],w);
