import{_ as t,n as e,t as i,h as s,I as a,a as r,i as o,k as n,g as l,e as c,B as p,b as u,c as d,d as h,f as m,j as g,s as _,l as v}from"./backend-ai-webui-RLW5RfEs.js";import"./backend-ai-resource-monitor-CR-jt4jC.js";import"./lablup-activity-panel-B3LFw-Q3.js";import"./lablup-loading-spinner-DwOOry65.js";import"./lablup-progress-bar-ByJM8Dlg.js";import"./backend-ai-session-launcher-BtZtvfGO.js";import"./mwc-switch-CSCM2MHj.js";import"./mwc-check-list-item-C_e7Jjla.js";let b=class extends s{constructor(){super(...arguments),this.currentNumber=50,this.maxNumber=100,this.unit="%",this.url="",this.textcolor="#888888",this.chartcolor="#ff2222",this.size=200,this.fontsize=60,this.chartFontSize="0",this.indicatorPath="",this.prefix="",this.sizeParam=""}static get is(){return"lablup-piechart"}static get styles(){return[a,r,o`
        #chart {
          cursor: pointer;
        }
                  ...
                  <div class="layout horizontal center flex resource">
                    ...
                    <div class="layout vertical start-justified wrap">
                      <lablup-progress-bar
                        ...
                        description="${this._addComma(this._prefixFormatWithoutTrailingZeros(this.mem_allocated,2))} / ${this._addComma(this._prefixFormatWithoutTrailingZeros(this.mem_total,2))} GiB ${m("summary.reserved")}."
                      ></lablup-progress-bar>
                      <lablup-progress-bar
                        id="mem-usage-bar-2"
                        class="end"
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithoutTrailingZeros(this.tpu_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.tpu_total,2)} TPUs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="tpu-usage-bar-2"
                                        class="end"
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithoutTrailingZeros(this.ipu_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.ipu_total,2)} IPUs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="ipu-usage-bar-2"
                                        class="end"
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithoutTrailingZeros(this.atom_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.atom_total,2)} ATOMs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="atom-usage-bar-2"
                                        class="end"
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithoutTrailingZeros(this.atom_plus_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.atom_plus_total,2)} ATOM+ ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithoutTrailingZeros(this.gaudi2_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.gaudi2_total,2)} Gaudi 2 ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithoutTrailingZeros(this.warboy_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.warboy_total,2)} Warboys ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithoutTrailingZeros(this.rngd_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.rngd_total,2)} RNGDs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="rngd-usage-bar-2"
                                        class="end"
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        description="${this._prefixFormatWithoutTrailingZeros(this.hyperaccel_lpu_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.hyperaccel_lpu_total,2)} Hyperaccel LPUs ${m("summary.reserved")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
          ...
          >
            <div slot="message">
              ...
              <div class="horizontal center-justified layout wrap">
                ...
                ${this.is_admin?n`
                      <button
                        @click="${()=>{this._moveTo("/credential","?tab=credentials&action=add")}}"
                        class="vertical center center-justified layout start-menu-items link-button"
                      ...
                      <button
                        @click="${()=>{this._moveTo("/credential","?tab=credentials")}}"
                        class="vertical center center-justified layout start-menu-items link-button"
                        style="border-left:1px solid var(--token-colorBorder, #ccc);"
                      >
