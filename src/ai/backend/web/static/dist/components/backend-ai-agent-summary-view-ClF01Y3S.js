import{_ as t,n as s,e,t as i,B as a,b as o,I as r,a as l,i as n,d,Q as c,k as p,f as u,g as _}from"./backend-ai-webui-DDgiEQ8A.js";import"./lablup-progress-bar-D6tN2SzX.js";import"./mwc-switch-3GZYhcOo.js";import"./backend-ai-list-status-CjXf2ZH4.js";import"./lablup-activity-panel-DTwwLrVC.js";import"./mwc-tab-bar-CPRdx4tw.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
