import{_ as e,n as i,K as t,e as o,t as r,B as s,b as a,I as l,a as n,i as u,d as c,Q as d,k as p,g as h,f as v}from"./backend-ai-webui-IlRp-wMX.js";import"./backend-ai-multi-select-CHQa5WRS.js";import"./mwc-switch-C-zaXCpc.js";import"./vaadin-item-doOWNtPU.js";import"./mwc-check-list-item-AcYXY5QB.js";import"./vaadin-item-mixin-Nr_ykoC4.js";let m=class extends s{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.allowedSessionTypes=["interactive","batch","inference"],this.enableSchedulerOpts=!1,this.enableWSProxyAddr=!1,this.enableIsPublic=!1,this.functionCount=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.resourceGroups=[],this.resourceGroupInfo={},this.domains=[]}static get styles(){return[a,l,n,u`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
