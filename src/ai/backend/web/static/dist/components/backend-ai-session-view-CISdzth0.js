import{m as e,r as i,i as t,o as s,p as o,q as n,T as a,D as l,P as r,_ as c,n as d,e as u,t as p,B as m,b as h,I as g,a as v,d as _,Q as b,k as f,g as y,f as w,u as k,v as x,c as A}from"./backend-ai-webui-ClPaDngW.js";import{J as $}from"./vaadin-iconset-BlEY8bJv.js";import"./backend-ai-resource-monitor-QJpWtdUa.js";import"./backend-ai-session-launcher-VTqQXX0O.js";import"./backend-ai-list-status-uyKJhArD.js";import"./lablup-grid-sort-filter-column-qJ5UzPi_.js";import"./lablup-progress-bar-DWfFzAsr.js";import"./vaadin-grid-filter-column-COSP5o_y.js";import"./lablup-activity-panel-CMRQ6cmG.js";import"./mwc-formfield-W0qg4gyC.js";import"./mwc-tab-bar-Dx4r--lZ.js";import"./mwc-switch-DNCscRWy.js";import"./slider-BH95QYxl.js";import"./mwc-check-list-item-s9xKKbad.js";
/**
 * @license
...
${t.item[this.sessionNameField]}</pre
      ...
      `,e)}configRenderer(e,i,t){const s=t.item.mounts.map((e=>e.startsWith("[")?JSON.parse(e.replace(/'/g,'"'))[0]:e));"system"===this.condition?b(f``,e):b(f`
        ...
        `,e)}usageRenderer(e,i,t){var s,o,n,a,l,r,c,d,u,p,m,h,g,v,_,y,w,k,x,A,$,S,T,C,I,D,E,R,N,F,z,M,L,B,P,O,G,U,K,W,H,q,Z,V,J,Y,Q,X,ee,ie,te,se,oe,ne,ae,le,re,ce,de,ue,pe,me,he,ge,ve,_e,be,fe,ye,we,ke,xe,Ae,$e,Se,Te,Ce,Ie,De,Ee,Re,je,Ne,Fe,ze,Me,Le,Be,Pe,Oe,Ge,Ue,Ke,We,He,qe,Ze,Ve,Je,Ye,Qe,Xe,ei,ii,ti,si,oi,ni,ai,li,ri,ci,di,ui,pi,mi,hi,gi,vi,_i,bi,fi,yi,wi,ki,xi,Ai,$i,Si,Ti,Ci,Ii,Di,Ei,Ri,ji,Ni,Fi,zi,Mi,Li,Bi,Pi,Oi,Gi,Ui,Ki,Wi,Hi,qi,Zi,Vi,Ji,Yi,Qi,Xi,et,it,tt,st,ot,nt,at,lt,rt,ct,dt,ut,pt;["batch","interactive","inference","running"].includes(this.condition)?b(f`
          <div class="vertical start start-justified layout">
            ...
            ${t.item.rocm_gpu_slot&&parseFloat(t.item.rocm_gpu_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      GPU(util)
                      ${t.item.live_stat?(100*(null===(M=null===(z=t.item.live_stat)||void 0===z?void 0:z.rocm_util)||void 0===M?void 0:M.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
            ...
            ${t.item.atom_plus_slot&&parseFloat(t.item.atom_plus_slot)>0?f`
                  <div class="vertical start-justified layout">
                    <div class="usage-items">
                      ATOM+(util)
                      ${(null===(Ne=t.item.live_stat)||void 0===Ne?void 0:Ne.atom_plus_util)?(100*(null===(ze=null===(Fe=t.item.live_stat)||void 0===Fe?void 0:Fe.atom_plus_util)||void 0===ze?void 0:ze.ratio)).toFixed(1):"-"}
                      %
                    </div>
                    <div class="horizontal start-justified center layout">
                      <lablup-progress-bar
                        class="usage"
                        progress="${(null===(Be=null===(Le=null===(Me=t.item)||void 0===Me?void 0:Me.live_stat)||void 0===Le?void 0:Le.atom_plus_util)||void 0===Be?void 0:Be.current)/(null===(Ge=null===(Oe=null===(Pe=t.item)||void 0===Pe?void 0:Pe.live_stat)||void 0===Oe?void 0:Oe.atom_plus_util)||void 0===Ge?void 0:Ge.capacity)||0}"
                        description=""
                      ></lablup-progress-bar>
                    </div>
                  </div>
    ...
    `}};c([d({type:String})],z.prototype,"_status",void 0),c([d({type:Boolean,reflect:!0})],z.prototype,"active",void 0),c([d({type:Boolean})],z.prototype,"is_admin",void 0),c([d({type:Boolean})],z.prototype,"enableInferenceWorkload",void 0),c([d({type:Boolean})],z.prototype,"enableSFTPSession",void 0),c([d({type:String})],z.prototype,"filterAccessKey",void 0),c([d({type:String})],z.prototype,"_connectionMode",void 0),c([d({type:Object})],z.prototype,"_defaultFileName",void 0),c([d({type:Object})],z.prototype,"resourceBroker",void 0),c([function(i){return(t,s)=>e(t,s,{get(){return(this.renderRoot??(S??=document.createDocumentFragment())).querySelectorAll(i)}})}("backend-ai-session-list")],z.prototype,"sessionList",void 0),c([u("#running-jobs")],z.prototype,"runningJobs",void 0),c([u("#resource-monitor")],z.prototype,"resourceMonitor",void 0),c([u("#export-file-name")],z.prototype,"exportFileNameInput",void 0),c([u("#date-from")],z.prototype,"dateFromInput",void 0),c([u("#date-to")],z.prototype,"dateToInput",void 0),c([u("#dropdown-menu")],z.prototype,"dropdownMenu",void 0),c([u("#export-to-csv")],z.prototype,"exportToCsvDialog",void 0),z=F=c([p("backend-ai-session-view")],z);
