import{_ as e,n as t,e as i,t as a,B as s,b as o,I as r,a as n,i as d,d as l,s as c,l as p,Q as h,k as g,f as b,g as u}from"./backend-ai-webui-BJUcX0PI.js";import"./backend-ai-list-status-C8-dmAvH.js";import"./backend-ai-storage-host-settings-view-CwMXYcws.js";import"./lablup-progress-bar-DIfN72v9.js";var v;let m=v=class extends s{constructor(){super(),this.condition="running",this.listCondition="loading",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[o,r,n,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      <div class="list-wrapper">
        ...
        >
          ...
          <vaadin-grid-column
            resizable
            width="80px"
            header="${b("agent.Endpoint")}"
            .renderer="${this._boundEndpointRenderer}"
          ></vaadin-grid-column>
          <vaadin-grid-column
            width="100px"
            resizable
            header="${b("agent.BackendType")}"
            .renderer="${this._boundTypeRenderer}"
          ></vaadin-grid-column>
          <vaadin-grid-column
            resizable
            width="60px"
            header="${b("agent.Resources")}"
          ...
          <vaadin-grid-column
            ...
            flex-grow="0"
            resizable
            header="${b("agent.Capabilities")}"
            .renderer="${this._boundCapabilitiesRenderer}"
          ></vaadin-grid-column>
          <vaadin-grid-column
            resizable
            header="${b("general.Control")}"
        ...
        <backend-ai-list-status
          ...
          message="${u("agent.NoAgentToDisplay")}"
        ></backend-ai-list-status>
      </div>
      <backend-ai-dialog
        ...
        scrollable
      >
        <span slot="title">${b("agent.DetailedInformation")}</span>
        <div slot="content">
