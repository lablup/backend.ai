import{_ as t,n as e,b as i,e as s,B as a,c as o,I as r,a as n,i as l,l as c,x as d,t as p,g as h,m as g,d as u,L as b,f as v,h as m,N as y}from"./backend-ai-webui-a9940dc0.js";import"./vaadin-grid-7aa99257.js";import"./vaadin-grid-selection-column-3b7b0ad4.js";import"./vaadin-grid-sort-column-4f44c0ff.js";import"./vaadin-iconset-8594ac1d.js";import"./backend-ai-list-status-caaae261.js";import"./lablup-codemirror-85098261.js";import"./lablup-loading-spinner-8b3da9d1.js";import"./mwc-switch-405e373b.js";import"./lablup-activity-panel-d2e7b975.js";import"./mwc-tab-bar-f47ea595.js";import"./dir-utils-2ca2933c.js";let f=class extends a{constructor(){super(...arguments),this.timestamp="",this.errorType="",this.requestUrl="",this.statusCode="",this.statusText="",this.title="",this.message="",this.logs=[],this._selected_items=[],this.listCondition="loading",this._grid=Object(),this.logView=[],this._pageSize=25,this._currentPage=1,this._totalLogCount=0,this.boundTimeStampRenderer=this.timeStampRenderer.bind(this),this.boundStatusRenderer=this.statusRenderer.bind(this),this.boundErrTitleRenderer=this.errTitleRenderer.bind(this),this.boundErrMsgRenderer=this.errMsgRenderer.bind(this),this.boundErrTypeRenderer=this.errTypeRenderer.bind(this),this.boundMethodRenderer=this.methodRenderer.bind(this),this.boundReqUrlRenderer=this.reqUrlRender.bind(this),this.boundParamRenderer=this.paramRenderer.bind(this)}static get styles(){return[o,r,n,l`
      ...
      `,t)}statusRenderer(t,e,i){c(d`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">
            ${i.item.statusCode+" "+i.item.statusText}
          </span>
        </div>
      `,t)}errTitleRenderer(t,e,i){c(d`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">
            ${i.item.title}
          </span>
        </div>
      `,t)}errMsgRenderer(t,e,i){c(d`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">
            ${i.item.message}
          </span>
        </div>
      `,t)}errTypeRenderer(t,e,i){c(d`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">
            ${i.item.type}
          </span>
        </div>
      `,t)}methodRenderer(t,e,i){c(d`
        <div class="layout vertical">
          <span class="${i.item.isError?"error-cell":""}">
            ${i.item.requestMethod}
          </span>
        </div>
      `,t)}reqUrlRender(t,e,i){c(d`
        <div class="layout vertical">
          <span class="monospace ${i.item.isError?"error-cell":""}">
            ${i.item.requestUrl}
          </span>
        </div>
      `,t)}paramRenderer(t,e,i){c(d`
        <div class="layout vertical">
          <span class="monospace ${i.item.isError?"error-cell":""}">
      ...
      <div class="horizontal wrap layout">
        <div class="horizontal layout wrap setting-item">
          <div class="vertical start start-justified layout setting-desc">
            ...
            <div class="description">
              ${m("usersettings.DescDesktopNotification")}
            </div>
          </div>
        ...
        <div class="horizontal layout wrap setting-item">
          <div class="vertical start start-justified layout setting-desc">
            ...
            <div class="description">
              ${m("usersettings.DescUseCompactSidebar")}
            </div>
          </div>
          <div class="vertical center-justified layout setting-button flex end">
            <mwc-switch
        ...
        <div class="horizontal layout wrap setting-item">
          ...
          >
            ...
            <div class="description">${m("usersettings.DescLanguage")}</div>
          </div>
        ...
        ${globalThis.isElectron?d`
              <div class="horizontal layout wrap setting-item">
                <div class="vertical start start-justified layout setting-desc">
                  ...
                  <div class="description">
                    ${m("usersettings.DescKeepLoginSessionInformation")}
                  </div>
                </div>
                <div
              ...
              <div class="horizontal layout wrap setting-item">
                ...
                >
                  ...
                  <div class="description">
                    ${m("usersettings.DescPreferredSSHPort")}
                  </div>
                </div>
        ...
        <div class="horizontal layout wrap setting-item">
          <div class="vertical start start-justified layout setting-desc">
            ...
            <div class="description">
              ${m("usersettings.DescSSHKeypairManagement")}
            </div>
          </div>
        ...
        <div class="horizontal layout wrap setting-item">
          <div class="vertical start start-justified layout setting-desc">
            ...
            <div class="description">
              ${m("usersettings.DescAutomaticUpdateCheck")}
            </div>
          </div>
          <div class="vertical center-justified layout setting-button flex end">
            <mwc-switch
        ...
        <div class="horizontal layout wrap setting-item" style="display:none;">
          <div class="vertical start start-justified layout setting-desc">
            ...
            <div class="description">
              ${m("usersettings.DescBetaFeatures")}
            </div>
          </div>
          <div class="vertical center-justified layout setting-button flex end">
            <mwc-switch
        ...
        <div class="horizontal layout wrap setting-item">
          <div class="vertical start start-justified layout setting-desc">
            ...
            <div class="description">${m("usersettings.DescAutoLogout")}</div>
          </div>
          <div class="vertical center-justified layout setting-button flex end">
            <mwc-switch
    ...
    `}};t([e({type:Object})],S.prototype,"notification",void 0),t([e({type:Array})],S.prototype,"supportLanguages",void 0),t([e({type:Boolean})],S.prototype,"beta_feature_panel",void 0),t([e({type:Boolean})],S.prototype,"shell_script_edit",void 0),t([e({type:Array})],S.prototype,"rcfiles",void 0),t([e({type:String})],S.prototype,"rcfile",void 0),t([e({type:String})],S.prototype,"prevRcfile",void 0),t([e({type:String})],S.prototype,"preferredSSHPort",void 0),t([e({type:String})],S.prototype,"publicSSHkey",void 0),t([i("#loading-spinner")],S.prototype,"spinner",void 0),t([i("#bootstrap-editor")],S.prototype,"bootstrapEditor",void 0),t([i("#usersetting-editor")],S.prototype,"userSettingEditor",void 0),t([i("#select-rcfile-type")],S.prototype,"rcFileTypeSelect",void 0),t([i("#ssh-public-key")],S.prototype,"sshPublicKeyInput",void 0),t([i("#ssh-private-key")],S.prototype,"sshPrivateKeyInput",void 0),t([i("#current-ssh-public-key")],S.prototype,"currentSSHPublicKeyInput",void 0),t([i("#copy-current-ssh-public-key-button")],S.prototype,"copyCurrentSSHPublicKeyButton",void 0),t([i("#bootstrap-dialog")],S.prototype,"bootstrapDialog",void 0),t([i("#change-current-editor-dialog")],S.prototype,"changeCurrentEditorDialog",void 0),t([i("#userconfig-dialog")],S.prototype,"userconfigDialog",void 0),t([i("#ssh-keypair-management-dialog")],S.prototype,"sshKeypairManagementDialog",void 0),t([i("#clear-ssh-keypair-dialog")],S.prototype,"clearSSHKeypairDialog",void 0),t([i("#generate-ssh-keypair-dialog")],S.prototype,"generateSSHKeypairDialog",void 0),t([i("#ssh-keypair-form-dialog")],S.prototype,"sshKeypairFormDialog",void 0),t([i("#entered-ssh-public-key")],S.prototype,"enteredSSHPublicKeyInput",void 0),t([i("#entered-ssh-private-key")],S.prototype,"enteredSSHPrivateKeyInput",void 0),t([i("#ui-language")],S.prototype,"languageSelect",void 0),t([i("#delete-rcfile")],S.prototype,"deleteRcfileButton",void 0),S=t([s("backend-ai-usersettings-general-list")],S);let w=class extends a{constructor(){super(),this.images=Object(),this.options=Object(),this._activeTab=Object(),this.logGrid=Object(),this.options={automatic_image_update:!1,cuda_gpu:!1,cuda_fgpu:!1,rocm_gpu:!1,tpu:!1,scheduler:"fifo"}}static get is(){return"backend-ai-usersettings-view"}static get styles(){return[o,r,n,g,u,l`
        div.spinner,
        span.spinner {
          font-size: 9px;
          margin-right: 5px;
    ...
    `}firstUpdated(){void 0===globalThis.backendaiclient||null===globalThis.backendaiclient?document.addEventListener("backend-ai-connected",(()=>{this.updateSettings()}),!0):this.updateSettings(),this.notification=globalThis.lablupNotification,document.addEventListener("backend-ai-usersettings-logs",(()=>{this._viewStateChanged(!0)})),document.addEventListener("backend-ai-usersettings",(()=>{this._viewStateChanged(!0)}))}async _viewStateChanged(t){const e=y.getState().app.params.tab;e&&"logs"===e?globalThis.setTimeout((()=>{var t;(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector('mwc-tab[title="logs"]')).click()}),0):globalThis.setTimeout((()=>{var t;(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector('mwc-tab[title="general"]')).click()}),0)}updateSettings(){}_hideClearLogsDialog(){this.clearLogsDialog.hide()}_removeLogMessage(){localStorage.getItem("backendaiwebui.logs")&&localStorage.removeItem("backendaiwebui.logs");const t=new CustomEvent("log-message-clear",{});document.dispatchEvent(t),localStorage.getItem("backendaiwebui.logs"),this.clearLogsDialog.hide(),this.notification.text=h("logs.LogMessageRemoved"),this.notification.show(),this.spinner.hide()}_showClearLogsDialog(){this.clearLogsDialog.show()}_refreshLogs(){this.logGrid=JSON.parse(localStorage.getItem("backendaiwebui.logs")||"{}");const t=new CustomEvent("log-message-refresh",this.logGrid);document.dispatchEvent(t)}_showTab(t){var e,i;const s=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelectorAll(".tab-content");for(let t=0;t<s.length;t++)s[t].style.display="none";this._activeTab=t.title,"logs"===this._activeTab&&this._refreshLogs(),(null===(i=this.shadowRoot)||void 0===i?void 0:i.querySelector("#"+t.title)).style.display="block"}};t([e({type:Object})],w.prototype,"images",void 0),t([e({type:Object})],w.prototype,"options",void 0),t([e({type:Object})],w.prototype,"_activeTab",void 0),t([e({type:Object})],w.prototype,"logGrid",void 0),t([i("#loading-spinner")],w.prototype,"spinner",void 0),t([i("#clearlogs-dialog")],w.prototype,"clearLogsDialog",void 0),w=t([s("backend-ai-usersettings-view")],w);
