import{_ as t,n as e,e as o,t as i,B as a,b as s,I as n,a as r,c as l,i as c,g as d,d as h,k as p,f as u}from"./backend-ai-webui-IlRp-wMX.js";import"./backend-ai-resource-monitor-B1HfxIaA.js";import"./backend-ai-session-launcher-DDvnRQ1c.js";import"./lablup-activity-panel-BI3aowK_.js";import"./lablup-progress-bar-C2c3e07h.js";import"./mwc-switch-C-zaXCpc.js";import"./slider-DSxqDIxt.js";import"./mwc-check-list-item-AcYXY5QB.js";import"./vaadin-grid-filter-column-CozmkQTP.js";let m=class extends a{constructor(){super(...arguments),this.condition="running",this.authenticated=!1,this.indicator=Object(),this.notification=Object(),this.requestURL="",this.queryString="",this.environment="python",this.importNotebookMessage="",this.importGithubMessage="",this.importGitlabMessage="",this.allowedGroups=[],this.allowed_folder_type=[],this.vhost="",this.vhosts=[],this.storageInfo=Object(),this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.sessionLauncherType="neo"}static get styles(){return[s,n,r,l,c`
        div.description {
          font-size: 14px;
