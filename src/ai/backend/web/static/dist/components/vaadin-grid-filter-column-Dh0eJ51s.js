import{r as e,a5 as t,aG as a,aE as i,aF as r,aH as s,o as l,W as n,m as d,T as o,G as u,P as h,i as p,U as c,ac as g,C as _,a3 as v}from"./backend-ai-webui-lOeH5wm0.js";import{G as m}from"./vaadin-grid-N4zkwbUz.js";
/**
 * @license
...
e("vaadin-grid-filter",p`
  ...
  `,{moduleId:"vaadin-grid-filter-styles"});const b=e=>class extends(c(e)){static get properties(){return{path:{type:String,sync:!0},value:{type:String,notify:!0,sync:!0},_textField:{type:Object,sync:!0}}}static get observers(){return["_filterChanged(path, value, _textField)"]}ready(){super.ready(),this._filterController=new g(this,"","vaadin-text-field",{initializer:e=>{e.addEventListener("input",(e=>{this.value=e.target.value})),this._textField=e}}),this.addController(this._filterController)}_filterChanged(e,t,a){void 0!==e&&void 0!==t&&a&&(a.value=t,this._debouncerFilterChanged=_.debounce(this._debouncerFilterChanged,v.after(200),(()=>{this.dispatchEvent(new CustomEvent("filter-changed",{bubbles:!0}))})))}focus(){this._textField&&this._textField.focus()}}
/**
 * @license
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
