import{_ as i,n as e,e as t,B as o,c as a,I as l,a as s,F as n,d as c,i as d,aQ as r,aR as h,g as f,x as g,t as u}from"./backend-ai-webui-aedf1078.js";let v=class extends o{constructor(){super(...arguments),this.webUIShell=Object(),this.clientConfig=Object(),this.client=Object(),this.notification=Object(),this.successDialog=Object(),this.failDialog=Object()}static get styles(){return[a,l,s,n,c,d`
        mwc-textfield {
          width: 100%;
      ...
      <backend-ai-dialog id="verification-fail-dialog" fixed backdrop blockscrolling persistent style="padding:0;">
        ...
        <div slot="content">
          <div class="horizontal layout center">
            <p style="width:256px;">${u("signup.EmailVerificationFailedMessage")}</p>
          </div>
          <div style="margin:20px;">
            <mwc-textfield id="email" label="${u("data.explorer.EnterEmailAddress")}"
                autofocus auto-validate validationMessage="${u("signup.InvalidEmail")}"
                pattern="^[A-Z0-9a-z#-_]+@.+\\..+$"
                maxLength="64" placeholder="${u("maxLength.64chars")}"></mwc-textfield>
    ...
    `}};i([e({type:Object})],v.prototype,"webUIShell",void 0),i([e({type:Object})],v.prototype,"clientConfig",void 0),i([e({type:Object})],v.prototype,"client",void 0),i([e({type:Object})],v.prototype,"notification",void 0),i([e({type:Object})],v.prototype,"successDialog",void 0),i([e({type:Object})],v.prototype,"failDialog",void 0),v=i([t("backend-ai-email-verification-view")],v);
