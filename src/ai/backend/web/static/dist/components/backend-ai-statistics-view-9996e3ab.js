import{i as t,r as e,ao as i,ap as n,aq as a,l as r,T as o,D as s,P as l,ar as d,as as c,at as u,Y as h,W as m,au as p,am as g,n as v,O as f,av as y,aw as b,ax as w,p as _,ay as x,az as C,aA as T,E as k,u as D,aB as M,an as S,w as E,v as U,_ as I,e as A,a as P,s as O,y as W,d as B,I as j,b as q,z as N,f as $,t as R,c as L,B as Y,g as z,o as F}from"./backend-ai-webui-ab578ea5.js";import"./progress-spinner-628dde96.js";import"./tab-group-c5b18252.js";import"./mwc-tab-bar-49a4eacc.js";import{I as H}from"./vaadin-item-mixin-c0aca504.js";import{g as K,s as G}from"./dir-utils-1d3affeb.js";import{B as Q,M as X}from"./media-query-controller-c0b142ca.js";import"./chart-js-5eeeff65.js";import"./radio-behavior-2904b95e.js";const V=t`
  :host {
...
let le=class extends O{constructor(){super(),this.num_sessions=0,this.used_time="0:00:00.00",this.cpu_used_time="0:00:00.00",this.gpu_used_time="0:00:00.00",this.disk_used=0,this.traffic_used=0}static get styles(){return[j,q,N,$,t`
      ...
      <wl-card>
        <wl-title level="3">${R("usagepanel.StatisticsForThisMonth")}</wl-title>
        <div class="horizontal layout">
          <div class="vertical center layout">
            <span class="value">${this.num_sessions}</span>
            <span class="desc">${R("usagepanel.NumSessions")}</span>
          </div>
          <div class="vertical center layout">
            <span class="value">${this.used_time}</span>
            <span class="desc">${R("usagepanel.UsedTime")}</span>
          </div>
          <div class="vertical center layout">
            <span class="value">${this.cpu_used_time}</span>
            <span class="desc">${R("usagepanel.CpuUsedTime")}</span>
          </div>
          <div class="vertical center layout">
            <span class="value">${this.gpu_used_time}</span>
            <span class="desc">${R("usagepanel.GpuUsedTime")}</span>
          </div>
          <div class="vertical center layout">
            <span class="value">${this.disk_used}GB</span>
            <span class="desc">${R("usagepanel.DiskUsed")}</span>
          </div>
          <div class="vertical center layout">
            <span class="value">${this.traffic_used}MiB</span>
            <span class="desc">${R("usagepanel.TrafficUsed")}</span>
          </div>
        </div>
      </wl-card>
...
let de=class extends Y{constructor(){super(),this._map={num_sessions:"Sessions",cpu_allocated:"CPU",mem_allocated:"Memory",gpu_allocated:"GPU",io_read_bytes:"IO-Read",io_write_bytes:"IO-Write"},this.templates={"1D":{interval:1,length:96},"1W":{interval:1,length:672}},this.periodSelectItems=new Array,this.collection=Object(),this.period="1D",this.updating=!1,this.elapsedDays=0,this._helpDescription="",this._helpDescriptionTitle="",this._helpDescriptionIcon="",this.data=[]}static get styles(){return[B,j,q,N,$,t`
      ...
      <div class="card" elevation="0">
        ...
        <div class="horizontal layout center">
          <p id="select-period">${R("statistics.SelectPeriod")}</p>
        ...
        <lablup-activity-panel elevation="1" noheader narrow autowidth>
          <div slot="message">
            <h3 class="tab horizontal center layout">
              <mwc-tab-bar>
                <mwc-tab title="usage" label="${R("statistics.UsageHistory")}"></mwc-tab>
              </mwc-tab-bar>
            </h3>
