import{_ as t,n as e,t as i,h as s,I as a,a as r,i as o,k as n,g as l,e as p,B as c,b as u,c as d,d as h,f as m,j as _,s as g,l as v}from"./backend-ai-webui-B-owHRLe.js";import"./lablup-activity-panel-D7iD82Gl.js";let b=class extends s{constructor(){super(...arguments),this.currentNumber=50,this.maxNumber=100,this.unit="%",this.url="",this.textcolor="#888888",this.chartcolor="#ff2222",this.size=200,this.fontsize=60,this.chartFontSize="0",this.indicatorPath="",this.prefix="",this.sizeParam=""}static get is(){return"lablup-piechart"}static get styles(){return[a,r,o`
        #chart {
          cursor: pointer;
        }
        ...
        <div slot="message">
          ...
          <div class="vertical-card" style="align-items: flex-start">
            ${this.is_superadmin?n`
                  ...
                  ${this.cuda_gpu_total||this.cuda_fgpu_total||this.rocm_gpu_total||this.tpu_total||this.ipu_total||this.atom_total||this.atom_plus_total||this.atom_max_total||this.gaudi2_total||this.warboy_total||this.rngd_total||this.hyperaccel_lpu_total?n`
                        <div class="resource-line"></div>
                        <div class="layout horizontal center flex resource">
                          <div
                            class="layout vertical center center-justified resource-name"
                                  ...
                                  <div class="layout horizontal">
                                    ...
                                    >
                                      <lablup-progress-bar
                                        ...
                                        class="start"
                                        progress="${this.atom_max_used/100}"
                                        description="${this._prefixFormatWithoutTrailingZeros(this.atom_max_used,2)} / ${this._prefixFormatWithoutTrailingZeros(this.atom_max_total,2)} ATOM Max ${m("summary.ReservedShort")}."
                                      ></lablup-progress-bar>
                                      <lablup-progress-bar
                                        id="atom-max-usage-bar-2"
                                        class="end"
                                        progress="0"
                                        description="${m("summary.ATOMMaxEnabled")}."
                                      ></lablup-progress-bar>
                                    </div>
                                    <div
                                      class="layout vertical center center-justified"
                                    >
                                      <span class="percentage start-bar">
                                        ${this._prefixFormatWithoutTrailingZeros(this.atom_max_used,1)+"%"}
                                      </span>
                                      <span class="percentage end-bar"></span>
                                    </div>
                                  </div>
