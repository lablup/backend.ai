import{_ as e,n as t,b as i,e as s,s as o,c as a,I as r,a as n,m as l,d as c,i as d,x as h,r as u,a9 as p,K as m,T as _,a0 as v,P as g,a1 as f,k as y,a8 as b,aa as x,ab as w,at as k,au as D,av as S,aw as P,ax as C,ay as T,az as $,aA as I,aB as M,aC as E,aD as O,aE as A,ao as R,aF as F,G as z,a6 as B,aj as N,aG as V,ac as q,D as L,af as j,ag as G,aH as H,a3 as W,aI as Y,aJ as U,aK as K,aL as X,aM as J,aN as Q,aO as Z,a7 as ee,aP as te,aQ as ie,aR as se,aS as oe,aT as ae,aU as re,aV as ne,aW as le,aX as ce,aY as de,aZ as he,ai as ue,a_ as pe,B as me,g as _e,f as ve,l as ge,t as fe,o as ye}from"./backend-ai-webui-d4819018.js";import"./mwc-check-list-item-de5f8c59.js";import"./slider-2bcf3732.js";import"./vaadin-grid-8bcb41b9.js";import"./vaadin-grid-filter-column-ea2d3d99.js";import"./vaadin-grid-selection-column-132c974d.js";import{B as be,M as xe}from"./media-query-controller-83d85766.js";import{a as we,b as ke}from"./dir-utils-31fa6465.js";import"./lablup-codemirror-6731a5d1.js";import"./lablup-progress-bar-eedf2fcd.js";
/**
 @license
...
u("vaadin-date-picker-overlay",d`
  ...
  `,{moduleId:"vaadin-date-picker-overlay-styles"});class $e extends(x(w)){static get is(){return"vaadin-date-picker-overlay"}static get template(){return Te||(Te=super.template.cloneNode(!0),Te.content.querySelector('[part~="overlay"]').removeAttribute("tabindex")),Te}}
/**
@license
...
*/
function Ie(e,t,i,s,o){let a;o&&(a="object"==typeof i&&null!==i,a&&(s=e.__dataTemp[t]));let r=s!==i&&(s==s||i==i);return a&&r&&(e.__dataTemp[t]=i),r}customElements.define($e.is,$e);const Me=k((e=>class extends e{_shouldPropertyChange(e,t,i){return Ie(this,e,t,i,!0)}})),Ee=k((e=>class extends e{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(e,t,i){return Ie(this,e,t,i,this.mutableData)}}));Me._mutablePropertyChange=Ie;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
      ...
      <backend-ai-dialog id="new-session-dialog" narrowLayout fixed backdrop persistent @dialog-closed="${()=>this._toggleScheduleTime(!0)}">
        ...
        <form slot="content" id="launch-session-form" class="centered" style="position:relative;">
                  ...
                  ${this.preOpenPorts.length>0?h`
                    <div class="horizontal flex center layout" style="overflow-x:hidden;margin:auto 5px;">
                      ${this.preOpenPorts.map((e=>h`
                        <lablup-shields color="lightgrey" description="${e}" style="padding:4px;"></lablup-shields>
                      `))}
                    </div>
                  `:h`
                    <div class="vertical layout center flex blank-box">
                      <span>${fe("session.launcher.NoPreOpenPortsConfigured")}</span>
                    </div>
                  `}
                </div>
              </lablup-expansion>
          ...
          <div id="progress-04" class="progress center layout fade">
            ...
            ${this.maxCountForPreopenPorts>0?h`
              <p class="title">${fe("session.launcher.PreOpenPortPanelTitle")}</p>
              <div class="preopen-ports-container">
                ${this.preOpenPorts.length>0?h`
                  <div class="horizontal flex center layout" style="overflow-x:hidden;margin:auto 5px;">
                    ${this.preOpenPorts.map((e=>h`
        ...
        <div slot="content" id="modify-preopen-ports-container">
          ...
          <div class="layout center">
            ${this.preOpenPorts.forEach((e=>h`
              <div class="horizontal layout center row">
                <mwc-textfield value="${e}" type="number" min="1024" max="65535"></mwc-textfield>
                <mwc-icon-button class="green minus-btn" icon="remove"
