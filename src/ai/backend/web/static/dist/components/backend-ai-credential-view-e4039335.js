import{_ as e,n as i,b as t,e as s,B as o,c as a,I as r,a as l,m as n,d as c,i as d,f as u,g as p,l as h,x as m,t as v,w as _,Q as y}from"./backend-ai-webui-c3bf0732.js";import{J as g}from"./json_to_csv-35c9e191.js";import"./backend-ai-list-status-b8558877.js";import"./lablup-grid-sort-filter-column-9ed2ac3e.js";import"./vaadin-grid-f4a3e07c.js";import"./vaadin-grid-filter-column-2105c31b.js";import"./vaadin-grid-sort-column-6ca286db.js";import"./vaadin-iconset-3dd6143d.js";import"./vaadin-item-08769b38.js";import"./backend-ai-multi-select-a387b694.js";import"./mwc-switch-64619ab6.js";import"./lablup-activity-panel-c3e41062.js";import"./mwc-formfield-aa060d27.js";import"./mwc-tab-bar-25fb956e.js";import"./dir-utils-926fdc3c.js";import"./vaadin-item-mixin-cd4404c5.js";import"./mwc-check-list-item-c70c2fc2.js";var f;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let w=f=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey=""}static get styles(){return[a,r,l,n,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
          ...
          <div class="vertical center layout distancing" id="dropdown-area">
            ...
            <div class="horizontal layout justified" style="width:100%;">
              <div class="vertical layout flex popup-right-margin">
                <mwc-textfield
                  label="${v("resourcePolicy.Capacity")}(GB)"
    ...
    `}_indexRenderer(e,i,t){const s=t.index+1;h(m`
        <div>${s}</div>
      `,e)}_displayResourcesByResourceUnit(e=0,i=!1,t=""){let s=0;const o=this._markIfUnlimited(e,i);switch(t=t.toLowerCase()){case"cpu":case"cuda_device":case"max_vfolder_count":s=0;break;case"mem":case"cuda_shares":case"max_vfolder_size":s=1}return["∞","-"].includes(o)?o:Number(o).toFixed(s)}resourceRenderer(e,i,t){h(m`
        <div class="layout horizontal wrap center">
          <div class="layout horizontal configuration">
        ...
        <div class="layout horizontal wrap center">
          <div class="layout horizontal configuration">
            ...
            <span>
              ${this._displayResourcesByResourceUnit(t.item.max_vfolder_size,!0,"max_vfolder_size")}
            </span>
            <span class="indicator">GB</span>
          </div>
          <div class="layout horizontal configuration">
      ...
      ></backend-ai-react-user-setting-dialog>
    `}};var I;e([i({type:Boolean})],P.prototype,"isAdmin",void 0),e([i({type:Boolean})],P.prototype,"editMode",void 0),e([i({type:Array})],P.prototype,"users",void 0),e([i({type:Object})],P.prototype,"userInfo",void 0),e([i({type:Array})],P.prototype,"userInfoGroups",void 0),e([i({type:String})],P.prototype,"userEmail",void 0),e([i({type:Boolean})],P.prototype,"openUserInfoModal",void 0),e([i({type:Boolean})],P.prototype,"openUserSettingModal",void 0),e([i({type:String})],P.prototype,"condition",void 0),e([i({type:Object})],P.prototype,"_boundControlRenderer",void 0),e([i({type:Object})],P.prototype,"_userIdRenderer",void 0),e([i({type:Object})],P.prototype,"_userNameRenderer",void 0),e([i({type:Object})],P.prototype,"_userStatusRenderer",void 0),e([i({type:Object})],P.prototype,"_totpActivatedRenderer",void 0),e([i({type:Object})],P.prototype,"keypairs",void 0),e([i({type:String})],P.prototype,"signoutUserName",void 0),e([i({type:Object})],P.prototype,"notification",void 0),e([i({type:String})],P.prototype,"listCondition",void 0),e([i({type:Number})],P.prototype,"_totalUserCount",void 0),e([i({type:Boolean})],P.prototype,"isUserInfoMaskEnabled",void 0),e([i({type:Boolean})],P.prototype,"totpSupported",void 0),e([i({type:Boolean})],P.prototype,"totpActivated",void 0),e([i({type:Object})],P.prototype,"userStatus",void 0),e([t("#user-grid")],P.prototype,"userGrid",void 0),e([t("#loading-spinner")],P.prototype,"spinner",void 0),e([t("#list-status")],P.prototype,"_listStatus",void 0),e([t("#password")],P.prototype,"passwordInput",void 0),e([t("#confirm")],P.prototype,"confirmInput",void 0),e([t("#username")],P.prototype,"usernameInput",void 0),e([t("#full_name")],P.prototype,"fullNameInput",void 0),e([t("#description")],P.prototype,"descriptionInput",void 0),e([t("#status")],P.prototype,"statusSelect",void 0),e([t("#signout-user-dialog")],P.prototype,"signoutUserDialog",void 0),P=e([s("backend-ai-user-list")],P);let S=I=class extends o{constructor(){super(),this.concurrency_limit={},this.idle_timeout={},this.session_lifetime={},this.vfolder_capacity={},this.vfolder_max_limit={},this.container_per_session_limit={},this.rate_metric=[1e3,2e3,3e3,4e3,5e3,1e4,5e4],this.resource_policies=Object(),this.isAdmin=!1,this.isSuperAdmin=!1,this._status="inactive",this.new_access_key="",this.new_secret_key="",this._activeTab="users",this.notification=Object(),this._defaultFileName="",this.enableSessionLifetime=!1,this.enableParsingStoragePermissions=!1,this.default_vfolder_host="",this.all_vfolder_hosts=[],this.resource_policy_names=[]}static get styles(){return[a,r,l,n,c,d`
        #new-keypair-dialog {
          min-width: 350px;
          height: 100%;
        }
      ...
      <backend-ai-dialog id="new-policy-dialog" fixed backdrop blockscrolling narrowLayout>
        ...
        <div slot="content">
          ...
          <div class="vertical center layout distancing" id="dropdown-area">
            ...
            <div class="horizontal layout justified" style="width:100%;">
              <div class="vertical layout flex popup-right-margin">
                <mwc-textfield label="${v("resourcePolicy.Capacity")}(GB)" id="vfolder-capacity-limit" type="number" min="0" max="1024" step="0.1"
                    @change="${e=>this._validateResourceInput(e)}"></mwc-textfield>
                <mwc-formfield label="${v("resourcePolicy.Unlimited")}" class="unlimited">
                    <mwc-checkbox @change="${e=>this._toggleCheckbox(e)}"></mwc-checkbox>
                </mwc-formfield>
              ...
              <div class="vertical layout flex popup-left-margin">
                <mwc-textfield label="${v("credential.Max#")}" class="discrete" id="vfolder-count-limit" type="number" min="0" max="50"
                    @change="${e=>this._validateResourceInput(e)}"></mwc-textfield>
              </div>
            </div>
          </div>
    ...
    `}};e([i({type:Object})],S.prototype,"cpu_resource",void 0),e([i({type:Object})],S.prototype,"ram_resource",void 0),e([i({type:Object})],S.prototype,"gpu_resource",void 0),e([i({type:Object})],S.prototype,"fgpu_resource",void 0),e([i({type:Object})],S.prototype,"concurrency_limit",void 0),e([i({type:Object})],S.prototype,"idle_timeout",void 0),e([i({type:Object})],S.prototype,"session_lifetime",void 0),e([i({type:Object})],S.prototype,"vfolder_capacity",void 0),e([i({type:Object})],S.prototype,"vfolder_max_limit",void 0),e([i({type:Object})],S.prototype,"container_per_session_limit",void 0),e([i({type:Array})],S.prototype,"rate_metric",void 0),e([i({type:Object})],S.prototype,"resource_policies",void 0),e([i({type:Array})],S.prototype,"resource_policy_names",void 0),e([i({type:Boolean})],S.prototype,"isAdmin",void 0),e([i({type:Boolean})],S.prototype,"isSuperAdmin",void 0),e([i({type:String})],S.prototype,"_status",void 0),e([i({type:String})],S.prototype,"new_access_key",void 0),e([i({type:String})],S.prototype,"new_secret_key",void 0),e([i({type:String})],S.prototype,"_activeTab",void 0),e([i({type:Object})],S.prototype,"notification",void 0),e([i({type:String})],S.prototype,"_defaultFileName",void 0),e([i({type:Number})],S.prototype,"selectAreaHeight",void 0),e([i({type:Boolean})],S.prototype,"enableSessionLifetime",void 0),e([i({type:Boolean})],S.prototype,"enableParsingStoragePermissions",void 0),e([t("#active-credential-list")],S.prototype,"activeCredentialList",void 0),e([t("#inactive-credential-list")],S.prototype,"inactiveCredentialList",void 0),e([t("#active-user-list")],S.prototype,"activeUserList",void 0),e([t("#resource-policy-list")],S.prototype,"resourcePolicyList",void 0),e([t("#dropdown-area")],S.prototype,"dropdownArea",void 0),e([t("#rate-limit")],S.prototype,"rateLimit",void 0),e([t("#resource-policy")],S.prototype,"resourcePolicy",void 0),e([t("#id_user_email")],S.prototype,"userEmailInput",void 0),e([t("#id_new_policy_name")],S.prototype,"newPolicyNameInput",void 0),e([t("#id_new_user_id")],S.prototype,"userIdInput",void 0),e([t("#id_user_confirm")],S.prototype,"userPasswordConfirmInput",void 0),e([t("#id_user_name")],S.prototype,"userNameInput",void 0),e([t("#id_user_password")],S.prototype,"userPasswordInput",void 0),e([t("#new-keypair-dialog")],S.prototype,"newKeypairDialog",void 0),e([t("#new-policy-dialog")],S.prototype,"newPolicyDialog",void 0),e([t("#new-user-dialog")],S.prototype,"newUserDialog",void 0),e([t("#export-to-csv")],S.prototype,"exportToCsvDialog",void 0),e([t("#export-file-name")],S.prototype,"exportFileNameInput",void 0),e([t("#allowed-vfolder-hosts")],S.prototype,"allowedVfolderHostsSelect",void 0),e([_()],S.prototype,"all_vfolder_hosts",void 0),e([_()],S.prototype,"default_vfolder_host",void 0),e([_()],S.prototype,"vfolderPermissions",void 0),S=I=e([s("backend-ai-credential-view")],S);
