import{_ as e,n as t,e as s,t as i,B as a,b as o,I as r,a as l,i as n,d,p as c,x as p,f as u,g as _}from"./backend-ai-webui-OltTK2Ch.js";import"./lablup-progress-bar-CfQ38VFB.js";import"./mwc-switch-B4ridzlv.js";import"./vaadin-grid-ori3mwSb.js";import"./vaadin-grid-sort-column-tC8_iSFZ.js";import"./backend-ai-list-status-CM5iFAFu.js";import"./lablup-activity-panel-Xrp0-Ruq.js";import"./mwc-tab-bar-C0onxas8.js";import"./dir-utils-Djx442Fy.js";let g=class extends a{constructor(){super(),this._enableAgentSchedulable=!1,this.condition="running",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.agentDetailDialog=Object(),this.agentSettingDialog=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
        vaadin-grid {
          border: 0;
          font-size: 14px;
