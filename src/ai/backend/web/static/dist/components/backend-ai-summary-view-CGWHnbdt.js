import{_ as t,n as e,t as i,h as s,I as a,a as o,i as r,k as n,g as l,e as c,B as p,b as u,c as d,d as h,f as m,j as _,s as g,l as v}from"./backend-ai-webui-DSafjoko.js";import"./backend-ai-resource-monitor-BUK33ct-.js";import"./lablup-activity-panel-BwH92Ud0.js";import"./lablup-loading-spinner-DdXAzrGV.js";import"./lablup-progress-bar-DpcC3Gtx.js";import"./backend-ai-session-launcher-BGN5BnJ4.js";import"./mwc-switch-D15G8e-c.js";import"./slider-D_hljphi.js";import"./mwc-check-list-item-DrjKQBNS.js";import"./vaadin-grid-filter-column-DvuDq-Oh.js";let b=class extends s{constructor(){super(...arguments),this.currentNumber=50,this.maxNumber=100,this.unit="%",this.url="",this.textcolor="#888888",this.chartcolor="#ff2222",this.size=200,this.fontsize=60,this.chartFontSize="0",this.indicatorPath="",this.prefix="",this.sizeParam=""}static get is(){return"lablup-piechart"}static get styles(){return[a,o,r`
        #chart {
          cursor: pointer;
        }
        ...
        <div slot="message">
          ...
          <div class="vertical-card" style="align-items: flex-start">
            ${this.is_superadmin?n`
                  ...
                  ${this.cuda_gpu_total||this.cuda_fgpu_total||this.rocm_gpu_total||this.tpu_total||this.ipu_total||this.atom_total||this.atom_plus_total||this.gaudi2_total||this.warboy_total||this.hyperaccel_lpu_total?n`
                        <div class="resource-line"></div>
                        <div class="layout horizontal center flex resource">
                          <div
                            class="layout vertical center center-justified resource-name"
