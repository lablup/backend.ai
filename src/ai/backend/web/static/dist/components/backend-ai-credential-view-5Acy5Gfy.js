import{_ as e,n as t,e as i,t as a,B as s,b as o,I as r,a as n,v as l,c,i as d,d as u,g as p,Q as h,k as m,f as v,L as y}from"./backend-ai-webui-DDgiEQ8A.js";import{J as _}from"./vaadin-iconset-Bek0H3_B.js";import"./backend-ai-list-status-CjXf2ZH4.js";import"./lablup-grid-sort-filter-column-BH_CFus6.js";import"./vaadin-grid-filter-column-tdWQLd9x.js";import"./vaadin-item-CBhrgdOz.js";import"./backend-ai-multi-select-OltczwZr.js";import"./mwc-switch-3GZYhcOo.js";import"./lablup-activity-panel-DTwwLrVC.js";import"./mwc-formfield-B9xL3pKJ.js";import"./mwc-tab-bar-CPRdx4tw.js";import"./vaadin-item-mixin-4ySLH_En.js";import"./mwc-check-list-item-DDtuDJtO.js";var g;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let f=g=class extends s{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey="",this.supportMainAccessKey=!1,this._mainAccessKeyList=[]}static get styles(){return[o,r,n,l,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
