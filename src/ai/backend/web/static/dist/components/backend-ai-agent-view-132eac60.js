import{_ as e,n as t,b as i,e as s,B as a,c as o,I as r,a as l,i as n,f as d,C as c,x as u,t as p,g as h,a1 as g,a2 as v,R as b}from"./backend-ai-webui-aedf1078.js";import"./mwc-tab-bar-fc7f3c19.js";import"./lablup-activity-panel-897d665b.js";import"./vaadin-grid-609be2ad.js";import"./vaadin-grid-sort-column-8ddab2be.js";import"./lablup-progress-bar-309da793.js";import"./backend-ai-list-status-c77c240c.js";import"./backend-ai-storage-host-settings-view-4aa84aa4.js";import"./vaadin-item-9ab68611.js";import"./label-4414bd3d.js";import"./select-c3659f48.js";import"./switch-dac8de53.js";import"./backend-ai-multi-select-f95f1f67.js";import"./textfield-f06e3f8a.js";import"./mwc-switch-5506e5cb.js";import"./dir-utils-086eb4a0.js";import"./vaadin-item-mixin-f9fae871.js";import"./mwc-check-list-item-fbd74804.js";
/**
 @license
 Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
 */var m;let _=m=class extends a{constructor(){super(...arguments),this._enableAgentSchedulable=!1,this.condition="running",this.list_condition="loading",this.useHardwareMetadata=!1,this.agents=[],this.agentsObject=Object(),this.agentDetail=Object(),this.notification=Object(),this.enableAgentSchedulable=!1,this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundRegionRenderer=this.regionRenderer.bind(this),this._boundContactDateRenderer=this.contactDateRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundUtilizationRenderer=this.utilizationRenderer.bind(this),this._boundDiskRenderer=this.diskRenderer.bind(this),this._boundStatusRenderer=this.statusRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundSchedulableRenderer=this.schedulableRenderer.bind(this),this.filter="",this.listCondition="loading"}static get styles(){return[o,r,l,n`
          ...
          ${i.item.warboy_slots?u`
            <div class="layout horizontal center-justified flex progress-bar-section">
              ...
              <img class="indicator-icon fg green" src="/resources/icons/furiosa.svg"/>
                <span class="monospace" style="padding-left:5px;">${i.item.used_warboy_slots}/${i.item.warboy_slots}</span>
                <span class="indicator">Warboy</span>
              </div>
              <span class="flex"></span>
              <lablup-progress-bar id="warboy-bar" progress="${i.item.used_warboy_slots_ratio}"
                                   description="${i.item.used_warboy_slots}"></lablup-progress-bar>
            </div>
          `:u``}
          ...
          `}
            ...
            <div>
              ...
              <div class="layout horizontal justified flex progress-bar-section">
                ...
                <lablup-progress-bar class="utilization" progress="${t.mem_util.ratio}" description="${m.bytesToGiB(t.mem_util.current)}/${m.bytesToGiB(t.mem_util.capacity)} GiB"></lablup-progress-bar>
              </div>
              ${t.cuda_util?u`
                <div class="layout horizontal justified flex progress-bar-section">
                ...
                <div class="layout horizontal justified flex progress-bar-section">
                  ...
                  <lablup-progress-bar class="utilization" progress="${(null===(n=t.cuda_mem)||void 0===n?void 0:n.ratio)||0}" description="${m.bytesToGiB(null===(d=t.cuda_mem)||void 0===d?void 0:d.current)}/${m.bytesToGiB(null===(h=t.cuda_mem)||void 0===h?void 0:h.capacity)} GiB"></lablup-progress-bar>
                </div>
              `:u``}
            </div>
              ...
              <div class="vertical layout start-justified flex">
                ...
                ${(null===(i=null===(t=this.agentDetail)||void 0===t?void 0:t.live_stat)||void 0===i?void 0:i.node)?u`
                  <div class="horizontal layout justified" style="width:100px;">
                    <span>TX: </span>
                    <span>${m.bytesToMB(this.agentDetail.live_stat.node.net_tx.current)}MiB</span>
                  </div>
                  <div class="horizontal layout justified flex" style="width:100px;">
                    <span>RX: </span>
                    <span>${m.bytesToMB(this.agentDetail.live_stat.node.net_rx.current)}MiB</span>
                  </div>
                `:u`
    ...
    `}render(){return u`
      <div class="list-wrapper">
        <vaadin-grid class="${this.condition}" theme="row-stripes column-borders compact" aria-label="Job list"
          ...
          <vaadin-grid-column resizable width="200px" header="${p("agent.Allocation")}"
    ...
    `}};var y;e([t({type:String})],_.prototype,"condition",void 0),e([t({type:String})],_.prototype,"list_condition",void 0),e([t({type:Boolean})],_.prototype,"useHardwareMetadata",void 0),e([t({type:Array})],_.prototype,"agents",void 0),e([t({type:Object})],_.prototype,"agentsObject",void 0),e([t({type:Object})],_.prototype,"agentDetail",void 0),e([t({type:Object})],_.prototype,"notification",void 0),e([t({type:Boolean})],_.prototype,"enableAgentSchedulable",void 0),e([t({type:Object})],_.prototype,"_boundEndpointRenderer",void 0),e([t({type:Object})],_.prototype,"_boundRegionRenderer",void 0),e([t({type:Object})],_.prototype,"_boundContactDateRenderer",void 0),e([t({type:Object})],_.prototype,"_boundResourceRenderer",void 0),e([t({type:Object})],_.prototype,"_boundUtilizationRenderer",void 0),e([t({type:Object})],_.prototype,"_boundDiskRenderer",void 0),e([t({type:Object})],_.prototype,"_boundStatusRenderer",void 0),e([t({type:Object})],_.prototype,"_boundControlRenderer",void 0),e([t({type:Object})],_.prototype,"_boundSchedulableRenderer",void 0),e([t({type:String})],_.prototype,"filter",void 0),e([i("#agent-detail")],_.prototype,"agentDetailDialog",void 0),e([i("#agent-setting")],_.prototype,"agentSettingDialog",void 0),e([i("#schedulable-switch")],_.prototype,"schedulableToggle",void 0),e([t({type:String})],_.prototype,"listCondition",void 0),e([i("vaadin-grid")],_.prototype,"_agentGrid",void 0),e([i("#list-status")],_.prototype,"_listStatus",void 0),_=m=e([s("backend-ai-agent-list")],_);let f=y=class extends a{constructor(){super(),this.condition="running",this.listCondition="loading",this.storagesObject=Object(),this.storageProxyDetail=Object(),this.notification=Object(),this._boundEndpointRenderer=this.endpointRenderer.bind(this),this._boundTypeRenderer=this.typeRenderer.bind(this),this._boundResourceRenderer=this.resourceRenderer.bind(this),this._boundCapabilitiesRenderer=this.capabilitiesRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this.filter="",this.storages=[]}static get styles(){return[o,r,l,n`
      ...
      `,e)}capabilitiesRenderer(e,t,i){c(u`
        ...
        <div id="controls" class="layout horizontal flex center" agent-id="${i.item.id}">
          ...
          <mwc-icon-button class="fg blue controls-running" icon="settings"
                          @click="${()=>this._moveTo(`/storage-settings/${i.item.id}`)}"></mwc-icon-button>
          ...
          <div class="horizontal start start-justified layout">
            ...
            <div style="margin-left:10px;">
              ...
              ${"live_stat"in this.storageProxyDetail&&"node"in this.storageProxyDetail.live_stat?u`
                <div>TX: ${y.bytesToMB(this.storageProxyDetail.live_stat.node.net_tx.current)} MB</div>
                <div>RX: ${y.bytesToMB(this.storageProxyDetail.live_stat.node.net_rx.current)} MB</div>
              `:u``}
            </div>
          </div>
        </div>
    ...
    `}};e([t({type:String})],f.prototype,"condition",void 0),e([t({type:Array})],f.prototype,"storages",void 0),e([t({type:String})],f.prototype,"listCondition",void 0),e([t({type:Object})],f.prototype,"storagesObject",void 0),e([t({type:Object})],f.prototype,"storageProxyDetail",void 0),e([t({type:Object})],f.prototype,"notification",void 0),e([t({type:Object})],f.prototype,"_boundEndpointRenderer",void 0),e([t({type:Object})],f.prototype,"_boundTypeRenderer",void 0),e([t({type:Object})],f.prototype,"_boundResourceRenderer",void 0),e([t({type:Object})],f.prototype,"_boundCapabilitiesRenderer",void 0),e([t({type:Object})],f.prototype,"_boundControlRenderer",void 0),e([t({type:String})],f.prototype,"filter",void 0),e([i("#storage-proxy-detail")],f.prototype,"storageProxyDetailDialog",void 0),e([i("#list-status")],f.prototype,"_listStatus",void 0),f=y=e([s("backend-ai-storage-proxy-list")],f);
/**
 @license
 Copyright (c) 2015-2018 Lablup Inc. All rights reserved.
 */
let x=class extends a{constructor(){super(),this._boundControlRenderer=this._controlRenderer.bind(this),this.allowedSessionTypes=["interactive","batch","inference"],this.enableSchedulerOpts=!1,this.enableWSProxyAddr=!1,this.enableIsPublic=!1,this.functionCount=0,this.active=!1,this.schedulerTypes=["fifo","lifo","drf"],this.resourceGroups=[],this.resourceGroupInfo={},this.domains=[]}static get styles(){return[o,r,l,n`
        h4 {
          font-weight: 200;
          font-size: 14px;
          margin: 0px;
    ...
    `,e)}_indexRenderer(e,t,i){const s=i.index+1;c(u`
      ...
      <vaadin-grid theme="row-stripes column-borders compact" aria-label="Job list" .items="${this.resourceGroups}">
        ...
        <vaadin-grid-column flex-grow="1" header="${p("resourceGroup.Name")}" path="name" resizable>
        </vaadin-grid-column>
        <vaadin-grid-column flex-grow="1" header="${p("resourceGroup.Description")}" path="description" resizable>
        </vaadin-grid-column>
        <vaadin-grid-column flex-grow="1" header="${p("resourceGroup.ActiveStatus")}" resizable .renderer=${this._activeStatusRenderer}>
        </vaadin-grid-column>
        <vaadin-grid-column flex-grow="1" header="${p("resourceGroup.PublicStatus")}" resizable .renderer=${this._isPublicRenderer}>
        </vaadin-grid-column>
        <vaadin-grid-column flex-grow="1" header="${p("resourceGroup.Driver")}" path="driver" resizable>
        </vaadin-grid-column>
        <vaadin-grid-column flex-grow="1" header="${p("resourceGroup.Scheduler")}" path="scheduler" resizable>
        </vaadin-grid-column>
        ${this.enableWSProxyAddr?u`
        <vaadin-grid-column resizable header="${p("resourceGroup.WsproxyAddress")}" path="wsproxy_addr" resizable>
        </vaadin-grid-column>
        `:u``}
      ...
      <backend-ai-dialog id="resource-group-dialog" fixed backdrop blockscrolling>
        ...
        <div slot="content" class="login-panel intro centered">
          ...
          <div class="horizontal layout flex wrap center justified">
            ...
            <mwc-switch id="resource-group-active" style="margin-right:10px;" ?selected="${!(Object.keys(this.resourceGroupInfo).length>0)||this.resourceGroupInfo.is_active}">
            </mwc-switch>
            ${this.enableIsPublic?u`
              <p style="margin-left: 18px;color:rgba(0, 0, 0, 0.6);">
                ${p("resourceGroup.Public")}
              </p>
              <mwc-switch id="resource-group-public" style="margin-right:10px;" ?selected="${!(Object.keys(this.resourceGroupInfo).length>0)||this.resourceGroupInfo.is_public}">
              </mwc-switch>
            `:u``}
          </div>
        ...
        ${Object.keys(this.resourceGroupInfo).length>0?u`
          ...
          <div slot="content" class="intro">
            <div class="horizontal layout" style="margin-bottom:15px;">
              <div style="width:250px;">
                ...
                <div role="listbox" class="vertical layout">
                  ...
                  ${this.enableIsPublic?u`
                    <vaadin-item>
                      <div><strong>${h("resourceGroup.PublicStatus")}</strong></div>
                      <lablup-shields
                        app=""
                  ...
                  <vaadin-item>
                    ...
                    <div class="scheduler-option-value">${null===(_=this.resourceGroupInfo)||void 0===_?void 0:_.driver}</div>
                  </vaadin-item>
                  <vaadin-item>
                    <div><strong>${h("resourceGroup.Scheduler")}</strong></div>
                    <div class="scheduler-option-value">${null===(y=this.resourceGroupInfo)||void 0===y?void 0:y.scheduler}</div>
                  </vaadin-item>
                  ${this.enableWSProxyAddr?u`
                  <vaadin-item>
                    <div><strong>${h("resourceGroup.WsproxyAddress")}</strong></div>
                    <div class="scheduler-option-value">${null!==(x=null===(f=this.resourceGroupInfo)||void 0===f?void 0:f.wsproxy_addr)&&void 0!==x?x:"none"}</div>
                  </vaadin-item>
                  `:u``}
                </div>
              </div>
            ...
            <div>
              ...
              <wl-textarea readonly value="${null!==(k=null===($=this.resourceGroupInfo)||void 0===$?void 0:$.description)&&void 0!==k?k:""}">
              </wl-textarea>
            </div>
          </div>`:""}
      </backend-ai-dialog>
    `}};e([t({type:Object})],x.prototype,"_boundControlRenderer",void 0),e([t({type:Array})],x.prototype,"domains",void 0),e([t({type:Object})],x.prototype,"resourceGroupInfo",void 0),e([t({type:Array})],x.prototype,"resourceGroups",void 0),e([t({type:Array})],x.prototype,"schedulerTypes",void 0),e([t({type:Object})],x.prototype,"schedulerOpts",void 0),e([b()],x.prototype,"allowedSessionTypes",void 0),e([t({type:Boolean})],x.prototype,"enableSchedulerOpts",void 0),e([t({type:Boolean})],x.prototype,"enableWSProxyAddr",void 0),e([t({type:Boolean})],x.prototype,"enableIsPublic",void 0),e([t({type:Number})],x.prototype,"functionCount",void 0),e([i("#resource-group-name")],x.prototype,"resourceGroupNameInput",void 0),e([i("#resource-group-description")],x.prototype,"resourceGroupDescriptionInput",void 0),e([i("#resource-group-domain")],x.prototype,"resourceGroupDomainSelect",void 0),e([i("#resource-group-scheduler")],x.prototype,"resourceGroupSchedulerSelect",void 0),e([i("#resource-group-active")],x.prototype,"resourceGroupActiveSwitch",void 0),e([i("#resource-group-public")],x.prototype,"resourceGroupPublicSwitch",void 0),e([i("#resource-group-wsproxy-address")],x.prototype,"resourceGroupWSProxyaddressInput",void 0),e([i("#allowed-session-types")],x.prototype,"allowedSessionTypesSelect",void 0),e([i("#num-retries-to-skip")],x.prototype,"numberOfRetriesToSkip",void 0),e([i("#pending-timeout")],x.prototype,"timeoutInput",void 0),e([i("#delete-resource-group")],x.prototype,"deleteResourceGroupInput",void 0),x=e([s("backend-ai-resource-group-list")],x);
/**
 @license
 Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
 */
let w=class extends a{constructor(){super(...arguments),this._status="inactive",this._tab="running-lists",this.enableStorageProxy=!1}static get styles(){return[o,n`
        h3.tab {
    ...
    `}};e([b()],w.prototype,"_status",void 0),e([b()],w.prototype,"_tab",void 0),e([b()],w.prototype,"enableStorageProxy",void 0),w=e([s("backend-ai-agent-view")],w);
