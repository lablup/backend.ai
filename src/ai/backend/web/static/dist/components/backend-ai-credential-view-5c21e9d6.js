import{_ as e,n as i,b as t,e as s,B as o,c as a,I as r,a as l,m as n,d as c,i as d,f as u,g as p,l as h,x as m,t as v,u as _,Q as y}from"./backend-ai-webui-8aa3adc0.js";import"./mwc-formfield-f7062814.js";import"./mwc-tab-bar-62606cb0.js";import"./lablup-activity-panel-583c8bf2.js";import"./lablup-expansion-5c02cbff.js";import"./vaadin-grid-112dabc9.js";import"./vaadin-grid-filter-column-33ab50ff.js";import"./vaadin-grid-sort-column-00b2d020.js";import"./vaadin-iconset-82932f7f.js";import"./vaadin-item-196c5fba.js";import"./backend-ai-list-status-6b509513.js";import"./lablup-grid-sort-filter-column-82b86571.js";import"./backend-ai-multi-select-67bb77b2.js";import"./mwc-switch-49915f1a.js";import{J as g}from"./json_to_csv-35c9e191.js";import"./dir-utils-f8170f68.js";import"./vaadin-item-mixin-dfdc9571.js";
/**
 @license
 Copyright (c) 2015-2023 Lablup Inc. All rights reserved.
 */var f;class b extends Error{constructor(e){super(e),Object.setPrototypeOf(this,b.prototype),this.title="Unable to delete keypair"}}let w=f=class extends o{constructor(){super(),this.keypairInfo={user_id:"1",access_key:"ABC",secret_key:"ABC",last_used:"",is_admin:!1,resource_policy:"",rate_limit:5e3,concurrency_used:0,num_queries:0,created_at:""},this.isAdmin=!1,this.condition="active",this.keypairs=[],this.resourcePolicy=Object(),this.indicator=Object(),this._boundKeyageRenderer=this.keyageRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundAccessKeyRenderer=this.accessKeyRenderer.bind(this),this._boundPermissionRenderer=this.permissionRenderer.bind(this),this._boundResourcePolicyRenderer=this.resourcePolicyRenderer.bind(this),this._boundAllocationRenderer=this.allocationRenderer.bind(this),this._boundUserIdRenderer=this.userIdRenderer.bind(this),this.keypairGrid=Object(),this.listCondition="loading",this._totalCredentialCount=0,this.isUserInfoMaskEnabled=!1,this.deleteKeyPairUserName="",this.deleteKeyPairAccessKey=""}static get styles(){return[a,r,l,n,c,d`
        vaadin-grid {
          border: 0;
          font-size: 14px;
      ...
      `,e)}controlRenderer(e,i,t){h(m`
        <div id="controls" class="layout horizontal flex center"
             .access-key="${t.item.access_key}" .user-id="${t.item.user_id}">
        ...
        <div class="layout horizontal center flex">
          <div class="vertical start layout">
            <div style="font-size:11px;width:40px;">
              ${t.item.concurrency_used} / ${t.item.concurrency_limit}
            </div>
            <span class="indicator">Sess.</span>
          </div>
          <div class="vertical start layout">
            <span style="font-size:8px">${t.item.rate_limit} <span class="indicator">req./15m.</span></span>
            <span style="font-size:8px">${t.item.num_queries} <span class="indicator">queries</span></span>
          </div>
        </div>
      ...
      <div class="list-wrapper">
        <vaadin-grid theme="row-stripes column-borders compact" aria-label="Credential list"
          ...
          <vaadin-grid-column width="200px" resizable header="${v("credential.ResourcePolicy")}"
...
var x;e([i({type:Object})],w.prototype,"notification",void 0),e([i({type:Object})],w.prototype,"keypairInfo",void 0),e([i({type:Boolean})],w.prototype,"isAdmin",void 0),e([i({type:String})],w.prototype,"condition",void 0),e([i({type:Array})],w.prototype,"keypairs",void 0),e([i({type:Object})],w.prototype,"resourcePolicy",void 0),e([i({type:Object})],w.prototype,"indicator",void 0),e([i({type:Object})],w.prototype,"_boundKeyageRenderer",void 0),e([i({type:Object})],w.prototype,"_boundControlRenderer",void 0),e([i({type:Object})],w.prototype,"_boundAccessKeyRenderer",void 0),e([i({type:Object})],w.prototype,"_boundPermissionRenderer",void 0),e([i({type:Object})],w.prototype,"_boundResourcePolicyRenderer",void 0),e([i({type:Object})],w.prototype,"_boundAllocationRenderer",void 0),e([i({type:Object})],w.prototype,"_boundUserIdRenderer",void 0),e([i({type:Object})],w.prototype,"keypairGrid",void 0),e([i({type:String})],w.prototype,"listCondition",void 0),e([i({type:Number})],w.prototype,"_totalCredentialCount",void 0),e([i({type:Boolean})],w.prototype,"isUserInfoMaskEnabled",void 0),e([i({type:String})],w.prototype,"deleteKeyPairUserName",void 0),e([i({type:String})],w.prototype,"deleteKeyPairAccessKey",void 0),e([t("#keypair-info-dialog")],w.prototype,"keypairInfoDialog",void 0),e([t("#keypair-modify-dialog")],w.prototype,"keypairModifyDialog",void 0),e([t("#delete-keypair-dialog")],w.prototype,"deleteKeyPairDialog",void 0),e([t("#policy-list")],w.prototype,"policyListSelect",void 0),e([t("#rate-limit")],w.prototype,"rateLimit",void 0),e([t("#list-status")],w.prototype,"_listStatus",void 0),w=f=e([s("backend-ai-credential-list")],w);class k{static getValue(){return 1e6}}let $=x=class extends o{constructor(){super(),this.visible=!1,this.listCondition="loading",this.keypairs={},this.resourcePolicy=[],this.keypairInfo={},this.active=!1,this.condition="active",this.current_policy_name="",this.enableSessionLifetime=!1,this.enableParsingStoragePermissions=!1,this._boundResourceRenderer=Object(),this._boundConcurrencyRenderer=this.concurrencyRenderer.bind(this),this._boundControlRenderer=this.controlRenderer.bind(this),this._boundPolicyNameRenderer=this.policyNameRenderer.bind(this),this._boundClusterSizeRenderer=this.clusterSizeRenderer.bind(this),this._boundStorageNodesRenderer=this.storageNodesRenderer.bind(this),this.is_super_admin=!1,this.all_vfolder_hosts=[],this.allowed_vfolder_hosts={},this.vfolderPermissions=[],this.resource_policy_names=[],this._boundResourceRenderer=this.resourceRenderer.bind(this)}static get styles(){return[a,r,l,d`
      ...
      <div class="list-wrapper">
        <vaadin-grid theme="row-stripes column-borders compact" aria-label="Resource Policy list"
          ...
          <vaadin-grid-sort-column frozen resizable header="${v("resourcePolicy.Name")}" path="name" .renderer="${this._boundPolicyNameRenderer}"></vaadin-grid-sort-column>
          <vaadin-grid-column width="180px" resizable header="${v("resourcePolicy.Resources")}" .renderer="${this._boundResourceRenderer}">
          </vaadin-grid-column>
          ...
          <vaadin-grid-column frozen-to-end width="110px" resizable header="${v("general.Control")}" .renderer="${this._boundControlRenderer}">
          </vaadin-grid-column>
        </vaadin-grid>
      ...
      <backend-ai-dialog id="modify-policy-dialog" fixed backdrop blockscrolling narrowLayout>
        ...
        <div slot="content">
          ...
          <div class="horizontal layout justified distancing wrap">
            ...
            <div class="vertical left layout ${this.enableSessionLifetime?"sessions-section":""}">
              <mwc-textfield label="${v("resourcePolicy.IdleTimeoutSec")}" class="discrete" id="idle-timeout" type="number" min="0" max="15552000"
                  @change="${e=>this._validateResourceInput(e)}"></mwc-textfield>
              <mwc-formfield label="${v("resourcePolicy.Unlimited")}" class="unlimited">
                  <mwc-checkbox @change="${e=>this._toggleCheckbox(e)}"></mwc-checkbox>
              </mwc-formfield>
      ...
      `,e)}_displayResourcesByResourceUnit(e=0,i=!1,t=""){let s=0;const o=this._markIfUnlimited(e,i);switch(t=t.toLowerCase()){case"cpu":case"cuda_device":case"max_vfolder_count":s=0;break;case"mem":case"cuda_shares":case"max_vfolder_size":s=1}return["∞","-"].includes(o)?o:Number(o).toFixed(s)}resourceRenderer(e,i,t){h(m`
        <div class="layout horizontal wrap center">
          <div class="layout horizontal configuration">
            ...
            <span>${this._displayResourcesByResourceUnit(t.item.total_resource_slots.cpu,!1,"cpu")}</span>
            <span class="indicator">cores</span>
          </div>
          <div class="layout horizontal configuration">
            <mwc-icon class="fg green indicator">memory</mwc-icon>
            <span>${this._displayResourcesByResourceUnit(t.item.total_resource_slots.mem,!1,"mem")}</span>
            <span class="indicator">GB</span>
          </div>
        </div>
        <div class="layout horizontal wrap center">
        ${t.item.total_resource_slots.cuda_device?m`
          <div class="layout horizontal configuration">
            ...
            <span>${this._displayResourcesByResourceUnit(t.item.total_resource_slots.cuda_device,!1,"cuda_device")}</span>
            <span class="indicator">GPU</span>
          </div>
`:m``}
        ${t.item.total_resource_slots.cuda_shares?m`
          <div class="layout horizontal configuration">
            <mwc-icon class="fg green indicator">view_module</mwc-icon>
            <span>${this._displayResourcesByResourceUnit(t.item.total_resource_slots.cuda_shares,!1,"cuda_shares")}</span>
            <span class="indicator">fGPU</span>
          </div>
`:m``}
        </div>
        <div class="layout horizontal wrap center">
          <div class="layout horizontal configuration">
            ...
            <span>${this._displayResourcesByResourceUnit(t.item.max_vfolder_size,!0,"max_vfolder_size")}</span>
            <span class="indicator">GB</span>
          </div>
          <div class="layout horizontal configuration">
            <mwc-icon class="fg green indicator">folder</mwc-icon>
            <span>${this._displayResourcesByResourceUnit(t.item.max_vfolder_count,!1,"max_vfolder_count")}</span>
            <span class="indicator">Folders</span>
          </div>
        </div>
      `,e)}concurrencyRenderer(e,i,t){h(m`
        <div>${[0,k.getValue()].includes(t.item.max_concurrent_sessions)?"∞":t.item.max_concurrent_sessions}</div>
    `,e)}controlRenderer(e,i,t){h(m`
        <div id="controls" class="layout horizontal flex center" .policy-name="${t.item.name}">
      ...
      <div>${[0,k.getValue()].includes(t.item.max_containers_per_session)?"∞":t.item.max_containers_per_session}</div>
      ...
      `,e)}userStatusRenderer(e,i,t){const s="active"===t.item.status?"green":"lightgrey";h(m`
        <lablup-shields app="" color="${s}" description="${t.item.status}" ui="flat"></lablup-shields>
      ...
      <div class="list-wrapper">
        <vaadin-grid theme="row-stripes column-borders compact"
          ...
          <vaadin-grid-column frozen-to-end width="160px" resizable header="${v("general.Control")}"
      ...
      <backend-ai-react-user-info-dialog value="${JSON.stringify({open:this.openUserInfoModal,userEmail:this.userEmail})}"
        @cancel="${()=>this.openUserInfoModal=!1}"
        ></backend-ai-react-user-info-dialog>
      <backend-ai-react-user-setting-dialog value="${JSON.stringify({open:this.openUserSettingModal,userEmail:this.userEmail})}"
