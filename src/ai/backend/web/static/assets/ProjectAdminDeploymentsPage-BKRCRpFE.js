import{i as vl,u as Kl,an as jl,j as a,bI as Tl,r as Fe,az as kl,A as Al,E as Ll,w as Pl,x as Nl,aY as Rl,bt as Fl,a6 as Ml,a4 as xl,aa as Vl,au as _l,k as Dl,aN as Bl,ac as wl,ax as Ol,c2 as El,B as nl,bX as Ul,aZ as $l,a_ as ql,V as Sl,T as al,da as zl,b8 as Ql,v as Gl,bJ as Hl}from"./index-DB7yUW94.js";import{i as Jl,B as Wl,D as Yl}from"./DeploymentRevisionDetailDrawer-d0xOqlsg.js";import{a as Xl,p as Zl,B as en}from"./BAIModelDeploymentNodes-DhMFfApN.js";import{B as ln}from"./BAIGraphQLPropertyFilter-URVW9R-R.js";import{S as nn}from"./square-pen-BbLd2-Yf.js";import"./parseCliCommand-DLNI3aPC.js";import"./FolderLink-DJPzhdHs.js";import"./BAIId-DEscoFqK.js";import"./BooleanTag-UCS-BJYP.js";const bl=(function(){var n=[{defaultValue:null,kind:"LocalArgument",name:"input"}],e=[{alias:null,args:[{kind:"Variable",name:"input",variableName:"input"}],concreteType:"DeleteDeploymentPayload",kind:"LinkedField",name:"deleteModelDeployment",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"id",storageKey:null}],storageKey:null}];return{fragment:{argumentDefinitions:n,kind:"Fragment",metadata:null,name:"ProjectAdminDeploymentsPageDeleteMutation",selections:e,type:"Mutation",abstractKey:null},kind:"Request",operation:{argumentDefinitions:n,kind:"Operation",name:"ProjectAdminDeploymentsPageDeleteMutation",selections:e},params:{cacheID:"1463ddcf31aa971e7f72ca3901c5db76",id:null,metadata:{},name:"ProjectAdminDeploymentsPageDeleteMutation",operationKind:"mutation",text:`mutation ProjectAdminDeploymentsPageDeleteMutation(
...
`}}})();hl.hash="c0915455c90833c0f8fa382e2c4d6319";const an=n=>{"use memo";var sl,ol,dl,ul,cl,ml,pl,yl,gl;const e=vl.c(163),{projectId:m}=n,{t:l}=Kl(),{message:d}=Al.useApp(),{logger:c}=Ll(),o=Pl(),t=Nl(),[u,De]=Fe.useState(null),[b,j]=Fe.useState(null),[h,Se]=Fe.useState(null);let I;e[0]===Symbol.for("react.memo_cache_sentinel")?(I={current:1,pageSize:10},e[0]=I):I=e[0];const{baiPaginationOption:g,tablePaginationOption:f,setTablePaginationOption:k}=Rl(I);let Ce,je;e[1]===Symbol.for("react.memo_cache_sentinel")?(Ce={filter:Ml(tn),order:Fl(Xl),statusCategory:Fl(["running","finished"]).withDefault("running")},je={history:"replace"},e[1]=Ce,e[2]=je):(Ce=e[1],je=e[2]);const[s,F]=xl(Ce,je),[Ue,$e]=Vl("table_column_overrides.ProjectAdminDeploymentsPage"),[ve,D]=_l();let Te;e[3]===Symbol.for("react.memo_cache_sentinel")?(Te=["STOPPED"],e[3]=Te):Te=e[3];const tl=Te;let Ae;e[4]!==s.statusCategory?(Ae=s.statusCategory==="finished"?{status:{in:tl}}:{status:{notIn:tl}},e[4]=s.statusCategory,e[5]=Ae):Ae=e[5];const qe=Ae;let Le;e[6]!==s.order?(Le=Zl(s.order),e[6]=s.order,e[7]=Le):Le=e[7];const Ke=Le;let T;e[8]!==s.filter?(T=s.filter??{},e[8]=s.filter,e[9]=T):T=e[9];let A;e[10]!==qe||e[11]!==T?(A={...T,...qe},e[10]=qe,e[11]=T,e[12]=A):A=e[12];let L;e[13]!==Ke?(L=Ke?[{field:Ke.field,direction:Ke.direction}]:void 0,e[13]=Ke,e[14]=L):L=e[14];let Pe;e[15]!==g.limit||e[16]!==g.offset||e[17]!==m||e[18]!==A||e[19]!==L?(Pe={projectId:m,filter:A,orderBy:L,limit:g.limit,offset:g.offset},e[15]=g.limit,e[16]=g.offset,e[17]=m,e[18]=A,e[19]=L,e[20]=Pe):Pe=e[20];const il=Pe,rl=Fe.useDeferredValue(il),be=Fe.useDeferredValue(ve);let Ne;e[21]===Symbol.for("react.memo_cache_sentinel")?(Ne=hl,e[21]=Ne):Ne=e[21];const ze=be===Ol?"store-and-network":"network-only";let Re;e[22]!==be||e[23]!==ze?(Re={fetchKey:be,fetchPolicy:ze},e[22]=be,e[23]=ze,e[24]=Re):Re=e[24];const P=Dl.useLazyLoadQuery(Ne,rl,Re);let p,he,Me,N;e[25]!==((sl=P.projectDeployments)==null?void 0:sl.count)||e[26]!==((ol=P.projectDeployments)==null?void 0:ol.edges)||e[27]!==b||e[28]!==u?(p=Bl(wl((dl=P.projectDeployments)==null?void 0:dl.edges,"node")),N=((ul=P.projectDeployments)==null?void 0:ul.count)??0,he=u==null?null:p.find(i=>i.id===u)??null,Me=b==null?null:p.find(i=>i.id===b)??null,e[25]=(cl=P.projectDeployments)==null?void 0:cl.count,e[26]=(ml=P.projectDeployments)==null?void 0:ml.edges,e[27]=b,e[28]=u,e[29]=p,e[30]=he,e[31]=Me,e[32]=N):(p=e[29],he=e[30],Me=e[31],N=e[32]);const r=Me,R=rl!==il||be!==ve;let xe;e[33]===Symbol.for("react.memo_cache_sentinel")?(xe=bl,e[33]=xe):xe=e[33];const[Qe,Ge]=Dl.useMutation(xe);let M;e[34]!==l?(M=l("deployment.filter.Name"),e[34]=l,e[35]=M):M=e[35];let x;e[36]!==M?(x={key:"name",propertyLabel:M,type:"string"},e[36]=M,e[37]=x):x=e[37];let V;e[38]!==l?(V=l("deployment.filter.Tags"),e[38]=l,e[39]=V):V=e[39];let _;e[40]!==V?(_={key:"tags",propertyLabel:V,type:"string"},e[40]=V,e[41]=_):_=e[41];let B;e[42]!==l?(B=l("deployment.filter.EndpointUrl"),e[42]=l,e[43]=B):B=e[43];let w;e[44]!==B?(w={key:"endpointUrl",propertyLabel:B,type:"string"},e[44]=B,e[45]=w):w=e[45];let O;e[46]!==l?(O=l("deployment.filter.OpenToPublic"),e[46]=l,e[47]=O):O=e[47];let E;e[48]!==O?(E={key:"openToPublic",propertyLabel:O,type:"boolean"},e[48]=O,e[49]=E):E=e[49];let Ve;e[50]!==x||e[51]!==_||e[52]!==w||e[53]!==E?(Ve=[x,_,w,E],e[50]=x,e[51]=_,e[52]=w,e[53]=E,e[54]=Ve):Ve=e[54];const He=Ve;let _e;e[55]===Symbol.for("react.memo_cache_sentinel")?(_e={flexShrink:1},e[55]=_e):_e=e[55];const Il=s.statusCategory;let U;e[56]!==F||e[57]!==k?(U=i=>{F({statusCategory:i.target.value}),k({current:1})},e[56]=F,e[57]=k,e[58]=U):U=e[58];let $;e[59]!==l?($=l("deployment.Running"),e[59]=l,e[60]=$):$=e[60];let q;e[61]!==$?(q={label:$,value:"running"},e[61]=$,e[62]=q):q=e[62];let z;e[63]!==l?(z=l("deployment.status.Terminated"),e[63]=l,e[64]=z):z=e[64];let Q;e[65]!==z?(Q={label:z,value:"finished"},e[65]=z,e[66]=Q):Q=e[66];let G;e[67]!==q||e[68]!==Q?(G=[q,Q],e[67]=q,e[68]=Q,e[69]=G):G=e[69];let H;e[70]!==s.statusCategory||e[71]!==U||e[72]!==G?(H=a.jsx(El,{optionType:"button",value:Il,onChange:U,options:G}),e[70]=s.statusCategory,e[71]=U,e[72]=G,e[73]=H):H=e[73];const Je=s.filter??void 0;let J;e[74]!==F||e[75]!==k?(J=i=>{F({filter:i??null}),k({current:1})},e[74]=F,e[75]=k,e[76]=J):J=e[76];let W;e[77]!==He||e[78]!==Je||e[79]!==J?(W=a.jsx(ln,{filterProperties:He,value:Je,onChange:J}),e[77]=He,e[78]=Je,e[79]=J,e[80]=W):W=e[80];let Y;e[81]!==H||e[82]!==W?(Y=a.jsxs(nl,{gap:"sm",align:"start",wrap:"wrap",style:_e,children:[H,W]}),e[81]=H,e[82]=W,e[83]=Y):Y=e[83];let X;e[84]!==D?(X=i=>D(i),e[84]=D,e[85]=X):X=e[85];let Z;e[86]!==ve||e[87]!==R||e[88]!==X?(Z=a.jsx(Ul,{settingId:"project-admin-deployments",defaultAutoUpdateDelay:15e3,loading:R,value:ve,onChange:X}),e[86]=ve,e[87]=R,e[88]=X,e[89]=Z):Z=e[89];let ee;e[90]!==Y||e[91]!==Z?(ee=a.jsxs(nl,{justify:"between",wrap:"wrap",gap:"sm",children:[Y,Z]}),e[90]=Y,e[91]=Z,e[92]=ee):ee=e[92];let le;e[93]!==F?(le=i=>{F({order:i??null})},e[93]=F,e[94]=le):le=e[94];let ne;e[95]!==k?(ne=(i,C)=>{k({current:i,pageSize:C})},e[95]=k,e[96]=ne):ne=e[96];let ae;e[97]!==ne||e[98]!==f.current||e[99]!==f.pageSize||e[100]!==N?(ae={current:f.current,pageSize:f.pageSize,total:N,onChange:ne},e[97]=ne,e[98]=f.current,e[99]=f.pageSize,e[100]=N,e[101]=ae):ae=e[101];let te;e[102]!==Ue||e[103]!==$e?(te={columnOverrides:Ue,onColumnOverridesChange:$e},e[102]=Ue,e[103]=$e,e[104]=te):te=e[104];let ie;e[105]!==t||e[106]!==p||e[107]!==l||e[108]!==o?(ie=i=>{const C=["name","currentRevisionNumber","status","replicaSummary","model","createdAt","owner","id","endpointUrl","tags","updatedAt","openToPublic","resourceGroup","domainName","projectId"],Cl=new Set(["name","currentRevisionNumber","status","replicaSummary","model","createdAt","owner"]);return i.filter(y=>C.includes(y.key)).map(y=>{let Ie=y;return y.key==="name"?Ie={...y,render:(fl,S)=>{var K,Ee;const v=Jl((K=S.metadata)==null?void 0:K.status);return a.jsx($l,{title:((Ee=S.metadata)==null?void 0:Ee.name)??"-",onTitleClick:()=>o(t(`deployments/${Sl(S.id)}`)),copyable:!0,showActions:"always",actions:[{key:"edit",title:l("deployment.EditDeployment"),icon:a.jsx(nn,{}),disabled:v,onClick:()=>De(S.id)},{key:"delete",title:l("deployment.DeleteDeployment"),icon:a.jsx(ql,{}),type:"danger",disabled:v,onClick:()=>j(S.id)}]})}}:y.key==="currentRevisionNumber"?Ie={...y,render:(fl,S)=>{const v=p.find(Ee=>Ee.id===S.id),K=v==null?void 0:v.currentRevision;return(K==null?void 0:K.revisionNumber)==null?a.jsx(al.Text,{type:"secondary",children:"-"}):a.jsx(al.Link,{onClick:()=>Se(K),children:`#${K.revisionNumber}`})}}:y.key==="tags"&&(Ie={...y,render:(fl,S)=>a.jsx(Wl,{metadataFrgmt:S.metadata,stopRowClick:!0,onTagClick:v=>{o({pathname:t("deployments"),search:new URLSearchParams({filter:JSON.stringify({tags:{iContains:v}})}).toString()})},fallback:a.jsx(al.Text,{type:"secondary",children:"-"})})}),y.key==="name"?Ie:{...Ie,defaultHidden:!Cl.has(y.key)}})},e[105]=t,e[106]=p,e[107]=l,e[108]=o,e[109]=ie):ie=e[109];let re;e[110]!==p||e[111]!==R||e[112]!==s.order||e[113]!==le||e[114]!==ae||e[115]!==te||e[116]!==ie?(re=a.jsx(en,{deploymentsFrgmt:p,loading:R,order:s.order,onChangeOrder:le,pagination:ae,tableSettings:te,customizeColumns:ie}),e[110]=p,e[111]=R,e[112]=s.order,e[113]=le,e[114]=ae,e[115]=te,e[116]=ie,e[117]=re):re=e[117];let se;e[118]!==ee||e[119]!==re?(se=a.jsxs(nl,{direction:"column",align:"stretch",gap:"sm",children:[ee,re]}),e[118]=ee,e[119]=re,e[120]=se):se=e[120];const We=!!he,Ye=he??null;let oe;e[121]!==D?(oe=i=>{De(null),i&&D()},e[121]=D,e[122]=oe):oe=e[122];let de;e[123]!==We||e[124]!==Ye||e[125]!==oe?(de=a.jsx(zl,{open:We,deploymentFrgmt:Ye,onRequestClose:oe}),e[123]=We,e[124]=Ye,e[125]=oe,e[126]=de):de=e[126];const Xe=!!r;let ue;e[127]!==l?(ue=l("deployment.DeleteDeployment"),e[127]=l,e[128]=ue):ue=e[128];let ce;e[129]!==l?(ce=l("deployment.Deployment"),e[129]=l,e[130]=ce):ce=e[130];let me;e[131]!==r?(me=r?[{key:r.id,label:((pl=r.metadata)==null?void 0:pl.name)??""}]:[],e[131]=r,e[132]=me):me=e[132];const Ze=((yl=r==null?void 0:r.metadata)==null?void 0:yl.name)??"",el=((gl=r==null?void 0:r.metadata)==null?void 0:gl.name)??"";let pe;e[133]!==el?(pe={placeholder:el},e[133]=el,e[134]=pe):pe=e[134];let ye;e[135]!==Ge?(ye={loading:Ge},e[135]=Ge,e[136]=ye):ye=e[136];let ge;e[137]!==Qe||e[138]!==r||e[139]!==c||e[140]!==d||e[141]!==l||e[142]!==D?(ge=()=>{r&&Qe({variables:{input:{id:Sl(r.id)??r.id}},onCompleted:(i,C)=>{if(C&&C.length>0){c.error("Failed to delete deployment",C),d.error(l("deployment.FailedToDeleteDeployment"));return}d.success(l("deployment.DeploymentDeleted")),j(null),D()},onError:i=>{c.error("Failed to delete deployment",i),d.error(l("deployment.FailedToDeleteDeployment"))}})},e[137]=Qe,e[138]=r,e[139]=c,e[140]=d,e[141]=l,e[142]=D,e[143]=ge):ge=e[143];let Be;e[144]===Symbol.for("react.memo_cache_sentinel")?(Be=()=>j(null),e[144]=Be):Be=e[144];let fe;e[145]!==Xe||e[146]!==ue||e[147]!==ce||e[148]!==me||e[149]!==Ze||e[150]!==pe||e[151]!==ye||e[152]!==ge?(fe=a.jsx(Ql,{open:Xe,title:ue,target:ce,items:me,confirmText:Ze,requireConfirmInput:!0,inputProps:pe,okButtonProps:ye,onOk:ge,onCancel:Be}),e[145]=Xe,e[146]=ue,e[147]=ce,e[148]=me,e[149]=Ze,e[150]=pe,e[151]=ye,e[152]=ge,e[153]=fe):fe=e[153];const ll=!!h;let we;e[154]===Symbol.for("react.memo_cache_sentinel")?(we=()=>Se(null),e[154]=we):we=e[154];let ke;e[155]!==h||e[156]!==ll?(ke=a.jsx(Gl,{children:a.jsx(Yl,{open:ll,revisionFrgmt:h,onClose:we})}),e[155]=h,e[156]=ll,e[157]=ke):ke=e[157];let Oe;return e[158]!==se||e[159]!==de||e[160]!==fe||e[161]!==ke?(Oe=a.jsxs(a.Fragment,{children:[se,de,fe,ke]}),e[158]=se,e[159]=de,e[160]=fe,e[161]=ke,e[162]=Oe):Oe=e[162],Oe},gn=()=>{"use memo";const n=vl.c(9),{t:e}=Kl(),m=jl();let l;n[0]!==e?(l=e("webui.menu.ProjectDeployments"),n[0]=e,n[1]=l):l=n[1];let d;n[2]===Symbol.for("react.memo_cache_sentinel")?(d={header:{borderBottom:"none"},body:{paddingTop:0}},n[2]=d):d=n[2];let c;n[3]===Symbol.for("react.memo_cache_sentinel")?(c=a.jsx(kl,{active:!0}),n[3]=c):c=n[3];let o;n[4]!==m.id?(o=a.jsx(Tl,{children:a.jsx(Fe.Suspense,{fallback:c,children:m.id?a.jsx(an,{projectId:m.id}):a.jsx(kl,{active:!0})})}),n[4]=m.id,n[5]=o):o=n[5];let t;return n[6]!==l||n[7]!==o?(t=a.jsx(Hl,{variant:"borderless",title:l,styles:d,children:o}),n[6]=l,n[7]=o,n[8]=t):t=n[8],t};function tn(n){return typeof n=="object"&&n!==null&&!Array.isArray(n)?n:{}}export{gn as default};
//# sourceMappingURL=ProjectAdminDeploymentsPage-BKRCRpFE.js.map
