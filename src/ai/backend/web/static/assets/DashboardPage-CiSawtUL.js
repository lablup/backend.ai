...
`}}})();U.hash="33191e01e0635b3635f28c7383463c39";const Re=ie(({css:e,token:a})=>({invitationTooltip:e`
  ...
  `})),j=90,Ne=({fetchKey:e,onRequestBadgeClick:a,style:d,...g})=>{const{t:s}=D(),{token:t}=R.useToken(),{styles:u}=Re(),y=M(),l=Q();if(!l.name)throw new Error("Project name is required for StorageStatusPanelCard");if(!l.id)throw new Error("Project ID is required for StorageStatusPanelCard");const F=_.useDeferredValue(e),[i,{updateInvitations:S}]=ne(),c=i.length;ae(()=>{S()},[e]);const o=m=>G(["delete-ongoing","delete-complete","delete-error"],m),{data:r}=$({queryKey:["vfolders",{deferredFetchKey:F,id:l.id}],queryFn:()=>{if(!(l!=null&&l.id))throw new Error("Project ID is required for StorageStatusPanelCard");return y.vfolder.list(l.id)}}),k=r==null?void 0:r.filter(m=>m.is_owner&&m.ownership_type==="user"&&!o(m.status)).length,v=r==null?void 0:r.filter(m=>m.ownership_type==="group"&&!o(m.status)).length,h=r==null?void 0:r.filter(m=>!m.is_owner&&m.ownership_type==="user"&&!o(m.status)).length,{user_resource_policy:p,project_resource_policy:f}=q.useLazyLoadQuery(U,{name:l.name});return n.jsxs(W,{direction:"column",align:"stretch",style:{paddingInline:t.paddingXL,paddingBottom:t.padding,...d},...g,children:[n.jsx(w,{title:s("data.FolderStatus")}),n.jsxs(te,{rowGap:t.marginXL,columnGap:t.marginXL,dividerColor:t.colorBorder,dividerInset:t.marginXS,dividerWidth:t.lineWidth,children:[n.jsx(b,{title:s("data.MyFolders"),value:k,unit:p!=null&&p.max_vfolder_count?`/ ${p==null?void 0:p.max_vfolder_count}`:void 0,style:{maxWidth:j},color:t.colorText}),n.jsx(b,{title:s("data.ProjectFolders"),value:v,unit:f!=null&&f.max_vfolder_count?`/ ${f==null?void 0:f.max_vfolder_count}`:void 0,style:{maxWidth:j},color:t.colorText}),n.jsx(b,{title:c>0?n.jsx("a",{onClick:()=>{a==null||a()},children:n.jsx(se,{title:s("data.InvitedFoldersTooltip",{count:c}),rootClassName:u.invitationTooltip,placement:"topRight",children:n.jsx(le,{count:`+${c}`,offset:[-`${t.sizeXS}`,-`${t.sizeXS}`],style:{zIndex:50},children:n.jsx(x.Text,{style:{fontSize:t.fontSizeHeading5},children:s("data.InvitedFolders")})})})}):n.jsx(x.Text,{style:{fontSize:t.fontSizeHeading5},children:s("data.InvitedFolders")}),value:n.jsx(x.Text,{style:{fontSize:t.fontSizeHeading1},children:h}),style:{maxWidth:j}})]})]})},He=()=>{const{token:e}=R.useToken(),{t:a}=D(),d=Q(),g=oe(),s=re(),t=M(),u=de(),y=ue(),[l,F]=ce(),i=_.useDeferredValue(l),[S,c]=_.useTransition(),o=S||l!==i,[r,k]=me("dashboard_board_items"),v=ge(),h=t.supports("agent-stats"),p=q.useLazyLoadQuery(z,{scopeId:`project:${d.id}`,resourceGroup:g||"default",skipTotalResourceWithinResourceGroup:!v,isSuperAdmin:T(s,"superadmin"),agentNodeFilter:`schedulable == true & status == "ALIVE" & scaling_group == "${g}"`},{fetchPolicy:i===pe?"store-and-network":"network-only",fetchKey:i});Se(()=>{c(()=>{F()})},15e3);const f=B([{id:"mySession",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:n.jsx(_.Suspense,{fallback:n.jsx(C,{active:!0,style:{padding:`0px ${e.marginMD}px`}}),children:n.jsx(ve,{queryRef:p,isRefetching:o,title:T(s,"superadmin")?a("session.ActiveSessions"):a("session.MySessions")})})}},{id:"myResource",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:n.jsx(A,{title:a("webui.menu.MyResources"),status:"error",children:n.jsx(_.Suspense,{fallback:n.jsx(C,{active:!0,style:{padding:e.marginMD}}),children:n.jsx(ye,{fetchKey:i,refetching:o})})})}},{id:"myResourceWithinResourceGroup",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:n.jsx(A,{title:a("webui.menu.MyResourcesInResourceGroup"),status:"error",children:n.jsx(_.Suspense,{fallback:n.jsx(C,{active:!0,style:{padding:e.marginMD}}),children:n.jsx(Fe,{fetchKey:i,refetching:o})})})}},{id:"folderStatus",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:n.jsx(A,{title:a("data.FolderStatus"),status:"error",children:n.jsx(_.Suspense,{fallback:n.jsx(C,{active:!0,style:{padding:e.marginMD}}),children:n.jsx(Ne,{fetchKey:i,onRequestBadgeClick:()=>{u({pathname:y("data"),search:new URLSearchParams({invitation:"true"}).toString()})}})})})}},{id:"quotaPerStorageVolume",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:n.jsx(A,{title:a("data.QuotaPerStorageVolume"),status:"error",children:n.jsx(_.Suspense,{fallback:n.jsx(C,{active:!0,style:{padding:e.marginMD}}),children:n.jsx(Te,{})})})}},v&&{id:"totalResourceWithinResourceGroup",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:p.TotalResourceWithinResourceGroupFragment&&n.jsx(fe,{queryRef:p.TotalResourceWithinResourceGroupFragment,refetching:o})}},T(s,"superadmin")&&h&&p.AgentStatsFragment&&{id:"agentStats",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:n.jsx(_.Suspense,{fallback:n.jsx(C,{active:!0,style:{padding:`0px ${e.marginMD}px`}}),children:n.jsx(Ce,{queryRef:p.AgentStatsFragment,isRefetching:o})})}},T(s,"superadmin")&&{id:"activeAgents",rowSpan:4,columnSpan:4,definition:{minRowSpan:3,minColumnSpan:4},data:{content:n.jsx(_.Suspense,{fallback:n.jsx(C,{active:!0,style:{padding:`0px ${e.marginMD}px`}}),children:n.jsx(he,{fetchKey:i,onChangeFetchKey:()=>F()})})}},{id:"recentlyCreatedSession",rowSpan:3,columnSpan:4,definition:{minRowSpan:2,minColumnSpan:2},data:{content:n.jsx(Le,{queryRef:p,isRefetching:o})}}]),m=ke(f,L=>!E(r,I=>I.id===L.id)),X=[...B(V(r,L=>{var K;const I=(K=E(f,H=>H.id===L.id))==null?void 0:K.data;return I?{...L,data:I}:void 0})),...m];return n.jsx(Ie,{movable:!0,resizable:!0,bordered:!0,items:X,onItemsChange:L=>{const I=[...L.detail.items];k(V(I,K=>_e(K,"data")))}})};export{He as default};
//# sourceMappingURL=DashboardPage-CiSawtUL.js.map
