import{h as Dl,u as bl,j as n,r as Se,aw as Il,B as Te,bI as Nl,A as Rl,v as Al,p as Ml,aV as xl,bs as Pl,bt as Sl,c$ as Vl,bu as jl,a4 as _l,ar as Bl,aj as wl,i as Kl,aK as Ol,a6 as El,au as $l,c0 as Ul,aA as ql,b2 as Ql,aX as zl,d0 as Gl,aZ as Hl,N as vl,T as cl,d1 as Wl,b7 as Jl,a7 as Xl}from"./index-r5M52Un8.js";import{i as Yl,B as Zl,D as en}from"./DeploymentRevisionDetailDrawer-v9Kfvuq9.js";import{p as ln,B as nn,a as an}from"./BAIModelDeploymentNodes-NOzjGV57.js";import{B as tn}from"./BAIGraphQLPropertyFilter-CGIFK1tA.js";import"./parseCliCommand-DLNI3aPC.js";import"./FolderLink-CVus6lm-.js";import"./BAIId-DYp9TwD-.js";import"./BooleanTag-B3quKU6d.js";const hl=function(){var e=[{defaultValue:null,kind:"LocalArgument",name:"input"}],l=[{alias:null,args:[{kind:"Variable",name:"input",variableName:"input"}],concreteType:"DeleteDeploymentPayload",kind:"LinkedField",name:"deleteModelDeployment",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"id",storageKey:null}],storageKey:null}];return{fragment:{argumentDefinitions:e,kind:"Fragment",metadata:null,name:"DeploymentListPageDeleteMutation",selections:l,type:"Mutation",abstractKey:null},kind:"Request",operation:{argumentDefinitions:e,kind:"Operation",name:"DeploymentListPageDeleteMutation",selections:l},params:{cacheID:"4639cd2572faeb586296319d8202e23a",id:null,metadata:{},name:"DeploymentListPageDeleteMutation",operationKind:"mutation",text:`mutation DeploymentListPageDeleteMutation(
...
`}}}();Cl.hash="7e57808b70c4eb1aab4a7a4d8af607d7";const sn=()=>{"use memo";var yl,fl,kl;const e=Dl.c(171),{t:l}=bl(),{message:r}=Rl.useApp(),{logger:o}=Al(),u=Ml(),[p,d]=xl(!1),{setLeft:c,setRight:L}=d,[v,Ke]=Se.useState(null),[D,T]=Se.useState(null),[b,ve]=Se.useState(null);let h;e[0]===Symbol.for("react.memo_cache_sentinel")?(h={current:1,pageSize:10},e[0]=h):h=e[0];const{baiPaginationOption:I,tablePaginationOption:N,setTablePaginationOption:y}=Pl(h);let Ie,Ne;e[1]===Symbol.for("react.memo_cache_sentinel")?(Ie={filter:Vl(rn),order:Sl(an),statusCategory:Sl(["running","finished"]).withDefault("running")},Ne={history:"replace"},e[1]=Ie,e[2]=Ne):(Ie=e[1],Ne=e[2]);const[s,f]=jl(Ie,Ne),[He,We]=_l("table_column_overrides.DeploymentListPage"),[De,k]=Bl(),Re=wl();let Ae;e[3]!==s.order?(Ae=ln(s.order),e[3]=s.order,e[4]=Ae):Ae=e[4];const be=Ae;let Me;e[5]!==be?(Me=be?[{field:be.field,direction:be.direction}]:void 0,e[5]=be,e[6]=Me):Me=e[6];const Je=Me;let xe;e[7]===Symbol.for("react.memo_cache_sentinel")?(xe=["STOPPED"],e[7]=xe):xe=e[7];const ml=xe;let Pe;e[8]!==s.statusCategory?(Pe=s.statusCategory==="finished"?{status:{in:ml}}:{status:{notIn:ml}},e[8]=s.statusCategory,e[9]=Pe):Pe=e[9];const Xe=Pe;let Ve;e[10]!==Re.id?(Ve=Re.id?{projectId:{equals:Re.id}}:{},e[10]=Re.id,e[11]=Ve):Ve=e[11];const Ye=Ve;let je;e[12]!==s.filter?(je=s.filter??{},e[12]=s.filter,e[13]=je):je=e[13];const Ze=je;let R;e[14]!==Ye||e[15]!==Xe||e[16]!==Ze?(R={...Ze,...Xe,...Ye},e[14]=Ye,e[15]=Xe,e[16]=Ze,e[17]=R):R=e[17];let _e;e[18]!==I.limit||e[19]!==I.offset||e[20]!==Je||e[21]!==R?(_e={filter:R,orderBy:Je,limit:I.limit,offset:I.offset},e[18]=I.limit,e[19]=I.offset,e[20]=Je,e[21]=R,e[22]=_e):_e=e[22];const gl=_e,pl=Se.useDeferredValue(gl),he=Se.useDeferredValue(De);let Be;e[23]===Symbol.for("react.memo_cache_sentinel")?(Be=Cl,e[23]=Be):Be=e[23];const el=he===$l?"store-and-network":"network-only";let we;e[24]!==he||e[25]!==el?(we={fetchPolicy:el,fetchKey:he},e[24]=he,e[25]=el,e[26]=we):we=e[26];const{myDeployments:a}=Kl.useLazyLoadQuery(Be,pl,we);let m,Ce,Oe,A;e[27]!==D||e[28]!==v||e[29]!==(a==null?void 0:a.count)||e[30]!==(a==null?void 0:a.edges)?(m=Ol(El(a==null?void 0:a.edges,"node")),A=(a==null?void 0:a.count)??0,Ce=v==null?null:m.find(t=>t.id===v)??null,Oe=D==null?null:m.find(t=>t.id===D)??null,e[27]=D,e[28]=v,e[29]=a==null?void 0:a.count,e[30]=a==null?void 0:a.edges,e[31]=m,e[32]=Ce,e[33]=Oe,e[34]=A):(m=e[31],Ce=e[32],Oe=e[33],A=e[34]);const i=Oe,M=pl!==gl||he!==De;let Ee;e[35]===Symbol.for("react.memo_cache_sentinel")?(Ee=hl,e[35]=Ee):Ee=e[35];const[ll,nl]=Kl.useMutation(Ee);let x;e[36]!==l?(x=l("deployment.filter.Name"),e[36]=l,e[37]=x):x=e[37];let P;e[38]!==x?(P={key:"name",propertyLabel:x,type:"string"},e[38]=x,e[39]=P):P=e[39];let V;e[40]!==l?(V=l("deployment.filter.Tags"),e[40]=l,e[41]=V):V=e[41];let j;e[42]!==V?(j={key:"tags",propertyLabel:V,type:"string"},e[42]=V,e[43]=j):j=e[43];let _;e[44]!==l?(_=l("deployment.filter.EndpointUrl"),e[44]=l,e[45]=_):_=e[45];let B;e[46]!==_?(B={key:"endpointUrl",propertyLabel:_,type:"string"},e[46]=_,e[47]=B):B=e[47];let w;e[48]!==l?(w=l("deployment.filter.OpenToPublic"),e[48]=l,e[49]=w):w=e[49];let O;e[50]!==w?(O={key:"openToPublic",propertyLabel:w,type:"boolean"},e[50]=w,e[51]=O):O=e[51];let $e;e[52]!==P||e[53]!==j||e[54]!==B||e[55]!==O?($e=[P,j,B,O],e[52]=P,e[53]=j,e[54]=B,e[55]=O,e[56]=$e):$e=e[56];const al=$e;let Ue;e[57]===Symbol.for("react.memo_cache_sentinel")?(Ue={flexShrink:1},e[57]=Ue):Ue=e[57];const Ll=s.statusCategory;let E;e[58]!==f||e[59]!==y?(E=t=>{f({statusCategory:t.target.value}),y({current:1})},e[58]=f,e[59]=y,e[60]=E):E=e[60];let $;e[61]!==l?($=l("deployment.Running"),e[61]=l,e[62]=$):$=e[62];let U;e[63]!==$?(U={label:$,value:"running"},e[63]=$,e[64]=U):U=e[64];let q;e[65]!==l?(q=l("deployment.status.Terminated"),e[65]=l,e[66]=q):q=e[66];let Q;e[67]!==q?(Q={label:q,value:"finished"},e[67]=q,e[68]=Q):Q=e[68];let z;e[69]!==U||e[70]!==Q?(z=[U,Q],e[69]=U,e[70]=Q,e[71]=z):z=e[71];let G;e[72]!==s.statusCategory||e[73]!==E||e[74]!==z?(G=n.jsx(Ul,{value:Ll,onChange:E,options:z}),e[72]=s.statusCategory,e[73]=E,e[74]=z,e[75]=G):G=e[75];const tl=s.filter??void 0;let H;e[76]!==f||e[77]!==y?(H=t=>{f({filter:t??null}),y({current:1})},e[76]=f,e[77]=y,e[78]=H):H=e[78];let W;e[79]!==al||e[80]!==tl||e[81]!==H?(W=n.jsx(tn,{filterProperties:al,value:tl,onChange:H}),e[79]=al,e[80]=tl,e[81]=H,e[82]=W):W=e[82];let J;e[83]!==G||e[84]!==W?(J=n.jsxs(Te,{gap:"sm",align:"start",wrap:"wrap",style:Ue,children:[G,W]}),e[83]=G,e[84]=W,e[85]=J):J=e[85];let X;e[86]!==De||e[87]!==M||e[88]!==k?(X=n.jsx(ql,{autoUpdateDelay:15e3,value:De,onChange:k,loading:M}),e[86]=De,e[87]=M,e[88]=k,e[89]=X):X=e[89];let Y;e[90]!==l?(Y=l("deployment.CreateDeployment"),e[90]=l,e[91]=Y):Y=e[91];let Z;e[92]!==L||e[93]!==Y?(Z=n.jsx(Ql,{type:"primary",onClick:L,children:Y}),e[92]=L,e[93]=Y,e[94]=Z):Z=e[94];let ee;e[95]!==X||e[96]!==Z?(ee=n.jsxs(Te,{gap:"xs",align:"center",children:[X,Z]}),e[95]=X,e[96]=Z,e[97]=ee):ee=e[97];let le;e[98]!==J||e[99]!==ee?(le=n.jsxs(Te,{justify:"between",wrap:"wrap",gap:"sm",children:[J,ee]}),e[98]=J,e[99]=ee,e[100]=le):le=e[100];let ne;e[101]!==f?(ne=t=>{f({order:t??null})},e[101]=f,e[102]=ne):ne=e[102];let ae;e[103]!==y?(ae=(t,C)=>{y({current:t,pageSize:C})},e[103]=y,e[104]=ae):ae=e[104];let te;e[105]!==ae||e[106]!==N.current||e[107]!==N.pageSize||e[108]!==A?(te={current:N.current,pageSize:N.pageSize,total:A,onChange:ae},e[105]=ae,e[106]=N.current,e[107]=N.pageSize,e[108]=A,e[109]=te):te=e[109];let ie;e[110]!==He||e[111]!==We?(ie={columnOverrides:He,onColumnOverridesChange:We},e[110]=He,e[111]=We,e[112]=ie):ie=e[112];let se;e[113]!==m||e[114]!==l||e[115]!==u?(se=t=>{const C=["name","currentRevisionNumber","status","replicaSummary","model","createdAt","id","endpointUrl","tags","updatedAt","openToPublic","resourceGroup"],Tl=new Set(["name","currentRevisionNumber","status","replicaSummary","model","createdAt"]);return t.filter(g=>C.includes(g.key)).map(g=>{let Le=g;return g.key==="name"?Le={...g,render:(Fl,F)=>{var K,Ge;const S=Yl((K=F.metadata)==null?void 0:K.status);return n.jsx(zl,{title:((Ge=F.metadata)==null?void 0:Ge.name)??"-",onTitleClick:()=>u(`/deployments/${vl(F.id)}`),copyable:!0,showActions:"always",actions:[{key:"edit",title:l("deployment.EditDeployment"),icon:n.jsx(Gl,{}),disabled:S,onClick:()=>Ke(F.id)},{key:"delete",title:l("deployment.DeleteDeployment"),icon:n.jsx(Hl,{}),type:"danger",disabled:S,onClick:()=>T(F.id)}]})}}:g.key==="currentRevisionNumber"?Le={...g,render:(Fl,F)=>{const S=m.find(Ge=>Ge.id===F.id),K=S==null?void 0:S.currentRevision;return(K==null?void 0:K.revisionNumber)==null?n.jsx(cl.Text,{type:"secondary",children:"-"}):n.jsx(cl.Link,{onClick:()=>ve(K),children:`#${K.revisionNumber}`})}}:g.key==="tags"&&(Le={...g,render:(Fl,F)=>n.jsx(Zl,{metadataFrgmt:F.metadata,stopRowClick:!0,onTagClick:S=>{u({pathname:"/deployments",search:new URLSearchParams({filter:JSON.stringify({tags:{iContains:S}})}).toString()})},fallback:n.jsx(cl.Text,{type:"secondary",children:"-"})})}),g.key==="name"?Le:{...Le,defaultHidden:!Tl.has(g.key)}})},e[113]=m,e[114]=l,e[115]=u,e[116]=se):se=e[116];let re;e[117]!==m||e[118]!==M||e[119]!==s.order||e[120]!==ne||e[121]!==te||e[122]!==ie||e[123]!==se?(re=n.jsx(nn,{deploymentsFrgmt:m,loading:M,order:s.order,onChangeOrder:ne,pagination:te,tableSettings:ie,customizeColumns:se}),e[117]=m,e[118]=M,e[119]=s.order,e[120]=ne,e[121]=te,e[122]=ie,e[123]=se,e[124]=re):re=e[124];let oe;e[125]!==le||e[126]!==re?(oe=n.jsxs(Te,{direction:"column",align:"stretch",gap:"sm",children:[le,re]}),e[125]=le,e[126]=re,e[127]=oe):oe=e[127];const il=p||!!Ce,sl=Ce??null;let ue;e[128]!==c||e[129]!==k?(ue=t=>{c(),Ke(null),t&&k()},e[128]=c,e[129]=k,e[130]=ue):ue=e[130];let de;e[131]!==il||e[132]!==sl||e[133]!==ue?(de=n.jsx(Wl,{open:il,deploymentFrgmt:sl,onRequestClose:ue}),e[131]=il,e[132]=sl,e[133]=ue,e[134]=de):de=e[134];const rl=!!i;let ce;e[135]!==l?(ce=l("deployment.DeleteDeployment"),e[135]=l,e[136]=ce):ce=e[136];let me;e[137]!==l?(me=l("deployment.Deployment"),e[137]=l,e[138]=me):me=e[138];let ge;e[139]!==i?(ge=i?[{key:i.id,label:((yl=i.metadata)==null?void 0:yl.name)??""}]:[],e[139]=i,e[140]=ge):ge=e[140];const ol=((fl=i==null?void 0:i.metadata)==null?void 0:fl.name)??"",ul=((kl=i==null?void 0:i.metadata)==null?void 0:kl.name)??"";let pe;e[141]!==ul?(pe={placeholder:ul},e[141]=ul,e[142]=pe):pe=e[142];let ye;e[143]!==nl?(ye={loading:nl},e[143]=nl,e[144]=ye):ye=e[144];let fe;e[145]!==ll||e[146]!==i||e[147]!==o||e[148]!==r||e[149]!==l||e[150]!==k?(fe=()=>{i&&ll({variables:{input:{id:vl(i.id)??i.id}},onCompleted:(t,C)=>{if(C&&C.length>0){o.error("Failed to delete deployment",C),r.error(l("deployment.FailedToDeleteDeployment"));return}r.success(l("deployment.DeploymentDeleted")),T(null),k()},onError:t=>{o.error("Failed to delete deployment",t),r.error(l("deployment.FailedToDeleteDeployment"))}})},e[145]=ll,e[146]=i,e[147]=o,e[148]=r,e[149]=l,e[150]=k,e[151]=fe):fe=e[151];let qe;e[152]===Symbol.for("react.memo_cache_sentinel")?(qe=()=>T(null),e[152]=qe):qe=e[152];let ke;e[153]!==rl||e[154]!==ce||e[155]!==me||e[156]!==ge||e[157]!==ol||e[158]!==pe||e[159]!==ye||e[160]!==fe?(ke=n.jsx(Jl,{open:rl,title:ce,target:me,items:ge,confirmText:ol,requireConfirmInput:!0,inputProps:pe,okButtonProps:ye,onOk:fe,onCancel:qe}),e[153]=rl,e[154]=ce,e[155]=me,e[156]=ge,e[157]=ol,e[158]=pe,e[159]=ye,e[160]=fe,e[161]=ke):ke=e[161];const dl=!!b;let Qe;e[162]===Symbol.for("react.memo_cache_sentinel")?(Qe=()=>ve(null),e[162]=Qe):Qe=e[162];let Fe;e[163]!==b||e[164]!==dl?(Fe=n.jsx(Xl,{children:n.jsx(en,{open:dl,revisionFrgmt:b,onClose:Qe})}),e[163]=b,e[164]=dl,e[165]=Fe):Fe=e[165];let ze;return e[166]!==oe||e[167]!==de||e[168]!==ke||e[169]!==Fe?(ze=n.jsxs(n.Fragment,{children:[oe,de,ke,Fe]}),e[166]=oe,e[167]=de,e[168]=ke,e[169]=Fe,e[170]=ze):ze=e[170],ze},fn=()=>{"use memo";const e=Dl.c(6),{t:l}=bl();let r;e[0]!==l?(r=l("webui.menu.Deployments"),e[0]=l,e[1]=r):r=e[1];let o;e[2]===Symbol.for("react.memo_cache_sentinel")?(o={body:{paddingTop:0}},e[2]=o):o=e[2];let u;e[3]===Symbol.for("react.memo_cache_sentinel")?(u=n.jsx(Se.Suspense,{fallback:n.jsx(Il,{active:!0}),children:n.jsx(sn,{})}),e[3]=u):u=e[3];let p;return e[4]!==r?(p=n.jsx(Te,{direction:"column",align:"stretch",gap:"md",children:n.jsx(Nl,{variant:"borderless",title:r,styles:o,children:u})}),e[4]=r,e[5]=p):p=e[5],p};function rn(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)?e:{}}export{fn as default};
//# sourceMappingURL=DeploymentListPage-B50Z_rCx.js.map
