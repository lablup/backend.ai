...
`}}}();N.hash="6db7f3ef05315f718654362f981b9dbf";const W=()=>{const{t:e}=h(),[d,F]=v(),m=b(),n=f.useDeferredValue(d),l=f.useDeferredValue(m),[c,_]=T("table_column_overrides.PendingSessionNodeList"),o=L(),t=I(),{baiPaginationOption:u,tablePaginationOption:i,setTablePaginationOption:r}=A({current:1,pageSize:10}),p=f.useMemo(()=>({resource_group_id:l??"",first:u.first,offset:u.offset}),[l,u]),S=f.useDeferredValue(p),{session_pending_queue:g}=w.useLazyLoadQuery(N,S,{fetchKey:n,fetchPolicy:n===M?"store-and-network":"network-only"});return a.jsxs(k,{direction:"column",align:"stretch",gap:"sm",children:[a.jsx(P,{type:"info",showIcon:!0,description:e("adminSession.PendingSessionsScopedToResourceGroup")}),a.jsxs(k,{align:"stretch",justify:"between",children:[a.jsx(x.Item,{label:e("session.ResourceGroup"),style:{marginBottom:0},children:a.jsx(j,{showSearch:!0,style:{minWidth:100},onChangeInTransition:()=>{r({current:1})},loading:m!==l,popupMatchSelectWidth:!1,tooltip:e("general.ResourceGroup")})}),a.jsx(B,{loading:S!==p||n!==d,autoUpdateDelay:7e3,value:d,onChange:s=>{F(s)}})]}),a.jsx(D,{disableSorter:!0,onClickSessionName:s=>{const y=new URLSearchParams(t.search);y.set("sessionDetail",s.row_id),o({pathname:t.pathname,hash:t.hash,search:y.toString()},{state:{sessionDetailDrawerFrgmt:s,createdAt:new Date().toISOString()}})},loading:S!==p,sessionsFrgmt:V(g==null?void 0:g.edges.map(s=>s==null?void 0:s.node)),pagination:{pageSize:i.pageSize,current:i.current,total:(g==null?void 0:g.count)??0,onChange:(s,y)=>{K(s)&&K(y)&&r({current:s,pageSize:y})}},tableSettings:{columnOverrides:c,onColumnOverridesChange:_}})]})},Z=U.lazy(()=>q(()=>import("./AdminComputeSessionListPage-DIHJYR3Z.js"),__vite__mapDeps([0,1]))),oe=()=>{"use memo";const e=R.c(23),{t:d}=h();let F,m;e[0]===Symbol.for("react.memo_cache_sentinel")?(F={tab:E.withDefault("compute-sessions")},m={history:"push"},e[0]=F,e[1]=m):(F=e[0],m=e[1]);const[n,l]=O(F,m),c=L(),_=n.tab;let o;e[2]!==l||e[3]!==c?(o=y=>{c({pathname:"/admin-session",search:new URLSearchParams({tab:y}).toString()}),l({tab:y})},e[2]=l,e[3]=c,e[4]=o):o=e[4];let t;e[5]!==d?(t=Q([{key:"compute-sessions",label:d("webui.menu.Sessions")},{key:"pending-sessions",label:d("adminSession.PendingSessions")}]),e[5]=d,e[6]=t):t=e[6];let u;e[7]===Symbol.for("react.memo_cache_sentinel")?(u=a.jsx(z,{active:!0}),e[7]=u):u=e[7];let i;e[8]!==n.tab?(i=n.tab==="compute-sessions"&&a.jsx(C,{children:a.jsx(Z,{})}),e[8]=n.tab,e[9]=i):i=e[9];let r;e[10]!==n.tab?(r=n.tab==="pending-sessions"&&a.jsx(C,{children:a.jsx(W,{})}),e[10]=n.tab,e[11]=r):r=e[11];let p;e[12]!==i||e[13]!==r?(p=a.jsxs(f.Suspense,{fallback:u,children:[i,r]}),e[12]=i,e[13]=r,e[14]=p):p=e[14];let S;e[15]!==n.tab||e[16]!==o||e[17]!==t||e[18]!==p?(S=a.jsx(G,{activeTabKey:_,onTabChange:o,tabList:t,children:p}),e[15]=n.tab,e[16]=o,e[17]=t,e[18]=p,e[19]=S):S=e[19];let g;e[20]===Symbol.for("react.memo_cache_sentinel")?(g=a.jsx($,{}),e[20]=g):g=e[20];let s;return e[21]!==S?(s=a.jsxs(a.Fragment,{children:[S,g]}),e[21]=S,e[22]=s):s=e[22],s};export{oe as default};
//# sourceMappingURL=AdminSessionPage-50i3SQ0O.js.map
