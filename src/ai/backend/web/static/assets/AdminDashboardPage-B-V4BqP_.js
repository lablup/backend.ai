...
`}}})();h.hash="96b17d3da84f2e5251488a099091bcf8";const ce=()=>{const{token:m}=R.useToken(),{t:F}=b(),k=E(),p=D(),y=M(),_=w(),[c,i]=V(),[a,g]=L.useTransition(),[o,s]=B("admin_dashboard_board_items"),r=x(),d=_.supports("agent-stats"),n=j.useLazyLoadQuery(h,{scopeId:`project:${k.id}`,resourceGroup:p||"default",skipTotalResourceWithinResourceGroup:!r,skipAgentStats:!d,isSuperAdmin:G(y,"superadmin"),agentNodeFilter:`schedulable == true & status == "ALIVE" & scaling_group == "${p}"`},{fetchPolicy:c===$?"store-and-network":"network-only",fetchKey:c});P(()=>{g(()=>{i()})},3e4);const S=N([{id:"activeSessions",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:e.jsx(L.Suspense,{fallback:e.jsx(K,{active:!0,style:{padding:`0px ${m.marginMD}px`}}),children:e.jsx(U,{queryRef:n,isRefetching:a,title:F("session.ActiveSessions")})})}},r&&{id:"totalResourceWithinResourceGroup",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:n.TotalResourceWithinResourceGroupFragment&&e.jsx(W,{queryRef:n.TotalResourceWithinResourceGroupFragment,refetching:a})}},d&&n.AgentStatsFragment&&{id:"agentStats",rowSpan:2,columnSpan:2,definition:{minRowSpan:2,minColumnSpan:2},data:{content:e.jsx(L.Suspense,{fallback:e.jsx(K,{active:!0,style:{padding:`0px ${m.marginMD}px`}}),children:e.jsx(z,{queryRef:n.AgentStatsFragment,isRefetching:a})})}},{id:"activeAgents",rowSpan:4,columnSpan:4,definition:{minRowSpan:3,minColumnSpan:4},data:{content:e.jsx(L.Suspense,{fallback:e.jsx(K,{active:!0,style:{padding:`0px ${m.marginMD}px`}}),children:e.jsx(J,{fetchKey:c,onChangeFetchKey:()=>i()})})}},{id:"recentlyCreatedSession",rowSpan:3,columnSpan:4,definition:{minRowSpan:2,minColumnSpan:2},data:{content:e.jsx(H,{queryRef:n,isRefetching:a})}}]),f=q(S,l=>!I(o,t=>t.id===l.id)),C=[...N(T(o,l=>{var u;const t=(u=I(S,v=>v.id===l.id))==null?void 0:u.data;return t?{...l,data:t}:void 0})),...f];return e.jsx(O,{movable:!0,resizable:!0,bordered:!0,items:C,onItemsChange:l=>{const t=[...l.detail.items];s(T(t,u=>Q(u,"data")))}})};export{ce as default};
//# sourceMappingURL=AdminDashboardPage-B-V4BqP_.js.map
