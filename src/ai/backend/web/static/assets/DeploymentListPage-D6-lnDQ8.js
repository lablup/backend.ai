import{i as fl,u as kl,bF as Dl,d$ as bl,j as a,at as hl,aV as Cl,l as ve,c as he,d as Ll,X as Tl,x as Il,Y as Nl,Z as Al,bG as Pl,ca as cl,ag as Ml,ae as Rl,a7 as xl,aN as Vl,z as jl,W as Bl,aS as _l,r as ml,aT as wl,al as Ol,bh as El,dg as Ul,dF as $l,bI as ql,aK as zl,aM as Gl,N as gl,a2 as pl,L as Ql,ao as yl,bO as Wl}from"./index-Bg9dLa8r.js";import{D as Hl,a as Jl}from"./DeploymentSettingModal-C6pW9IYJ.js";import{a as Yl,B as Xl}from"./BAIModelDeploymentNodes-CL_ZUHok.js";import{B as Zl}from"./BAIGraphQLPropertyFilter-CsaKfYKW.js";import{i as en,B as ln}from"./BAIDeploymentTagTokens-ZxoaXw6A.js";import"./parseCliCommand-DLNI3aPC.js";import"./FolderLink-QnkTdekF.js";import"./BAIBooleanToken-Dgc-5MGf.js";const Fl=(function(){var l=[{defaultValue:null,kind:"LocalArgument",name:"input"}],e=[{alias:null,args:[{kind:"Variable",name:"input",variableName:"input"}],concreteType:"DeleteDeploymentPayload",kind:"LinkedField",name:"deleteModelDeployment",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"id",storageKey:null}],storageKey:null}];return{fragment:{argumentDefinitions:l,kind:"Fragment",metadata:null,name:"DeploymentListPageDeleteMutation",selections:e,type:"Mutation",abstractKey:null},kind:"Request",operation:{argumentDefinitions:l,kind:"Operation",name:"DeploymentListPageDeleteMutation",selections:e},params:{cacheID:"4639cd2572faeb586296319d8202e23a",id:null,metadata:{},name:"DeploymentListPageDeleteMutation",operationKind:"mutation",text:`mutation DeploymentListPageDeleteMutation(
...
`}}})();Sl.hash="7e57808b70c4eb1aab4a7a4d8af607d7";const nn=l=>{"use memo";var rl,ol,ul;const e=fl.c(163),{isCreating:k,onCloseCreate:h}=l,{t:n}=kl(),{message:d}=Tl.useApp(),{logger:t}=Il(),i=Nl(),c=Al(),[m,g]=ve.useState(null),[p,M]=ve.useState(null),[I,R]=ve.useState(null);let N;e[0]===Symbol.for("react.memo_cache_sentinel")?(N={current:1,pageSize:10},e[0]=N):N=e[0];const{baiPaginationOption:F,tablePaginationOption:S,setTablePaginationOption:v}=Pl(N);let Ce,Le;e[1]===Symbol.for("react.memo_cache_sentinel")?(Ce={filter:Ml(an),order:cl(Yl),statusCategory:cl(["running","finished"]).withDefault("running")},Le={history:"replace"},e[1]=Ce,e[2]=Le):(Ce=e[1],Le=e[2]);const[u,K]=Rl(Ce,Le),[qe,ze]=xl("table_column_overrides.DeploymentListPage"),[Ke,D]=Vl(),A=jl();let Te;e[3]!==A?(Te=Bl(A),e[3]=A,e[4]=Te):Te=e[4];const Ie=Te;let Ne;e[5]!==u.order?(Ne=_l(u.order),e[5]=u.order,e[6]=Ne):Ne=e[6];const Ge=Ne;let Ae;e[7]===Symbol.for("react.memo_cache_sentinel")?(Ae=["STOPPED"],e[7]=Ae):Ae=e[7];const tl=Ae;let Pe;e[8]!==u.statusCategory?(Pe=u.statusCategory==="finished"?{status:{in:tl}}:{status:{notIn:tl}},e[8]=u.statusCategory,e[9]=Pe):Pe=e[9];const Qe=Pe;let Me;e[10]!==A.id?(Me=A.id?{projectId:{equals:A.id}}:{},e[10]=A.id,e[11]=Me):Me=e[11];const We=Me;let x;e[12]!==u.filter?(x=u.filter??{},e[12]=u.filter,e[13]=x):x=e[13];let V;e[14]!==We||e[15]!==Qe||e[16]!==x?(V={...x,...Qe,...We},e[14]=We,e[15]=Qe,e[16]=x,e[17]=V):V=e[17];let Re;e[18]!==F.limit||e[19]!==F.offset||e[20]!==Ge||e[21]!==V?(Re={filter:V,orderBy:Ge,limit:F.limit,offset:F.offset},e[18]=F.limit,e[19]=F.offset,e[20]=Ge,e[21]=V,e[22]=Re):Re=e[22];const il=Re,sl=ve.useDeferredValue(il),De=ve.useDeferredValue(Ke);let xe;e[23]===Symbol.for("react.memo_cache_sentinel")?(xe=Sl,e[23]=xe):xe=e[23];const He=De===El?"store-and-network":"network-only";let Ve;e[24]!==De||e[25]!==He?(Ve={fetchPolicy:He,fetchKey:De},e[24]=De,e[25]=He,e[26]=Ve):Ve=e[26];const{myDeployments:s}=ml.useLazyLoadQuery(xe,sl,Ve);let y,C,je,j;e[27]!==p||e[28]!==m||e[29]!==(s==null?void 0:s.count)||e[30]!==(s==null?void 0:s.edges)?(y=wl(Ol(s==null?void 0:s.edges,"node")),j=(s==null?void 0:s.count)??0,C=m==null?null:y.find(r=>r.id===m)??null,je=p==null?null:y.find(r=>r.id===p)??null,e[27]=p,e[28]=m,e[29]=s==null?void 0:s.count,e[30]=s==null?void 0:s.edges,e[31]=y,e[32]=C,e[33]=je,e[34]=j):(y=e[31],C=e[32],je=e[33],j=e[34]);const o=je,B=sl!==il||De!==Ke;let Be;e[35]===Symbol.for("react.memo_cache_sentinel")?(Be=Fl,e[35]=Be):Be=e[35];const[Je,Ye]=ml.useMutation(Be);let _;e[36]!==n?(_=n("deployment.filter.Name"),e[36]=n,e[37]=_):_=e[37];let w;e[38]!==_?(w={key:"name",propertyLabel:_,type:"string"},e[38]=_,e[39]=w):w=e[39];let O;e[40]!==n?(O=n("deployment.filter.Tags"),e[40]=n,e[41]=O):O=e[41];let E;e[42]!==O?(E={key:"tags",propertyLabel:O,type:"string"},e[42]=O,e[43]=E):E=e[43];let U;e[44]!==n?(U=n("deployment.filter.EndpointUrl"),e[44]=n,e[45]=U):U=e[45];let $;e[46]!==U?($={key:"endpointUrl",propertyLabel:U,type:"string"},e[46]=U,e[47]=$):$=e[47];let q;e[48]!==n?(q=n("deployment.filter.OpenToPublic"),e[48]=n,e[49]=q):q=e[49];let z;e[50]!==q?(z={key:"openToPublic",propertyLabel:q,type:"boolean"},e[50]=q,e[51]=z):z=e[51];let _e;e[52]!==w||e[53]!==E||e[54]!==$||e[55]!==z?(_e=[w,E,$,z],e[52]=w,e[53]=E,e[54]=$,e[55]=z,e[56]=_e):_e=e[56];const Xe=_e;let we;e[57]===Symbol.for("react.memo_cache_sentinel")?(we={flexShrink:1},e[57]=we):we=e[57];const vl=u.statusCategory;let G;e[58]!==K||e[59]!==v?(G=r=>{K({statusCategory:r.target.value}),v({current:1})},e[58]=K,e[59]=v,e[60]=G):G=e[60];let Q;e[61]!==n?(Q=n("deployment.Running"),e[61]=n,e[62]=Q):Q=e[62];let W;e[63]!==Q?(W={label:Q,value:"running"},e[63]=Q,e[64]=W):W=e[64];let H;e[65]!==n?(H=n("deployment.status.Terminated"),e[65]=n,e[66]=H):H=e[66];let J;e[67]!==H?(J={label:H,value:"finished"},e[67]=H,e[68]=J):J=e[68];let Y;e[69]!==W||e[70]!==J?(Y=[W,J],e[69]=W,e[70]=J,e[71]=Y):Y=e[71];let X;e[72]!==u.statusCategory||e[73]!==G||e[74]!==Y?(X=a.jsx(Ul,{value:vl,onChange:G,options:Y}),e[72]=u.statusCategory,e[73]=G,e[74]=Y,e[75]=X):X=e[75];const Ze=u.filter??void 0;let Z;e[76]!==K||e[77]!==v?(Z=r=>{K({filter:r??null}),v({current:1})},e[76]=K,e[77]=v,e[78]=Z):Z=e[78];let ee;e[79]!==Xe||e[80]!==Ze||e[81]!==Z?(ee=a.jsx(Zl,{filterProperties:Xe,value:Ze,onChange:Z}),e[79]=Xe,e[80]=Ze,e[81]=Z,e[82]=ee):ee=e[82];let le;e[83]!==X||e[84]!==ee?(le=a.jsxs(he,{gap:"sm",align:"start",wrap:"wrap",style:we,children:[X,ee]}),e[83]=X,e[84]=ee,e[85]=le):le=e[85];let ne;e[86]!==Ke||e[87]!==B||e[88]!==D?(ne=a.jsx(he,{gap:"xs",align:"center",children:a.jsx($l,{settingId:"deployment-list",defaultAutoUpdateDelay:15e3,value:Ke,onChange:D,loading:B})}),e[86]=Ke,e[87]=B,e[88]=D,e[89]=ne):ne=e[89];let ae;e[90]!==le||e[91]!==ne?(ae=a.jsxs(he,{justify:"between",wrap:"wrap",gap:"sm",children:[le,ne]}),e[90]=le,e[91]=ne,e[92]=ae):ae=e[92];let te;e[93]!==K?(te=r=>{K({order:r??null})},e[93]=K,e[94]=te):te=e[94];let ie;e[95]!==v?(ie=(r,P)=>{v({current:r,pageSize:P})},e[95]=v,e[96]=ie):ie=e[96];let se;e[97]!==ie||e[98]!==S.current||e[99]!==S.pageSize||e[100]!==j?(se={current:S.current,pageSize:S.pageSize,total:j,onChange:ie},e[97]=ie,e[98]=S.current,e[99]=S.pageSize,e[100]=j,e[101]=se):se=e[101];let re;e[102]!==qe||e[103]!==ze?(re={columnOverrides:qe,onColumnOverridesChange:ze},e[102]=qe,e[103]=ze,e[104]=re):re=e[104];let oe;e[105]!==c||e[106]!==y||e[107]!==n||e[108]!==i?(oe=r=>{const P=["name","currentRevisionNumber","status","replicaSummary","model","createdAt","id","endpointUrl","tags","updatedAt","openToPublic","resourceGroup"],Kl=new Set(["name","currentRevisionNumber","status","replicaSummary","model","createdAt"]);return r.filter(f=>P.includes(f.key)).map(f=>{let be=f;return f.key==="name"?be={...f,render:(dl,b)=>{var T,$e;const L=en((T=b.metadata)==null?void 0:T.status);return a.jsx(ql,{title:(($e=b.metadata)==null?void 0:$e.name)??"-",onTitleClick:()=>i(`${c("deployments")}/${gl(b.id)}`),copyable:!0,showActions:"always",actions:[{key:"edit",title:n("deployment.EditDeployment"),icon:a.jsx(zl,{}),disabled:L,onClick:()=>g(b.id)},{key:"delete",title:n("deployment.DeleteDeployment"),icon:a.jsx(Gl,{size:"1em"}),type:"danger",disabled:L,onClick:()=>M(b.id)}]})}}:f.key==="currentRevisionNumber"?be={...f,render:(dl,b)=>{const L=y.find($e=>$e.id===b.id),T=L==null?void 0:L.currentRevision;return(T==null?void 0:T.revisionNumber)==null?a.jsx(pl,{color:"secondary",children:"-"}):a.jsx(Ql,{onClick:()=>R(T),children:`#${T.revisionNumber}`})}}:f.key==="tags"&&(be={...f,render:(dl,b)=>a.jsx(ln,{metadataFrgmt:b.metadata,stopRowClick:!0,onTagClick:L=>{i({pathname:c("deployments"),search:new URLSearchParams({filter:JSON.stringify({tags:{iContains:L}})}).toString()})},fallback:a.jsx(pl,{color:"secondary",children:"-"})})}),f.key==="name"?be:{...be,defaultHidden:!Kl.has(f.key)}})},e[105]=c,e[106]=y,e[107]=n,e[108]=i,e[109]=oe):oe=e[109];let ue;e[110]!==y||e[111]!==B||e[112]!==u.order||e[113]!==te||e[114]!==se||e[115]!==re||e[116]!==oe?(ue=a.jsx(Xl,{deploymentsFrgmt:y,loading:B,order:u.order,onChangeOrder:te,pagination:se,tableSettings:re,customizeColumns:oe}),e[110]=y,e[111]=B,e[112]=u.order,e[113]=te,e[114]=se,e[115]=re,e[116]=oe,e[117]=ue):ue=e[117];let de;e[118]!==ae||e[119]!==ue?(de=a.jsxs(he,{direction:"column",align:"stretch",gap:"sm",children:[ae,ue]}),e[118]=ae,e[119]=ue,e[120]=de):de=e[120];let ce;e[121]!==C||e[122]!==k||e[123]!==h||e[124]!==Ie||e[125]!==D?(ce=Ie!=null&&a.jsx(yl,{children:a.jsx(Hl,{open:k||!!C,deploymentFrgmt:C??null,project:Ie,onRequestClose:r=>{h(),g(null),r&&!C&&D()}})}),e[121]=C,e[122]=k,e[123]=h,e[124]=Ie,e[125]=D,e[126]=ce):ce=e[126];const el=!!o;let me;e[127]!==n?(me=n("deployment.DeleteDeployment"),e[127]=n,e[128]=me):me=e[128];let ge;e[129]!==n?(ge=n("deployment.Deployment"),e[129]=n,e[130]=ge):ge=e[130];let pe;e[131]!==o?(pe=o?[{key:o.id,label:((rl=o.metadata)==null?void 0:rl.name)??""}]:[],e[131]=o,e[132]=pe):pe=e[132];const ll=((ol=o==null?void 0:o.metadata)==null?void 0:ol.name)??"",nl=((ul=o==null?void 0:o.metadata)==null?void 0:ul.name)??"";let ye;e[133]!==nl?(ye={placeholder:nl},e[133]=nl,e[134]=ye):ye=e[134];let fe;e[135]!==Ye?(fe={loading:Ye},e[135]=Ye,e[136]=fe):fe=e[136];let ke;e[137]!==Je||e[138]!==o||e[139]!==t||e[140]!==d||e[141]!==n||e[142]!==D?(ke=()=>{o&&Je({variables:{input:{id:gl(o.id)??o.id}},onCompleted:(r,P)=>{if(P&&P.length>0){t.error("Failed to delete deployment",P),d.error(n("deployment.FailedToDeleteDeployment"));return}d.success(n("deployment.DeploymentDeleted")),M(null),D()},onError:r=>{t.error("Failed to delete deployment",r),d.error(n("deployment.FailedToDeleteDeployment"))}})},e[137]=Je,e[138]=o,e[139]=t,e[140]=d,e[141]=n,e[142]=D,e[143]=ke):ke=e[143];let Oe;e[144]===Symbol.for("react.memo_cache_sentinel")?(Oe=()=>M(null),e[144]=Oe):Oe=e[144];let Fe;e[145]!==el||e[146]!==me||e[147]!==ge||e[148]!==pe||e[149]!==ll||e[150]!==ye||e[151]!==fe||e[152]!==ke?(Fe=a.jsx(Wl,{open:el,title:me,target:ge,items:pe,confirmText:ll,requireConfirmInput:!0,inputProps:ye,okButtonProps:fe,onOk:ke,onCancel:Oe}),e[145]=el,e[146]=me,e[147]=ge,e[148]=pe,e[149]=ll,e[150]=ye,e[151]=fe,e[152]=ke,e[153]=Fe):Fe=e[153];const al=!!I;let Ee;e[154]===Symbol.for("react.memo_cache_sentinel")?(Ee=()=>R(null),e[154]=Ee):Ee=e[154];let Se;e[155]!==I||e[156]!==al?(Se=a.jsx(yl,{children:a.jsx(Jl,{open:al,revisionFrgmt:I,onClose:Ee})}),e[155]=I,e[156]=al,e[157]=Se):Se=e[157];let Ue;return e[158]!==de||e[159]!==ce||e[160]!==Fe||e[161]!==Se?(Ue=a.jsxs(a.Fragment,{children:[de,ce,Fe,Se]}),e[158]=de,e[159]=ce,e[160]=Fe,e[161]=Se,e[162]=Ue):Ue=e[162],Ue},gn=()=>{"use memo";const l=fl.c(15),{t:e}=kl(),[k,h]=Dl(!1),{setLeft:n,setRight:d}=h;bl(d);let t;l[0]!==e?(t=e("webui.menu.Deployments"),l[0]=e,l[1]=t):t=l[1];let i;l[2]!==e?(i=e("deployment.CreateDeployment"),l[2]=e,l[3]=i):i=l[3];let c;l[4]!==d||l[5]!==i?(c=a.jsx(hl,{variant:"primary",label:i,onClick:d}),l[4]=d,l[5]=i,l[6]=c):c=l[6];let m;l[7]===Symbol.for("react.memo_cache_sentinel")?(m=a.jsx(Cl,{}),l[7]=m):m=l[7];let g;l[8]!==n||l[9]!==k?(g=a.jsx(ve.Suspense,{fallback:m,children:a.jsx(nn,{isCreating:k,onCloseCreate:n})}),l[8]=n,l[9]=k,l[10]=g):g=l[10];let p;return l[11]!==t||l[12]!==c||l[13]!==g?(p=a.jsx(he,{direction:"column",align:"stretch",gap:"md",children:a.jsx(Ll,{variant:"borderless",title:t,extra:c,children:g})}),l[11]=t,l[12]=c,l[13]=g,l[14]=p):p=l[14],p};function an(l){return typeof l=="object"&&l!==null&&!Array.isArray(l)?l:{}}export{gn as default};
//# sourceMappingURL=DeploymentListPage-D6-lnDQ8.js.map
