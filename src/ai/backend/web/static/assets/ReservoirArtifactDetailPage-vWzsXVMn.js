...
`}}})();Qe.hash="b59c2a54c55db7b77c2f8e36c51e81a8";const Je={argumentDefinitions:[],kind:"Fragment",metadata:null,name:"ImportArtifactRevisionToFolderModalModelStoreProjectsFragment",selections:[{alias:null,args:null,kind:"ScalarField",name:"id",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"name",storageKey:null}],type:"Group",abstractKey:null};Je.hash="55dc19bd0c05c3aaf314215595f0c8a0";const We={argumentDefinitions:[],kind:"Fragment",metadata:{plural:!0},name:"ImportArtifactRevisionToFolderModalArtifactRevisionFragment",selections:[{kind:"RequiredField",field:{alias:null,args:null,kind:"ScalarField",name:"id",storageKey:null},action:"THROW"}],type:"ArtifactRevision",abstractKey:null};We.hash="911b8e7ffb3a0042ecb970a90018b1e8";const Cn=l=>{"use memo";const e=tn.c(74);let s,R,c,r;e[0]!==l?({selectedArtifactRevisionFrgmt:r,modelStoreProjectsFrgmt:R,onOk:c,...s}=l,e[0]=l,e[1]=s,e[2]=R,e[3]=c,e[4]=r):(s=e[1],R=e[2],c=e[3],r=e[4]);const{t:i}=Ee(),{token:h}=re.useToken(),{message:p}=Ke.useApp(),o=E.useRef(null),v=E.useRef(null),[k,C]=an(!1),{toggle:d}=C,{logger:I}=ln(),S=rn(),P=sn();let B;e[5]===Symbol.for("react.memo_cache_sentinel")?(B=We,e[5]=B):B=e[5];const b=D.useFragment(B,r);let V;e[6]===Symbol.for("react.memo_cache_sentinel")?(V=Je,e[6]=V):V=e[6];const F=D.useFragment(V,R);let M;e[7]===Symbol.for("react.memo_cache_sentinel")?(M=Qe,e[7]=M):M=e[7];const[x,t]=D.useMutation(M);let K;e[8]!==b?(K=ae(b,En),e[8]=b,e[9]=K):K=e[9];const T=K;let N;e[10]!==i?(N=i("importArtifactRevisionToFolderModal.ImportToFolder"),e[10]=i,e[11]=N):N=e[11];let Q;e[12]!==i?(Q=i("importArtifactRevisionToFolderModal.Import"),e[12]=i,e[13]=Q):Q=e[13];let _;e[14]!==t||e[15]!==b?(_=t||ne(b),e[14]=t,e[15]=b,e[16]=_):_=e[16];let O;e[17]!==t||e[18]!==_?(O={loading:t,disabled:_},e[17]=t,e[18]=_,e[19]=O):O=e[19];let w;e[20]!==x||e[21]!==I||e[22]!==p||e[23]!==c||e[24]!==T||e[25]!==b||e[26]!==i?(w=oe=>{var ie;(ie=o.current)==null||ie.validateFields().then(W=>{if(ne(b)){p.error(i("importArtifactRevisionToFolderModal.NoArtifactsSelected"));return}x({variables:{input:{artifactRevisionIds:ae(T,Vn),vfolderId:W.vfolderId?te(W.vfolderId):null,options:{force:!0}}},onCompleted:(ue,me)=>{var ke;if(me&&me.length>0){me.forEach(fe=>p.error(fe.message??i("importArtifactRevisionToFolderModal.FailedToImport")));return}const ge=ue.importArtifacts;if(!ge){p.error(i("importArtifactRevisionToFolderModal.FailedToImport"));return}if(((ke=ge.artifactRevisions)==null?void 0:ke.count)>0){p.success(i("importArtifactRevisionToFolderModal.SuccessfullyImported"));const fe=ge.tasks.filter(Nn).map(_n);c==null||c(oe,fe,W.vfolderId)}else p.error(i("importArtifactRevisionToFolderModal.FailedToImport"))},onError:ue=>{p.error(ue.message??i("importArtifactRevisionToFolderModal.FailedToImport"))}})}).catch(W=>{I.error("ImportArtifactRevisionToFolderModal: Form validation failed",{error:W})})},e[20]=x,e[21]=I,e[22]=p,e[23]=c,e[24]=T,e[25]=b,e[26]=i,e[27]=w):w=e[27];let H;e[28]===Symbol.for("react.memo_cache_sentinel")?(H=["onChange","onBlur"],e[28]=H):H=e[28];let $;e[29]!==i?($=i("importArtifactRevisionToFolderModal.OverwriteWarning"),e[29]=i,e[30]=$):$=e[30];let U;e[31]!==h.marginMD?(U={marginBottom:h.marginMD},e[31]=h.marginMD,e[32]=U):U=e[32];let z;e[33]!==$||e[34]!==U?(z=n.jsx(Ie,{type:"warning",title:$,showIcon:!0,style:U}),e[33]=$,e[34]=U,e[35]=z):z=e[35];let G;e[36]!==i?(G=i("importArtifactRevisionToFolderModal.FolderMountForModelStore"),e[36]=i,e[37]=G):G=e[37];let X;e[38]===Symbol.for("react.memo_cache_sentinel")?(X=[{required:!0}],e[38]=X):X=e[38];const a=F!=null&&F.id?`group == "${F.id}"`:null;let m;e[39]!==a?(m=on(['ownership_type == "group"',a]),e[39]=a,e[40]=m):m=e[40];let g;e[41]!==m?(g=n.jsx(pe.Item,{name:"vfolderId",noStyle:!0,children:n.jsx(bn,{ref:v,excludeDeleted:!0,filter:m})}),e[41]=m,e[42]=g):g=e[42];let f;e[43]!==S.id||e[44]!==p||e[45]!==F||e[46]!==P||e[47]!==i||e[48]!==d?(f=S.id===(F==null?void 0:F.id)?n.jsx(de,{icon:n.jsx(Te,{}),onClick:()=>{d()}}):n.jsx(cn,{title:i("importArtifactRevisionToFolderModal.ModelStoreProjectRequired"),description:i("importArtifactRevisionToFolderModal.ModelStoreProjectRequiredDescription"),okText:i("button.ChangeProject"),cancelText:i("button.Cancel"),onConfirm:()=>{F&&F.id&&F.name?E.startTransition(()=>{P({projectId:F.id,projectName:F.name}),p.success(i("importArtifactRevisionToFolderModal.CurrentProjectChangedSuccessfully")),d()}):p.error(i("importArtifactRevisionToFolderModal.FailedToRetrieveModelStoreProject"))},children:n.jsx(de,{icon:n.jsx(Te,{})})}),e[43]=S.id,e[44]=p,e[45]=F,e[46]=P,e[47]=i,e[48]=d,e[49]=f):f=e[49];let A;e[50]!==g||e[51]!==f?(A=n.jsxs(j,{gap:"xs",align:"center",children:[g,f]}),e[50]=g,e[51]=f,e[52]=A):A=e[52];let y;e[53]!==G||e[54]!==A?(y=n.jsx(pe.Item,{label:G,name:"vfolderId",rules:X,children:A}),e[53]=G,e[54]=A,e[55]=y):y=e[55];let u;e[56]!==z||e[57]!==y?(u=n.jsx(pe,{ref:o,layout:"vertical",preserve:!1,validateTrigger:H,children:n.jsxs(j,{direction:"column",align:"stretch",children:[z,y]})}),e[56]=z,e[57]=y,e[58]=u):u=e[58];let q;e[59]!==s||e[60]!==w||e[61]!==u||e[62]!==N||e[63]!==Q||e[64]!==O?(q=n.jsx(dn,{title:N,okText:Q,centered:!0,destroyOnHidden:!0,...s,okButtonProps:O,onOk:w,children:u}),e[59]=s,e[60]=w,e[61]=u,e[62]=N,e[63]=Q,e[64]=O,e[65]=q):q=e[65];let J;e[66]!==d?(J=oe=>{var ie,W;d(),oe&&((ie=o.current)==null||ie.setFieldsValue({vfolderId:un("VirtualFolderNode",mn(oe.id))}),(W=v.current)==null||W.refetch())},e[66]=d,e[67]=J):J=e[67];let ee;e[68]!==k||e[69]!==J?(ee=n.jsx(gn,{open:k,initialValidate:!0,folderType:"model_project",onRequestClose:J}),e[68]=k,e[69]=J,e[70]=ee):ee=e[70];let se;return e[71]!==q||e[72]!==ee?(se=n.jsxs(n.Fragment,{children:[q,ee]}),e[71]=q,e[72]=ee,e[73]=se):se=e[73],se};function En(l){return l.id}function Vn(l){return te(l)}function Nn(l){return l.taskId!=null}function _n(l){const e=l.artifactRevision.artifact;return{taskId:l.taskId,version:l.artifactRevision.version,artifact:{id:te(e.id??""),name:e.name??""}}}le.extend(Me);const{Title:On,Text:wn,Paragraph:$n}=ye,Jn=()=>{var _,O,w,H,$,U,z,G,X;const{token:l}=re.useToken(),{t:e}=Ee(),{upsertNotification:s}=fn(),{artifactId:R}=pn(),[c,r]=An(Ae),[i,h]=E.useState([]),[p,o]=E.useState([]),[v,k]=E.useState([]),[C,d]=E.useState([]),[I,S]=vn({filter:yn(a=>a).withDefault({})},{history:"replace"}),P=JSON.stringify(I.filter),{baiPaginationOption:B,tablePaginationOption:b,setTablePaginationOption:V}=Fn({current:1,pageSize:10}),F=E.useMemo(()=>({id:R??"",offset:B.offset,limit:B.limit,filter:JSON.parse(P||"{}")}),[R,B.limit,B.offset,P]),M=E.useDeferredValue(F),x=E.useDeferredValue(c),{artifact:t,groups:K}=D.useLazyLoadQuery(Ge,M,{fetchKey:x===Ae?void 0:x,fetchPolicy:x===Ae?"store-and-network":"network-only"}),T=(O=(_=t==null?void 0:t.latestVersion)==null?void 0:_.edges[0])==null?void 0:O.node,N=ve((w=t==null?void 0:t.pullingArtifactRevisions)==null?void 0:w.edges.map(a=>a==null?void 0:a.node)),Q={key:"control",title:e("general.Control"),fixed:!0,required:!0,render:(a,m)=>{var f;const g=m.status;return n.jsxs(j,{gap:"xs",children:[n.jsx(Z,{title:e("reservoirPage.PullThisVersion"),children:n.jsx(Be,{size:"small",revisionsFrgmt:[m],loading:g==="PULLING"||g==="VERIFYING",onClick:()=>{var A,y;(y=(A=t==null?void 0:t.revisions)==null?void 0:A.edges)==null||y.forEach(u=>{u.node.id===m.id&&k([u.node])})}})}),n.jsx(Z,{title:e("importArtifactRevisionToFolderModal.ImportToFolder"),children:n.jsx(De,{size:"small",revisionsFrgmt:ae(hn((f=t==null?void 0:t.revisions)==null?void 0:f.edges,A=>A.node.id===m.id),"node"),onClick:()=>{var A,y;(y=(A=t==null?void 0:t.revisions)==null?void 0:A.edges)==null||y.forEach(u=>{u.node.id===m.id&&d([u.node])})}})}),n.jsx(Z,{title:e("reservoirPage.RemoveThisVersion"),children:n.jsx(xe,{size:"small",title:e("reservoirPage.RemoveThisVersion"),revisionsFrgmt:[m],onClick:()=>{var A,y;(y=(A=t==null?void 0:t.revisions)==null?void 0:A.edges)==null||y.forEach(u=>{u.node.id===m.id&&o([u.node])})}})})]})}};return n.jsxs("div",{children:[n.jsxs(j,{align:"center",style:{marginBottom:l.marginLG},justify:"between",children:[n.jsxs(j,{align:"center",gap:"xs",children:[n.jsx(On,{level:3,style:{margin:0},children:t==null?void 0:t.name}),t&&n.jsx(be,{artifactTypeFrgmt:t})]}),n.jsx(Rn,{settingId:"reservoir-artifact-detail",value:c,loading:x!==c,onChange:()=>{r()}})]}),N.length>0&&n.jsx(j,{direction:"column",gap:"sm",align:"stretch",style:{marginBottom:l.marginMD},children:N.map(a=>n.jsx(Kn,{pullingArtifactRevisionFrgmt:a,onOk:()=>{r()}},a.id))}),n.jsx(he,{title:e("reservoirPage.BasicInformation"),showDivider:!0,extra:n.jsx(Le,{type:"primary",icon:n.jsx(In,{size:16}),onClick:()=>{T&&k([T])},disabled:!T||T.status!=="SCANNED",children:T?e("reservoirPage.PullLatestVersion",{version:T.version}):"N/A"}),style:{marginBottom:l.marginMD},children:n.jsxs(Y,{column:2,bordered:!0,children:[n.jsx(Y.Item,{label:e("reservoirPage.Name"),children:t==null?void 0:t.name}),n.jsx(Y.Item,{label:e("reservoirPage.Type"),children:t&&n.jsx(be,{artifactTypeFrgmt:t})}),n.jsx(Y.Item,{label:e("reservoirPage.Size"),children:n.jsx(L,{monospace:!0,children:T!=null&&T.size?(H=Re(T.size,"auto"))==null?void 0:H.displayValue:"N/A"})}),n.jsx(Y.Item,{label:e("reservoirPage.Source"),children:t!=null&&t.source?n.jsx(ye.Link,{href:t.source.url??"",target:"_blank",rel:"noopener noreferrer",children:t.source.name||"N/A"}):"N/A"}),n.jsx(Y.Item,{label:e("reservoirPage.Registry"),children:n.jsx(ye,{children:t!=null&&t.registry?`${t.registry.name} (${t.registry.url})`:"N/A"})}),n.jsx(Y.Item,{label:e("reservoirPage.LastUpdated"),span:2,children:t!=null&&t.updatedAt?le(t==null?void 0:t.updatedAt).format("lll"):"N/A"}),n.jsx(Y.Item,{label:e("reservoirPage.Description"),span:2,children:t!=null&&t.description?n.jsx($n,{children:t.description}):"N/A"})]})}),n.jsx(he,{title:e("reservoirPage.VersionList"),showDivider:!0,style:{marginBottom:l.marginMD},styles:{body:{padding:`${l.paddingSM}px ${l.paddingLG}px ${l.paddingLG}px ${l.paddingLG}px`}},children:n.jsxs(j,{direction:"column",gap:"sm",align:"stretch",children:[n.jsxs(j,{align:"stretch",justify:"between",children:[n.jsx(jn,{combinationMode:"AND",onChange:a=>{S({filter:a??{}})},filterProperties:[{fixedOperator:"equals",propertyLabel:e("reservoirPage.Status"),key:"status",type:"enum",options:ae(["SCANNED","PULLING","PULLED","VERIFYING","NEEDS_APPROVAL","FAILED","AVAILABLE","REJECTED"],a=>({label:a,value:a}))},{fixedOperator:"contains",propertyLabel:e("reservoirPage.Version"),key:"version",type:"string"},{propertyLabel:e("reservoirPage.Size"),key:"size",type:"number",operators:["equals","greaterThan","greaterOrEqual","lessThan","lessOrEqual"]}]}),i.length>0?n.jsxs(j,{gap:"xs",children:[n.jsxs(wn,{children:[i.length," selected"]}),n.jsx(Z,{title:e("reservoirPage.PullSelectedVersions"),children:n.jsx(Be,{type:"default",revisionsFrgmt:i.flatMap(a=>a.data),onClick:()=>{t&&k(i.flatMap(a=>a.data))}})}),n.jsx(Z,{title:e("importArtifactRevisionToFolderModal.ImportToFolder"),children:n.jsx(De,{type:"default",revisionsFrgmt:i.flatMap(a=>a.data),onClick:()=>{t&&d(kn(i,a=>a.data))}})}),n.jsx(Z,{title:e("reservoirPage.RemoveSelectedVersions"),children:n.jsx(xe,{style:{borderColor:l.colorBorder},revisionsFrgmt:i.flatMap(a=>a.data),onClick:()=>{t&&o(i.flatMap(a=>a.data))}})})]}):null]}),n.jsx(Mn,{artifactRevisionFrgmt:ve((U=($=t==null?void 0:t.revisions)==null?void 0:$.edges)==null?void 0:U.map(a=>a.node)),latestRevisionFrgmt:(G=(z=t==null?void 0:t.latestVersion)==null?void 0:z.edges[0])==null?void 0:G.node,loading:M!==F,pagination:{current:b.current,pageSize:b.pageSize,total:((X=t==null?void 0:t.revisions)==null?void 0:X.count)??0,onChange:(a,m)=>{Se(a)&&Se(m)&&V({current:a,pageSize:m})}},onRow:a=>({onClick:m=>{var A,y;m.stopPropagation();const g=m.target;if(g.closest("button")||g.closest("a")||!t)return;const f=(y=(A=t.revisions)==null?void 0:A.edges.find(u=>u.node.id===a.id))==null?void 0:y.node;f&&h(u=>{const q=u.filter(J=>J.id!==a.id);return q.length===u.length?[...u,{id:a.id,data:f}]:q})}}),rowSelection:{type:"checkbox",onChange:a=>{if(!(t!=null&&t.revisions))return;const m=t.revisions,g=m.edges.map(f=>f.node.id);h(f=>{const A=f.filter(u=>!g.includes(u.id)),y=m.edges.filter(u=>a.includes(u.node.id)).map(u=>({id:u.node.id,data:u.node}));return A.concat(y)})},selectedRowKeys:i.map(a=>a.id)},customizeColumns:a=>[a[0],a[1],Q,...a.slice(2)]})]})}),n.jsx(Pn,{selectedArtifactFrgmt:t??null,selectedArtifactRevisionFrgmt:v,open:!!t&&!ne(v),connectionIds:t!=null&&t.pullingArtifactRevisions?[t.pullingArtifactRevisions.__id]:void 0,onOk:(a,m)=>{k([]),m.forEach(g=>{s({message:e("reservoirPage.PullingArtifact",{name:g.artifact.name,version:g.version}),type:"info",open:!0,duration:0,backgroundTask:{status:"pending",taskId:g.taskId,promise:null,percent:0,onChange:{resolved:(f,A)=>({type:"success",message:e("reservoirPage.SuccessFullyPulledArtifact",{name:g.artifact.name,version:g.version}),showIcon:!0,toText:e("reservoirPage.GoToArtifact"),to:Tn("admin",`reservoir/${g.artifact.id}`)}),rejected:(f,A)=>e("reservoirPage.FailedToPullArtifact",{name:g.artifact.name,version:g.version})}}})})},onCancel:()=>{k([])}}),n.jsx(Ln,{selectedArtifactFrgmt:t??null,selectedArtifactRevisionFrgmt:p,onOk:()=>{o([])},onCancel:()=>{o([])},open:!!t&&!ne(p)}),n.jsx(Cn,{selectedArtifactRevisionFrgmt:C,modelStoreProjectsFrgmt:(K==null?void 0:K[0])??void 0,onOk:(a,m,g)=>{d([]),r(),m.forEach(f=>{s({message:e("importArtifactRevisionToFolderModal.ImportingArtifact",{name:f.artifact.name,version:f.version}),type:"info",open:!0,duration:0,backgroundTask:{status:"pending",taskId:f.taskId,promise:null,percent:0,onChange:{resolved:(A,y)=>({type:"success",message:e("importArtifactRevisionToFolderModal.SuccessfullyImportedArtifact",{name:f.artifact.name,version:f.version}),showIcon:!0,toText:e(g?"data.folders.OpenAFolder":"reservoirPage.GoToArtifact"),to:g?{search:new URLSearchParams({folder:te(g)}).toString()}:`/reservoir/${f.artifact.id}`}),rejected:(A,y)=>e("importArtifactRevisionToFolderModal.FailedToImportArtifact",{name:f.artifact.name,version:f.version})}}})})},onCancel:()=>{d([])},open:!!t&&!ne(C)})]})};export{Jn as default};
//# sourceMappingURL=ReservoirArtifactDetailPage-vWzsXVMn.js.map
