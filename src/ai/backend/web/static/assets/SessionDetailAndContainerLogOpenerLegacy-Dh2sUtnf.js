...
`}}})();c.hash="5e3c1a9c71ef2548c32579df194e26ee";const f=({sessionId:n,open:s,loading:a,onRequestClose:e})=>{const{compute_session_node:o}=p.useLazyLoadQuery(c,{sessionId:n},{fetchPolicy:n?"network-only":"store-only"});return l.jsx(u,{children:l.jsx(y,{sessionFrgmt:o||null,open:s,loading:a,onCancel:()=>{e&&e()}})})},E=()=>{const[n,s]=L("sessionDetail",k.withOptions({history:"replace"})),[a,e]=r.useState(),[o,t]=r.useTransition(),i=S();r.useEffect(()=>{const d=g=>{t(()=>{e(g.detail)})};return document.addEventListener("bai-open-session-log",d),()=>{document.removeEventListener("bai-open-session-log",d)}},[t,e]);const m=i==null?void 0:i.supports("session-node");return l.jsxs(l.Fragment,{children:[m?l.jsx(u,{children:l.jsx(_,{open:!!n,sessionId:n||void 0,onClose:()=>{s(null)}})}):null,l.jsx(f,{open:!!a||o,loading:o,sessionId:a,onRequestClose:()=>{e(void 0)}})]})};export{E as default};
//# sourceMappingURL=SessionDetailAndContainerLogOpenerLegacy-Dh2sUtnf.js.map
