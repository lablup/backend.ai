...
def main(
    ...
    setproctitle("backend.ai: web.cli")
    if debug:
        log_level = "DEBUG"
...
@main.group(cls=LazyGroup, import_name="ai.backend.web.cli.dependencies:cli")
def dependencies() -> None:
    """Command set for dependency verification and validation."""


@main.group(cls=LazyGroup, import_name="ai.backend.web.cli.health:cli")
def health() -> None:
