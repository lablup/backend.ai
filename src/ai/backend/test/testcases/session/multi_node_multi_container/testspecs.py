...
BATCH_SESSION_TEST_SPECS = {
    "multi_node_multi_container_creation_batch_session_success": TestSpec(
        name="multi_node_multi_container_creation_batch_session_success",
...
INTERACTIVE_SESSION_TEST_SPECS = {
    "multi_node_multi_container_creation_interactive_session_success": TestSpec(
        name="multi_node_multi_container_creation_interactive_session_success",
        description=textwrap.dedent("""\
    ...
    "multi_node_multi_container_creation_interactive_session_success_with_bootstrap_script": TestSpec(
        name="multi_node_multi_container_creation_interactive_session_success_with_bootstrap_script",
        description=textwrap.dedent("""\
            Test for creating a multi-node, multi-container session.
            This test verifies that a session can be created with multiple nodes and multiple containers, and that it transitions through the expected lifecycle events.
            The test will:
    ...
    "multi_node_multi_container_execution_command_on_interactive_session_success": TestSpec(
        name="multi_node_multi_container_execution_command_on_interactive_session_success",
        description=textwrap.dedent("""\
    ...
    "multi_node_multi_container_execution_command_on_interactive_session_failure_wrong_command": TestSpec(
        name="multi_node_multi_container_execution_command_on_interactive_session_failure_wrong_command",
        description=textwrap.dedent("""\
            Test for executing code in an interactive session.
            This test verifies that code can be executed in an interactive session, and that the session transitions through the expected lifecycle events.
            The test will:
    ...
    "multi_node_multi_container_execution_command_on_interactive_session_failure_with_custom_exitcode": TestSpec(
        name="multi_node_multi_container_execution_command_on_interactive_session_failure_with_custom_exitcode",
        description=textwrap.dedent("""\
            Test for executing code in an interactive session.
            This test verifies that code can be executed in an interactive session, and that the session transitions through the expected lifecycle events.
            The test will:
    ...
    "multi_node_multi_container_imagify_interactive_session_success": TestSpec(
        name="multi_node_multi_container_imagify_interactive_session_success",
        description=textwrap.dedent("""\
    ...
    "multi_node_multi_container_commit_interactive_session_success": TestSpec(
        name="multi_node_multi_container_commit_interactive_session_success",
        description=textwrap.dedent("""\
...
SESSION_TEMPLATE_TEST_SPECS = {
    "multi_node_multi_container_creation_interactive_session_success_from_template": TestSpec(
        name="multi_node_multi_container_creation_interactive_session_success_from_template",
        description=textwrap.dedent("""\
    ...
    "multi_node_multi_container_creation_batch_session_success_from_template": TestSpec(
        name="multi_node_multi_container_creation_batch_session_success_from_template",
        description=textwrap.dedent("""\
...
SESSION_INFO_RETRIEVER_TEST_SPECS = {
    "multi_node_multi_container_session_container_log_retriever": TestSpec(
        name="multi_node_multi_container_session_container_log_retriever",
        description=textwrap.dedent("""\
    ...
    "multi_node_multi_container_session_dependency_graph_retriever": TestSpec(
        name="multi_node_multi_container_session_dependency_graph_retriever",
        description=textwrap.dedent("""
    ...
    "multi_node_multi_container_session_status_history": TestSpec(
        name="multi_node_multi_container_session_status_history",
        description=textwrap.dedent("""
...
SESSION_RENAME_TEST_SPECS = {
    "multi_node_multi_container_session_rename_success": TestSpec(
        name="multi_node_multi_container_session_rename_success",
        description=textwrap.dedent("""\
    ...
    "multi_node_multi_container_session_rename_fail_duplicated_name": TestSpec(
        name="multi_node_multi_container_session_rename_fail_duplicated_name",
        description=textwrap.dedent("""\
...
SESSION_VFOLDER_TEST_SPECS = {
    "multi_node_multi_container_session_with_vfolder_mount_works_successfully": TestSpec(
        name="multi_node_multi_container_session_with_vfolder_mount_works_successfully",
        description=textwrap.dedent("""
