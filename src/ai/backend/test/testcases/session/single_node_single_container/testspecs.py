...
BATCH_SESSION_TEST_SPECS = {
    "single_node_single_container_creation_batch_session_success": TestSpec(
        name="single_node_single_container_creation_batch_session_success",
...
INTERACTIVE_SESSION_TEST_SPECS = {
    "single_node_single_container_creation_interactive_session_success": TestSpec(
        name="single_node_single_container_creation_interactive_session_success",
        description=textwrap.dedent("""\
    ...
    "single_node_single_container_creation_interactive_session_success_with_bootstrap_script": TestSpec(
        name="single_node_single_container_creation_interactive_session_success_with_bootstrap_script",
        description=textwrap.dedent("""\
            Test for creating a single-node, single-container session.
            This test verifies that a session can be created with a single node and a single container, and that it transitions through the expected lifecycle events.
            The test will:
    ...
    "single_node_single_container_execution_command_on_interactive_session_success": TestSpec(
        name="single_node_single_container_execution_command_on_interactive_session_success",
        description=textwrap.dedent("""\
    ...
    "single_node_single_container_execution_command_on_interactive_session_failure_wrong_command": TestSpec(
        name="single_node_single_container_execution_command_on_interactive_session_failure_wrong_command",
        description=textwrap.dedent("""\
            Test for executing code in an interactive session.
            This test verifies that code can be executed in an interactive session, and that the session transitions through the expected lifecycle events.
            The test will:
    ...
    "single_node_single_container_execution_command_on_interactive_session_failure_with_custom_exitcode": TestSpec(
        name="single_node_single_container_execution_command_on_interactive_session_failure_with_custom_exitcode",
        description=textwrap.dedent("""\
            Test for executing code in an interactive session.
            This test verifies that code can be executed in an interactive session, and that the session transitions through the expected lifecycle events.
            The test will:
    ...
    "single_node_single_container_imagify_interactive_session_success": TestSpec(
        name="single_node_single_container_imagify_interactive_session_success",
        description=textwrap.dedent("""\
    ...
    "single_node_single_container_commit_interactive_session_success": TestSpec(
...
SESSION_INFO_RETRIEVER_TEST_SPECS = {
    ...
    "single_node_single_container_session_dependency_graph_retriever": TestSpec(
        ...
        """),
        tags={TestTag.SESSION, TestTag.MANAGER, TestTag.SINGLE_NODE_SINGLE_CONTAINER},
...
SESSION_VFOLDER_TEST_SPECS = {
    "single_node_single_container_session_with_vfolder_mount_works_successfully": TestSpec(
        ...
        """),
        tags={TestTag.SESSION, TestTag.VFOLDER, TestTag.SINGLE_NODE_SINGLE_CONTAINER},
    ...
    "single_node_single_container_session_with_vfolder_uuid_in_mounts_list_success": TestSpec(
        name="single_node_single_container_session_with_vfolder_uuid_in_mounts_list_success",
        description=textwrap.dedent("""
    ...
    "single_node_single_container_session_with_vfolder_name_in_mounts_list_success": TestSpec(
        name="single_node_single_container_session_with_vfolder_name_in_mounts_list_success",
        description=textwrap.dedent("""
