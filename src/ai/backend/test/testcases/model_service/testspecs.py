...
SINGLE_NODE_SINGLE_CONTAINER_MODEL_SERVICE_TEST_SPECS = {
    ...
    "single_node_single_container_scale_by_cpu_util_auto_scaling_rule_success": TestSpec(
        name="single_node_single_container_scale_by_cpu_util_auto_scaling_rule_success",
        description=textwrap.dedent("""\
...
SINGLE_NODE_MULTI_CONTAINER_MODEL_SERVICE_TEST_SPECS = {
    ...
    "single_node_multi_container_scale_by_cpu_util_auto_scaling_rule_success": TestSpec(
        name="single_node_multi_container_scale_by_cpu_util_auto_scaling_rule_success",
        description=textwrap.dedent("""\
            Test for successful scaling of a service by auto-scaling rule based on CPU utilization.
            This test verifies that a service can be scaled successfully using an auto-scaling rule.
            The test will:
...
MULTI_NODE_MULTI_CONTAINER_MODEL_SERVICE_TEST_SPECS = {
    ...
    "multi_node_multi_container_scale_by_cpu_util_auto_scaling_rule_success": TestSpec(
        name="multi_node_multi_container_scale_by_cpu_util_auto_scaling_rule_success",
        description=textwrap.dedent("""\
            Test for successful scaling of a service by auto-scaling rule based on CPU utilization.
            This test verifies that a service can be scaled successfully using an auto-scaling rule.
            The test will:
