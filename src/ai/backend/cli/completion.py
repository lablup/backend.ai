    ...
    def completion(shell: str | None, show: bool) -> None:
        ...
        if show:
            ...
            if shell == "bash":
                ...
                fish_config_dir = Path("~/.config/fish/completions").expanduser()
                fish_config_dir.mkdir(parents=True, exist_ok=True)
                completion_file = fish_config_dir / f"{prog_name}.fish"
                ...
                if result.returncode == 0 and result.stdout:
                    ...
                    rc_file = Path("~/.config/fish/config.fish").expanduser()
            ...
            if rc_file.exists():
                ...
                rc_file.write_text(f"# Backend.AI completion\n{completion_line}\n")
