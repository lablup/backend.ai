        ...
        for route in app.router.routes():
            ...
            for param in sig.parameters.values():
                ...
                if param_origin is BodyParam and "requestBody" not in route_def:
                    body_model = get_args(param.annotation)[0]
                ...
                if param_origin is QueryParam:
                    query_model = get_args(param.annotation)[0]
            ...
            if ret_type := original_type_hints.get("return"):
                ...
                if ret_type_origin is APIResponse:
                    ...
                    # Skip if response model is None or Any
                    if response_model is not type(None) and response_model is not Any:
