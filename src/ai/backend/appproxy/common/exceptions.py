...
class WorkerRegistrationError(BackendError):
    error_title: str = "E20013: Failed to register worker"


class CoordinatorConnectionError(BackendError):
    error_title: str = "E20014: Failed to communicate with coordinator"
