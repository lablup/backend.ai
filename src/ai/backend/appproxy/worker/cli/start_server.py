...
def main(
    ...
    prometheus_base_dir = _read_prometheus_dir_from_config(config_path, "app-proxy-worker")
    setup_prometheus_multiprocess_dir("appproxy-worker", base_dir=prometheus_base_dir)
