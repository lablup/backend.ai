...
@deployments.command(name="admin-search")
...
@deployments.command(name="admin-revisions-search")
@click.option(
    "--deployment-id",
    type=str,
    default=None,
...
@deployments.command(name="admin-replicas-search")
@click.option(
    "--deployment-id",
    type=str,
    default=None,
...
@deployments.command(name="admin-policies-search")
@click.option(
    "--deployment-id",
    type=str,
    default=None,
