...
def add(
    ...
    *,
    ...
    max_vfolder_count: int | Undefined = undefined,  # deprecated
    max_vfolder_size: int | Undefined = undefined,  # deprecated
) -> None:
    """
    ...
    """
    if max_vfolder_count is not undefined:
        warnings.warn("KeyPairResourcePolicy.max_vfolder_count is deprecated.", DeprecationWarning)
    if max_vfolder_size is not undefined:
        warnings.warn("KeyPairResourcePolicy.max_vfolder_count is deprecated.", DeprecationWarning)
    with Session() as session:
        try:
