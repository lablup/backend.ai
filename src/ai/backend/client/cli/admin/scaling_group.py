...
@pass_ctx_obj
@click.argument("name", type=str, metavar="NAME")
def delete(ctx: CLIContext, name) -> None:
    """
...
def associate_scaling_group(ctx: CLIContext, scaling_group, domain) -> None:
    """
...
@click.argument("scaling_group", type=str, metavar="SCALING_GROUP")
@click.argument("domain", type=str, metavar="DOMAIN")
def dissociate_scaling_group(ctx: CLIContext, scaling_group, domain) -> None:
    """
