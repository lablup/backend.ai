...
def add_RaftServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("RaftService", rpc_method_handlers)
...
class CommandServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Command = channel.unary_unary(
            ...
            response_deserializer=raft__pb2.CommandResponse.FromString,
        )
...
def add_CommandServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "Command": grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=raft__pb2.CommandResponse.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler("CommandService", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class CommandService(object):
    ...
    def Command(
        ...
        return grpc.experimental.unary_unary(
            ...
            raft__pb2.CommandResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
