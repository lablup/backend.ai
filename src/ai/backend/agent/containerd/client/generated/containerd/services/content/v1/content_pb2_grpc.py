...
class ContentStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListStatuses = channel.unary_unary('/containerd.services.content.v1.Content/ListStatuses', request_serializer=containerd_dot_services_dot_content_dot_v1_dot_content__pb2.ListStatusesRequest.SerializeToString, response_deserializer=containerd_dot_services_dot_content_dot_v1_dot_content__pb2.ListStatusesResponse.FromString, _registered_method=True)
        self.Write = channel.stream_stream('/containerd.services.content.v1.Content/Write', request_serializer=containerd_dot_services_dot_content_dot_v1_dot_content__pb2.WriteContentRequest.SerializeToString, response_deserializer=containerd_dot_services_dot_content_dot_v1_dot_content__pb2.WriteContentResponse.FromString, _registered_method=True)
        self.Abort = channel.unary_unary('/containerd.services.content.v1.Content/Abort', request_serializer=containerd_dot_services_dot_content_dot_v1_dot_content__pb2.AbortRequest.SerializeToString, response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString, _registered_method=True)
...
class Content(object):
    ...
    def Delete(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/containerd.services.content.v1.Content/Delete', containerd_dot_services_dot_content_dot_v1_dot_content__pb2.DeleteContentRequest.SerializeToString, google_dot_protobuf_dot_empty__pb2.Empty.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)
    ...
    def Read(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_stream(request, target, '/containerd.services.content.v1.Content/Read', containerd_dot_services_dot_content_dot_v1_dot_content__pb2.ReadContentRequest.SerializeToString, containerd_dot_services_dot_content_dot_v1_dot_content__pb2.ReadContentResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)
    ...
    @staticmethod
    def ListStatuses(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/containerd.services.content.v1.Content/ListStatuses', containerd_dot_services_dot_content_dot_v1_dot_content__pb2.ListStatusesRequest.SerializeToString, containerd_dot_services_dot_content_dot_v1_dot_content__pb2.ListStatusesResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)

    @staticmethod
    def Write(request_iterator, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/containerd.services.content.v1.Content/Write', containerd_dot_services_dot_content_dot_v1_dot_content__pb2.WriteContentRequest.SerializeToString, containerd_dot_services_dot_content_dot_v1_dot_content__pb2.WriteContentResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)
