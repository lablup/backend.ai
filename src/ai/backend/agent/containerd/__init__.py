...
from .agent import ContainerdAgent, create_runtime
...
class ContainerdAgentDiscovery(AbstractAgentDiscovery):
    ...
    def create_container_locator(self, local_config: AgentUnifiedConfig) -> ContainerLocator:
        # The privnet asks its three questions of the same runtime client this agent drives.
        return OciRuntimeLocator(self.create_oci_runtime(local_config))
