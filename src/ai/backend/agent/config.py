            ...
            t.Key("agent"): t.Dict(
                {
                    ...
                    t.Key("rpc-auth-manager-public-key", default=None): t.Null
                    | tx.Path(type="file"),
                    ...
                    t.Key("mount-path", default=None): t.Null
                    ...
                    t.Key("coredump", default=coredump_defaults): t.Dict(
                        {
                            ...
                            t.Key("backup-count", default=coredump_defaults["backup-count"]): t.Int[
                                1:
                            ],
                            t.Key(
                                "size-limit", default=coredump_defaults["size-limit"]
                            ): tx.BinarySize,
                        }
                    ).allow_extra("*"),
                }
...
agent_etcd_config_iv = t.Dict(
    {
        t.Key("container-logs", default=default_container_logs_config): t.Dict(
            {
                t.Key(
                    "max-length", default=default_container_logs_config["max-length"]
                ): tx.BinarySize(),
                t.Key(
