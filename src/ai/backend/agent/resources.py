...
"""Every compute plugin, and what a container says about its own allocation.

Runtime-neutral: the intrinsic CPU/memory plugins read the cgroup hierarchy and hold no runtime
client, so this serves a node that has containerd and no Docker as well as the Docker backend.
"""
...
async def load_resources(
    ...
    # Lazily: ai.backend.agent.intrinsic imports this module.
