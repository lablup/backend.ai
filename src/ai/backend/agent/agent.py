...
class AbstractKernelCreationContext(aobject, Generic[KernelObjectType]):
    ...
    async def mount_krunner(
        ...
        korean_font_path = self.resolve_krunner_filepath("runner/nanum_barun_gothic_font.zip")
        ...
        _mount(MountTypes.BIND, korean_font_path, "/opt/kernel/nanum_barun_gothic_font.zip")
