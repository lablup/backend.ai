"""Native veth/bridge attach runner (BEP-1079) — replaces the CNI ``bridge`` plugin binary.

The BEP-1079 data plane is host-native: the session fabric (vxlan device, bridge, FDB/ARP)
