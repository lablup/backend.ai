...
class AbstractBackend(ABC):
    ...
    async def load_resources(
        ...
        """
        raise NotImplementedError("load_resources() not implemented")
    ...
    async def scan_available_resources(
        ...
        """
        raise NotImplementedError("scan_available_resources() not implemented")
    ...
    async def create_local_network(self, network_name: str) -> None:
        ...
        """
        raise NotImplementedError("create_local_network() not implemented")
    ...
    async def destroy_local_network(self, network_name: str) -> None:
        ...
        """
        raise NotImplementedError("destroy_local_network() not implemented")
