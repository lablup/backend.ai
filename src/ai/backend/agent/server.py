...
from ai.backend.agent.etcd import AsyncEtcd, EtcdClientRegistry
...
class AgentRPCServer(aobject):
    ...
    def __init__(
        ...
        *,
        ...
        self._default_agent_id = self.local_config.agent_ids[0]
    ...
    async def __ainit__(self) -> None:
        ...
        agent_configs = {
            AgentId(agent_config.agent.id): agent_config
    ...
    async def read_agent_config(self) -> AgentUnifiedConfig:
        global_etcd = self.etcd_client_registry.global_etcd
...
async def service_discovery_ctx(
    ...
    match sd_type:
        ...
        case ServiceDiscoveryType.REDIS:
            local_config = await agent_server.read_agent_config()
...
async def server_main(
    ...
    try:
        ...
        local_config = await prepare_krunner_volumes(local_config)
        ...
        await agent_init_stack.enter_async_context(
            service_discovery_ctx(local_config, global_etcd, agent_server)
        )
