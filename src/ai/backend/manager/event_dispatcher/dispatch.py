...
def _dispatch_bgtask_events(
    ...
    """
    event_dispatcher.subscribe(BgtaskUpdatedEvent, None, dispatcher.propagate_bgtask_event)
    event_dispatcher.subscribe(BgtaskDoneEvent, None, dispatcher.propagate_bgtask_event)
    event_dispatcher.subscribe(
        BgtaskPartialSuccessEvent,
        None,
        dispatcher.propagate_bgtask_event,
    )
    event_dispatcher.subscribe(BgtaskCancelledEvent, None, dispatcher.propagate_bgtask_event)
    event_dispatcher.subscribe(BgtaskFailedEvent, None, dispatcher.propagate_bgtask_event)
