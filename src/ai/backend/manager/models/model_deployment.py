...
def _get_deployment_network_binding_join_cond():
    from .deployment_network_bindings import DeploymentNetworkBindingRow

    return ModelDeploymentRow.id == foreign(DeploymentNetworkBindingRow.deployment_id)


def _get_deployment_user_join_cond():
    from .user import UserRow

    return ModelDeploymentRow.created_user_id == foreign(UserRow.id)
...
class ModelDeploymentRow(Base):
    ...
    deployment_network_binding_rows = relationship(
        "DeploymentNetworkBindingRow",
        back_populates="model_deployment_row",
