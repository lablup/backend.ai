...
class EntityScopeConditions:
    ...
    by_scope_type_match = StringConditions(
        sa.type_coerce(AssociationScopesEntitiesRow.scope_type, sa.String())
    )
    ...
    by_entity_type_match = StringConditions(
        sa.type_coerce(AssociationScopesEntitiesRow.entity_type, sa.String())
    )
