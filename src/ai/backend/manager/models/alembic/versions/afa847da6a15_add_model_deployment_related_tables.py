...
Revision ID: afa847da6a15
Revises: 345551145801
Create Date: 2025-08-25 15:38:32.072089
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("pk_deployment_network_bindings")),
    )
    op.create_table(
        "deployment_states",
        sa.Column("id", GUID(), server_default=sa.text("uuid_generate_v4()"), nullable=False),
        ...
        sa.Column("status", StrEnumType(DeploymentExecutionStatus, length=64), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table("deployment_network_bindings")
    # ### end Alembic commands ###
