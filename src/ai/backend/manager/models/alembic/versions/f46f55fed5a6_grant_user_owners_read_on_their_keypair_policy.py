"""Grant user owners READ on their keypair resource policy

The user_owner preset granted READ on the user resource policy but not on the keypair
resource policy, so a user could read one policy that applies to them and not the
other. Write the grant to the preset and to every role made from it.

Revision ID: f46f55fed5a6
...
revision = "f46f55fed5a6"  # Part of: NEXT_RELEASE_VERSION
down_revision = "c4b1f7e9a2d3"
branch_labels = None
depends_on = None


_PRESET_ID: Final[str] = "776c1366-dcf3-5abd-b8de-bc3ad3b759ad"
_ENTITY_TYPE: Final[str] = "keypair_resource_policy"
_READ: Final[int] = 1
