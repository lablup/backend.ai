...
Revision ID: 34362a3b065d
Revises: 42feff246198
Create Date: 2025-08-12 11:04:15.422229
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("scope_type", sa.VARCHAR(length=32), nullable=True),
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", name="pk_object_permissions"),
    )
    op.create_index(
    ...
    op.drop_index("ix_id_role_id", table_name="permission_groups")
