"""add target_type in auditlogs

Revision ID: 4386103828ed
Revises: 18d8eddd6be5
Create Date: 2022-08-31 15:39:49.002678
...
def upgrade():
    ...
    sa.Column('target_type', sa.Enum('user', 'keypairs', 'vfolder', name='auditlogs_targettype'), nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('kernels', sa.Column('status_history', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True))
