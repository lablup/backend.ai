"""Grant domain members READ on their domain

The domain_member preset held no grant on the domain itself, so reading a domain was
open on login alone. Write the grant to the preset and to every role made from it.

Revision ID: c4a71e0d5b38
