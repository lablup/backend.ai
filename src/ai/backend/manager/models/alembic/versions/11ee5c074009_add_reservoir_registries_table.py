...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_reservoir_registries_name"), "reservoir_registries", ["name"], unique=True
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_reservoir_registries_name"), table_name="reservoir_registries")
