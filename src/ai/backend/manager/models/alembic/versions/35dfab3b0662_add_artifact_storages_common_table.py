...
def _migrate_object_storages_to_artifact_storages(
    ...
    if not inspector.has_table("object_storages"):
        return
...
def _migrate_vfs_storages_to_artifact_storages(
    ...
    if not inspector.has_table("vfs_storages"):
        return
...
def _migrate_artifact_storages_to_object_storages(
    ...
    if not inspector.has_table("artifact_storages"):
        return
...
def upgrade() -> None:
    ...
    _migrate_object_storages_to_artifact_storages(conn, inspector)
    _migrate_vfs_storages_to_artifact_storages(conn, inspector)
...
def downgrade() -> None:
    ...
    _migrate_artifact_storages_to_object_storages(conn, inspector)
    ...
    _migrate_artifact_storages_to_vfs_storages(conn, inspector)
