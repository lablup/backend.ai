...
def upgrade():
    ...
    op.create_foreign_key(op.f('fk_kernels_group_id_groups'),
                          'kernels', 'groups', ['group_id'], ['id'])
    op.create_foreign_key(op.f('fk_kernels_user_uuid_users'),
                          'kernels', 'users', ['user_uuid'], ['uuid'])
    op.create_foreign_key(op.f('fk_kernels_domain_name_domains'),
                          'kernels', 'domains', ['domain_name'], ['name'])
