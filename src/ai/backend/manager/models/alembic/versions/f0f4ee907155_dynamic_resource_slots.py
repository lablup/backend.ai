...
def upgrade():
    ...
    op.add_column('agents', sa.Column('available_slots', postgresql.JSONB(),
                                      nullable=False,
                                      server_default=sa.text("'{}'::jsonb")))
    op.add_column('agents', sa.Column('occupied_slots', postgresql.JSONB(),
                                      nullable=False,
                                      server_default=sa.text("'{}'::jsonb")))
    query = '''
    ...
    op.add_column('kernels', sa.Column('occupied_slots', postgresql.JSONB(),
                                       nullable=False,
                                       server_default=sa.text("'{}'::jsonb")))
    op.add_column('kernels', sa.Column('occupied_shares', postgresql.JSONB(),
                                       nullable=False,
                                       server_default=sa.text("'{}'::jsonb")))
    query = '''
...
def downgrade():
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('kernels', sa.Column('cpu_set', postgresql.ARRAY(sa.INTEGER()),
                                       autoincrement=False, nullable=True))
    op.add_column('kernels', sa.Column('gpu_set', postgresql.ARRAY(sa.INTEGER()),
                                       autoincrement=False, nullable=True))
    op.add_column('kernels', sa.Column('tpu_set', postgresql.ARRAY(sa.INTEGER()),
                                       autoincrement=False, nullable=True))
    op.add_column('kernels', sa.Column('cpu_slot',
                                       postgresql.DOUBLE_PRECISION(precision=53),
                                       autoincrement=False, nullable=False,
                                       server_default='0'))
    op.add_column('kernels', sa.Column('mem_slot', sa.BIGINT(),
                                       autoincrement=False, nullable=False,
                                       server_default='0'))
    op.add_column('kernels', sa.Column('gpu_slot',
                                       postgresql.DOUBLE_PRECISION(precision=53),
                                       autoincrement=False, nullable=False,
                                       server_default='0'))
    op.add_column('kernels', sa.Column('tpu_slot',
                                       postgresql.DOUBLE_PRECISION(precision=53),
                                       autoincrement=False, nullable=False,
                                       server_default='0'))
    query = '''
    ...
    op.add_column('agents', sa.Column('gpu_slots',
                                      postgresql.DOUBLE_PRECISION(precision=53),
                                      autoincrement=False, nullable=False,
                                      server_default='0'))
    op.add_column('agents', sa.Column('used_cpu_slots',
                                      postgresql.DOUBLE_PRECISION(precision=53),
                                      autoincrement=False, nullable=False,
                                      server_default='0'))
    op.add_column('agents', sa.Column('tpu_slots',
                                      postgresql.DOUBLE_PRECISION(precision=53),
                                      autoincrement=False, nullable=False,
                                      server_default='0'))
    op.add_column('agents', sa.Column('used_mem_slots', sa.BIGINT(),
                                      autoincrement=False, nullable=False,
                                      server_default='0'))
    op.add_column('agents', sa.Column('cpu_slots',
                                      postgresql.DOUBLE_PRECISION(precision=53),
                                      autoincrement=False, nullable=False,
                                      server_default='0'))
    op.add_column('agents', sa.Column('used_gpu_slots',
                                      postgresql.DOUBLE_PRECISION(precision=53),
                                      autoincrement=False, nullable=False,
                                      server_default='0'))
    op.add_column('agents', sa.Column('mem_slots', sa.BIGINT(),
                                      autoincrement=False, nullable=False,
                                      server_default='0'))
    op.add_column('agents', sa.Column('used_tpu_slots',
                                      postgresql.DOUBLE_PRECISION(precision=53),
                                      autoincrement=False, nullable=False,
                                      server_default='0'))
    query = '''
