"""migrate_artifact_data_to_rbac

Revision ID: 67f5338ff571
Revises: a4289ef5f0cd
Create Date: 2025-12-22 15:21:10.123456
...
def _add_entity_typed_permission_to_permission_groups(
    ...
    return [
        (permission_group.id, EntityType.ARTIFACT.value, operation.value)
        for operation in operations
    ]


def _migrate_new_entity_type(db_conn: Connection) -> None:
    """Add ARTIFACT entity type permissions to all permission groups."""
    offset = 0
