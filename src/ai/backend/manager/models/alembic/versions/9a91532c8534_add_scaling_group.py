...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['scaling_group'], ['scaling_groups.name'],
    ...
    op.create_index(op.f('ix_sgroups_for_domains_domain'),
                    'sgroups_for_domains', ['domain'], unique=False)
    op.create_index(op.f('ix_sgroups_for_domains_scaling_group'),
                    'sgroups_for_domains', ['scaling_group'], unique=False)
    op.create_table(
        'sgroups_for_groups',
        sa.Column('scaling_group', sa.String(length=64), nullable=False),
    ...
    op.create_index(op.f('ix_sgroups_for_groups_group'),
                    'sgroups_for_groups', ['group'], unique=False)
    op.create_index(op.f('ix_sgroups_for_groups_scaling_group'),
                    'sgroups_for_groups', ['scaling_group'], unique=False)
    op.create_table(
    ...
    op.create_index(op.f('ix_sgroups_for_keypairs_access_key'), 'sgroups_for_keypairs', ['access_key'], unique=False)
    op.create_index(op.f('ix_sgroups_for_keypairs_scaling_group'), 'sgroups_for_keypairs', ['scaling_group'], unique=False)
