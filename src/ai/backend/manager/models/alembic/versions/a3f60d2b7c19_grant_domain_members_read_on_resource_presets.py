"""Grant domain members READ on resource presets

A preset bound to a resource group is read at that group's scope, which a domain member
reaches through the relation between their domain and the group. The grant was missing,
so the read answered nothing. Write it to the preset and to every role made from it.

Revision ID: a3f60d2b7c19
Revises: f1c47b92e3a6
...
revision = "a3f60d2b7c19"  # Part of: NEXT_RELEASE_VERSION
down_revision = "f1c47b92e3a6"
branch_labels = None
depends_on = None


_PRESET_ID: Final[str] = "76616aa7-6597-5b11-8629-adff5d5640c2"
_ENTITY_TYPE: Final[str] = "resource_preset"
_READ: Final[int] = 1
