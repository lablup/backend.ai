...
def _get_model_revision_deployment_join_cond():
    ...
    return ModelRevisionRow.model_deployment_id == foreign(ModelDeploymentRow.id)


def _get_model_vfolder_revision_join_cond():
    from .vfolder import VFolderRow

    return ModelRevisionRow.model_vfolder_id == foreign(VFolderRow.id)


def _get_image_revision_join_cond():
    from .image import ImageRow

    return ModelRevisionRow.image_id == foreign(ImageRow.id)
