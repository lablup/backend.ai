...
_queryfilter_fieldspec: FieldSpecType = {
    "id": ("id", None),
    "type": ("session_type", SessionTypes.from_str),
    "name": ("name", None),
    ...
    "cluster_mode": ("cluster_mode", ClusterMode.from_str),
    "cluster_size": ("cluster_size", None),
    "status": ("status", SessionStatus.from_str),
    "status_info": ("status_info", None),
    "result": ("result", SessionResult.from_str),
...
class ComputeSession(graphene.ObjectType):
    ...
    _queryfilter_fieldspec: FieldSpecType = {
        "id": ("sessions_id", None),
        "type": ("sessions_session_type", SessionTypes.from_str),
        ...
        "cluster_mode": ("sessions_cluster_mode", ClusterMode.from_str),
        "cluster_size": ("sessions_cluster_size", None),
        "status": ("sessions_status", SessionStatus.from_str),
        "status_info": ("sessions_status_info", None),
        "result": ("sessions_result", SessionResult.from_str),
