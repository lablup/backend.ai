...
class ScalingGroupForDomainRow(Base):
    ...
    # scaling_group_row = relationship("ScalingGroupRow", back_populates="scaling_groups")
    # domain_row = relationship("DomainRow", back_populates="domains")
...
class ScalingGroupForProjectRow(Base):
    ...
    # scaling_group_row = relationship("ScalingGroupRow", back_populates="scaling_groups")
    # project_row = relationship("GroupRow", back_populates="groups")
...
class ScalingGroupForKeypairsRow(Base):
    ...
    # scaling_group_row = relationship("ScalingGroupRow", back_populates="scaling_groups")
    # keypair_row = relationship("KeyPairRow", back_populates="keypairs")
