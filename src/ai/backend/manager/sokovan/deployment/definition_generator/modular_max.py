...
class ModularMAXModelDefinitionGenerator(ModelDefinitionGenerator):
    """Model definition generator implementation for Modular MAX runtime variant."""

    @override
    async def generate_model_definition(self, context: ModelDefinitionContext) -> ModelDefinition:
        runtime_profile = MODEL_SERVICE_RUNTIME_PROFILES["modular-max"]
