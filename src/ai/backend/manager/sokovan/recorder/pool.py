...
class RecordPool(Generic[EntityIdT]):
    ...
    and shared phases that apply to all entities.
    ...
    def __init__(
        ...
        self._shared_phases: list[PhaseRecord] = []
        self._current_shared_phase: Optional[_SharedPhaseContext] = None
    ...
    def _build_all_records(self) -> None:
        ...
        build_data = RecordBuildData(
            ...
            ended_at=ended_at,
            shared_phases=self._shared_phases,
        )
