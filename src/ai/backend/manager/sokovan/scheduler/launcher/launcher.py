            ...
            async def create_kernels_on_agent(
                ...
                for idx, k in enumerate(agent_kernels):
                    ...
                    kernel_config: KernelCreationConfig = {
                        ...
                        # BEP-1078: manager-assigned overlay IP (multi-node), else None.
    ...
    async def _setup_network_configuration(
        ...
        if network_type == NetworkType.PERSISTENT:
            ...
            if session.cluster_mode == ClusterMode.SINGLE_NODE and len(session.kernels) > 1:
                ...
                # runtime-neutral plugins (BEP-1078 CNINetworkPlugin) can select and
                ...
                # (BEP-1078 central IPAM). container_id == kernel_id (the agent keys its
                ...
                endpoints = [
                    {
                        ...
                        # resolver can answer this kernel's hostname (BEP-1078).
