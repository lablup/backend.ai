...
class EmptyOperation(BackendAIError, web.HTTPBadRequest):
    error_type = "https://api.backend.ai/probs/empty-object-operation"
    error_title = "At least one operation must be specified when adding a permission."
