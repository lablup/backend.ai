...
@dataclass
class ResourceGroupNetworkConfig:
...
@dataclass
class ResourceGroupDriverConfig:
...
@dataclass
class ResourceGroupSchedulerOptions:
...
@dataclass
class ResourceGroupSchedulerConfig:
...
class FairShareResourceGroupSpec(BackendAISchema):
...
@dataclass
class ResourceGroupData(EntityData):
    id: ResourceGroupID
    name: str
