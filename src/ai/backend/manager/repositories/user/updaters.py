"""UpdaterSpec implementations for user repository."""
...
@dataclass
class UserUpdaterSpec(UpdaterSpec[UserRow]):
    """UpdaterSpec for user updates.

    Note: User updates use email as the lookup key and have complex validation logic
    in the repository, so this spec is used with custom db_source logic.
    """
