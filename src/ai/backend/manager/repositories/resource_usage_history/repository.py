...
class ResourceUsageHistoryRepository:
    ...
    async def get_decayed_usage_by_domain(
        ...
        """
        return await self._db_source.get_decayed_usage_by_domain(
            resource_group, today, half_life_days, lookback_days
        )
    ...
    async def get_decayed_usage_by_project(
        ...
        """
        return await self._db_source.get_decayed_usage_by_project(
            resource_group, today, half_life_days, lookback_days
        )
    ...
    async def get_decayed_usage_by_user(
        ...
        """
        return await self._db_source.get_decayed_usage_by_user(
            resource_group, today, half_life_days, lookback_days
        )
