...
from ai.backend.common.data.entity.manager_admin import ManagerAdminFieldType
...
def create_processors(
    ...
    processors = Processors(
        ...
        etcd_config=EtcdConfigProcessors(
            system_groups.dangling_field_group(FieldGroupMeta(EtcdConfigFieldType())),
            services.etcd_config,
        ),
        ...
        manager_admin=ManagerAdminProcessors(
            system_groups.dangling_field_group(FieldGroupMeta(ManagerAdminFieldType())),
            services.manager_admin,
        ),
        ...
        auth=AuthProcessors(
            organization_groups.dangling_field_group(FieldGroupMeta(AuthFieldType())),
            organization_groups.group(GroupMeta(UserEntityType())),
            services.auth,
        ),
