...
class ErrorLogProcessors:
    ...
    scoped_search: BulkActionProcessor[SearchErrorLogsAction, ScopedFieldsOpsResult[ErrorLogData]]
    ...
    def __init__(self, logs: LookupFieldGroup[ErrorLogData]) -> None:
        ...
        self.scoped_search = logs.atomic_bulk_scoped_search_ops(SearchErrorLogsAction)
