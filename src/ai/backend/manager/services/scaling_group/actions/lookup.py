...
from ai.backend.manager.models.scaling_group.lookups import ResourceGroupNameLookup
...
@dataclass
class LookupResourceGroupAction(LookupEntityOpsAction[ScalingGroupRow, ScalingGroupData]):
