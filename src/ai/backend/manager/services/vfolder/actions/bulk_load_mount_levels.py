...
class BulkLoadVFolderMountLevelsAction(BasePartialBulkAction):
    """Read the mount level the caller gets on each vfolder named."""
    ...
    def action_name(cls) -> str:
        return "bulk_load_vfolder_mount_levels"
