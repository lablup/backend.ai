...
@dataclass
class AdminSearchAppConfigDefinitionsAction(AppConfigDefinitionScopeAction):
...
@dataclass
class AdminSearchAppConfigDefinitionsActionResult(AppConfigDefinitionScopeActionResult):
