...
from ai.backend.manager.services.resource_group.actions.base import ResourceGroupGlobalAction


@dataclass(frozen=True)
class ResolveResourceGroupIDsByNamesAction(ResourceGroupGlobalAction):
