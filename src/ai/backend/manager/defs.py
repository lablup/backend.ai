...
class LockID(enum.IntEnum):
    ...
    LOCKID_SOKOVAN_SCHEDULE_TIMER = 201
    LOCKID_SOKOVAN_CHECK_PRECOND_TIMER = 202
    LOCKID_SOKOVAN_START_TIMER = 203
    LOCKID_SOKOVAN_TERMINATE_TIMER = 205
    LOCKID_SOKOVAN_SWEEP_TIMER = 206
    LOCKID_SOKOVAN_CHECK_PULLING_PROGRESS_TIMER = 207
    LOCKID_SOKOVAN_CHECK_CREATING_PROGRESS_TIMER = 208
    LOCKID_SOKOVAN_CHECK_TERMINATING_PROGRESS_TIMER = 209
