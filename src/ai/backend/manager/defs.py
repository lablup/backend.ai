...
class LockID(enum.IntEnum):
    ...
    LOCKID_SOKOVAN_SCHEDULE_IF_NEEDED_TIMER = 201
    LOCKID_SOKOVAN_SCHEDULE_PROCESS_TIMER = 202
    LOCKID_SOKOVAN_CHECK_PRECOND_IF_NEEDED_TIMER = 203
    LOCKID_SOKOVAN_CHECK_PRECOND_PROCESS_TIMER = 204
    LOCKID_SOKOVAN_START_IF_NEEDED_TIMER = 205
    LOCKID_SOKOVAN_START_PROCESS_TIMER = 206
    LOCKID_SOKOVAN_TERMINATE_IF_NEEDED_TIMER = 207
    LOCKID_SOKOVAN_TERMINATE_PROCESS_TIMER = 208
