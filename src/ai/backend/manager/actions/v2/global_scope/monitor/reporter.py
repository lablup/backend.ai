...
__all__ = ("GlobalActionReporterMonitor",)


class GlobalActionReporterMonitor(GlobalActionMonitor):
    """Reports the start and end of a global action run to the reporter hub."""
