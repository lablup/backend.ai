...
class ModelDeploymentGrantAllRBACAction(BaseRBACAction):
    @classmethod
    @override
    def action_name(cls) -> RBACActionName:
    ...
    @override
    def required_permission(cls) -> RBACRequiredPermission:
        return RBACRequiredPermission(RBACElementType.MODEL_DEPLOYMENT, OperationType.GRANT_ALL)


class ModelDeploymentGrantReadRBACAction(BaseRBACAction):
    @classmethod
    @override
    def action_name(cls) -> RBACActionName:
    ...
    @override
    def required_permission(cls) -> RBACRequiredPermission:
        return RBACRequiredPermission(RBACElementType.MODEL_DEPLOYMENT, OperationType.GRANT_READ)


class ModelDeploymentGrantUpdateRBACAction(BaseRBACAction):
    @classmethod
    @override
    def action_name(cls) -> RBACActionName:
    ...
    @override
    def required_permission(cls) -> RBACRequiredPermission:
        return RBACRequiredPermission(RBACElementType.MODEL_DEPLOYMENT, OperationType.GRANT_UPDATE)


class ModelDeploymentGrantHardDeleteRBACAction(BaseRBACAction):
    @classmethod
    @override
    def action_name(cls) -> RBACActionName:
    ...
    @override
    def required_permission(cls) -> RBACRequiredPermission:
        return RBACRequiredPermission(
            RBACElementType.MODEL_DEPLOYMENT, OperationType.GRANT_HARD_DELETE
        )
