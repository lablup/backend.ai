...
async def _handle_gql_common(request: web.Request, params: Any) -> ExecutionResult:
    ...
    max_depth = cast(int | None, root_ctx.unified_config.config.api.max_gql_query_depth)
...
async def init(app: web.Application) -> None:
    ...
    if root_ctx.unified_config.config.api.allow_graphql_schema_introspection:
        log.warning(
