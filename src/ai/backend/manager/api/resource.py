...
def create_app(
    ...
    cors.add(add_route("POST", "/usage/month", usage_per_month))
    cors.add(add_route("POST", "/usage/period", usage_per_period))
    cors.add(add_route("POST", "/stats/user/month", user_month_stats))
    cors.add(add_route("POST", "/stats/admin/month", admin_month_stats))
    cors.add(add_route("GET", "/watcher", get_watcher_status))
    cors.add(add_route("POST", "/watcher", get_watcher_status))
