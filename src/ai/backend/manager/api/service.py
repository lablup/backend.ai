...
@pydantic_request_body(ListServeRequestModel)
...
@pydantic_request_body(NewServiceRequestModel)
...
@auth_required
@server_status_required(READ_ALLOWED)
@pydantic_request_body(ScaleRequestModel)
...
@auth_required
@server_status_required(READ_ALLOWED)
@pydantic_request_body(UpdateRouteRequestModel)
...
@auth_required
@server_status_required(READ_ALLOWED)
@pydantic_request_body(TokenRequestModel)
