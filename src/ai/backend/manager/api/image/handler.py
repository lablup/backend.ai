"""Backward-compatibility shim for the image module.

All image handler logic has been migrated to:

* ``api.rest.image.handler`` — ImageHandler (constructor DI)
* ``api.rest.image`` — register_routes()
