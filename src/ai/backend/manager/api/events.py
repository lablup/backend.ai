...
async def events_app_ctx(app: web.Application) -> AsyncIterator[None]:
    ...
    event_dispatcher.subscribe(SessionScheduledBroadcastEvent, app, _propagate_events)
    ...
    event_dispatcher.subscribe(SessionStartedBroadcastEvent, app, _propagate_events)
