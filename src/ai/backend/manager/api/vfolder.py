...
async def resolve_vfolder_rows(
    ...
    *,
    ...
    allowed_vfolder_types = await root_ctx.unified_config.shared_config_loader.get_vfolder_types()
    vf_user_cond = None
    vf_group_cond = None
...
async def list_hosts(request: web.Request, params: Any) -> web.Response:
    ...
    default_host = await root_ctx.unified_config.shared_config_loader.get_raw(
...
async def get_quota(request: web.Request, params: Any) -> web.Response:
    ...
    if user_role == UserRole.SUPERADMIN:
        ...
        allowed_vfolder_types = (
            await root_ctx.unified_config.shared_config_loader.get_vfolder_types()
        )
        async with root_ctx.db.begin_readonly() as conn:
...
async def list_mounts(request: web.Request) -> web.Response:
    ...
    mount_prefix = await root_ctx.unified_config.shared_config_loader.get_raw("volumes/_mount")
