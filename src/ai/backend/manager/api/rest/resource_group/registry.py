"""Resource group module registrar."""
...
from .handler import ResourceGroupHandler

if TYPE_CHECKING:
    from ai.backend.manager.api.rest.types import RouteDeps


def register_resource_group_routes(
    handler: ResourceGroupHandler, route_deps: RouteDeps
) -> RouteRegistry:
    """Build the resource group sub-application."""
