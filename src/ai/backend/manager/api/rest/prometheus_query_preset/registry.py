...
def register_prometheus_query_preset_routes(
    ...
    reg = RouteRegistry.create("resource/prometheus-query-presets", route_deps.cors_options)
    ...
    reg.add("POST", "/{id}/execute", handler.execute_preset, middlewares=[auth_required])
