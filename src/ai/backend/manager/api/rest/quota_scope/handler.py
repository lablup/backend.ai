...
class QuotaScopeHandler:
    ...
    async def get(
        ...
        result = await self._vfs_storage.get_quota_scope.run(
            GetQuotaScopeAction(
    ...
    async def search(
        ...
        result = await self._vfs_storage.search_quota_scopes.run(SearchQuotaScopesAction())
        quota_scopes = [
            QuotaScopeDTO(
    ...
    async def set_quota(
        ...
        result = await self._vfs_storage.set_quota_scope.run(
            SetQuotaScopeAction(
    ...
    async def unset_quota(
        ...
        result = await self._vfs_storage.unset_quota_scope.run(
