...
class Query:
    ...
    admin_replica_group_scheduling_histories = admin_replica_group_scheduling_histories
    ...
    scoped_replica_group_scheduling_histories = scoped_replica_group_scheduling_histories
