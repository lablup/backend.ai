...
EntityTypeGQL: type[EntityType] = strawberry.enum(
    EntityType,
    name="EntityType",
    description="Added in 26.2.0. Entity types managed by the RBAC system",
)

OperationTypeGQL: type[OperationType] = strawberry.enum(
    OperationType,
    name="OperationType",
    description="Added in 26.2.0. Operations that can be performed on entities",
)

ScopeTypeGQL: type[ScopeType] = strawberry.enum(
    ScopeType,
    name="ScopeType",
    description="Added in 26.2.0. Scope types in the permission hierarchy",
)
...
@strawberry.enum(
    name="RoleOrderField",
    description="Added in 26.2.0. Fields available for ordering role queries",
)
...
@strawberry.enum(
    ...
    description="Added in 26.2.0. Fields available for ordering scoped permission queries",
)
...
@strawberry.enum(
    ...
    description="Added in 26.2.0. Fields available for ordering object permission queries",
)
