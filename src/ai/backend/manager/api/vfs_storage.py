"""Backward-compatibility shim for the VFS storage module.

All VFS storage handler logic has been migrated to:

* ``api.rest.vfs_storage`` — VFSStorageHandler + register_routes()
