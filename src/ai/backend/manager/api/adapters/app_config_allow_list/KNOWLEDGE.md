...
type: reference
description: TODO - what the app config allow list adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/app_config_allow_list
keywords: [app config allow list, scenario, adapter, todo]
generated:
