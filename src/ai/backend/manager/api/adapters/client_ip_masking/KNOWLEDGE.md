...
type: reference
description: TODO - what the client ip masking adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/client_ip_masking
keywords: [client ip masking, scenario, adapter, todo]
generated:
