...
type: reference
description: TODO - what the app config definition adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/app_config_definition
keywords: [app config definition, scenario, adapter, todo]
generated:
