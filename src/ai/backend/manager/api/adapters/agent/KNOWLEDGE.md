---
name: agent-adapter-scenarios
type: reference
description: TODO - what the agent adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/agent
keywords: [agent, scenario, adapter, todo]
generated:
