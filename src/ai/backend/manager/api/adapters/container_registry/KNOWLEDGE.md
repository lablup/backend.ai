...
type: reference
description: TODO - what the container registry adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/container_registry
keywords: [container registry, scenario, adapter, todo]
generated:
