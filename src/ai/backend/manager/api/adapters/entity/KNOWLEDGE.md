---
name: entity-adapter-scenarios
type: reference
description: TODO - what the entity adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/entity
keywords: [entity, scenario, adapter, todo]
generated:
