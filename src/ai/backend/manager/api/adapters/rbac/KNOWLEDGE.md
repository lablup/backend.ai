---
name: rbac-adapter-scenarios
type: reference
description: TODO - what the rbac adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/rbac
keywords: [rbac, scenario, adapter, todo]
generated:
