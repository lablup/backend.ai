...
type: reference
description: TODO - what the app config fragment adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/app_config_fragment
keywords: [app config fragment, scenario, adapter, todo]
generated:
