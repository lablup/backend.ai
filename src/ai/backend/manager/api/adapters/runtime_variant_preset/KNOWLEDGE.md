...
type: reference
description: TODO - what the runtime variant preset adapter guarantees, as scenarios; nobody has written these yet
scope: src/ai/backend/manager/api/adapters/runtime_variant_preset
keywords: [runtime variant preset, scenario, adapter, todo]
generated:
