...
from ai.backend.storage.abc import CAP_FAST_FOLDER_SIZE, CAP_FAST_SCAN, CAP_QUOTA, CAP_VFOLDER
...
class XfsVolume(BaseVolume):
    ...
    async def get_capabilities(self) -> FrozenSet[str]:
        return frozenset([CAP_VFOLDER, CAP_QUOTA, CAP_FAST_SCAN, CAP_FAST_FOLDER_SIZE])
